...
Die Check API stellt eine Registrierungsfunktion für Check-Plugins bereit (Beispiele in der 
//link:checkapisummary.html[Zusammenfassung]).
Zusammenfassung.
...
Siehe xref:checkapidraft#cluster[Clusterkompatibilität].
