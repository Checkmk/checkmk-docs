...
Wählen Sie nun [.guihint]#Issues}} und navigieren Sie im Abschnitt {{Fields# zu
[.guihint]#Custom Fields.}} Über {{Add Custom Field# können Sie ein neues,
...
`jira.server.your-domain.com`. Bei [.guihint]#User Name}} und {{Password# hinterlegen
Sie den Benutzernamen und das Passwort für den Zugriff.

Jetzt benötigen Sie die vorher ermittelten IDs für die Felder
[.guihint]#Project ID}} und {{Issue type ID.#
Die IDs der in Jira angelegten, benutzerdefinierten Felder tragen Sie
entsprechend unter [.guihint]#Host custom field ID}} und {{Service custom field ID#
ein.
...
[.guihint]#Summary for host notifications}} und {{Summary for service notifications#
ändern.
