...
Sollten nach der Einrichtung der Benachrichtigungsregel in {CMK} keine Tickets in Jira ankommen, prüfen Sie die entsprechende Log-Datei unter `~/var/log/notify.log`. 
