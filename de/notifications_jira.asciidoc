...
:description: Die neue Jira-Integration von {CMK} ermöglicht das Erstellen und Schließen von Issues aus der Monitoring-Lösung heraus.
...
Projektmanagement verwenden, können Sie mit den {CEE} Alarmierungen aus {CMK}
heraus an Jira senden.
