...
// IGNORE Balancer Piggyhosts Ratelimit Ressourcegruppen Subskriptions aufpoppenden mk + 25% 50%
...
Neben den allgemeinen Informationen zu den Kosten Ihrer Azure-Umgebung und dem aktuellen Status der link:https://checkmk.com/de/integrations/azure_status[Azure-Dienste in Ihrer Region^], können Sie mit allen Editionen von {CMK} die folgenden Microsoft Azure-Produkte überwachen:

* link:https://checkmk.com/de/integrations?distributions%5B%5D=check_mk&distributions%5B%5D=check_mk_cloud&search=azure_ad[AD Connect^]
* link:https://checkmk.com/de/integrations?distributions%5B%5D=check_mk&distributions%5B%5D=check_mk_cloud&search=azure_vm[Azure Virtual Machines^]
...
* link:https://checkmk.com/de/integrations?distributions%5B%5D=check_mk&distributions%5B%5D=check_mk_cloud&search=azure_databases[SQL Databases^]
...
* link:https://checkmk.com/de/integrations?distributions%5B%5D=check_mk&distributions%5B%5D=check_mk_cloud&search=azure_app_gateway[Application Gateway^]
* link:https://checkmk.com/de/integrations/azure_vault_backup_containers[Recovery Services vaults^]

Eine vollständige Auflistung aller verfügbaren Check-Plugins für die Überwachung von Azure finden Sie in unserem link:https://checkmk.com/de/integrations?tags=azure[Katalog der Check-Plugins^].
...
Sie überwachen möchten. Wenn Sie [.guihint]#explicitly specified groups# *nicht*
