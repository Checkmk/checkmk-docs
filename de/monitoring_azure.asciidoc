...
Sie die Auswahl [.guihint]#My apps}} auf {{All apps# um. In den Details der App
finden Sie auch die [.guihint]#Application-ID}}, welche Sie später benötigen. Die {{Object-ID#
ist nicht notwendig.
...
Seite den Punkt [.guihint]#All resources}} und hierin den Punkt {{Subscriptions#:

image::azure_subscriptions.png[]

In der Navigation dieser Seite gehen Sie auf [.guihint]#Access Control (IAM)# und dort
auf [.guihint]#Add}} und {{Add role assignment#:

image::azure_access_control.png[]

Tragen Sie nun die Rolle [.guihint]#Reader}}, bei {{Assign access to# den Wert
[.guihint]#Azure AD user, group, or service principal}} und bei {{Select# den Namen
Ihrer neuen App ein:
...
[.guihint]#Certificates & secrets}} an. Der Eintrag dazu heißt {{Client secrets#.
...
selbst), müssen Sie die [.guihint]#IP Address Family}} auf auf {{No IP# einstellen.
