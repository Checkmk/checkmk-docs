...
* link:https://checkmk.de/cms_check_azure_agent_info.html.html[Microsoft Azure Agent Info]
* link:https://checkmk.de/cms_check_azure_databases.html.html[Microsoft Azure SQL Databases]
* link:https://checkmk.de/cms_check_azure_databases.cpu.html.html[Microsoft Azure SQL Databases: CPU utilization]
* link:https://checkmk.de/cms_check_azure_databases.connections.html.html[Microsoft Azure SQL Databases: Connections]
* link:https://checkmk.de/cms_check_azure_databases.deadlock.html.html[Microsoft Azure SQL Databases: Deadlocks]
* link:https://checkmk.de/cms_check_azure_databases.storage.html.html[Microsoft Azure SQL Databases: Storage]
* link:https://checkmk.de/cms_check_azure_databases.dtu.html.html[Microsoft Azure SQL Databases: Throughput units]
* link:https://checkmk.de/cms_check_azure_storageaccounts.html.html[Microsoft Azure Storage Accounts]
* link:https://checkmk.de/cms_check_azure_storageaccounts.flow.html.html[Microsoft Azure Storage Accounts: Data flow]
* link:https://checkmk.de/cms_check_azure_storageaccounts.performance.html.html[Microsoft Azure Storage Accounts: Performance]
* link:https://checkmk.de/cms_check_azure_virtualmachines.html.html[Microsoft Azure Virtual Machines]
* link:https://checkmk.de/cms_check_azure_virtualmachines.summary.html.html[Microsoft Azure Virtual Machines: Summary]
* link:https://checkmk.de/cms_check_azure_virtualnetworkgateways.html.html[Microsoft Azure Virtual Network Gateways]
* link:https://checkmk.de/cms_check_azure_sites.html.html[Microsoft Azure Webserver]
