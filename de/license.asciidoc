...
Klicken Sie dann auf den Knopf icon:icon_assume_0[alt="Symbol zur Offline-Übertragung der Lizenzdaten."] [.guihint]#Offline verification.#

Sie gelangen auf die gleichnamige Seite:
...
=== {EE}
Öffnen Sie [guihint]#Setup > Maintenance > Licensing.#
Klicken Sie dann auf den Knopf icon:icon_assume_0[alt="Symbol zur Offline-Übertragung der Lizenzdaten."] [.guihint]#Submit license usage offline.#

Sie gelangen auf die Seite [.guihint]#Offline submission.#
