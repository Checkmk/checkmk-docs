...
Nutzen Sie auf der Seite [guihint]#License usage# den Knopf icon:icon_assume_0[alt="Grüner Kreis mit Haken."] [guihint]#Submit or download.#
...
Wenn Sie einen direkten Zugang zu {CMK} bei Ihrem Kunden haben, dann nutzen Sie auf der Seite [guihint]#License usage# den Knopf icon:icon_assume_0[alt="Grüner Kreis mit Haken."] [guihint]#Submit or download.#
