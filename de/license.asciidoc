...
Melden Sie sich dort mit Ihren Zugangsdaten an, um die [.guihint]#Application account credentials# zu ermitteln, die Sie im nächsten Schritt in {CMK} eintragen müssen.
...
Öffnen Sie in {CMK} als xref:wato_user#roles[{CMK}-Administrator] [.guihint]#Setup > Maintenance > License usage#.
...
Füllen Sie den Abschnitt [.guihint]#Application account credentials# mit den xref:generate_application_password[Informationen aus dem Kundenportal]. Achten Sie bitte darauf, dass Sie den [.guihint]#Application Account# als [.guihint]#Username# verwenden müssen.
