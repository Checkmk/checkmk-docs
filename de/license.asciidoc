...
Ihre Lizenzinformationen sind für Sie jederzeit transparent einsehbar und sie können diese herunterladen und manuell in das tribe29-link:https://customer.checkmk.com/[Kundenportal] hochladen.
...
Als Partner von tribe29 können Sie die Lizenzinformationen Ihrer Kunden entweder manuell aus {CMK} herunterladen und dann in das Partnerportal von tribe29 hochladen. Oder Sie lassen {CMK} den Großteil der Arbeit erledigen.
Die xref:direktübermittlung[Direktübermittlung durch {CMK}] entspricht exakt dem oben beschriebenen Vorgehen. Lediglich bei der manuellen Übermittlung gibt es kleine Unterschiede.
