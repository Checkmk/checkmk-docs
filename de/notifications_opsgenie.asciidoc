...
= Benachrichtigungen per Opsgenie (Notifications)
:revdate: 2020-08-14
...
Zum Testen können Sie das link:commands.html[Kommando] [.guihint]#Fake check results# verwenden und etwa einen Host auf {DOWN} setzen.
...
Darüber hinaus können Sie über den Punkt [.guihint]#Responsible teams# das Opsgenie-Team festlegen, wenn Sie nicht wie hier beschrieben speziell für ein Team, sondern für den gesamten Opsgenie-Acccount integriert haben -- was wiederum nur bei bestimmten Subskriptionen möglich ist.
