...
== Funktion
link:https://www.atlassian.com/software/opsgenie[Opsgenie,] mittlerweile
...
. Wählen Sie als [.guihint]#Notification Method# den Punkt [.guihint]#Opsgenie.#
...
[.guihint]#Fake check results# auf {DOWN} setzen. Die Funktion [.guihint]#Custom notification# generiert an
