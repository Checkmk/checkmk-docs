...
[.relateddoc]
basics_ackn, basics_downtimes, notifications
...
* Sie aktivieren die ICON[checkbox_checked.png] *Checkboxen*.
...
*Tipp:* In die Kommentare bei [.guihint]#Acknowledge}}, {{Downtimes# und
