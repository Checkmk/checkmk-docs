...
Führen Sie in diesem Fall das xref:#cee2cre[Downgrade nach {RE}] vor dem Update auf {v22} durch.
...
der Umstellung ein paar Dinge zu beachten. 
...
. Umschalten des Monitoring-Cores von CMC auf Nagios 3 – von dieser Änderung sind in erster Linie Performance-Nachteile zu erwarten.
