...
//[green]#pass:[*]# Installed file etc/logrotate.d/dcd
//[green]#pass:[*]# Installed file etc/init.d/cmc
//[green]#pass:[*]# Installed file etc/init.d/mknotifyd
//[green]#pass:[*]# Installed file etc/init.d/liveproxyd
//[green]#pass:[*]# Installed file etc/init.d/dcd
//[green]#pass:[*]# Installed link etc/rc.d/20-mknotifyd
//[green]#pass:[*]# Installed link etc/rc.d/85-dcd
//[green]#pass:[*]# Installed link etc/rc.d/80-cmc
//[green]#pass:[*]# Installed link etc/rc.d/20-liveproxyd
