// -*- coding: utf-8 -*-
// IGNORE Benachrichtigungs Ctrl+D XYZ p22
...
Auch die Appliance der {FE} können Sie ohne Datenverlust auf eine Vollversion einer der kommerziellen Editionen upgraden:
...
. Nun steht das Upgrade der Remote-Instanzen an. Dieses können Sie parallel durchführen und Remote-Instanzen nach dem Upgrade sofort wieder starten.
