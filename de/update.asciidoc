...
=== Update auf Major-Versionen
Bei Updates auf Major-Versionen sollten Sie immer direkt auf die nächste Version aktualisieren und nicht einfach welche überspringen.
...
Dennoch können Sie solche Updates durchführen, indem Sie den Vorgang mit der Option `-f` forcieren:
