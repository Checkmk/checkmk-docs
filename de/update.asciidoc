...
Der Funktionsumfang der {CE} ist eine echte Obermenge des Funktionsumfangs der {SE}, weshalb die größte Herausforderung in der Handhabung des unterschiedlichen xref:license#[Lizenz- und Subskriptionsmanagements] beim Upgrade der Edition liegt.
...
Diese wird dadurch in den 30 Tage laufenden Trial-Modus der {CE} versetzt.
...
Jede dieser wird nun ebenfalls in den 30 Tage laufenden Trial-Modus der {CE} versetzt.
