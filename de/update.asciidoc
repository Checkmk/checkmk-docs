...
//SP: Die beiden Sätze sind korrekt, aber ich bin dennoch gestrauchelt bei dem Wort Entfernung. Für mich hat Entfernung etwas räumliches, d.h. die Entfernung zwischen zwei Punkten beträgt x Kilometer, die Entfernung zwischen 2.2.0 und 2.1.0 beträgt eine Version. Vielleicht wäre "löschen" oder "abschaffen" (oder fällt dir noch etwas anderes ein?) klarer für das Stoppen?
