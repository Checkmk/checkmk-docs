...
*Betrifft Sie das?*
Nur, wenn bei Ihnen sehr alte Linux-Systeme im Einsatz sind (Python 2.6 ist von Oktober 2008 und wurde ab Juli 2010 von Python 2.7 abgelöst) _und_ Sie auf diesen Systemen in Python geschriebene Agenten-Plugins nutzen.
...
Aktualisierungen des Agentenskriptes sind dann manuell möglich.
Auch können Sie nach der Neuinstallation eines {v22} Agenten nicht mit Python 2.6 kompatible Plugins von Hand durch eine der {v21} entnommene Version ersetzen.
