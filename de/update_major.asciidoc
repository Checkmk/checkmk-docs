...
* _Natives Clustering_ per API-Funktion (frei Programmierbar, bspw: _80% der Nodes müssen {OK}_ sein, damit der Cluster OK ist)
...
// Dauerbrenner, siehe Kommentar von Lars G.
...
Gehen Sie hierfür in #[.guihint]Setup > General > Global Settings > Edit Global Settings# die Liste #[.guihint]Use new service descriptions# durch und identifizieren Sie die Services, bei denen die Checkbox noch nicht aktiv ist und aktivieren Sie diese.
