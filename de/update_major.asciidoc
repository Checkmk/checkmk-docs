...
*Betrifft Sie das?*
Dies betrifft Sie nur, wenn Sie für nachinstallierte Spezialagenten oder agentenbasierte Check-Plugins explizit Python-Module nachinstalliert haben.
...
*Was müssen Sie tun?*
Finden Sie zunächst heraus, ob und – wenn ja –, welche Python-Module im Site-Kontext installiert sind.
...
Testen Sie anschließend die Check-Plugins oder Spezialagenten, die auf im Site-Kontext installierte Module angewiesen sind.
