...
Während der Beta-Phase wird der Großteil der von {v21} unterstützten Distributionen weiterhin unterstützt, um Upgrades zu erleichtern.
// TK: Welches Upgrade meinst Du? Linux-Upgrade? oder CMK-Update?
...
// TK: Da ich nicht testen kann, ist nicht klar, was beim 2.2.0 Update passiert: Bleibt es bei einer Warnung oder bricht omd update ab?

Ab Version {v22} ist die Verwendung bestimmter Sonderzeichen in Benutzernamen nicht mehr zulässig.
Dies hat zur Folge, dass Benutzernamen, die bis zur {v21} noch akzeptiert wurden, in {v22} ungültig werden.
...
*Betrifft Sie das?*
Beim Erstellen lokaler Benutzer über [.guihint]#Setup > Users# hat {CMK} schon seit längerem, d.h. vor der Version {v16}, ungültige Benutzernamen abgelehnt.
// TK: seit längerem: Genauer wär schöner
