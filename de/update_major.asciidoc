...
Für Patchversionen gilt prinzipiell das gesagte: Die Zentral-Instanz darf nie einen höheren Versionsstand als die Remote-Instanzen nutzen.
...
// MFS: So besser, kleine Anpassung an Deinem Vorschlag? Und Umstellung der Reihenfolge: Man kann 2.1.0 Pakete hinzufügen, bevor auch nur eine 2.1.0 ausgerollt ist.
Um dieses Feature nutzen zu können, muß zunächst die Zentralinstanz auf Patch-Version {v20}p33 gebracht werden.
