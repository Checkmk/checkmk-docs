...
Neuere Ubuntu STS Versionen erhalten nicht mehr über den gesamten Support-Zeitraum von {CMK} {v22} Unterstützung.
Nutzern dieser Versionen geben wir jedoch die Möglichkeit, nahtlos auf die nächste LTS 24.04 zu aktualisieren.
Details entnehmen Sie bitte der xref:update_matrix#ossupport[Richtlinie zur Betriebssystemunterstützung (_OS Support Policy_)].
