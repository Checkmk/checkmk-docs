...
Die Support-Zeiträume weiterer Versionen werden während der Beta-Phase bekanntgegeben.
...
// {v20} Thema - auch gültig für {v21} + {v22}
[#local_files]
...
Mit dem link:https://checkmk.com/de/werk/13320[Werk #13320^] der Version {v21} wurde aus dieser Empfehlung eine Voraussetzung -- und eine Sperre eingeführt, die zum Beispiel ein direktes Update von Version {v20} auf {v22} verhindert.
...
Mit link:https://checkmk.com/de/werk/13313[Werk #13313^] der Version {v21} wurden Versionsprüfungen hinzugefügt, die sicherstellen, dass die beteiligten Instanzen kompatible Versionen verwenden.
Die Kurzfassung ist:
