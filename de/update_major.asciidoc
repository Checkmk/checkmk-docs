...
Allerdings sind häufig größere Abweichungen als eine Patchversion erlaubt.
Details zur konkreten Kompatibilität entnehmen Sie bitte den link:https://checkmk.com/werks/[Werks^]. 
