...
// MFS: Admin-Passwort auf der Kommandozeile finde ich so semi-optimal, evtl. besser --password weglassen und auf Interaktivität verweisen? Bonus: Spart eine Zeile im Beispiel.
...
// MFS: Durch den Bug muss vor der Aufnahme ins Monitoring zuerst Connection Test erfolgen. Sollen wir das noch hier rein schreiben oder gehen wir davon aus, dass niemand, der hier liest, mit der Beta arbeitet und sprechen in diesem Artikel ausschließlich 2.1.0 final Nutzer an?
