...
:description: {CMK} kann häufig verwendete Passwörter für Sie im Passwortspeicher ablegen. In diesem Artikel erfahren Sie, wie das geht.
...
////
URLs? (Token) des Service-Accounts 
////
...
Wählen Sie stattdessen [.guihint]#From password store#.
...
// TK: Soll das hier aus Werk 13633 hinzugefügt werden? Ich sehe den Vorteil nicht. Ausserdem weiss ich nicht, wie man den Password store neu initialisiert.
