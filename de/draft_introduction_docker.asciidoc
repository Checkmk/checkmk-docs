...
|{CEE} |link:https://checkmk.com/de/download?method=docker&edition=cce&version=stable[{CMK}-Download-Seite^] (für die {CE}), link:https://portal.checkmk.com/de/[{CMK}-Kundenportal^]
|===
