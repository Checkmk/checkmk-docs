...
:description: Das Incident-Management-System ServiceNow an Checkmk anbinden
...
. Wählen Sie als [.guihint]#Notification Method}} den Punkt {{Servicenow (Enterprise only).#
...
beiden ServiceNow-eigenen Daten [.guihint]#Urgency}} und {{Impact# finden Sie Links auf die
