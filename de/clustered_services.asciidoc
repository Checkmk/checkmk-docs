...
Schließen Sie die Erstellung mit [.guihint]#Save & go to folder# ab und link:wato.html#activate_changes[aktivieren Sie die Änderungen].
...
*Tipp:* Falls Sie link:localchecks.html[lokale Checks] in einem Cluster ausführen, in der die Regel [.guihint]#Clustered services# angewendet ist, können Sie mit dem Regelsatz [.guihint]#Local checks in {CMK} clusters# das Ergebnis beeinflussen, indem Sie zwischen [.guihint]#Worst state# und [.guihint]#Best state# auswählen.
