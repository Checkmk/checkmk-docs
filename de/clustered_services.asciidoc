...
Schließen Sie die Erstellung mit [.guihint]#Save & go to folder# ab und link:wato.html[aktivieren Sie die Änderungen].
...
Um herauszufinden, ob die Auswahl der Cluster-Services zum gewünschten Ergebnis geführt hat, können Sie sich alle Services auflisten, die nunmehr dem Cluster zugewiesen sind: Unter [.guihint]#Setup => Hosts => Hosts# klicken Sie in der Host-Liste beim Eintrag des Cluster-Hosts auf das Symbol icon:icon_services_edit[] zum Bearbeiten der Services. Auf der folgenden Seite [.guihint]#Services of host# werden unter [.guihint]#Monitored services# alle Cluster-Services aufgelistet:
...
*Tipp:* Falls Sie link:localchecks.html[lokale Checks] in einem Cluster ausführen, in der die Regel [.guihint]#Clustered services# angewendet ist, können Sie mit dem Regelsatz [.guihint]#Local checks in Checkmk clusters# das Ergebnis beeinflussen, indem Sie zwischen [.guihint]#Worst state# und [.guihint]#Best state# auswählen.
