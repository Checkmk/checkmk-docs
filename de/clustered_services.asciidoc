...
[.guihint]#WATO|Hosts}} > Klicken Sie in der Host-Liste für den Cluster-Host auf icon:icon_services[] > {{Services of host}} page. Auf dieser Seite werden unter {{Monitored services# alle Services aufgelistet, die dem Cluster zugewiesen sind.
