...
. [.guihint]#WATO|Hosts# > Cluster-Name anklicken > [.guihint]#Clustered Services|Create rule in folder# > Ordner mit den Knoten-Hosts auswählen > [.guihint]#New rule: Clustered Services# mit Screenshot: Create new cluster page mit aufgeklappter Kategorie Conditions
...
[.guihint]#WATO|Hosts# > Klicken Sie in der Host-Liste für den Cluster-Host auf icon:icon_services[] > [.guihint]#Services of host# page. Auf dieser Seite werden unter [.guihint]#Monitored services# alle Services aufgelistet, die dem Cluster zugewiesen sind.
...
. [.guihint]#WATO|Hosts# > Alle beteiligten Hosts markieren > [.guihint]#Discovery|Bulk discovery# mit Screenshot: Bulk discovery
