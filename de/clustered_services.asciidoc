...
* Cluster-Hosts können auf die gleiche Art und Weise konfiguriert werden wie „normale“ Hosts, zum Beispiel mit xref:wato_rules#hosttags[Host-Merkmalen] oder xref:wato_hosts#Hostgruppen[Host-Gruppen].
