...
link:http://nagstamon.ifw-dresden.de/[Nagstamon^] ist ein kleines Tool für den Desktop, welches ursprünglich für Monitoringsysteme mit Livestatus entwickelt wurde.
