...
[.relateddoc]
wato_monitoringagents, monitoring_azure, monitoring_aws, monitoring_kubernetes, monitoring_docker, monitoring_vmware
...
z.B. bei der Überwachung von [monitoring_aws|AWS], link:monitoring_azure.html[Azure],
[monitoring_kubernetes|Kubernetes] oder link:monitoring_docker.html[Docker]. Es
...
image::piggyback_scheme_1.png[center, width=50%]
...
image::piggyback_scheme_2.png[center, width=38%]
