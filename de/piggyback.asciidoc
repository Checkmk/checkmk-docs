...
image::piggyback_settings.png["Die Umleitung der Piggyback-Daten wird in den Agenten-Einstellungen festgelegt"]
...
image::piggyback_hostname_translation.png["Screenshot: Optionen der Hostname translation, Entfernen des Domain-Parts, Umwandlung nach Kleinbuchstaben oder explizites Mapping."]
