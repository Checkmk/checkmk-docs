...
Neben Virtualisierungsumgebungen kann der Piggyback-Mechanismus auch beim Monitoring von Mobilgeräten (MobileIron) oder dem Klima-Monitoring im Rechenzentrum (MQTT) eingesetzt werden.
