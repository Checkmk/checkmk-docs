...
image::sidebar_add_snapin2.png[center, width=300]
//hilite:78,50,16,33
...
[.guihint]#ID}} tragen Sie den internen Namen {{myautomap}} und bei {{Alias# Namen
...
Hier vergeben Sie unter [.guihint]#Create Map}} den Namen {{mymap# und den
Alias [.guihint]#My Map}}. Als {{Map Type}} wählen Sie {{Regular map# und bestätigen
...
öffnet sich der [.guihint]#Create Object}}-Dialog. Im Reiter {{General# wählen
...
[.guihint]#event_on_load}} und setzen Sie ein Häkchen ganz unten bei {{event_sound#,
...
[.guihint]#Worldmaps}}, die _nicht-interaktiven_ Varianten {{Geomaps#. Worldmaps
...
[.guihint]#Options|Manage Maps|Create Map}} an. Als {{Map Type# wählen Sie den
Eintrag [.guihint]#Geographical Map (interactive)#. Vergeben Sie auch hier wieder
ID [.guihint]#(mygeomap)}} und Alias {{(My Geographical Map)#.
...
[.guihint]#Edit Map|Viewport|Save as new map}} als neue Karte {{mygeomap_nrw#.
...
[.guihint]#Create Object}}-Dialog müssen Sie lediglich die Karte {{mygeomap_nrw#
...
[.guihint]#Options|Manage Maps|Create Map}} und vergeben ID {{(mydynamicmap)# und
...
wird in der Spalte [.guihint]#description}} nach dem String {{CPU load# gesucht. Das
...
[.guihint]#view_type}} auf {{line}}. Als {{line_type# aktivieren Sie die Variante
...
Wechseln Sie zum Reiter [.guihint]#Appearance}} und setzen Sie {{view_type#
auf [.guihint]#gadget}}. Direkt darunter aktivieren Sie {{gadget_url#. Hier
...
Im Reiter [.guihint]#General}} setzen Sie den {{view_type# auf
[.guihint]#iframe}}. Die eigentliche Arbeit steckt in der Option {{url#:
...
zu definieren. Hier den Pool [.guihint]#myrotation}} mit den Karten {{mymap1#,
[.guihint]#mymap3}} und {{mymap# sowie einem Intervall von 30 Sekunden:
