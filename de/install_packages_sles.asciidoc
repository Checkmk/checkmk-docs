...
:description: Jede Linux-Distribution hat ihre Besonderheiten, die bei der Installation von {CMK} zu beachten sind. Hier erfahren Sie, was bei SLES notwendig ist.
...
[{shell}]
----
{c-root} scp check-mk-raw-2.0.0p3-sles15-38.x86_64.rpm root@mymonitoring.mydomain.org:
----
...
[{shell}]
----
{c-root} rpm -K check-mk-raw-2.0.0p3-sles15-38.x86_64.rpm
check-mk-raw-2.0.0p3-sles15-38.x86_64.rpm: digests signatures OK
{c-root} zypper install check-mk-raw-2.0.0p3-sles15-38.x86_64.rpm
----
