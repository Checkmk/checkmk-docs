...
////
SP: Bitte allgemein prüfen:
- Schreibweise: Weboberfläche (nicht Web-Oberfläche)
- xrefs zu einem anderen Handbuch-Artikel brauchen ein # am Ende, sonst funktionieren sie nicht
////
...
//SP: Das kommt jetzt für mich überraschend. Wieso habe ich jetzt auf einmal mehrere Terminals? Von Terminals war bisher nichts zu lesen.
...
//SP: Ist das überhaupt möglich: mehr Speicher belegen als vorhanden ist?
...
//SP: Wer ist der Distributor? Ist das tribe29 oder lande ich dann bei einer anderen Firma?
