...
setzen können: Bei den [.guihint]#Host- &amp; Service&shy;parameters# finden Sie unter [.guihint]#Monitoring Configuration|Notifications#
...
* Über die Regelsätze link:.guihint].html#Monitoring configuration[Enable/disable flapping detection for hosts# bzw. [.guihint]#... services# können Sie Objekte von der Erkennung ausklammern.
