...
Wie gewohnt, können
Sie die Regel icon:icon_edit.png] editieren, ICON[button_clone[] kopieren,
...
icon:icon_downtime.png] markiert, Hosts mit einem blauen ICON[icon_derived_downtime[].
