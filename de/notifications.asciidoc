...
Morgens um 9 Uhr tritt im Betrieb ein Problem auf. Die Mitarbeiter werden benachrichtigt, reagieren aber beide nicht (aus welchen Gründen auch immer). So bekommen sie um 10, 11, 12 und 13 Uhr jeweils eine weitere E-Mail. Ab der sechsten Alarmierung um 14 Uhr bekommt nun zusätzlich auch der Teamleiter eine Benachrichtigung -- aber auch dieser kann keinen der Mitarbeiter zur Problemlösung bewegen. So werden um 15, 16, 17 und 18 Uhr weiter E-Mails an die Mitarbeiter und an den Teamleiter verschickt. Um 19 Uhr greift die dritte Eskalationsstufe: ab jetzt werden keine E-Mails mehr an die Mitarbeiter oder den Teamleiter verschickt. Stattdessen bekommt die Firmenleitung bis zur Problembehebung nun täglich um 19 Uhr eine E-Mail.
