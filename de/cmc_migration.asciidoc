...
und können über das WATO-Modul ICON[icon_alert_handlers.png] [.guihint]#Alert Handlers# konfiguriert werden.
...
Im WATO-Modul ICON[icon_timeperiods.png] [.guihint]#Timeperiods# gibt es aber die Möglichkeit eines iCal-Imports.
