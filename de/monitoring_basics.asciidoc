...
In diesem Artikel erläutern wird die grundlegende Begriffe und Konzepte in {CMK}, wie z.B. Host, Service, Benutzer, Kontaktgruppe, Benachrichtigung, Zeitraum, Wartungszeit.
