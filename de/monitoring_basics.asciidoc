...
|===
|Rolle |Bedeutung 
|`admin` |Darf alles sehen und tun, hat alle Privilegien.
...
|`agent_registration` |Darf nur xref:draft_hosts_autoregister[Hosts registrieren] -- sonst nichts. Diese Rolle gibt es nur in der {CCE}.
