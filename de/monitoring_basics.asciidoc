...
Fällt ein Agent - aus welchen Gründen auch immer - über längere Zeit aus, so liefert er an ein oder mehrere Checks keine aktuellen Daten für die Auswertung. Somit können auch die abhängigen Services nicht mit Daten versorgt werden.
...
In den [.guihint]#Global settings# ist im Abschnitt [.guihint]#User interface# unter anderem der [.guihint]#Staleness value to mark hosts / services stale# definiert:
