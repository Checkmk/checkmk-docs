...
Solch ein aktiver Check wird von {CMK} direkt ausgeführt und kümmert sich sowohl um die Datenerhebung als auch um die Auswertung.
Services mit dem grauen Pfeil basieren dann auf passiven Checks, deren Daten von einem anderen, d.h. einem aktiven Check ermittelt werden.
