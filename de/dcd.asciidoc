...
:revdate: draft
:title: Dynamische Hostkonfiguration - Überwachen von dynamischen Infrastrukturen
...
// MFS: Lassen wir "entstehen und vergehen" drin, oder? Auch wenn es etwas schwültig klingt.
...
Die {CEE} von {CMK} unterstützt Sie bei diesem
...
Der Menüpunkt [.guihint]#Setup > Hosts > Dynamic host configuration bringt Sie zur Konfiguration
...
image::dcd_connection_general.png["Screenhsot: General properties beim Hinzufügen einer neuen Connection"]
...
image::dcd_connection_properties_2.png["Screenshot: Ordner, in dem Hosts erstellt werden und Datenquellen, die hierfür herangezogen werden"]
...
direkt nach dem Aktivieren der Änderungen sofort sehen, wie Hosts im Monitoring angelegt wurden:

image::dcd_pending_changes.png["Screenshot: Liste der Pending changes unmittelbar vor der automatischen Übernahme ins Monitoring""]
...
„nicht mehr gibt“ automatisch aus dem Monitoring löschen lassen. Das klingt erstmal
...
image::dcd_deletion_tuning.png["Screenshot: Feineinstellungen zum automatischen Löschen von Hosts"]
...
image::dcd_execution_history.png["Screenshot: Ausführungshistorie bei Suche und Anlegen neuer Hosts"]
...
Wenn Sie in der Setup-GUI auf der Seite sind, wo Sie Änderungen aktivieren können, finden Sie dort einen
