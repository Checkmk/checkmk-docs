...
Das Umbenennen von Hosts ist auf den ersten Blick eine einfache Sache. Bei näherem Hinsehen entpuppt es sich aber als komplexe Operation. Der Grund
...
Logdaten, xref:glossar#rule[Konfigurationsregeln], xref:glossar#bi[BI-Aggregationen], Berichte, xref:glossar#dashboard[Dashboards] und
...
Das [.guihint]#Bulk renaming of hosts# ermöglicht systematische Namensanpassungen:
...
Es stehen weitere Operationen zur Verfügung, die großteils selbsterklärend sind. Ansonsten können Sie durch Einblenden der kontextsensitiven Hilfe ([.guihint]#Help > Show inline help#) weitere Informationen erhalten.
