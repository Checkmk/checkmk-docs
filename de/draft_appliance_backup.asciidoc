...
Damit Ihre Monitoring-Daten im Falle eines Hardware-Defekts oder einer andersartigen Zerstörung gesichert sind, können Sie über die Web-Oberfläche die Sicherung Ihrer Daten konfigurieren.
...
//SP: "Auf der Netzwerkfreigabe ablegt" kannte ich noch nicht. Ist dieser Ausdruck üblich? Ich hätte eher "auf einem freigegebenen Netzwerk-Rechner" oder ähnliches erwartet.
...
//SP: Hier bin ich mir mit der Schreibweise unsicher. Desaster ist deutsch (disaster wäre die englische Form), Recovery ist aber englisch. Ist diese Sprachenmischung beabsichtigt?
...
Für jeden konfigurierten Sicherungsjob findet das [.guihint]#Service Discovery# von {CMK} auf dem Gerät einen neuen Service [.guihint]#Backup [JOB-ID].#
//SP: Wird dieser Backup-Service automatisch erstellt? Wenn checkmk den findet, woher kommt er?
