...
Sie können die Appliance-Software über die xref:https://checkmk.com/de/download[Download-Seite^] herunterladen.
...
1. Anlegen der virtuellen Maschine per Proxmox-Web-Oberfläche
...
Legen Sie zunächst eine virtuelle Maschine in der Proxmox-Web-Oberfläche an.
