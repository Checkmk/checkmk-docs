...
Mit der Navigationsleiste (_navigation bar_) auf der linken Seite und der sich darin befindenden Symbole treffen Sie die Grundsatzentscheidung, worum sich {CMK} für Sie kümmern soll:
