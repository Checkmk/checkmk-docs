...
Hierfür nutzen Sie den [.guihint]#Agent controller auto-registration (Cloud Edition)# Regelsatz der Agentenbäckerei, der, wie sein Titel schon vermuten lässt, nur in der {CE} vorhanden ist.
