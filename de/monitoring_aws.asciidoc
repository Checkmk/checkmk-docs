...
link:dcd.html[Dynamische Host-K onfiguration]
{related-end}
...
dafür bei AWS als Root-User ein und navigieren Sie unter [.guihint]#All services# zu [.guihint]#Security, Identity, & Compliance > IAM#
...
Aktuell sind hier die Daten über die Kosten und dem Dienst [.guihint]#Route53# auswählbar:
