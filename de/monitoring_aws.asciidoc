...
Wie das funktioniert beschreibt AWS detailiert in dem Artikel link:https://docs.aws.amazon.com/AmazonS3/latest/userguide/configure-request-metrics-bucket.html[Erstellen einer CloudWatch-Metrik-Konfiguration für alle Objekte in Ihrem Bucket^].
