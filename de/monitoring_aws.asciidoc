...
[.relateddoc]
monitoring_azure, check_plugins_catalog, dcd
...
* link:check_aws_glacier.summary.html[AWS Glacier Summary] (ab VERSION[1.7.0])
...
link:check_plugins_catalog.html[Katalog der Check-Plugins].
...
Wichtig ist, dass Sie bei [.guihint]#Access Type}} den {{Programmatic Access# auswählen.
...
Wählen Sie dazu unter [.guihint]#Security, Identity, & Compliance|IAM|Policies}} den Knopf {{Create Policy#.
Wählen Sie unter [.guihint]#Select a Service|Service|Choose a Service}} den Service {{Billing# aus.
Unter [.guihint]#Actions}} kreuzen Sie die Checkbox {{Read# an.
Sie müssen noch eine weitere Berechtigung setzen. Fügen Sie diese mit dem Knopf [.guihint]#Add additional permissions# hinzu.
Wählen Sie in der neuen Box unter [.guihint]#Select a Service|Service|Choose a Service}} den Service {{Cost Explorer Service# aus.
Unter [.guihint]#Actions}} kreuzen Sie die Checkbox {{Read# an.

image::aws_policies.png[]

Mit dem Knopf [.guihint]#Review}} geht es zum Schritt zwei. Legen Sie dort als {{Name# den Namen `BillingViewAccess`
...
zu [.guihint]#Security, Identity, & Compliance|IAM|Policies}}, suchen im Suchfeld {{Filter Policies#
...
müssen Sie die [.guihint]#IP Address Family}} auf {{No IP# einstellen.

image::azure_wato_no_ip.png[]


=== Regel für AWS-Agenten anlegen#agent_rule
