...
Alle Möglichkeiten, die es vom {CMK}-Server aus gibt, sind im allgemeinen Artikel über die Agenten xref:wato_monitoringagents#diagnostics[beschrieben].
...
// 16 zeigt an, dass die Gegenseite auf zwei Bytes wartet. 
