...
Auch in diesem Fall können Sie die Routing- oder Firewall-Einstellungen so anpassen, dass aufzunehmende Hosts den {CMK}-Server auf Port 8000 (oder 8001…) erreichen können.
