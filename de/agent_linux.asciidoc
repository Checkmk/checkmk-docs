...
Sollte es erwünscht sein, wieder unverschlüsselten Legacy-Pull-Modus zu aktivieren, z.B. um die Kommunikation einer {v20} Site mit einem {v22} Agenten zu ermöglichen, müssen Sie diesen xref:deregister[explizit aktivieren].
