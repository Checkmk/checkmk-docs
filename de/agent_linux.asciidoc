...
Beachten Sie in diesem Fall, dass Sie auf anderem Weg die Integrität des Zertifikats sicher stellen sollten, beispielsweise per Skript durch Kontrolle der xref:files[Datei] `/var/lib/cmk-agent/registered_connections.json`.
