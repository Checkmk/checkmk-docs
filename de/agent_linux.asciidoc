...
// Der Agent Controller kümmert sich um die rechtzeitige Erneuerung der Zertifikate vor deren Ablauf.
// Nur inaktive Agenten, d.h., ohne laufenden Agent Controller, können ihre Registrierung bei Ablauf verlieren.
