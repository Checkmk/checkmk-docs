...
Die Regel, die Sie gerade angelegt haben, erzeugt bei der nächsten xref:wato#activate_changes[Aktivierung der Änderungen] einen xref:active_checks#[aktiven Check] pro Host,
