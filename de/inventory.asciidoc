...
.CPU-Daten im Inventurpfad [.guihint]#hardware.cpu#
...
*Hinweis:* Die hier erwähnte Web-API ist *nicht* die (abgekündigte) {CMK} Web-API.
Diese Inventur-eigene Web-API ist von der Abkündigung nicht betroffen.
