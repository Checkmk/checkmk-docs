...
[.guihint]#Hardware#, icon:icon_networking.png] [.guihint]#Networking# und ICON[icon_software[] [.guihint]#Software#
...
ist z.B. die Tabelle [.guihint]#ICONlink:icon_software.png] Software.html[icon:icon_packages[] Packages#:
...
mit dem Knopf icon:icon_inv[] [.guihint]#Inventory history#:
