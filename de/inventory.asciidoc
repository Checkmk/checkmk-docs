...
{CMK}-Instanzen, die Sie mit Version {v14} oder höher angelegt haben,
...
// ML: In wato_user gibt es unter "3. Kontaktgruppen" ein Kapitel zu Inventory-Pfaden - beim Update auf 2.0 bitte hier rüber ziehen und dort nur verlinken.
