...
[.guihint]#Hardware#, ICON[icon_networking.png] [.guihint]#Networking# und ICON[icon_software.png] [.guihint]#Software#
...
unter dem Eintrag [.guihint]#Inventory#. Diejenigen, die mit dem Wort [.guihint]#Search# beginnen, geben erst
