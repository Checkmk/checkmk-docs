...
Das finden Sie in den kommerziellen Editionen unter [.guihint]#Setup > Agents > Windows, Linux, Solaris, AIX > Related# und in der {RE} unter [.guihint]#Setup > Agents.# 
...
{cee-only}
In den kommerziellen Editionen funktioniert die HW/SW-Inventur auch in xref:distributed_monitoring#[verteilten Umgebungen.]
