...
// FIXME!
// MFS: Ein Scheiß ist die eingebaute Verschlüsselung. Die ist symetrisch, jeder, der ein Agentenpaket mit dem Schlüssel in die Finger bekommt, kann entschlüsseln!

=== Zugriff auf xinetd beschränken
...
Selbstverständlich können Sie einen anderen Pfad angeben, beispielsweise wenn Sie mit verschiedenen Schlüsseln für verschiedene Hosts arbeiten wollen.
