...
Soll bei Nutzung des Legacy-Modus ein Host ins Monitoring aufgenommen werden, der vom {CMK}-Server nicht erreichbar ist, verwenden Sie xref:datasource_programs#[Datenquellenprogramme], um eine Verbindung vom überwachten Host ausgehend aufzubauen und die darüber übertragene Agentenausgabe einzulesen.
