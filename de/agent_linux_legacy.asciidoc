...
Alternativ können Sie auch über die IP-Adresse zugreifen, müssen dann aber das Macro `$HOSTADDRESS$` verwenden, welches die von {CMK} zwischengespeicherte IP-Adresse enthält.
