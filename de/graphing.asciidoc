...
image::snapin_graph_collections.png[align=center, width=50%]
...
Protokoll von link:http://graphite.wikidot.com/[Graphite]
unterstützt. Neben Graphite selbst hat z.B. die
link:https://influxdata.com/[InfluxDB] eine derartige Schnittstelle.
...
image::historic_metrics_2.png[align=center, width=85%]
...
Die oben gezeigte Regel hat noch eine weitere Einstellung: [.guihint]#RRD storage format#.
