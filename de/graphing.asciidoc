...
*Hinweis:* Wollen Sie nicht nur die Graphen auf eine andere Temperaturmaßeinheit umstellen, sondern alle Ansichten, so verwenden Sie den xref:wato_rules#checkparameters[Service-Regelsatz] _Temperature._
