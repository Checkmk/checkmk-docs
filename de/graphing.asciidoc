...
auch möglich, Metriken <b>von verschiedenen Hosts und Services in einem
Graphen</b> zu kombinieren. Zu den Freiformgraphen gelangen Sie z.B. über
...
Dies ist seit Version VERSION[1.6.0] von {CMK} möglich. Sie können in einer
...
Jede Änderung des RRD-Aufbaus hat zunächst nur Einfluss auf <b>neu
angelegte</b> RRDs -- sprich wenn Sie neue Hosts oder Services in das Monitoring
...
VERSION[1.2.8] erzeugt worden sein, lohnt sich gegebenenfalls ein genauer Blick
