...
Auch hier im Handbuch begegnen Sie daher verschiedenen Varianten des Begriffs Version.
...
Nach der Beta-Phase gibt es den feierlichen Augenblick, an dem die neue stabile Version, auch *Major-Version* genannt, erscheint (z.B. `2.2.0`).
...
Diese werden in einer Reihe von *Patch-Versionen*, manchmal auch als Patch Releases bezeichnet, behoben (`2.2.0p1`, `2.2.0p2`, usw.).
