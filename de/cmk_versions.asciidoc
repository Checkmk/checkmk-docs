...
// TK: Auskommentiert, da es meiner Meinung nicht im Handbuch stehen sollte, was vom Support abgedeckt wird. Außerdem: Gibt es Break/Fix überhaupt noch?
...
{cee-only}
Innovation-Versionen sind ein besonderes Feature der {CEE} und geben Ihnen die Möglichkeit,
...
// TK: Auskommentiert: siehe Kommentar oben
...
Dies ist manchmal sogar sehr sinnvoll -- nämlich wenn Sie von der CRE auf die CEE umsteigen möchten.
...
// TK: Auskommentiert: siehe Kommentar oben
// Falls Sie einen Vertrag mit Break/Fix-Option haben, sind solche Fehlerbehebungen darin enthalten.
...
|{v22} |23.05.2022 |6 Monate nach Freigabe von {v23}footnote:stable_version[Aktuell ist noch kein Freigabedatum festgesetzt.] |18 Monate nach Freigabe von {v23}footnote:stable_version[]
|{v21} |24.05.2022 |23.11.2023 |23.11.2024
