...
[.relateddoc]
wato_monitoringagents, update, cmk_commandline
...
[.guihint]#Activation of automatic agent updates}} unter {{WATO|Global Settings|Automatic Agent Updates.#
...
[.guihint]#Monitoring Agents# das für den Host passende ICON[icon_agents.png]
...
=== Einsehen der lokalen Konfiguration#show_config
...
== Agenten-Updates im verteilten Monitoring#distr_wato
...
== FAQ
=== Typische Fehler und ihre Ursachen#faq
