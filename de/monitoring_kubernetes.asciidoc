...
// MFS: 2022-05-24 Auf Wunsch von Martin auskommentiert:
////
...
Aktuell empfehlen wir die Installation des Kubernetes-Monitoring mit Hilfe des Tools `helm`, da es sich auch für weniger versierte Nutzer eignet. Machen Sie dafür zu allererst das Repository bekannt. In dem folgenden Beispiel nutzen wir den Namen `k8scmk`, um später einfacher auf das Repository zugreifen zu können. Sie können aber selbstverständlich auch jeden anderen Namen nutzen:
