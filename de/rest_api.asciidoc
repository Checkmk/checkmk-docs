...
{c-omd} ./rest-api_test.sh
{
  ...
  "members":{
    "folder_config":{
      "id":"folder_config",
      "memberType":"property",
      "value":"\/objects\/folder_config\/0eb62757ebce447ebf80429a32f8b90c",
      "format":"string",
      "title":null,
      "choices":[]}},
  "extensions":{
...
|Wartungszeit (downtime) |erstellen |POST |-
| |für einen Service erstellen |POST service |-
| |entfernen |POST delete |-
|Wartungszeit (downtime) |entfernen |DEL |-
|Wartungszeit (downtime) |mehrere entfernen |DEL bulk-delete |-
...
| |ändern |PUT |-
| |entfernen |DEL |-
|Benutzer (user) |alle anzeigen |- |get_all_users
...
|Quittierung von Problemen (acknowledge problems) |für mehrere Hosts quittieren |POST host bulk-acknowledge |-
|Quittierung von Problemen (acknowledge problems) |für Hosts einer Host-Gruppe quittieren |POST hostgroup |-
|Quittierung von Problemen (acknowledge problems) |für Services auf einem Host quittieren |POST host service |-
| |für Services quittieren |POST service |-
|Quittierung von Problemen (acknowledge problems) |für mehrere Services auf einem Host quittieren |POST service bulk-acknowledge |-
|Quittierung von Problemen (acknowledge problems) |für Services einer Service-Gruppe quittieren |POST servicegroup |-
