...
{CMK} {v22} geht den nächsten Schritt und bietet link:https://azuremarketplace.microsoft.com/de-de/marketplace/apps/tribe29gmbh1665582614827.checkmk003?tab=Overview[ein vorinstalliertes Image^] auf Basis von Ubuntu 22.04 _(Jammy Jellyfish)_, bei denen alle Abhängigkeiten bereits erfüllt sind.
// TK: vorinstallierte Images: Plural? Ist doch nur eines, oder?
// MFS: Ein Image, welches konfigurierbar ist...
...
// MFS: Dopplungen in aufeinanderfolgenden Sätzen vermeiden...
...
// MFS: Der Experte weiß es, der Laie bekommt brauchbare Defaults.
