...
|[.guihint]#Disable Notifications# |start_url |Deaktiviert *alle* Benachrichtungen an den Benutzer 
|[.guihint]#Start-URL to display in main frame# |start_url |Welche View im rechten Frame angezeigt werden soll 
|[.guihint]#Visibility of Hosts/Services# |start_url |Nur Hosts/Services anzeigen, für die man Kontakt ist 
|===
