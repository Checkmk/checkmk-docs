...
die Verbindung in
den [.guihint]#General Properties#. Optional können Sie hier unter [.guihint]#Description#
...
über den Button icon:button_sync_users[] anstoßen. Zusätzlich wird ein
...
[cols="35,~,55"]
|===
|Plugin |Attribut |Beschreibung 

|[.guihint]#Alias# |cn |Normalerweise der Vor- und Nachname des Benutzers
|[.guihint]#Authentication Expiration# |pwdlastset |Wann ein Benutzer ausgeloggt oder gesperrt wird
|[.guihint]#Email address# |mail |Die Email Adresse des Benutzers
|[.guihint]#Pager# |mobile |Eine hinterlegte Telefon-/Pagernummer
|[.guihint]#Disable Nortifications# |disable_notifications |Deaktiviert *alle* Benachrichtungen an den Benutzer
|[.guihint]#Start-URL to display in main frame# |start_url |Welche View im rechten Frame angezeigt werden soll
|[.guihint]#Visibility of Hosts/Services# |force_authuser |Nur Hosts/Services anzeigen, für die man Kontakt ist
|===
