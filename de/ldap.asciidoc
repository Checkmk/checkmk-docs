...
|[.guihint]#Show more / Show less# |show_mode |String | `default_show_less, default_show_more, enforce_show_more`| Voreinstellung auf den xref:ldap#other_attr["Show more"- bzw. "Show less"-Modus]. Mit `enfore_show_more` werden immer alle Funktionen, Filter und Eingabefelder angezeigt und der Knopf zum Umschalten entfernt
...
// Bis einschließlich Version {v128} galt die zuletzt beschriebene Option
...
// Version {v14} durchgeführt haben, werden sie an dem neuen Ort
// übernommen.
