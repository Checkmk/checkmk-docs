...
Um dies umzusetzen, benötigen Sie zunächst eine Regel aus dem Regelsatz [.guihint]#Windows Services#, den Sie z.B. über die Suchfunktion [.guihint]#Setup => General => Rule search# finden können. Der entscheidende Parameter in der neuen Regel lautet [.guihint]#Service states#. Aktivieren Sie diesen und fügen Sie drei neue Elemente für die Zustände der Dienste hinzu:
