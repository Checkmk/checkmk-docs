...
image::cpu_single_core.png[alt=Die Überwachung der CPU-Auslastung einzelner Kerne für Windows-Server festlegen]
...
image::windows_services_rule.png[alt=Die zu überwachenden Windows-Server-Dienste in Abhängigkeit ihres Zustands festlegen]
...
image::windows_service_discovery.png[alt=Die Namen der zu überwachenden Windows-Server-Dienste festlegen]
...
image::service_internet.png[alt=Service zur Überwachung der Internetverbindung zu mehreren IP-Adressen]
...
image::http_service.png[alt=Service zur Überwachung der HTTP/HTTPS-Dienste auf einem Host]
...
image::magic_factor.png[alt=Den Magic Factor für Dateisystem-Schwellwerte festlegen]
