...
image::cpu_single_core.png[Dialog, um die Überwachung der CPU-Auslastung einzelner Kerne für Windows-Server festzulegen.]
...
image::windows_services_rule.png[Dialog, um die zu überwachenden Windows-Server-Dienste in Abhängigkeit ihres Zustands festzulegen.]
...
image::windows_service_discovery.png[Dialog, um die Namen der zu überwachenden Windows-Server-Dienste festzulegen.]
...
image::service_internet.png[Darstellung von Servicedaten zur Überwachung der Internetverbindung zu mehreren IP-Adressen.]
...
image::http_service.png[Service-Daten zur Überwachung der HTTP/HTTPS-Dienste auf einem Host.]
...
image::magic_factor.png[Dialog zur Festlegung des Magic Factors für Dateisystem-Schwellwerte.]
...
image::magic_factor_services.png[Liste mit zwei Dateisystem-Services und ihren Schwellwerten.]
