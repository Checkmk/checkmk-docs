...
image::cpu_single_core.png[alt=Überwachung der CPU-Auslastung einzelner Kerne eines Windows-Server in einer Regel]
...
image::windows_services_rule.png[alt=Überwachung des Zustands von Windows-Diensten eines Windows-Server in einer Regel]
...
image::windows_service_discovery.png[alt=Festlegung von zu überwachenden Windows-Diensten eines Windows-Server in einer Regel]
...
image::service_internet.png[alt=Liste mit einem Service zur Überwachung der Internetverbindung zu mehreren IP-Adressen]
...
image::http_service.png[alt=Liste mit einem Service zur Überwachung der HTTP/HTTPS-Dienste auf einem Host]
...
image::magic_factor.png[alt=Festlegung des Magic Factor für Dateisystem-Schwellwerte in einer Regel]
