...
// Es gibt noch eine dritte Variante, das Update im laufenden Betrieb. Da es allerdings nicht möglich war, hier alle denkbaren Konfigurationen und Setups zu testen, geschieht dies **auf eigenes Risiko und wird nicht empfohlen!** Es kann bei diesem Vorgehen durchaus passieren, dass größere Probleme auftreten, bis hin zu Abstürzen ganzer Instanzen. Sollten Sie das Update dennoch live durchführen, raten wir dringend dazu, vorher Backups zu erstellen.
// 
// Um das Update aller im verteilten Monitoring beteiligten Instanzen im laufenden Betrieb auf die {v20} zu ermöglichen, funktioniert die Synchronisation für eine Übergangszeit auch in einer gemischten Umgebung, d.&thinsp;h., zwischen einer Zentralinstanz mit Version {v16} und fernen Instanzen mit Version {v20} oder zwischen einer {v20}-Zentralinstanz und fernen {v16}-Instanzen. In gemischten Umgebungen wird weiterhin, wie in der Version {v16}, komplett synchronisiert.
// 
