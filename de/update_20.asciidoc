...
Um das Update aller im verteilten Monitoring beteiligten Instanzen im laufenden Betrieb auf die {v20} grundsätzlich zu ermöglichen, funktioniert die Synchronisation für eine Übergangszeit auch in dieser gemischten Umgebung, indem nur dann eine inkrementelle Synchronisation ausgeführt, wenn beide Instanzen auf der Version {v20} sind. Andernfalls wird die alte Methode verwendet. Beachten Sie hier unbedingt die Hinweise zu dem xref:live_update[Update in verteilten Umbegungen].
