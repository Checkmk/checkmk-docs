...
Ein Update auf die Version {v20} setzt zwar kein konkretes {v16} Patch Release voraus.
Es wird jedoch empfohlen, zuerst {CMK} auf das aktuelle {v16}    Patch Release zu aktualisieren und erst dann das Update auf die {v20} durchzuführen.
