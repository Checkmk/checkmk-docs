...
Wenn Sie die automatische Verteilung von Agenten verwenden, sollten Sie überlegen, dieses vor dem Update auf {CMK} {v20} kurzzeitig zu deaktivieren. Dazu genügt es in den entsprechenden Regeln vom Regelsatz [.guihint]#Agent updater (Linux, Windows)# den Haken bei [.guihint]#Rule activation > do not apply this rule# zu setzen, die Regel anschließend zu speichern und die Änderungen zu aktivieren. Nach dem Update auf {CMK} {v20} kopieren Sie dann einige dieser Regeln, entfernen in den Kopien den Haken bei [.guihint]#do not apply this rule# und setzen stattdessen unter [.guihint]#Explicit hosts# einfach die Namen von 2-3 Hosts ein, die von dieser Regel betroffen sind.
