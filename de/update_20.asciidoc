...
Auf diese Weise wird der neue Agent nicht gleich über all Ihre Server ausgerollt und Sie können sich auf eingen wenigen Systemen mit den neu angeliferten Daten vertraut machen. Auch aufgrund der deutlich gestiegenen Zahl an miotgeliferten Checkplugins könnten Sie eine ganze Reihe neuer Services finden, welche Sie dann auf den von Ihnen gewählten Testsystemen richtig einstellen können. Eventuell sind für neue Services auch neue Schwellwerte vonnöten. Wenn Sie dies erstmal im Kleinen angehen, ersparen Sie sich ggf. einige Fehlalarme.
