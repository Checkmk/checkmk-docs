...
Führen Sie das Update im Anschluss erstmal auf dieser neuen geklonten Instanz durch um hier beispielsweise Ihre oben angesprochenen lokalen Änderungen in der neuen Umgebung zu prüfen.
...
In {CMK} {v20} verrichten diese Helper ihre Aufgaben noch spezialisierter und zielgerichteter. Statt, wie bis zur {v16}, die Informationen abzuholen *und* anschließend auszuwerten, wird der eine Teil der Helper nur für das Abholen der Informationen zuständig sein. Diese Helper heißen _Fetcher_. Der andere Teil hingegen kümmert sich darum, die vom _Fetcher_ übergebenen Informationen auszuwerten. Diese Prozesse nennen wir _Checker_.
