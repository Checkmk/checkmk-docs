...
Welche Linux-Distributionsversionen {CMK} unterstützt, erfahren Sie in der xref:update_matrix#[Update-Matrix für {v20}] und auf der link:https://checkmk.com/download[Download-Seite] nachdem Sie die {CMK}-Version und Ihre Linux-Distribution ausgewählt haben.
...
Auf der oben angegebenen Seite können Sie dafür einfach ein paar Hosts oder Host-Gruppen in die entsprechenden Felder eintragen und den Master switch wieder aktivieren.
