...
// MFS: Nein, da geht es auch auch um REST APIs irgendwo, da ist mir egal, ob das ein Server, ein Plaste-Accesspoint oder ein Client PC ist...
...
// MFS: Nennt _man_ das Obfuscation. Machen alle.
...
// MFS: Ja, entweder hier oder in der Einleitung. Auch mal die eigene Suchfunktion füttern.
...
// MFS: Solch ein Broker sammelt Sensordaten im „Internet der Dinge“ (IoT, IoT). Über ihn können Sie beispielsweise Daten zur Raumklimaüberwachung auslesen.
// TK: Beispiel ist etwas verwegen, da ich es nicht testen kann und auch sonst keinen Schimmer von MQTT habe.
// MFS: ACHTUNG! Das Beispiel zeigt "MQTT Broker Statistics" Da geht es um Überwachung des Brokers selbst, bspw. zum Schauen, dass nicht zuviele Messages in der Schlange warten.
...
// MFS: Konsistent bei Broker bleiben.
...
// MFS: Kann man nicht oft genug drauf hinweisen.
...
// MFS: Nein, da sind so wenige GUI-Elemente sichtbar, die sind sofort erkennbar.
...
// MFS: Nein, das passt wie besprochen erstmal. Jetzt brauchen wir einen Artikel zur Programmierung von Spezialagenten.
|===
