...
// TK: Satz hinzugefügt. Bitte lesen wg. Abgrenzung Passwort/Secret/Token/etcpp.:
...
// TK: Folgenden Satz geändert und einen neuen hinzugefügt.
...
// TK: Nun nur noch Broker und nicht mehr Server
