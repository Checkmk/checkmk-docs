...
|Mitgeliefertes RPM/DEB-Paket |Einfache Installation eines Standard-Agenten mit manueller Konfiguration über Konfigurationsdateien. Die Installationsroutine überprüft in allen Editionen, ob `systemd` vorhanden ist und konfiguriert den vorhandenen Superserver `systemd` oder `xinetd`. |X |X
