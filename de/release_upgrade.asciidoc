...
[{shell}]
----
{c-root} apt-get remove --purge -y check-mk-enterprise-2.0.0p39
...
Removing check-mk-enterprise-2.0.0p39 (0.focal) ...
(Reading database ... 89444 files and directories currently installed.)
Purging configuration files for check-mk-enterprise-2.0.0p39 (0.focal) ...
