// -*- coding: utf-8 -*-
// IGNORE BTRFS Checkmk Herkopieren Hinkopieren Instanzbenutzer Paläontologie Softlink Softlinks Unmount ZFS checkmk instanzspezifischen localdev
...
xref:update_matrix#[Update-Matrix für Version {v20}]
{related-end}
...
Wenn Sie ein Release-Upgrade der Linux-Distribution mit einem xref:update_20#[Versions-Update] kombinieren wollen oder müssen (zum Beispiel wenn eine ältere {CMK}-Version mehr nicht für eine neuere Distributionsversion angeboten wird), bestimmen Sie bitte anhand unserer xref:update_matrix#[Update-Matrix] die geeignete Reihenfolge der durchzuführenden Schritte.
...
* Eine Sicherung mit den von {CMK} bereitgestellten Tools, entweder auf der Kommandozeile mit dem xref:omd_basics#[Befehl `omd`] oder im xref:backup#[Setup] erstellt.
...
mysite    2.0.0p38.cee    default version
----
...
[{shell}]
----
{c-root} apt-get remove --purge -y check-mk-enterprise-2.0.0p37
Reading package lists... Done
Building dependency tree       
Reading state information... Done
The following packages will be REMOVED:
  check-mk-enterprise-2.0.0p37*
...
Removing check-mk-enterprise-2.0.0p37 (0.focal) ...
(Reading database ... 89444 files and directories currently installed.)
Purging configuration files for check-mk-enterprise-2.0.0p37 (0.focal) ...
...
[{shell}]
----
{c-root} apt-get remove -y check-mk-enterprise-2.0.0p38
Reading package lists... Done
Building dependency tree       
Reading state information... Done
The following packages will be REMOVED:
  check-mk-enterprise-2.0.0p38*
...
----
...
[{shell}]
----
{c-root} apt install /tmp/check-mk-enterprise-2.0.0p38_0.jammy_amd64.deb
----
...
. Erstellen Sie ein xref:omd_basics#[Archiv] (in anderen Kontexten Backup) der Instanz.
