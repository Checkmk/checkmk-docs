...
Discovery aus. {CMK} geht deswegen etwas zielsicherer vor.
...
OID-Zweige für das eigentlich Monitoring (`tree`). Hier ist ein Beispiel für ein
...
* Was es mit den END_OIDs auf sich hat.
