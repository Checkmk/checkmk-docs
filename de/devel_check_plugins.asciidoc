...
:description: Hier erfahren Sie, wie Sie {CMK}-Plugins entwickeln können — mit allem was dazugehört, insbesondere mit der in der Version {v20} neu entwickelten Check-API.
