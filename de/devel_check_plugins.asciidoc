...
:description: In diesem Artikel erfahren Sie, wie Sie {CMK}-Plugins entwickeln können — mit allem was dazugehört, insbesondere mit der in der  Version 2.0.0 neu entwickelten Check-API für die Pluginprogrammierung.
...
Damit er nicht über die Modulgrenze hinaus sichtbar wird, sollte
er mit einem Unterstrich beginnen.
