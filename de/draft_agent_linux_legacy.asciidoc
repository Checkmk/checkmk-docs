...
Der Legacy Pull Modus erfordert einen laufenden Internet-Superserver.
...
Verschieben Sie dieses alte Skript, beispielsweise indem Sie `.bak` anhängen.
...
Nach einem Speichern und einem xref:wato#activate_changes[Aktivieren der Änderungen] sollte alles funktionieren!
...
Auch ohne Agentenbäckerei geht der erste Schritt dennoch über das [.guihint]#Setup#-Menü und das Anlegen einer Regel im Regelsatz [.guihint]#Setup > Agents > Access to agents > Checkmk agent > Encryption (Linux, Windows)#.
