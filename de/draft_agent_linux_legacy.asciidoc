...
[#manual]
=== Manuelle Installation des Scripts
...
Alle weiteren Zugriffe können dann ohne Nutzerinteraktion erfolgen, so auch die minütliche automatische Abfrage des Agentenskriptes durch den {CMK}-Server.
