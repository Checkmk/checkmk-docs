...
* Aktive Checks: Wenn ein aktiver Check in die Oberfläsche von {CMK} integriert wurde, nehmen Sie die Kategorie `active`
...
definiert werden -- bzw. ab Version {v16} in der Datei
