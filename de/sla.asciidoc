...
// TK: SLA funtioniert so wie beschrieben,Stand heute (01.02.22), nur mit dem Daily stable build,
// TK: 2 Fehler sind mittlerweile gefixt (Werks 13609,13290), aber noch nicht überall verfügbar, z.B. nicht im master.
...
Im folgenden Bild ist der Status {WARN}, weil nur noch zwei von drei erlaubten Ausfällen übrig sind:

.Ein Tooltip zeigt genaue Informationen zu der Ergebniszeile
image::sla_view_details_result.png[alt="Tooltip einer Ergebniszeile auf der SLA-Detailseite."]
...
// TK: Beschreibung umgestellt, damit klarer wird, was man als Aggregation Name eintragen muss.
