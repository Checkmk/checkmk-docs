...
Und auch hier dürfen Sie wieder über die [.guihint]#Levels for SLA monitoring# verfeinern und bestimmen, bei wievielen verbleibenden Vorfällen vor dem Brechen des SLA Sie mit einem {WARN} beziehungsweise {CRIT} gewarnt werden.
