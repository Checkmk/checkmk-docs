...
. Während des Starts des Geräts werden Sie an der Konsole zur Initialisierung des RAID auffordert *(Achtung: Alle Daten auf den Festplatten werden gelöscht!).* Bestätigen Sie.
