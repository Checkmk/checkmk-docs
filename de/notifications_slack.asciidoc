...
= Benachrichtigungen per Slack (Notifications)
:revdate: 2020-08-14
...
Zum Testen bekommen Sie nach Abschluss eine `curl`-Anweisung, die _Hello World_ in den gewünschten Channel postet.
