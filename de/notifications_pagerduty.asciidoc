...
= Benachrichtigungen per PagerDuty (Notifications)
:revdate: 2020-08-14
...
Zum Testen können Sie die link:commands.html[Kommandos] [.guihint]#Fake check results# und [.guihint]#Custom notification# verwenden und einen von der Regel erfassten Host dadurch auf {DOWN} setzen.
