...
:description: Jede Linux-Distribution hat ihre Besonderheiten, die bei der Installation von {CMK} zu beachten sind. Hier erfahren Sie, was bei Debian und Ubuntu notwendig ist.
