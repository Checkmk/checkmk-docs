...
Es gibt jedoch Umgebungen-- zum Beispiel bei sehr schlanken Containern, Legacy- oder Embedded-Systemen --, in der Agent Controller nicht verwendet werden kann.
...
In vielen Fällen verlangen Policies, dass Sicherheitsaspekte wie der Verzicht auf die Übertragung von Daten im Klartext berücksichtigt werden müssen.
