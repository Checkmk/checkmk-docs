...
image::empty_main_directory.png[Ordneransicht 'Main directory' ohne Ordner und Hosts.]
...
Die Aktionsleiste können Sie mit dem Knopf icon:button_hide_toolbar[alt="Symbol zum Ausblenden der Aktionsleiste"] rechts neben dem [.guihint]#Help#-Menü ausblenden und mit icon:button_show_toolbar[Symbol zum Einblenden der Aktionsleiste.] wieder einblenden. 
Bei ausgeblendeter Aktionsleiste werden die Symbole in der Menüleiste rechts neben icon:button_show_toolbar[Symbol zum Einblenden der Aktionsleiste.] angezeigt.
...
Aktionen zum Erstellen eines Ordners auswählen (z.B. den Aktionsknopf icon:icon_newfolder[Symbol zum Erstellen eines Ordners.] [.guihint]#Add subfolder#). Auf der neuen Seite
[.guihint]#Create new folder# tragen Sie im ersten Kasten [.guihint]#Basic settings# den Ordnernamen ein:

image::folder_basic_settings.png[Dialog mit Eigenschaften beim Erstellen eines Ordners: die Basic settings mit Titel.]
...
image::three_empty_folders.png[Ansicht 'Main directory' mit drei Ordnern, einer davon aufgeklappt mit Symbolen für Ordneraktionen.]
...
image::agent_download_cee.png[Liste der Linux-Agenten zum Download in den {EE}.]
...
image::agent_download_page.png[Liste der Linux-Agenten zum Download in der {RE}.]
...
image::host_allsettings_less.png[Dialog der Eigenschaften beim Erstellen eines Hosts.]
...
icon:button_showmore[Symbol zum Wechsel in den Show-more-Modus.] anklicken und die beiden zugeklappten Kästen am Ende der Seite öffnen. Wie am Anfang erwähnt, ist {CMK} ein komplexes System,
...
image::host_diagnostics.png[Ergebnis des Verbindungstests zum Host mit ping und mit Ausgabe des Agenten.]
...
image::intro_setup_monitor_services_of_host.png[Auf dem Host gefundene Services zur Aufnahme ins Monitoring.]
...
image::activate_changes.png[Liste der aufgelaufenen Änderungen zur Aktivierung.]
...
image::host_snmp_configuration.png[Eigenschaften beim Erstellen eines Hosts per SNMP: die Data sources.]
...
image::snmp_diagnostics.png[Ergebnis des Verbindungstests zum Host per SNMP.]
