...
. In den Eigenschaften des Hosts, im Kasten [.guihint]#Monitoring agents# aktivieren Sie [.guihint]#{CMK} agent / API integrations# und wählen Sie [.guihint]#No API integration, no {CMK} agent# aus.
