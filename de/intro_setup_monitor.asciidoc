...
image::empty_main_directory.png[alt=Das leere Main directory ohne Ordner und Hosts]
...
Bei ausgeblendeter Aktionsleiste werden die Symbole in der Menüleiste rechts neben icon:button_show_toolbar[Symbol] angezeigt.
...
Aktionen zum Erstellen eines Ordners auswählen (z.B. den Aktionsknopf icon:icon_newfolder[alt=Icon zum Erstellen eines Ordners] [.guihint]#Add subfolder#). Auf der neuen Seite
[.guihint]#Create new folder# tragen Sie im ersten Kasten [.guihint]#Basic settings# den Ordnernamen ein:

image::folder_basic_settings.png[alt="Eigenschaften beim Erstellen eines Ordners: die Basic Settings mit Titel"]
...
image::three_empty_folders.png[alt="Main directory mit drei Ordnern, einer davon aufgeklappt mit Symbolen für Ordneraktionen"]
...
image::host_allsettings_less.png[alt=Eigenschaften beim Erstellen eines Hosts]
...
image::intro_setup_monitor_services_of_host.png[alt=Auf dem Host gefundene Services zur Aufnahme ins Monitoring]
...
image::host_snmp_configuration.png[alt=Eigenschaften beim Erstellen eines Hosts per SNMP: die Data sources]
