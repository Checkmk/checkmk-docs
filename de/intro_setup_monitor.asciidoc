...
// MFS: Historisch gewachsen? Erst sagen wir "IP-Adresse", dann entfernen wir dieses Kriterium wieder. 
...
// MFS: In der Regel? Immer! SNMP betrachten wir als "generischen Agenten", Spezialagenten oder Datasource können "virtuelle Agenten" sein.
...
// MFS: Ich weiss, das ist übernommen, aber warum nehmen wir nicht "/tmp" für eine temporäre Datei?
// MFS: Und warum zeigen wir nicht den Sonderfall, dass der Agent auf dem CMK Server direkt ohne Download installiert werden kann?
// MFS: Z.B. /opt/omd/versions/2022.04.26.cee/share/check_mk/agents/check-mk-agent_2022.04.26-1_all.deb
...
// MFS: Hier sollte man IMHO abkürzen. Für Test-Setups und kleine Umgebungen immer localhost nehmen. In größeren Umgebungen das externe Interface und einen auf dieses auflösenden Hostnamen.
...
// MFS: Ich möchte ein Feld "IPv6 address" haben. Ich prangere das an!
...
// MFS: Der erste Absatz ist IMHO Blabla. Würde Information verloren gehen, entfernte man ihn komplett?
// MFS: Evtl. ab Ende ein Link zur Diagonose im Agentenartikel?
