...
:description: Bei vielen Diensten ist es nur sinnvoll, diese von außen auf Funktion oder Antwortzeiten zu überwachen. Hier erfahren Sie, wie das in {CMK} funtioniert.
...
entsprechend gesetzt wurde. In den [.guihint]#Status Details# können Sie dann
