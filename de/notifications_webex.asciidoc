...
== Installation des Erweiterungspakets

Um die Alarmierung per Cisco Webex Teams nutzen zu können, müssen Sie zunächst
das entsprechende Erweiterungspaket installieren. Dieses wurde mit dem
link:https://blog.checkmk.com/feature-pack-2-comes-with-prometheus-integration#how-to-install-feature-pack[Feature Pack 2]
in {CMK} {v16}p12 ausgeliefert. Sofern ihr {CMK} also mindestens
diesem Patchlevel entspricht, öffnen Sie WATO > Extension Packages und klicken
Sie auf den Knopf icon:install_extension[]
[.guihint]#cisco_webex_teams_notifications#.

[{image-border}]
image::notifications_webex_install_extension.png[]
