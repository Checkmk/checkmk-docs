...
// ML: Ich würde auf die Joined columns verzichten - werden oben bereits erklärt und verwirren hier eher, weil die Dialoge strukturell unterschiedlich sind und auch der Join technisch anders ist. Stattdessen vielleicht in 3.6 noch ein Beispiel mit Makro nachreichen?
