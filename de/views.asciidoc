...
Seitenleistenelemente [.guihint]#Overview# und [.guihint]#Views#. In der 
...
. Im Seitenleistenelement [.guihint]#Views# über den Knopf icon:button_view_snapin_edit[]. Dort können Sie mit icon:button_add_view[] ganz neue Ansichten erzeugen oder mit icon:icon_clone[] bestehende anpassen:
