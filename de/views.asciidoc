...
[.guihint]#Check_MK Discovery# und [.guihint]#Check_MK HW/SW Inventory#.
...
Die Ansicht [.guihint]#All hosts# sieht nach einer Umstellung auf [.guihint]#Single dataset# etwa so aus:
...
dass bei einem der drei Hosts die Services [.guihint]#CPU load# udn [.guihint]#Memory# nicht
