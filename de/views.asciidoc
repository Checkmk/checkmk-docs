...
|[.guihint]#Reports > This view as PDF# |Nur in den {EE}: Hierbei wird ein sogenannter Sofortbericht (_instant report_) erzeugt, der die aktuelle Tabellenansicht in ein PDF-Dokument überführt, abzüglich Icons, Navigation und so weiter.
...
// TK: Meinem Verständnis hilft es, wenn man am Anfang kurz skizziert, was man vorhat. Dann kämen auch die Themen Instanzen und Editionen auch nicht so überraschend daher wie zurzeit.
