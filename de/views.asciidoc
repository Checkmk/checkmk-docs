...
*Wichtig:* Die Anzahl der Zeilen der finalen Ansicht entspricht der der Anzahl der Zeilen der zugrundeliegenden Datenquelle Ihrer Ansicht. Verknüpfte Tabellen fügen lediglich ausgewählte Spalten hinzu.
...
// MA: Das geht nicht, weil es mittendrin ist
...
// MA: Finde ich schwierig, weil es die Makros nur in der Inventory-View gibt. Umgekehrt, gibt es die Joined Columns in bei der Host-Datenquelle und bei allen Inventory-Datenquellen. Bei letzterem hat man aber mehr Möglichkeiten. Das oben in 3.6 abzubilden, halte ich für schwierig, weil der Nutzer ja noch gar nichts von Inventory-Tabellen weiß. 
...
// MA: Aber dann fällt ein Teil der Sidebar weg. Hier wird ja ein kompletter Bildschirmausschnitt gezeigt. Ist das nicht ein Problem?
