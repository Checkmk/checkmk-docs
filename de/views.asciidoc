...
. Bei einer bestehenden Tabellenansicht über den Menüeintrag [.guihint]#Display > Customize view# -- womit ein Klon der Tabellenansicht angelegt wird.
...
Die Konfiguration dieser Tabellenansicht geschah über das Hinzufügen von Spalten vom Typ [.guihint]#Joined column#.
...
So eine Darstellung ist natürlich nur dann nützlich, wenn die Tabellenansicht eine Liste von ähnlichen
