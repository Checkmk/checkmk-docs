...
|===
|Funktion |Ergänzende Informationen
|Grafana |Das xref:grafana#[Grafana-Plugin] können Sie direkt aus dem Grafana Store installieren.
|===
////
...
// TK: Eintrag für die Images (AWS und Microsoft Marketplaces) fehlt noch
...
In kleinem Rahmen, d.h. mit einer Instanz und bis zu 750 Services, können Sie {CMK} mit der {CE} auch dauerhaft ohne Lizenzierung betreiben.
// MFS: Lizenzierung ist das schon, nämlich eine Gratis-Lizenzierung, für die keine Subskription benötigt wird. Oder?
|===


[#other]
=== Weitere Funktionen
// TK: In der folgenden Tabelle werden die Plugins direkt verlinkt. Doppelter Pflegeaufwand, da in den Cloud-Artikeln die gleichen Links gibt. Stattdessen nur Verweis in die Cloud-Artikel?
// MFS: Ich halte die Links hier für sinnvoll und würde sie erstmal drinlassen.
