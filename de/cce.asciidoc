...
Die Unterstützung bei der Verlagerung von Anwendungen und Prozessen in die Cloud, d.h. in sogenannten _Lift and Shift_-Szenarien, ist bereits in die {EE} integriert 
...
* Fortgeschrittene Check-Plugins für AWS, Microsoft Azure und GCP +
////
