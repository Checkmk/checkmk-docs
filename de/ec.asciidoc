...
* link:.guihint].html#Matching criteria[Invert matching# auf [.guihint]#Negate match: Execute this rule if the upper conditions are not fulfilled.#
* link:.guihint].html#Outcome & action[Rule type# auf [.guihint]#Skip this rule pack, continue rule execution with next rule pack#
