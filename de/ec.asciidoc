...
icon:icon_event_console[] [.guihint]#Event Console#. Dieses ist ab Werk leer -- es
...
image::ec_define_action_E-Mail.png[]
...
* Funktionen wie link:notifications.html#bulk[Sammelalarme], HTML-E-Mails und andere nützliche Dinge stehen zur Verfügung.
