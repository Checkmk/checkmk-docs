...
*Hinweis:* Wenn Sie die Appliance der {FE} nutzen und auf eine der {EE} upgraden wollen, müssen Sie vorher die xref:cma_webconf_firmware[Firmware] der Appliance upgraden.
Mehr Informationen finden Sie unter xref:update#upgrade[Updates und Upgrades.]
