// -*- coding: utf-8 -*-
// IGNORE % Benachrichtigungs betreiber1 Huckepackdaten Konfigurations kunde1 kunde2 kunde3 p11 se ⇄ Ausfälle spooler
...
{cre-only}
Wenn Sie die {CRE} einsetzen (oder die CEE mit Nagios als Kern), dann verwenden Sie das Werkzeug `livedump`.
