...
Dieses zeigt den Status der einzelnen Instanzen und bietet darüber hinaus die Möglichkeit, vorübergehend eine einzelne Instanz durch einen Klick auf den Status zu deaktivieren und wieder zu aktivieren -- oder auch gleich alle Instanzen auf einmal durck Klick auf [.guihint]#Disable all# oder [.guihint]#Enable all.#
