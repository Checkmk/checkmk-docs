...
seit {v20} einen Mischbetrieb, bei dem die Differenz eine Major-Version sein darf.
...
Dabei ist darauf zu achten, dass die Remote-Instanzen zuerst aktualisiert werden,
...
Auch hier sollten Sie die Werks auf die exakten Anforderungen zu prüfen.
...
So ist zu erwarten, dass erst ein bestimmtes Patchlevel der älteren Version auf der Zentralinstanz einen reibungslosen Mischbetrieb ermöglicht.

Eine Besonderheit im Mischbetrieb ist die zentrale Verwaltung von Erweiterungspaketen, welche nun in Varianten für beide Versionen vorgehalten werden können.
