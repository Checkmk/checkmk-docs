...
Dabei ist darauf zu achten, dass die Remote-Instanzen zuerst aktualisiert werden, die Zentralinstanz aber erst, wenn alle Remote-Instanzen auf dem höheren Versionsstand sind.
