...
COMMENT[Englisch so: link:http://docs.nagvis.org/1.9/en_US/backends.html[NagVis].]
...
* Der Dump der Konfiguration ist auch auf einem [cmc|CMC-Kern] möglich, das Einspielen benötigt Nagios. Wenn auf Ihrem Master der link:cmc.html[CMC] läuft, dann verwenden Sie link:distributed_monitoring.html#cmcdump[CMCDump].
