...
Ausnahmen gelten lediglich während der Durchführung von Updates.
...
Für die reibungslose Durchführung von xref:update_major#[Major-Updates] (beispielsweise von {v21} auf {v22} auf 2.2) in großen verteilten Umgebungen erlaubt {CMK} seit {v20} einen Mischbetrieb, bei dem die Differenz eine Major-Version sein darf.
Dabei ist darauf zu achten, dass die Remote-Instanzen zuerst aktualisiert werden, die Zentralinstanz aber erst, wenn die Remote-Instanzen auf dem höheren Versionsstand sind.
