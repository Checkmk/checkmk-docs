...
|icon:button_sitestatus_online[]
|Die Instanz ist per Livestatus erreichbar.

|icon:button_sitestatus_dead[]
...
|icon:button_sitestatus_disabled[]
...
|icon:button_sitestatus_unreach[]
