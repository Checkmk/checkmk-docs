...
|icon:button_pdf_lo[]
|Vorschau anzeigen
|icon:button_reportscheduler_lo[]
...
Tragen Sie Werte für [.guihint]#Title}} und {{Topic# ein. Wenn Sie den Bericht für alle
...
icon:icon_edit.png] bearbeitet, ICON[icon_new[] kopiert,
icon:icon_delete.png] gelöscht und ICON[button_top_lo[]
icon:button_up_lo.png] ICON[button_down_lo[]
...
[.guihint]#Embedded Image}} und setzen über {{Continue# fort.
...
== Neue Berichte erstellen#create_reports
...
[.guihint]#Report Properties}} und {{Context / Search Filters# an Ihre Anforderungen
an.
...
== Ansichten und Verlaufsgraphen in Berichte einfügen#views
