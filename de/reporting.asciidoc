...
Die {CEE} liefern einige vorgefertigte Berichte.
...
image::reporting_exportmenu_original.png[alt="Liste der Berichte im Menü Export."]
...
Wählen Sie dafür die [.guihint]#Action - Store locally#:
