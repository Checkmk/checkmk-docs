...
Ein weiteres Problem kann darin liegen, dass verschiedene Programme versuchen, auf gleichnamige Dateien versuchen zu schreiben und bei vielen Spool-Dateien leicht der Überblick verloren gehen kann, welches Programm welche Spool-Datei schreibt.
Insbesondere, wenn eine falsch formatierte Spool-Datei zur Folge hat, dass ein Teil der Agentenausgabe unbrauchbar wird, ist dies sehr ärgerlich.
