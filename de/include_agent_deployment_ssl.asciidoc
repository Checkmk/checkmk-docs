...
Der Agent Updater (eine vom Agenten separate Komponente), versucht grundsätzlich, HTTPS-Verbindungen zu verifizieren und bricht diese ab, wenn dies nicht möglich ist.
