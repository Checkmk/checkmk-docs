...
// SK: Mir gefällt hier das Wort "Regel" gar nicht. Es geht hier ja nur um einen Paramerter. Das kommt weiter unten noch mal.
...
// SK: Auch hier ist das Wort Regel m.E. falsch. "Certificates for HTTPS verification" ist ein Parameter einer Regel "Agent updater (Linux, Windows, Solaris)".
