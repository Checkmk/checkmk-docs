...
image::overview_more.png[alt="Snapin Overview im Show-less-Modus.",width=50%]
...
Übrigens werden Probleme von Services hier nicht mitgezählt, deren Host {DOWN} oder in einer xref:glossar#scheduled_downtime[Wartungszeit] ist.
...
image::gui_overview_less.png[alt="Snapin Overview im Show-more-Modus.",width=50%]
