...
Sie in unserem link:check_plugins_catalog.html#Applications[Katalog der Check-Plugins]
nachlesen. Unter anderem kann {CMK} die folgenden Werte überwachen:

* link:check_mysql.sessions.html[ MySQL Database sessions]
* link:check_mysql.galeradonor.html[ MySQL Database: Galera Donor]
* link:check_mysql.galerasize.html[ MySQL Database: Galera Size]
* link:check_mysql.galerastartup.html[ MySQL Database: Galera Startup]
* link:check_mysql.galerastatus.html[ MySQL Database: Galera Status]
* link:check_mysql.galerasync.html[ MySQL Database: Galera Sync Status]
* link:check_mysql.connections.html[ MySQL Maximum connection usage since startup]
* link:check_mysql_slave.html[ MySQL Database: Slave Sync Status]
* link:check_mysql_ping.html[ MySQL Deamon: Status]
* link:check_mysql.innodb_io.html[ MySQL InnoDB engine IO statistics]
* link:check_mysql.html[ MySQL: Version]
* link:check_mysql_capacity.html[ Size of MySQL tablespaces]
...
Unter Zuhilfenahme des Check-Plugins link:check_logwatch.html[Logwatch] können Sie auch
...
[CEE]Die Einrichtung wird mittels der link:wato_monitoringagents.html#bakery[Agent Bakery]
