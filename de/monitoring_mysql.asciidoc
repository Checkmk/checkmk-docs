...
Sie in unserem link:https://checkmk.de/cms_check_plugins_catalog.html.html#Applications[Katalog der Check-Plugins]
nachlesen. Unter anderem kann {CMK} die folgenden Werte überwachen:

* link:https://checkmk.de/cms_check_mysql.sessions.html.html[ MySQL Database sessions]
* link:https://checkmk.de/cms_check_mysql.galeradonor.html.html[ MySQL Database: Galera Donor]
* link:https://checkmk.de/cms_check_mysql.galerasize.html.html[ MySQL Database: Galera Size]
* link:https://checkmk.de/cms_check_mysql.galerastartup.html.html[ MySQL Database: Galera Startup]
* link:https://checkmk.de/cms_check_mysql.galerastatus.html.html[ MySQL Database: Galera Status]
* link:https://checkmk.de/cms_check_mysql.galerasync.html.html[ MySQL Database: Galera Sync Status]
* link:https://checkmk.de/cms_check_mysql.connections.html.html[ MySQL Maximum connection usage since startup]
* link:https://checkmk.de/cms_check_mysql_slave.html.html[ MySQL Database: Slave Sync Status]
* link:https://checkmk.de/cms_check_mysql_ping.html.html[ MySQL Deamon: Status]
* link:https://checkmk.de/cms_check_mysql.innodb_io.html.html[ MySQL InnoDB engine IO statistics]
* link:https://checkmk.de/cms_check_mysql.html.html[ MySQL: Version]
* link:https://checkmk.de/cms_check_mysql_capacity.html.html[ Size of MySQL tablespaces]
...
unten, gehen wir auf die Einrichtung über die link:monitoring_mysql.html#bakery[Agent Bakery]
ein.
...
in einem ersten Schritt in das Plugins-Verzeichnis des link:agent_linux.html#manualplugins[Agenten]
...
link:agent_linux.html#async_plugins[asychron ausgeführt] werden.
...
link:agent_linux.html#pluginconfig[Konfigurationsverzeichnis] (regulär: `/etc/check_mk`)
...
diesen Host eine link:wato_hosts.html#services[Serviceerkennung] durchführen. Der folgende
...
link:agent_linux.html#async_plugins[Artikel über den Linux-Agenten].
...
link:agent_windows.html#customizeexecution[Windows-Agenten].
...
link:check_mysql_capacity.html[mysql_capacity] überwacht. Schwellwerte hierfür lassen sich
...
Unter Zuhilfenahme des Check-Plugins link:https://checkmk.de/cms_check_logwatch.html.html[Logwatch] können Sie auch
...
{cee-only}
Die Einrichtung wird mittels der link:wato_monitoringagents.html#bakery[Agent Bakery]
...
link:monitoring_mysql.html#benutzereinrichten[Datenbankbenutzer auf dem MySQL-Host einrichten]
und eine entsprechende Regel in der Bakery anlegen. Sie finden den Regelsatz
unter [.guihint]#WATO => Monitoring Agents => Rules#. In dem Suchfeld können Sie dann nach
`MySQL` suchen:
...
link:monitoring_mysql.html#benutzereinrichten[Benutzer einrichten] angegeben.
...
|C:\Program Files (x86)\checkmk\agent\config\ |übliches Konfigurationsverzeichnis vor {CMK}-Version VERSION[1.6.0]
|C:\Program Files (x86)\check_mk\plugins\ |übliches Plugins-Verzeichnis vor {CMK}-Version VERSION[1.6.0]
|===
