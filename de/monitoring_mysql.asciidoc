...
* link:https://checkmk.de/cms_check_mysql.sessions.html[ MySQL Database sessions]
* link:https://checkmk.de/cms_check_mysql.galeradonor.html[ MySQL Database: Galera Donor]
* link:https://checkmk.de/cms_check_mysql.galerasize.html[ MySQL Database: Galera Size]
* link:https://checkmk.de/cms_check_mysql.galerastartup.html[ MySQL Database: Galera Startup]
* link:https://checkmk.de/cms_check_mysql.galerastatus.html[ MySQL Database: Galera Status]
* link:https://checkmk.de/cms_check_mysql.galerasync.html[ MySQL Database: Galera Sync Status]
* link:https://checkmk.de/cms_check_mysql.connections.html[ MySQL Maximum connection usage since startup]
...
* link:https://checkmk.de/cms_check_mysql.innodb_io.html[ MySQL InnoDB engine IO statistics]
