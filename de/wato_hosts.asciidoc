...
Das ist bei Services nützlich, die sich bei der Erkennung einen aktuellen Zustand merken (z.&ThinSpace;B. den aktuelle Zustand von Switch Ports).
...
Dazu gehören auch Dateinamen, Logdaten, Konfigurationsregeln, BI-Aggregationen, Berichte, Dashboards und vieles mehr. 
