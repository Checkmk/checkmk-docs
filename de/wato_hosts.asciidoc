...
Das Anlegen neuer Ordner erledigen Sie über ICON[icon_newfolder.png]. Die
...
ICON[icon_folder.png] [.guihint]#Hosts#:
...
das ICON[icon_insert.png] Klonen eines bestehenden Hosts und auch das ICON[icon_edit.png] Editieren
...
[.guihint]#Data Sources}} und {{Custom Attributes.# Die hier
...
Services zu konfigurieren. [.guihint]#Criticality}} und {{Network Segment# sind lediglich
Beispiele.
...
* beim Service [.guihint]#{CMK} Discovery}} im ICON[icon_menu.png] Menü mit dem Eintrag ICON[icon_services.png] {{Edit Services#.
...
* Der normale Weg nach dem Anlegen eines *neuen* Hosts ist der Knopf [.guihint]#Save manual check configuration}}, welcher alle gefundenen Services zur Überwachung übernimmt ({{Available (missing) services#).
...
sucht also alle Hosts mit dem Merkmal [.guihint]#Test system}}, welche gleichzeitig {{ora# in ihrem
Namen haben.
...
ICON[icon_parentscan.png] [.guihint]#Parent scan#.
...
gesetzten Parents, wählen Sie unter [.guihint]#Selection}} die Optionen {{Include all subfolders#
und [.guihint]#Scan all hosts}}. Im Bereich {{Performance# können
...
von [.guihint]#Hostgroups}} als Datenquelle.  Im {{Views#-Widget finden Sie freilich
