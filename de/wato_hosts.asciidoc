...
image::wato_folders_step_2.png[align=center, width=430]
...
image::wato_folders_step_4.png[align=center, width=500]
...
|4 |Über den link:wato_rules.html[Regelsatz] [.guihint]#Hosts with dynamic DNS lookup during monitoring# bestimmen Sie       Hosts für ein dymisches DNS. Das Resultat ist analog zu 3, nur dass für die DNS-Anfrage       jetzt das Feld _Hostname_ verwendet wird. |beim Ausführen der Checks
|===
...
image::filter_wato_folder.png[align=center, width=50%]
...
image::folders_snapin.png[align=center, width=50%]
