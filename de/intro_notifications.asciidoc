...
image::fake_check_results.png[Eingeblendeter Bereich zur manuellen Festlegung des Status für einen Host/Service.]
...
* wenn der Status in letzter Zeit zu oft gewechselt hat und der Service deswegen als icon:icon_flapping[Symbol zur Anzeige eines unstetigen Zustands.] „unstetig“ (_flapping_) markiert wurde. Dies kann übrigens schnell passieren, wenn Sie mittels [.guihint]#Fake check results# den Zustand häufig gewechselt haben.
...
image::service_notifications_broken_alarm.png[Liste der Ereignisse zu Benachrichtigungen für einen Service.]
