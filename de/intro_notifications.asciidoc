...
Sie finden [.guihint]#Fake check results# auf einem ähnlichen Weg wie die Kommandos zum link:intro_monitor.html#ack[Quittieren von Problemen] und zur link:intro_monitor.html#downtimes[Festlegung von Wartungszeiten]: Öffnen Sie eine Statusansicht mit einer Service-Liste (am schnellsten über die [.guihint]#Tactical overview#), blenden Sie die Checkboxen ein und wählen die einen Service aus -- am besten einen, der gerade {OK} ist. Klicken Sie im Menü [.guihint]#Commands => Fake check results#:
