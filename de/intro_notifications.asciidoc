...
* Benutzer können selbständig Benachrichtigungen „abonnieren“ oder abbestellen, wenn Sie das zulassen möchten.
...
* Aktivieren Sie die Benachrichtigungen für andere Benutzer erst dann, wenn Sie die Fehlalarme (_false positives_) auf ein Minimum reduziert haben. Was Sie dafür tun können, haben wir im link:intro_finetune.html[Kapitel über die Feinjustierung des Monitoring] beschrieben.
...
Falls Sie keine E-Mail bekommen haben, muss das nicht gleich ein Fehler sein, denn es gibt Situationen, in denen die Benachrichtigungen von {CMK} absichtlich unterdrückt wird, z.B.:
