...
*Hinweis*: Bei den 50 MByte handelt es sich um eine Schätzung, die der grundsätzlichen Orientierung dienen soll. Unter bestimmten Umständen (z.B. bei der Konfiguration von IPMI im xref:hosts_setup#management_board[Management board]) kann der Wert auch höher sein.
