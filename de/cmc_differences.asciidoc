...
Es ist standardmäßig aktiv, d.h. die Option [.guihint]#Global settings > Monitoring Core > Use separate fetchers and checkers# ist eingeschaltet.
...
Dies hatte gegenüber der Kombination „Nagios und {CMK}“ die sehr angenehme Folgen, dass die benötigte CPU-Zeit für einen
