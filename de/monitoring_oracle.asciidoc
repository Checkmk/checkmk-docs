...
Über [.guihint]#Setup > Agents > Windows, Linux, Solaris, AIX# und das Menü [.guihint]#Agents > Agent rules > ORACLE Databases (Linux, Solaris, AIX# legen Sie eine Regel an.
...
|[.guihint]#Add pre or postfix to TNSALIASes# |Mit dieser Option können Sie den link:monitoring_oracle.html#tns_config[TNSALIAS] entweder global oder für eine spezifische Instanz erweitern.
