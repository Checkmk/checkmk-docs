...
ab der die Möglichkeit eigene SQLs zu definieren und mit dem
...
link:devel_check_plugins.html[{CMK}-Check programmiert] und in die Monitoring-Instanz einbindet. Danach ordnen
