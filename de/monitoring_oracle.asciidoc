...
Vollständigkeit halber erwähnt. Er setzt voraus, dass Sie wissen, wie man ein
xref:devel_check_plugins#[Check-Plugin programmiert] und in die Monitoring-Instanz einbindet. Danach ordnen
