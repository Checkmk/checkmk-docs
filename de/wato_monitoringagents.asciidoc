...
// TK: Update für 2.2.0: Wenn Sie eine der {EE} oder die {CE} verwenden, ...
...
Was es mit den unterschiedlichen Agentenkonfigurationen auf sich hat, erfahren Sie im nächsten beiden Abschnitten.
...
// TK: Update für 2.2.0: Screenshot ggf. neu ziehen wg. neuem Used rulesets icon
...
// TK: Bei dem Satz weiß man auch nicht genau, was gemeint ist. 
...
// TK: Attribut ist per Default gesetzt für den Ordner root. Es ändert sich aber auch nix am Verhalten, wenn das Attribut auf "Do not bake a generic agent package for this folder" gesetzt wird.
...
Der Ordner kann sogar leer sein.
// TK: Update für 2.2.0: Der Ordner kann sogar leer sein, um dort später xref:hosts_autoregister#[Hosts automatisch erstellen zu lassen.]
...
Je mehr Host-spezifische Regeln aufstellen, desto mehr unterschiedliche Varianten von Agenten werden gebaut. 
