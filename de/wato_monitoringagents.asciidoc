...
// IGNORE Hashs Programmier umkonfigurierte
...
// MFS: Muss hier nicht "...Host oder Ordner..." hin, den als Vorbereitung auf Autoregistrierung können Pakete ja für leere Ordner vorbereitet werden.
