...
|xref:agent_deployment#[Automatische Agenten-Updates] |Das Paket aus der Agentenbäckerei wird erstmalig manuell oder per Skript installiert und ird von da an automatisch aktualisiert. |{EE} und {CE}
