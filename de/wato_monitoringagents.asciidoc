...
[.relateddoc]
agent_linux, agent_windows, agent_unix
...
Die Agenten erreichen Sie über das [.guihint]#WATO#-Modul ICON[icon_agents.png]
[.guihint]#Monitoring Agents}}. Bei den {EE} gelangen Sie so erstmal in die {{Agent Bakery#.
Der Knopf ICON[icon_agents.png] [.guihint]#Agent files# bringt Sie dann
...
Sie erreichen die Bakery über [.guihint]#WATO|ICON[icon_agents.png] Monitoring Agents#:
...
Über den Knopf ICON[button_rules.png] [.guihint]#Rules# gelangen Sie zu einer
...
zurück zur [.guihint]#Agent Bakery#. Der Knopf ICON[button_bake_agents.png] sorgt für ein neues Backen der Agenten.
...
eines Hosts in WATO über den Knopf ICON[button_monitoring_agent.png] [.guihint]#Monitoring Agent#:
