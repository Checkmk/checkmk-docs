// -*- coding: utf-8 -*-
// IGNORE Url UserPrincipalName saml | SHA256 SHA384 SHA512 SLES15
...
* {CMK}-Server mit SSL
* Ein unterstütztes Betriebssystem. SLES15 SP4 wird derzeit _nicht_ unterstützt!
