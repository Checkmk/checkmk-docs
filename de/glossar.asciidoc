...
[#check]
==== Check
Ein Check im Sinne von Checkmk ist das Prüfen eines Hosts oder Services gemäß erstellter Regeln,
...
Checks können zum Beispiel mit einem Check-Plugin oder einem lokalen Check implementiert werden. 
