...
// TK: In den Views gibt es neu(?) im Menü Commands > Favorites. Ich habs ausprobiert und Add to Favorites ausgewählt, aber keine Ahnung, wo diese "Favoriten" gespeichert werden - jedenfalls nicht als Lesezeichen.
