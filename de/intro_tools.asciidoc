...
* Sie können die Tabelleneinträge mit der *Filterleiste* reduzieren -- was im gezeigten Beispiel nicht wirklich notwendig, aber bei langen Tabellen sehr hilfreich ist.
