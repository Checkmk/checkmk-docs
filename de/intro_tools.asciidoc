...
image::view_service_filter.png[alt="Tabellenansicht mit geöffneter Filterleiste."]
...
image::filesystem_c.png[alt="Listeneintrag eines Services für ein Windows-Server-Dateisystem."]
...
image::service_metrics.png[alt="Service-Details mit der Tabelle aller Messwerte."]
...
image::example_graph.png[alt="Service-Details mit einem Zeitreihen-Graph der Messwerte."]
