...
Wird eines dieser Dashboards angezeigt, können Sie schnell zu den anderen umschalten: in der Menüleiste rechts neben dem [.guihint]#Help#-Menü finden Sie die Symbole für die verfügbaren Dashboards.

{cre-only}
Das [.guihint]#Main# Dashboard der {EE}, das den Zustand der Instanz anzeigt, ist in der {RE} nicht enthalten. In der {RE} ist das [.guihint]#Problem# auch das [.guihint]#Main# Dashboard.
