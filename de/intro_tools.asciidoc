...
//SK: Der Hinweis kommt mir hier ein wenig spät. Sonst beschreiben wir in intro_* auch immer den Zustand von Checkmk nach einer Neuinstallation und dann wird oben die TO einfach mit allen 4 Spalten gezeigt.
...
link:intro_monitor.html[Weiter geht es mit Checkmk im Monitoring]
