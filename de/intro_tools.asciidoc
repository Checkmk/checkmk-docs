...
//SK: Als Reviewer musste ich jetzt erstmal kurz verstehen, wie aus der alten Struktur von intro diese neue geworden ist. Ich finde die Aufteilung in die Artikel intro_gui und intro_tools aber gerade für Neueinsteiger sehr gut.
