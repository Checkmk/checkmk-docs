...
[.relateddoc]
commands, notifications, timeperiods
...
[.border]
image::downtimeseinrichten_affectedhosts.png[center, width=78%]
...
einschränken. Über die ICON[commands.png] Kommandos in dieser Ansicht können Sie
...
== Regelmäßige Wartungszeiten#scheduled
...
ICON[icon_painteroptions.png] Option einstellen:
