...
(nur {CEE}), z.&ThinSpace;B. wenn diese verlängert werden müssen, wenn die eigentliche
...
|[.guihint]#same day of the month# |Bei dieser Variante bleibt der Wochentag unberücksichtigt. Hier geht es nur darum, der wievielte Tag im Monat ist. Wenn also das Startdatum am 5. eines Monats ist, so wird die Downtime fortan jeden 5. eines Monats wiederholt.
|===
