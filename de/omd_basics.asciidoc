...
:description: {CMK} ermöglicht die Verwaltung von beliebig vielen Instanzen und Softwareversionen auf einem Server. Details zu der Nutzung finden Sie in diesem Artikel.
...
Ab Version {v14} wird bei der Erstellung des Benutzers `cmkadmin`
