...
// TK: Nach dem Kopieren und omd start komme ich nicht auf die kopierte Instanz:
// TK: http://klapp-0245/mysite210z/ > Not Found. The requested URL was not found on this server.
// TK: What have I forgotten?
...
// TK: Gleiches Problem wie nach dem Kopieren: Nach omd start komme ich nicht auf die unter neuem Namen wiederhergestellte Instanz:
// TK: http://klapp-0245/mysite2/ > Not Found. The requested URL was not found on this server.
