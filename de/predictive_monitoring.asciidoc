...
|Arbeitsspeicher | link:https://checkmk.com/de/integrations/mem_linux[Linux: Detailed Usage of RAM, Swap, VMalloc and other Memory Areas], link:https://checkmk.com/de/integrations/winperf_mem[Windows: Memory Statistics], link:https://checkmk.com/de/integrations/hp_procurve_mem[HP Procurve Switches: Memory Usage], link:https://checkmk.com/de/integrations/f5_bigip_mem[F5 Big-IP: Usage of Memory]
