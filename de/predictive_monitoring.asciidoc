...
:description: Prognosebasiertes Monitoring wertet Messdaten der Vergangenheit aus und berechnet daraus eine Vorhersage, wie sich ein Service in {CMK} in Zukunft verhalten wird.
