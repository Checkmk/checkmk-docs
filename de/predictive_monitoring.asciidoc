...
|CPU |link:check_kernel.util.html[CPU Utilization] link:check_cpu.loads.html[CPU Load] link:check_vms_cpu.html[OpenVMS: CPU Utilization and IO-Wait] link:check_ucd_cpu_util.html[UCD SNMP Daemon: CPU Utilization]
|Arbeitsspeicher |link:check_mem.linux.html[Linux: Detailed Usage of RAM, Swap, VMalloc and other Memory Areas] link:check_winperf_mem.html[Windows: Memory Statistics] [check_hp_procurve_mem|HP Procurve Switches: Memory Usage] link:check_f5_bigip_mem.html[F5 Big-IP: Usage of Memory]
|Festplatte |link:check_diskstat.html[Disk Throughput] link:check_winperf_phydisk.html[Windows: Disk Throughput] link:check_scaleio_volume.html[EMC ScaleIO: Volume Size and Throughput] link:check_esx_vsphere_counters.diskio.html[VMWare ESX Host Systems: Disk Throughput] link:check_aws_ec2.disk_io.html[AWS EC2: Instance Disk IO]
|Schnittstelle |link:check_lnx_if.html[Linux: State of Network Interfaces] link:check_winperf_if.html[Windows: State and Performance of Network Interfaces] link:check_statgrab_net.html[Network Interfaces: Traffic] link:check_if64.html[Monitor Network Interfaces via Standard MIB Using 64 Bit Counters]
|Firewall |link:check_checkpoint_packets.html[Checkpoint Firewalls: Packet Statistics]
|===
