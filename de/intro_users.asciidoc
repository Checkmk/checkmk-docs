...
image::contactgroup_example.png[alt="Grafische Darstellung der Beziehung zwischen mehreren Benutzern, Hosts/Services und Kontaktgruppen",width=50%]
...
image::wato_new_contact_group.png[alt=Festlegung der Eigenschaften für eine neue Kontaktgruppe]
...
image::host_group_assignment_rule.png[alt=Zuweisung von Kontaktgruppen zu Hosts in einer Regel]
...
image::host_permissions.png[alt=Zuweisung von Kontaktgruppen zu Hosts in den Host-Eigenschaften]
...
image::wato_new_user_identity.png[alt=Festlegung der Identität für den neuen Benutzer]
...
image::wato_new_user_security.png[alt=Festlegung der Sicherheitseinstellungen für den neuen Benutzer]
...
image::wato_new_user_contact_groups.png[alt=Auswahl der Kontaktgruppen für den neuen Benutzer]
