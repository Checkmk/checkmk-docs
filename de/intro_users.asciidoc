...
Sie zunächst die Hinweise im link:intro_notifications.html[Kapitel über Benachrichtigungen].
...
link:intro_notifications.html[Weiter geht es mit den Benachrichtigungen]
