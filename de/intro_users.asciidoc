...
image::contactgroup_example.png[Illustration der Beziehung zwischen Benutzern, Hosts/Services und Kontaktgruppen.,width=50%]
...
image::wato_new_contact_group.png[Dialog zur Festlegung der Eigenschaften für die neue Kontaktgruppe.]
...
image::host_group_assignment_rule.png[Dialog für die Zuweisung von Kontaktgruppen zu Hosts in einer Regel.]
...
image::host_permissions.png[Dialog zur Zuweisung von Kontaktgruppen zu Hosts in den Host-Eigenschaften.]
...
image::wato_module_users.png[Liste der {CMK}-Benutzer.]
...
image::wato_new_user_identity.png[Dialog zur Festlegung der Identität für den neuen Benutzer.]
...
image::wato_new_user_security.png[Dialog zur Festlegung der Sicherheitseinstellungen für den neuen Benutzer.]
...
image::wato_new_user_contact_groups.png[Dialog zur Auswahl der Kontaktgruppen für den neuen Benutzer.]
