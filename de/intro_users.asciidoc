...
:description: Benutzer in Checkmk werden Rollen für Berechtigungen und Kontaktgruppen für Zuständigkeiten zugewiesen. Um diese Themen geht es im aktuellen Kapitel des Leitfadens für Checkmk Einsteiger, der kompakt durch die ersten Schritte führt, um das IT-Monitoring mit Checkmk optimal einzurichten.
...
//SK: Dieser Artikel heißt jetzt "Benutzer einrichten" statt "Arbeiten mit mehreren Benutzern". Die Artikel fängt dann mit einer Einleitung zu Benutzern an und
//SK: springt dann zu Rollen und Kontaktgruppen, legt solche an und kommt ganz zum Schluss wieder zum "Benutzer anlegen". Ich finde nicht, dass der neue Titel diesem Bogen noch genug Raum lässt.

link:intro_finetune.html[Was zuletzt geschah]
...
Die benötigte Regelsatz heißt [.guihint]#Assignment of hosts to contact groups#. Sie finden ihn z.B. auf der Seite [.guihint]#Contact groups#, die Sie im vorherigen Kapitel geöffnet hatten, im Menü [.guihint]#Contact groups# > [.guihint]#Rules#.
...
link:intro_notifications.html[Hier geht es weiter]
