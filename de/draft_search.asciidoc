...
// MFS: Eher ein philosophisches Problem…
|===
...
// MFS: Ja, es gibt Fälle, in denen die Gewichtung viel Sinn ergibt. Das mögen seltene Fälle sein, 
|===
...
[cols="20,~"]
|===
|  `find=suchbegriff` | Erforderlich, der zu findende Suchbegriff
