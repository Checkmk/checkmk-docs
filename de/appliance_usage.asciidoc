// -*- coding: utf-8 -*-
// IGNORE Absenderadresse CFW CIFS CMA FQDNs Geclustert Instanzlogin Instanzverwaltung Kernelmeldungen SSHFS Systemlog Systemlogs Zertifikatsregistrierungsanforderung cma textbasierte +49 User_Memory support@checkmk
...
Ein Update der {CE} im Lizenzstatus „Trial“ oder „Free“ auf eine Vollversion der {EE} ist natürlich ebenfalls möglich.
...
Für den Zugriff auf die {EE} und {ME} benötigen Sie die Zugangsdaten Ihres laufenden Support-Vertrags.
