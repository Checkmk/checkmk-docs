...
Nach einem Major-Update der Firmware von der Version xref:majorfirmwareupdate[1.4 auf 1.5] sehen Sie hier unter Umständen einen Hinweis auf Inkompatibilitäten der installierten {CMK}-Versionen.
...
Hintergrund ist ein neues Betriebssystem als Basis für die 1.5er Firmware.
