...
:description: Anleitung zur Einrichtung der physischen und virtuellen Checkmk Appliances.
...
Maschine, wahlweise link:introduction_virt1.html[VirtualBox] oder
link:introduction_virt1.html[VMWare ESXi], eingerichtet und gestartet haben.
