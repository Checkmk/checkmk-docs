...
[.guihint]#Device Infos# und [.guihint]#Web Configuration: on# im Kasten [.guihint]#Access#. Wenn Sie
das Gerät bereits korrekt mit Ihrem Netzwerk verbunden haben, sehen Sie nun,
dass die Netzwerkverbindung aktiv ist ([.guihint]#LAN: UP# im Kasten [.guihint]#Status#.)
...
image::cma_webconf_login_2.png[align=center, width=260]
...
image::cma_site_sidebar_2.png[align=center, width=280]
...
Laden Sie dazu zunächst die gewünschte {CMK}-Version von unserer
link:https://checkmk.de/download.php[Webseite] auf Ihren Computer herunter
...
Laden Sie zunächst das gewünschte Firmware-Paket von unserer
link:https://checkmk.de/appliance-download.php[Webseite] auf Ihren
...
image::cma_caution.png[float=left, width=30]
...
image::cma_important.png[float=left, width=30]
...
image::cma_tip.png[float=left, width=30]
...
image::cluster.png[align=center, width=457]
...
image::cma_de_sms_1.png[align=center, width=457]
...
image::cma_de_sms_3.png[align=center, width=457]
...
image::cma_de_rack1_raid_ok.png[align=center, width=457]
...
image::cma_de_rack1_raid_broken.png[align=center, width=457]
...
image::cma_de_rack1_raid_repair.png[align=center, width=457]
...
image::cma_de_rack1_mgmt_board.png[align=center, width=549]
...
image::cma_note.png[float=left, width=30]
...
Bei einem Hardwareausfall kontaktieren Sie uns bitte per Email an
