...
link:cma_rack1_quick_start.html[Rack] beziehungsweise in einer virtuellen
Maschine, wahlweise link:cma_virt1_basic_virtualbox.html[VirtualBox] oder
link:cma_virt1_basic_esx.html[VMWare ESXi], eingerichtet und gestartet haben.
...
Über den Punkt [.guihint]#Network Configuration# richten Sie zunächst das
...
`F1` und wählen Sie [.guihint]#Device Password#, um das Passwort festzulegen.

Anschließend wählen Sie aus dem Konfigurationsmenü die Option
[.guihint]#Web Configuration#, um die Weboberfläche zu aktivieren.
...
[.guihint]#Device Infos}} und {{Web Configuration: on}} im Kasten {{Access#. Wenn Sie
das Gerät bereits korrekt mit Ihrem Netzwerk verbunden haben, sehen Sie nun,
dass die Netzwerkverbindung aktiv ist ([.guihint]#LAN: UP}} im Kasten {{Status#.)
...
[.guihint]#Console Login# sollten Sie daher den Passwortschutz aktivieren.

Anschließend sehen Sie auf der Startseite im Kasten [.guihint]#Access# die Meldung
[.guihint]#Console Login: on#.
...
//und wählen [.guihint]#Device Password#, um das Passwort festzulegen.
//
...
image::cma_webconf_login_2.png[center, width=260]
...
Wählen Sie hier den Menüpunkt [.guihint]#Device Settings#. In diesem Dialog können
...
oder Hostnamen unter dem Punkt [.guihint]#NTP Servers# ein.

Wenn von Ihrem Gerät aus E-Mails verschickt werden sollen, z.B. Notifikationen
bei erkannten Problemen, müssen Sie die Option [.guihint]#Outgoing Emails#
...
== Monitoring-Instanzen verwalten#site_management

=== Neue Instanz anlegen

Öffnen Sie das Hauptmenü der Weboberfläche und klicken auf den
Menüpunkt [.guihint]#Site Management#. In diesem Dialog haben Sie Zugriff auf
...
Monitoring-Instanz, klicken Sie nun auf den Knopf [.guihint]#Create New Site#. Im
...
Sobald Sie den Dialog mit [.guihint]#Create Site# bestätigen, wird die neue
...
Hier sehen Sie die soeben angelegte Instanz mit der ID [.guihint]#mysite# und
ihren Status, hier [.guihint]#running#. Mit dem rechts daneben sichtbaren Knopf in
der Spalte [.guihint]#Control# können Sie die Instanz starten bzw. stoppen. Links
...
das Snapin [.guihint]#{CMK} Appliance# verfügbar. Damit gelangen Sie aus Ihren
Monitoring-Instanzen direkt zur Weboberfläche der Appliance.

//BI:cma_site_sidebar.png center width:457
image::cma_site_sidebar_2.png[center, width=280]
...
In der Weboberfläche finden Sie unter dem Punkt [.guihint]#Site Management# einen
Knopf [.guihint]#Migrate Site#.
...
oder IP-Adresse) des Quellsystems unter [.guihint]#Source Host# angeben. Außerdem
geben Sie die ID der zu migrierenden Instanz unter [.guihint]#Source site ID# an.
...
Knopf [.guihint]#Complete# verlassen. Sie landen wieder in der Instanzverwaltung
...
== {CMK}-Versionen verwalten#manage_cmk
...
den Eintrag [.guihint]#{CMK} versions#.
...
== Firmware-Installation#cma_webconf_firmware
...
und wählen Sie im Hauptmenü den Punkt [.guihint]#Firmware Update#.
...
[.guihint]#Upload & Install#. Nun wird das Paket auf Ihr Gerät geladen, was je nach
...
== Geräteeinstellungen#cma_webconf_system_settings
...
im Kasten [.guihint]#Access# der Konsole einsehen.
...
image::cma_caution.png[left, width=30]
...
== Appliance-GUI per TLS absichern#ssl
...
Beim letzten Punkt [.guihint]#Signing method}} wählen Sie nun {{Create a self signed certificate#.
...
In der Weboberfläche finden Sie die Menüpunkte [.guihint]#Reboot Device#
bzw. [.guihint]#Shutdown Device}} unterhalb des Punkts {{Control Device# im
...
Wählen Sie nun aus dem Hauptmenü der Weboberfläche den Punkt [.guihint]#Device backup#
...
Seite [.guihint]#Device backup}} und wählen dort {{New job# aus. Hier können Sie
...
image::cma_important.png[left, width=30]
...
image::cma_tip.png[left, width=30]
...
wollen, wählen Sie auf der Seite [.guihint]#Device backup}} den Punkt {{Restore#
...
== Einbinden von Netzwerkdateisystemen#cma_mounts
...
Wählen Sie aus dem Hauptmenü der Weboberfläche den Punkt [.guihint]#Manage mounts#
...
Die im Schaubild verwendeten Schnittstellenbezeichnungen [.guihint]#LAN1}}, {{LAN2#
usw. entsprechen den Bezeichnungen der physikalischen Schnittstellen am
Gerät. Im Betriebssystem entspricht [.guihint]#LAN1}} dem Gerät {{eth0}}, {{LAN2#
dem Gerät [.guihint]#eth1# usw.

image::cluster.png[center, width=457]
...
zwei Modi zur Verfügung. Der [.guihint]#Simple Mode}}, mit dem Sie nur {{LAN1#
...
[.guihint]#eth0}} (entspricht {{LAN1#), hier im Screenshot _enp0s17_, hat aktuell
...
Öffnen Sie zunächst das Modul [.guihint]#Clustering# in der Weboberfläche des
...
Weboberfläche auf [.guihint]#Disband Cluster#. Beachten Sie den Text der folgenden
...
image::cma_de_sms_1.png[center, width=457]
...
Über den Menüpunkt [.guihint]#Send test SMS# ist es möglich, eine Test-SMS an
eine Nummer Ihrer Wahl zu verschicken.

COMMENT[ML:Geht mit der VM nicht - bitte nachschiessen]
image::cma_de_sms_3.png[center, width=457]
...
COMMENT[ML:Geht mit der VM nicht - bitte nachschiessen]
image::cma_de_rack1_raid_ok.png[center, width=457]
...
COMMENT[ML:Geht mit der VM nicht - bitte nachschiessen]
image::cma_de_rack1_raid_broken.png[center, width=457]
...
COMMENT[ML:Geht mit der VM nicht - bitte nachschiessen]
image::cma_de_rack1_raid_repair.png[center, width=457]
...
COMMENT[ML:Geht mit der VM nicht - bitte nachschiessen]
image::cma_de_rack1_mgmt_board.png[center, width=549]
...
Menüpunkt [.guihint]#View Log Files# im Hauptmenü der Weboberfläche.
...
image::cma_note.png[left, width=30]
