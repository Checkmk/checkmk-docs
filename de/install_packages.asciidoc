...
* SUSE Linux Enterprise Server (SLES), Version 12 ab SP4 oder Version 15 ab SP1
...
{CMK} legt seine Daten unter dem physikalischen Pfad `/opt/omd` ab, konkret `/opt/omd/versions` für die {CMK} Software und `/opt/omd/sites` für Monitoringdaten.
