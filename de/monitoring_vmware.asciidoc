...
link:https://checkmk.de/cms_check_plugins_catalog.html[Katalog der Check-Plugins] unter
...
verschiedene Möglichkeiten den Huckepacknamen anzupassen. In der
Konfigurationsregel selbst gibt es die folgenden Optionen:

* Ab Version {v14}i1] ist es möglich, den Hostnamen des Betriebssystems der VM zu nutzen, falls dieser über die vSphere-API abgerufen werden kann.
