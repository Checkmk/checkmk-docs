// -*- coding: utf-8 -*-
// IGNORE GSM H5 MTD fernsteuern iDrac zusammengeschaltet rack4+
...
Diese sind bei den rack4-Geräten mit den Nummern 0 und 1 markiert.
...
Alle unterstützten Modelle finden Sie in der link:https://kb.checkmk.com/display/KB/Tested+and+qualified+SMS+Modems[{CMK} Knowledge Base.^]
