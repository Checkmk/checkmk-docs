...
// ML: Der Link zu legacy_checks ist tot. Vielleicht lässt sich active_checks.html#_andere_zu_nagios_kompatible_plugins_einbinden referenzieren, dort heißt der REgelsatz in der 1.6 aber noch " Classical active and passive Monitoring checks", müsste hier also textlich angepasst werden, irgenwie ...
