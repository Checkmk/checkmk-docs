...
* über den Eintrag ICON[icon_services.png] [.guihint]#Edit services# im Kontextmenü des Services link:wato_services.html#discovery_check[[.guihint]#Check_MK Discovery#] eines Hosts
