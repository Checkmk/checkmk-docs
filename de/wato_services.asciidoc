...
* über den Eintrag icon:icon_services[] [.guihint]#Edit services}} im Kontextmenü des Services link:wato_services.html#discovery_check[{{Check_MK Discovery#] eines Hosts
...
von [.guihint]#Undecided services (currently not monitored}} sehen Sie {{Monitored services#. Sollte
...
* Verwendung der [.guihint]#Description}} oder des {{Alias# im Servicenamen
...
Sie gerne gruppiert hätten, beispielsweise [.guihint]#Filesystem}} und {{myservice,# um eine Gruppe mit Dateisystemen zu erstellen. Die Angabe der
...
dass Sie als Datenquelle die [.guihint]#Servicegroups}} setzen. Im {{Views#-Widget
