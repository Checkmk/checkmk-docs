...
* über den Knopf icon:icon_save_to_services[] [.guihint]#Save & go to service configuration# in den [.guihint]#Properties of host# im Setup
* in der der Menüleiste der [.guihint]#Properties of host# über [.guihint]#Hosts > Service configuration#
...
Das Verschwinden eines Dateisystems kann ja auch bedeuten, dass dieses aufgrund eines Fehlers nicht gemounted werden konnte.
...
|--cache |Verwendung von Cachedateien erzwingen (sonst nur bei fehlender Host-Angabe).
