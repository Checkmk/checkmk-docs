...
//SK: Bei Gelegenheit vielleicht noch ein Screenshot davon, wie das dann in Checkmk aussieht.
...
weiterverwenden. Schalten Sie dazu den NSCA-Empfänger mittels `omd config` ein und
...
link:notifications.html[Alarmierungen] und link:alert_handlers.html[Alerthandler] zu schalten.
