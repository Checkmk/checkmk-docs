...
von ihnen repräsentiert ein wichtiges Rädchen ihn Ihrer komplexen IT-Landschaft.
...
des Services link:wato_services.html#discovery_check[[.guihint]#Check_MK Discovery#] eines Hosts
...
image::wato_services_adding_newly_discovered_services.png[alt=""]
...
[.guihint]#Fix all#. Alternativ können die verschwundenen Services auch über den
...
Hilfe des link:wato_rules.html[Regelsatzes] [.guihint]#Disabled services#. Hier
...
_merken_.  So merkt sich z.B. das Plugin für Netzwerkinterfaces die
...
einmal Speichern. Oder Sie frischen _alle_ Services des Host auf, in dem Sie in
...
sich die Arbeit mit link:wato_hosts.html#bulk_operations[Bulkoperationen] von
...
drücken.
. Mit der link:wato_hosts.html#search[Hostsuche] Hosts suchen, alle gefunden mit
...
link:wato_services.html#enforced_services[erzwungenen Services] arbeiten oder -- und
...
konfiguriert die _Erkennung_ der Services -- also das _Was_. Sind die Services
...
auch mit link:wato_services.html#enforced_services[erzwungenen Services]
...
link:wato_rules.html[Regelsätzen], welche exakt die gleichen Namen haben, wie
...
link:wato_rules.html[Regelsatz] [.guihint]#Periodic service discovery#. In einer
...
link:notifications.html[Benachrichtigungen] und link:alert_handlers.html[Alert Handler] zu schalten.
...
link:wato_rules.html#conditions[Regelsatz] [.guihint]#Assignment of services to
...
der Services erfolgt hier in Form link:regexes.html[Regulärer Ausdrücke]. So
...
link:views.html[Ansichten], NagVis-Karten,
link:notifications.html[Benachrichtigungen] und link:alert_handlers.html[Alert
...
Wenn Sie Servicegruppen in link:notifications.html[Benachrichtigungen]
