...
[.relateddoc]
commands, notifications, monitoring_basics
...
* taucht es in der [.guihint]#Tactical Overview}} nicht mehr bei {{Unhandled# auf,
...
|[.guihint]#sticky#
|Normalerweise gilt eine Quittierung immer nur bis zum *nächsten Zustandswechsel*. Wenn also z.B. ein Service im Zustand {WARN} quittiert wird und später nach {CRIT} wechselt, so wird die Quittierung automatisch entfernt. Durch das Einschalten von [.guihint]#sticky# bleibt die Quittierung solange erhalten, bis der Zustand {OK} bzw. {UP} erreicht wird.

|[.guihint]#send notification#
|Löst eine Alarmierung an alle Kontakte des Hosts/Services vom Typ [.guihint]#Acknowledgement of host/service problem# aus. So wissen Ihre Kollegen Bescheid.</td></tr> <tr><td>[.guihint]#persistent comment#</td><td>Mit dieser Option wird Ihr Kommentar nicht automatisch gelöscht, wenn die Quittierung verschwindet oder entfernt wird. So erstellte Kommentare müssen Sie später manuell löschen (siehe am Ende dieses Kapitels).

|[.guihint]#Expire acknowledgement after ...#
|{CEE}: Mit dieser Option setzen Sie eine Gültigkeitsdauer für die Quittierung.  Nach Ablauf der eingestellten Zeit verschwindet die Quittierung von selbst, auch wenn der Host/Service nicht wieder auf {OK} bzw. {UP} geht.  
