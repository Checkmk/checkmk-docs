...
image::service_rule_icon.png[alt=Service mit geöffnetem Aktionsmenü]
...
image::ruleset_oracle_tablespaces.png[alt="Erstellung einer Regel aus dem Regelsatz 'Oracle Tablespaces'"]
...
image::rule_ora_properties.png[alt=Festlegung der Eigenschaften für die neue Regel]
...
image::rule_ora_value.png[alt=Festlegung der Werte für die neue Regel]
...
image::rule_ora_condition.png[alt=Festlegung der Bedingungen für die neue Regel]
...
image::new_taggroup_basic.png[alt=Festlegung der Grundeinstellungen für die neue Host-Merkmalsgruppe]
...
image::new_taggroup_choices.png[alt=Festlegung der Merkmale für die neue Host-Merkmalsgruppe]
...
image::host_custom_attributes.png[alt=Eigenschaften eines Hosts mit der neuen Host-Merkmalsgruppe]
...
image::host_check_command.png[alt="Festlegung des 'Host Check Command' in der gleichnamigen Regel"]
...
image::rule_status_of_cmk_services.png[alt="Festlegung des Zustands von '{CMK} Services' in einer Regel"]
...
image::port_discovery.png[alt=Festlegung zur Überwachung von Switch Ports in einer Regel]
...
image::cpu_util_average.png[alt=Festlegung von Mittelwerten für die CPU-Auslastung in einer Regel]
...
image::discovery_service.png[alt="Service-Liste mit dem Service 'Check_MK Discovery'"]
