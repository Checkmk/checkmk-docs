...
// TK: Die Beschreibungen zu hard state/soft state in anderen Artikeln (monitoring_basics.html#checkintervall und availability.html#softstates) nicht ausführlicher. Insbesondere fehlt, ob und wie sich hard state soft stae in der GUI bemerkbar machen.
