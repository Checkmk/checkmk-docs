...
image::service_rule_icon.png[Service-Dialog mit geöffnetem Aktionsmenü.]

Sie erhalten eine Seite, von der aus Sie Zugriff auf alle Regelsätze dieses Services haben:

image::parameters_of_this_service.png[Liste aller Regelsätze für einen Service.]
...
image::ruleset_search_tablespace.png[Ergebnis der Suche nach 'tablespace' in Regeln.]
...
image::ruleset_oracle_tablespaces.png[Dialog zur Erstellung einer Regel aus dem Regelsatz 'Oracle Tablespaces'.]
...
image::rule_ora_properties.png[Dialog zur Festlegung der Eigenschaften für die neue Regel.]
...
image::rule_ora_value.png[Dialog zur Festlegung der Werte für die neue Regel.]
...
image::rule_ora_condition.png[Dialog zur Festlegung der Bedingungen für die neue Regel.]
...
image::ruleset_ora_one_rule.png[Liste der Regeln mit der erstellten neuen Regel.]
...
image::wato_tag_groups.png[Liste der Host-Merkmalsgruppen.]
...
image::new_taggroup_basic.png[Dialog zur Festlegung der Grundeinstellungen für die neue Host-Merkmalsgruppe.]
...
image::new_taggroup_choices.png[Dialog zur Festlegung der Merkmale für die neue Host-Merkmalsgruppe.]
...
image::host_custom_attributes.png[Dialog mit Eigenschaften eines Hosts mit der neuen Host-Merkmalsgruppe.]
...
image::host_check_command.png[Dialog zur Festlegung des 'Host Check Command' in der gleichnamigen Regel.]
...
image::rule_status_of_cmk_services.png[Dialog zur Festlegung des Zustands von '{CMK} Services' in einer Regel.]
...
image::port_discovery.png[Dialog zur Festlegung der Überwachung von Switch Ports in einer Regel.]
...
image::cpu_util_average.png[Dialog zur Festlegung von Mittelwerten für die CPU-Auslastung in einer Regel.]
