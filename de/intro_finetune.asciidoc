...
[.guihint]#Setup => General => Rule search# die Seite zur Regelsuche öffnen. Wir werden diesen Weg im folgenden Kapitel gehen, in der wir die Erstellung einer Regel vorstellen.
...
Dann suchen Sie sich den passenden Regelsatz -- in diesem Beispiel über die Regelsuche: [.guihint]#Setup => General => Rule search#. Dies öffnet die folgende Seite, in der Sie nach „Oracle“ oder nach „tablespace“ suchen können (Groß- und Kleinschreibung spielen keine Rolle) und alle Regelsätze finden, die diesen Text im Namen oder in der (hier unsichtbaren) Beschreibung enthalten:
