...
entweder das link:intro_gui.html#search_setup[Suchfeld im Setup-Menü] nutzen oder über [.guihint]#Setup > General > Rule search# die Seite zur Regelsuche öffnen. Wir werden den letztgenannten Weg im folgenden Kapitel gehen, in dem wir die Erstellung einer Regel vorstellen.
