...
Der erste Regelsatz [.guihint]#Network interface and switch port discovery# legt fest, unter welchen Bedingungen Switchports überwacht werden sollen. Legen Sie eine Regel für die gewünschten Switches an und wählen Sie aus, ob einzelne Interfaces ([.guihint]#Configure discovery of single interfaces#) oder Gruppen ([.guihint]#Configure grouping of interfaces#) gefunden werden sollen. Aktivieren Sie dann unter [.guihint]#Conditions for this rule to apply > Specify matching conditions > Match port states   # zusätzlich zu  [.guihint]#1 - up# auch [.guihint]#2 - down#:
