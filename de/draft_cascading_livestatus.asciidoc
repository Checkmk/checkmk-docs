...
So verbindet sich der Livestatus-Proxy der Zentralinstanz mit der Remote-Instanz und öffnet einen Port für Anfragen der Viewer-Instanz -- welche dann eben an die Remote-Instanz weitergeleitet werden.

image::distributed_livestatus_cascading_master.png[Verbindungseinstellungen im verteilten Monitoring mit aktiviertem TCP-Zugriff für Viewer-Instanzen.]
...
image::distributed_livestatus_cascading_viewer_01.png[Instanz-ID in den Verbindungseinstellungen.]
...
image::distributed_livestatus_cascading_viewer_02.png[Verbindungseinstellungen mit Zentralinstanz und freiem Port für Livestatus.]
...
Möchten Sie weiter kaskadieren, müssten Sie auf der Viewer-Instanz, wie zuvor auf der Zentralinstanz, ebenfalls den TCP-Zugriff auf den Livestatus-Proxy erlauben, natürlich wieder mit einem anderen, freien Port.
////
