...
* Der Knopf [.guihint]#Fix all# ist meist die beste Aktion für einen neuen Host oder auch für einen bestehenden Host, bei dem Services gefunden wurden, die aktuell nicht überwacht werden: Abschnitt [.guihint]#Undecided services (currently not monitored#). [.guihint]#Fix all# fügt die fehlenden Services hinzu, entfernt verschwundene Services und übernimmt gefundene Host-Labels. 
...
Das ist bei Services nützlich, die sich bei der Erkennung einen aktuellen Zustand merken (z.B. den aktuellen Zustand von Switch Ports oder von Dateisystemen und ihren Mountpoints).
