...
*Hinweis:* Das oben abgebildete [.guihint]#Main dashboard# ist das der {RE}. Die {EE} bieten standardmäßig ein anderes Haupt-link:intro_tools#dashboards[Dashboard], das den Zustand der Instanz anzeigt.
