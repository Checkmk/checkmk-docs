...
.Die Hauptseite mit dem [.guihint]#Main dashboard# der {RE}
...
*Hinweis:* Die Suche in der Monitoring-Umgebung wird so lange keine Ergebnisse liefern, bis Sie den ersten Host ins Monitoring aufgenommen haben.
