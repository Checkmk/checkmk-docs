...
Im Monitor-Menü können Sie Hosts und Services suchen. Die Suche ist sehr interaktiv: Sobald Sie etwas getippt haben, sehen Sie sofort unterhalb des Suchfelds die Ergebnisse, die zu Ihrer Eingabe passen:
...
Die Suchfunktion im [.guihint]#Monitor#-Menü ist übrigens identisch mit derjenigen, die Ihnen das Snapin [.guihint]#Quicksearch# bietet.
