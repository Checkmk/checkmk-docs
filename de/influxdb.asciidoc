...
// TK: Gehören Buckets immer zu einer Organisation? Muss ich beim Einrichten was beachten? In der InfluxDB-GUI sehe ich keine Zuordnung von Bucket zu Organisation. Ich vermute: Wenn ich unter einer Org angemeldet bin und dort einen Bucket erstele, gehört der Bucket zur Org.
...
// TK: Es ist im Vergleich verwirrend, dass die Zusatzwerte bei InfluxDB und bei Graphite unterschiedlich aufgebaut und benamst sind.
