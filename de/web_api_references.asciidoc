...
:description: Dieser Artikel beschreibt alle Möglichkeiten {CMK} per HTTP-API (oder Web-API) zu konfigurieren. Er erweitert damit den einführenden Artikel zur Web-API.
