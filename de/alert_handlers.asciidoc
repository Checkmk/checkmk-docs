...
image::master_control_alert_handlers.png[float=left, float=right, width=280]
...
image::alert_handlers_options.png[align=center, width=580]
...
image::master_control_alert_handlers_off.png[float=left, width=280]
