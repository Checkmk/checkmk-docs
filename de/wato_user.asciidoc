...
pass:[automation:$2b$12$C91bpV...]
pass:[cmkadmin:$2b$12$EQmL3H6O...]
pass:[myuser:!$2b$12$XSOsMciG.z...]
...
Das Ändern geschieht mit dem Befehl `htpasswd`, der aus der Apache-Installation kommt.
Dieser fragt Sie *nicht* nach dem bestehenden Passwort. Wir empfehlen, dass Sie ihr Passwort durch Verwendung der Optionen `-B -C 12` mithilfe von bcrypt verschlüsseln.
Unverschlüsselte verschlüsselte Passwörter erlauben keinen Login in die GUI.
