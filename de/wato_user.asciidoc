...
werden soll, der per Email link:notifications.html[alarmiert] werden soll (link:install_packages.html#smtpconfig[SMTP-Konfiguration] notwendig). Analog ist das Feld
