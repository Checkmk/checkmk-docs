...
Um die Sicherheit in Ihrem Unternehmen weiter zu erhöhen, bietet {CMK} die Nutzung einer Zwei-Faktor-Authentifizierung für jeden Benutzer an. 
...
{CMK} erkennt die auf Ihrem Computer bereits eingerichteten Authentifizierungsmöglichkeiten und erwartet Ihre Auswahl.
