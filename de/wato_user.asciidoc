...
////
TK:
Unschön finde ich den Sprung Benutzerverwaltung > Inventory und wieder zurück.
Eleganter wäre es im inventory im Kap. "3. Mit den Inventurdaten arbeiten" ein neues Unterkapitel anzulegen.
Arbeitstitel: Interne Pfadinformationen anzeigen - und wofür man sie gebrauchen kann
Dann Link dahin und der Leser kann in der Benutzerverwaltung bleiben.

ML:
Für später lasse ich den Kommentar mal drin. Da der Inventory-Artikel aber noch auf 1.6 ist will ich keinen 2.0-Absatz einbauen.
////
...
{CMK} beherrscht noch zwei weitere Spielarten der Anmeldung:
