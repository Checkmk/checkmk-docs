...
|share/ |Hauptteil der installierten Software. Sehr viele Komponenten befinden sich unter `share/check_mk` -- unter anderem auch die weit über 1.300 Check-Plugins.
...
|-v |Checkergebnisse ausgeben: Ohne diese Option sehen nur Sie die Ausgabe des {CMK}-Services selbst und nicht die Resultate der anderen Services.
