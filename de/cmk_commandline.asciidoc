...
Neben dem wichtigen xref:omd_basics#[Befehl `omd`], welcher zum Starten und Stoppen
...
Die {CEE} verwenden als Monitoringkern den xref:cmc#[{CMK} Micro Core] (CMC), bei der
