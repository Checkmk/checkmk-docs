...
Damit entsprechen die angezeigten Daten den Daten, die bei aktivierter TLS-Verschlüsselung dem _Agent Controller_ oder bei Verwendung eines xref:datasource_programs#[Datenquellen-Programms] dem übertragenden Programm übergeben werden.
