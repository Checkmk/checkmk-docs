...
// TK: Vielleicht ist ja mein Mausrad buggy :-)
...
// TK: Stimmt, hab ein wenig mit den ntop-Dahlets rumgespielt, die tun gar nix, was man ihnen sagt. 
...
// TK: Einmalig? Achwas. Einmal reciht nicht? Egal, ist nicht wichtig.
...
// TK: Dass alle Einstellungen perdu sind, hatte ich nicht gar nicht gemerkt. Ticket halte ich trotzdem nicht für notwendig. 
...
// TK: Done. Ich hab wieder nur einen ntop-Link reingetan. Dass man mindestens 3 Voraussetzungen braucht, um die Biester zu sehen (1. CEE, 2. Subscription (hab ich nur in der GUI gelesen, ich weiss gar nicht, wie die aktiviert wird) 3. hochkomplizierte Benutzerzuordnung) steht leider nicht zusammenhängend im ntop-Artikel. Da muss ich mir bei der nächsten Überarbeitung was einfallen lassen... 
