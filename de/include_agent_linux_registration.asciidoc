...
Zunächst wird auf einem im Monitoring befindlichen Host die Registrierung stellvertretend durchgeführt, die JSON-Ausgabe leiten wir dabei in eine Datei um:
