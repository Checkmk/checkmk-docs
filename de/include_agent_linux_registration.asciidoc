...
Wie beim Beispiel oben gilt, dass Sie das Passwort per Parameter übergeben können oder interaktiv danach gefragt werden, wenn Sie den Parameter `--password` weglassen.
