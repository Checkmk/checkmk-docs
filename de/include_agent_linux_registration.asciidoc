...
tcp	LISTEN	0	1024	0.0.0.0:6556	0.0.0.0:pass[*]	users:(("*cmk-agent-ctl*",pid=1861810,fd=9))
----
...
Anschließend können Sie am {CMK} Server eine xref:glossar#service_discovery[Service-Erkennung] durchführen, die gefundenen Services ins Monitoring aufnehmen und schließlich erneut die Änderungen aktivieren.
