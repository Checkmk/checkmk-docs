...
Die Registrierung mit dem Agent Controller setzt ein Linux-Systeme voraus mit einem init-System `systemd` ab Version 220 und einer x86/64-Rechnerarchitektur.
