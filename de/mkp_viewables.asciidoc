...
// TK: Da sonst MKP-Management für RE über Kommandozeile geht, hier klarer machen, dass die Kommandozeile auch für die Erstellung der GUI-Erweiterungen zur Verfügung steht, aber nur eine Alternative für Kommerz-Benutzer ist und *kein* Ersatz für RE-Nutzer. Installation auf anderem Wege erzeugter MKPs geht dann auch wieder für RE-Nutzer.
...
// TK: In dem Screenshot steht deutscher Browser-Text: Datei auswählen
...
// TK: In der folgenden Liste die Kommandos mit {shell} formatieren.
...
// TK: Hier auch mit {shell} formatieren.
...
{cre-only} *Hinweis* für Nutzer der {RE}:
