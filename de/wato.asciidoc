...
image::watosnapin.png[float=left, float=right, width=210]
...
image::wato_activate_changes.png[align=center, width=400]
...
image::wato_quickaccess.png[align=center, width=42%]
