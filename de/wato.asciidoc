...
// TK: Das klingt jetzt sehr danach, als ob du bereits aktivierte Änderungen zurücknehmen könntest. Zuerst dachte ich Dussel tatsächlich, dass es darum geht.
// TK: Besser motivieren, dass man bereits durchgeführte Änderungen *statt* sie zu aktivieren auch wieder rückgängig machen kann.
// TK: Daher würde ich auch den Satz in intro_setup_monitor so formulieren: Informationen dazu, wie man ausstehende Änderungen wieder zurückzieht, finden Sie in ...

Nutzen Sie hierfür den Menüeintrag [.guihint]#Changes > Revert changes#
// TK: Hier fehlt ein Punkt.

image::intro_setup_monitor_activate_pending.png[alt="Auswahl der Funktion 'Revert pending changes'.", width=41%]
// TK: Viele Screenshots = viel aktuell zu halten: Braucht es den hier für die Auswahl eines Menüeintrags?

Damit können Sie alle seit dem letzten [.guihint]#Activate on selected sites# aufgelaufenen Änderungen verwerfen:
// TK: aufgelaufenen > ausstehenden, siehe Wörterbuch
// TK: ZUm Schluss noch das Datum in revdate aktualisieren
