...
image::distributed_monitoring.png[Illustration der Beziehung zwischen mehreren Instanzen und ihrer Komponenten im verteilten Monitoring.,width=470]
...
image::avail_screenshot_neu.png[Liste von Services mit den Prozentwerten ihrer Verfügbarkeit.]
...
image::sla_view_example_modern.png[Ein Service und sein Service Level Agreement für die letzten 15 Tage.]
...
image::inventory_example.png[Baumdarstellung der Hardware-/Software-Inventurdaten eines Hosts.]
...
image::ec_open_events.png[Liste von Ereignissen in der Event Console.]
...
[{image-border}]
image::nagvis_map_2.png[Eine mit NagVis erstellte geografische Karte mit Symbolen für den Zustand von Hosts und Services.]
