...
image::distributed_monitoring_overview_de.png[alt="Illustration der Beziehung zwischen mehreren Instanzen und ihrer Komponenten im verteilten Monitoring.",width=470px]
