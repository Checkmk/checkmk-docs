...
image::distributed_monitoring.png[alt=Illustration der Beziehung zwischen mehreren Instanzen und ihrer Komponenten im verteilten Monitoring,width=470]
...
image::sla_view_example_modern.png[alt=Ein Service und sein Service Level Agreement für die letzten 15 Tage]
