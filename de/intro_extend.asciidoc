...
:description: Checkmk bietet eine Reihe von Möglichkeiten, um das Monitoring nach der Einrichtung auszubauen, unter anderem durch die Optimierung der Sicherheit, die Überwachung sehr große Umgebungen und die Nutzung der Business-Intelligence (BI). Um diese Themen geht es im aktuellen Kapitel des Leitfadens für Checkmk Einsteiger, der kompakt durch die ersten Schritte führt, um das IT-Monitoring mit Checkmk optimal einzurichten.
...
link:intro_notifications.html[Was zuletzt geschah]
...
link:intro_bestpractise.html[Hier geht es weiter]
