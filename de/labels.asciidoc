...
== Übersicht der automatisch generierten Labels
...
|cmk/vsphere_object |„vcenter“, wenn der Host ein VMware vCenter ist, „server“, wenn der Host ein ESXi Hostsystem ist
|esx_vsphere_vm |
|k8s_daemon_pods |
|k8s_ingress_infos |
|k8s_job_info |
