...
// ML: Ich finde so Basislogik soweit ziemlich selbsterklärend - aber falls im Review der Wunsch nach mehr Erläuterung aufkommt, hier ein Vorschlag:
// ML: Die Filter im obigen Bild würden also Hosts herausfiltern, die ein Linux-System sind und nicht "name1" heißen sowie Windows-Systeme, die nicht headless und nicht französisch sind.
