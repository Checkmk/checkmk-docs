...
[.guihint]#Hardwaretype is Real Hardware}}, das Label {{hw:real# hinzu:
...
Diese ist per Default auf [.guihint]#Warning}} eingestellt. Wählen Sie hier {{OK - do not alert, just display# und
...
== Labels als Bedingungen in Regeln#conditions
