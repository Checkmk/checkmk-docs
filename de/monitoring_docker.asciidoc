...
Ab Version {v16} der {CEE} können Sie mithilfe der link:dcd.html[dynamischen Konfiguration]
...
Dazu benötigen Sie noch folgende link:agent_linux.html#plugins[Agent-Plugins]:
...
Verwenden Sie dazu in der link:dcd.html[dynamische Konfiguration] den Konnektor [.guihint]#Piggyback#.
...
Ab Version {v16} von {CMK} gibt es sogenannte link:labels.html[Hostlabels]. Das
...
für Ihre link:wato_rules.html[Regeln] verwenden, um Ihre Monitoringkonfiguration abhängig
