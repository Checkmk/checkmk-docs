...
image::docker_logo_breit.png[float=left, width=40%]
...
* In der Version VERSION[1.5.0] die Regelsätze [.guihint]#Docker node# und [.guihint]#Piggybacked Docker containers#
...
image::docker_node_dropdown.png[align=center, width=55%]
...
image::docker_container_namemapping.png[align=center, width=70%]
