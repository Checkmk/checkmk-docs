...
////
SP: Weiß der normale Anwender, wie das über die Konfigurationsdatei geht? Ich bräuchte mehr Details.
...
//SP: Und was sind geeignete Translation-Regeln? Ich sehe die Optionen. Kann ich davon ausgehen, dass ein Docker-Anwender jetzt weiß, was er einstellen kann/muss? Oder liegt das außerhalb unserer Zuständigkeiten?//
...
//SP: ich kann diesen Service bei mir nicht finden. Ist das "Docker containers"?//
