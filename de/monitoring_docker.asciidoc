...
////
Frage SP: Weiß der normale Anwender, wie das über die Konfigurationsdatei geht? Ich bräuchte mehr Details.
Bei Nutzung der Agentenbäckerei bin ich durch herumklicken am richtigen Punkt gelandet. Sollte ich dazu hier mehr beschreiben oder führt das zu weit?
////
...
[.guihint]#Docker container status# 
//SP: ich kann diesen Service bei mir nicht finden.//
an. Dieser prüft ohnehin, ob der Container läuft
