...
// MFS: Der Einschub der CCE erschwert es, zu sehen, worauf sich das "Gegenstück" bezieht, vielleicht CE ans Ende, so?
// MFS: Sie passt aber besonders gut als Gegenstück zur Möglichkeit, Hosts automatisch erstellen zu lassen (nur im Funktionsumfang der {CE}).  
Sie passt aber als Gegenstück besonders gut zur Möglichkeit in der {CCE}, xref:hosts_autoregister#[Hosts automatisch erstellen zu lassen.]
