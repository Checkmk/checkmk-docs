...
drei Befehlen. Prinzipiell gehen Sie dabei genauso vor, wie im {CMK} link:wato.html[Setup]:
...
Zuletzt werden die Änderungen, wie im {CMK} link:wato.html#activate_changes[Setup] auch, aktiviert:
