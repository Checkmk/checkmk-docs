...
vergeben oder {CMK} eines mit dem icon:button_random[]
...
|etc/check_mk/multiside.d/wato/users.mk |Benutzereinstellungen in {CMK} werden in dieser Datei definiert.
