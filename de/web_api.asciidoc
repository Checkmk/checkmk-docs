...
drei Befehlen. Prinzipiell gehen Sie dabei genauso vor, wie in der {CMK} Konfigurationsumgebung:
...
Zuletzt werden die Änderungen, wie in der {CMK}-Konfigurationsumgebung auch, aktiviert:
