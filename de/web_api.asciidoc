...
:description: Die Checkmk HTTP-API (oder Web-API) ist eine Schnittstelle, um Checkmk über HTTP zu konfigurieren, und dieser Artikel gibt eine Einführung in die Nutzung dieser API.
<<<<<<< HEAD
=======
...
<<<<<<< HEAD
*Hinweis:* Ab der Version VERSION[2.0] gibt es in {CMK} eine neue API, die link:rest_api.html[REST-API], die die Web-API ablösen soll.
=======
*Hinweis:* Ab der Version VERSION[2.0] gibt es in {CMK} eine neue API, die REST-API, die die Web-API ablösen soll.
>>>>>>> 69bce14a9e6f98faa81be5530894f2e51d3121e1
