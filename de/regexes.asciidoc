...
Das wichtigste Sonderzeichen ist der `.` Punkt. Er <b>matcht ein
beliebiges Zeichen:</b>
...
leere Folge als Folge. Das heißt, `.*` <b>matcht eine beliebige
...
dafür eine Syntax mit geschweiften Klammern, die die <b>exakte
Anzahl oder einen Bereich angibt:</b>
...
So steht beispielsweise `[abc]` für genau eines der Zeichen <b>a,
...
In der [ec|Event Console], im link:bi.html[Business Intelligence (BI)] und auch beim
...
anderem die [wato_rules|Konfigurationsregeln], die link:ec.html[Event Console]
