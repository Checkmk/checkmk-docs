...
// MS: RegExe ist Mischung aus Deutsch und Englich, besser IMHO auszuschreiben:
...
// MS: Neu: Verweis auf die Unterschiede
...
// MS: Neu: Verweis auf weitere Unterschiede bei Plugins
...
// MS: Auskommentiert, bis Unicode-Handling in den Bestandteilen von CheckMK geklärt
////
