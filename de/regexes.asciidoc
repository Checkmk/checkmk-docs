// -*- coding: utf-8 -*-
// IGNORE 1960ern Glyphen Lookahead Manpage Matcht POSIX Regexe Tabstop escapen gematchter matchenden
// IGNORE matchender matcht nonmatch regex101
// In den Schnitzel-Beispielen
// IGNORE Schnit el
