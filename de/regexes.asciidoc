...
== Tabelle aller Sonderzeichen#characters
...
== Wenn Sie es genau wissen möchten#reference
...
und das link:bi.html[Business Intelli&shy;gence (BI)]. Die Python-Regexe sind
