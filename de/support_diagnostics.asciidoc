...
// SK: Ich habe intern darum gebeten diese Option in Crash report umzubenennen.
...
Eine genaue Auflistung sehen Sie direkt unter dem jeweiligen Drop-down-Me­nü.
