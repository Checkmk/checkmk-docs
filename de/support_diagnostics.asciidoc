...
// Instanzauswahl entfernt mit https://checkmk.com/werk/13753
...
// TK: [.guihint]#Business Intelligence# hat keine Dateiauswahl
Auch nach der Aktivierung der Optionen [.guihint]#CMC ({CMK} Microcore)# oder [.guihint]#Licensing information# haben Sie wieder die Möglichkeit, mehr oder weniger vertrauliche Daten aus dem jeweiligen Teil des Pakets zu entfernen -- über die Vorgaben [.guihint]#Pack only Medium and Low sensitivity files# oder [.guihint]#Pack only Low sensitivity files#.

image::support_diagnostics_components.png[alt="Auswahl der Dateien für Licensing information."]
