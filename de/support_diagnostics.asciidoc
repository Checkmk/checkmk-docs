...
image::support_diagnostics.png[alt="Übersicht der Support diagnostics."]
...
image::support_diagnostics_sensitivity_levels.png[alt="Ansicht der auswählbaren Dateien."]

Als Nächstes haben Sie die Möglichkeit, [.guihint]#Performance Graphs of {CMK} Server# mit einzupacken.
Gerade bei Problemen mit der Performance einer {CMK}-Instanz werden diese Reporte fast immer angefragt.
Es bietet sich also an, diese bei einem Performance-Problem einfach gleich mitzuschicken.
Die [.guihint]#Support diagnostics# nehmen Ihnen hier die Arbeit ab, eine ganze Reihe an Reporten manuell als PDF-Dateien zu erzeugen.
Unter anderem werden hier die Reporte des Service [.guihint]#OMD mysite performance# über die letzten 25 Stunden und die letzten 35 Tage generiert.
...
Auch nach der Aktivierung einer der Optionen [.guihint]#Business Intelligence# oder [.guihint]#CMC ({CMK} Microcore)# haben Sie wieder die Möglichkeit, mehr oder weniger vertrauliche Daten aus dem jeweiligen Teil des Pakets zu entfernen -- über die Vorgabe [.guihint]#Pack only Low sensitivity files#. Für den CMC noch einmal unterteilt in [.guihint]#Core files# und [.guihint]#Log files#.
...
Die Support Diagnostics sind darauf angewiesen, dass die {CMK}-Server in Ihrer Umgebung entsprechend gelabelt sind.
