...
Ihnen mit dem offiziellen link:https://checkmk.com/de/produkt/support[{CMK}-Support^] und dem link:https://forum.checkmk.com/[{CMK}-Forum^] zwei exzellente Anlaufstellen.
