...
* Weisen Sie diese über den Regelsatz link:.guihint].html#Host & Service parameters|Monitoring configuration[Service period for hosts# bzw. [.guihint]#... for services# den Objekten zu.
