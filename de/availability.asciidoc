...
// MFS: Das Icon wird stellenweise (inkonsistent) in der GUI noch für
// Availability genutzt, IMHO sollte man es auch für besseren Textfluß
// entfernen.
[{image-left}]
...
oder link:bi.html[BI-Aggregaten] auf. Dort finden Sie im Service-Menü den
