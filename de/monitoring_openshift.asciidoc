...
// MFS: War ein Absatz, umgewandelt in zwei Listenpunkte
...
Klicken Sie anschließend auf [.guihint]#Add new element# und wählen Sie unter [.guihint]#Create hosts in# den zuvor angelegten Ordner aus.
...
// MFS: Wegen inclusiver Sprache, Vermeidung ableistischer Sprache, "blind" durch "unbesehen" ersetzt.
Wir raten davon ab, einfach unbesehen alle _Annotations_ zu importieren, weil hierdurch mitunter ein sehr großer Berg nutzloser Labels in {CMK} erzeugt wird.
