...
- https://checkmk.com/de/werk/13561 - Werk #13561: agent_kubernetes: deprecate special agent and associated checks > Vorbereitungen(?), Nachbereitungen(?), Ausblick
...
- Einige (7?) Snapins entfernt > Nachbereitungen
////
