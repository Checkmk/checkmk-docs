...
*Hinweis:* Da auf sehr alten Windows-Systemen (Server 2008R1 und Vista) kein Agent Controller mit TLS lauffähig ist, müssen Sie bei Bedarf andere Wege der Verschlüsselung wählen. Wir empfehlen, in diesem Fall einen xref:ssh[SSH-Tunnel] einzurichten.
