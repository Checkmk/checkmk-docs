...
{cee-only}
Wann immer wir in diesem Handbuch Funktionen besprechen, die nur für die {EE} gelten -- also für die {SE}, {CE} oder {ME} -- , kennzeichnen wir dies mit dem Symbol wie in diesem Absatz.
