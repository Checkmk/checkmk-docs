...
[{image-border}]
image::omd_site_not_started.png[Fehlermeldung im Webbrowser zu einer nicht gestarteten Instanz.]
...
[{image-border}]
image::omd_site_not_found.png[Fehlermeldung im Webbrowser zu einer nicht vorhandenen Instanz.]
