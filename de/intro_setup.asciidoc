...
Die {CSE} (CSE) richtet sich vor allem an professionelle Anwender und bietet über den Umfang der {RE} hinaus eine Reihe von interessanten Features,
...
{cee-only}
Wann immer wir in diesem Handbuch Funktionen besprechen, die nur für eine der {EE} -- also für die CFE, CEE oder CME -- oder für die CCE gelten, kennzeichnen wir dies mit dem Symbol wie in diesem Absatz.
