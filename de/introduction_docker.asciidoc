...
|-p 8000:8000 |Seit {CMK} {v21} müssen Sie zusätzlich noch den Port für die REST-API nach außen freigeben, um die xref:agent_linux:registration[Registrierung des Agent Controllers] durchführen zu können.
