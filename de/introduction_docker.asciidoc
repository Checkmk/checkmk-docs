...
Um Ihnen die Nutzung als Container so einfach wie möglich zu machen, stellen wir für jede {CMK}-Edition eigene Images zur Verfügung, welche neben {CMK} das Linux-Betriebssystem Ubuntu (_Jammy Jellyfish_) enthalten:
