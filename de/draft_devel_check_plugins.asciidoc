// -*- coding: utf-8 -*-
// IGNORE % Benachrichtigungs greppen
...
ausgegeben werden. Was wir noch brauchen, ist ein *Sektions-Header* (_section header_).
...
Wählen wir für unser Beispiel den Namen `myhostgroups`. In diesem
...
./usr/lib/check_mk_agent/plugins/my_hostgroups
[{file}]
----
#!/bin/bash
...
//SP: 2.6 angepasst, kann vermutlich so bleiben
...
Nachdem das Agentenplugin aktualisert ist, können Sie sich wieder als Instanzbenutzer anmelden.
