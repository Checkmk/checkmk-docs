// -*- coding: utf-8 -*-
// IGNORE % 1000er 1024er Benachrichtigungs check_mk lt → Ganzzahldivison
...
Zuerst werden die zu verarbeitenden Spalten unter ihrem Namen als Liste `column_names` definiert.
...
Ist dagegen die geschachtelte Liste in ein Dictionary überführt, steigt der Aufwand für die Suche eines Elementes nur linear mit der Größe des Dictionaries. 

Im Python-Wiki finden Sie eine link:https://wiki.python.org/moin/TimeComplexity[Übersicht der Kosten^] für die Suche in verschiedenen Datentypen, inclusive Erläuterung und _O-Notation_.
