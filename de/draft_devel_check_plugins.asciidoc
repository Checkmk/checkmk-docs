// -*- coding: utf-8 -*-
// IGNORE % 1000er 1024er Benachrichtigungs check_mk lt → Ganzzahldivison Gleitkommadivison 000er 024er Graphens fehlkonfiguriert
...
Beachten Sie, dass verbleibende Debug-Ausgaben sparsam verwendet und auf Hinweise beschränkt sein sollten, die dem späteren Nutzer bei der Fehlersuche helfen.
Offensichtliche und abzusehende Fehler des Nutzers (z.B. die Inhalte der Agentensektion deuten darauf hin, dass das Agenten-Plugin fehlkonfiguriert ist) sollten Sie mit dem Zustand {UNKNOWN} und aussagekräftigen Hinweisen in der Zusammenfassung beantworten.
