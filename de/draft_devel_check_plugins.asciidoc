...
Die Angaben erfolgen immer in _Sekunden ab dem 1. Januar 1970, 00:00:00 UTC_ -- der sogenannten _Epochenzeit._
...
// TK: oder render.date_and_time(0)?
|`render.date(1700000000)` |`Nov 14 2023`
|`render.date_and_time(1700000000)` |`Nov 14 2023 23:13:20`
|===
...
dass ein _Kilobyte_ nicht 1000, sondern 1024 Bytes ist.
Das ist sehr praktisch, weil so meist runde Zahlen rauskommen.
Der legendäre Commodore C64 hatte eben 64 Kilobyte Speicher und nicht 65,536.

Leider kamen irgendwann Festplattenhersteller auf die Idee, die Größen ihrer Platten in 1000'er-Einheiten anzugeben. Da bei jeder Größenordnung
