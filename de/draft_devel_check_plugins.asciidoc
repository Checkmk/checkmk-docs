...
|Konfiguration der Schwellwerte nur beim Agenten selbst, keine xref:snmp#[SNMP]-Unterstützung durch {CMK} und keine Service-Erkennung möglich.
...
Dabei zeigen wir Ihnen, wie Sie die in Version {v20} von {CMK} *neu entwickelte API* für die
