...
Archivierte Agenten älterer {CMK}-Versionen, die Sie auf eigenes Risiko mit nicht aufgeführten Windows-Versionen nutzen können, stellen wir link:https://download.checkmk.com/legacy-agents/[hier zum Download^] zur Verfügung.
