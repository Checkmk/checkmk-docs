...
noch den Umweg über den Knopf [.guihint]#Unpackaged agents# bzw. [.guihint]#Agent files#:
...
heißt der Kasten [.guihint]#Host tags# und wird auf [.guihint]#Dual: Check_MK Agent + SNMP#
