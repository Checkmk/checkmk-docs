...
// IGNORE Pfadtrenner Skriptbestandteile
...
|xref:agent_deployment#[Automatisches Update] |Das Paket aus der Agentenbäckerei wird erstmalig von Hand oder per Skript installiert und von da an automatisch aktualisiert. | |X |X
|===
