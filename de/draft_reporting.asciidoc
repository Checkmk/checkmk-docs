...
//SP: Mir erschliesst sich nicht der Sinn dieser Auswahl. Das mache ich doch alles im Bericht noch einmal. 
...
In gleicher Weise werden die weiteren Berichtselemente erstellt:
...
SP: Tabelle muss noch erstellt werden

ML:
Vorzugsweise Inhalte und Seitenelemente getrennt - "Bild" taucht in beiden auf und würde sich daher anbieten, um die Unterschiede zwischen Inhalt und Seitenelement zu verdeutlichen.
...
Dann werden sich auch automatisch Fragen ergeben wie zum Beispiel nach einem Inhaltsverzeichnis, Verlinkungen etc. Oder lohnt es sich vielleicht sogar, extra für die Verwendung in Reporten Views anzulegen? 
...
[.guihint]#Add page element# sind reine Gestaltungselemente für Seiten: Horizontale Linie, Bild, Seitenrahmen und eine einzelne Textzeile.
...
Die Einstellungen hierfür finden Sie in der Reportbearbeitung im Kasten [.guihint]#Report Properties#.
