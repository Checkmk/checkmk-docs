...
:description: Das aktuelle Kapitel des Leitfadens für {CMK} Einsteiger stellt kurz das {CMK} Handbuch im allgemeinen und im besonderen den Leitfaden vor, der kompakt durch die ersten Schritte führt, um das IT-Monitoring mit {CMK} optimal einzurichten.
...
link:intro_setup.html[Weiter geht es mit dem Aufsetzen von {CMK}]
