...
image::development_cycle.png[center, width=550]

== Verschiedene Versionen im Detail

=== Tagesversionen vom Master (Daily builds)#daily
...
Ein Tabelle der Pflegezeiträume finden Sie link:cmk_versionen.html#lifecycle[am Ende dieses Artikels.]
...
== Supportzeiträume für stabile Versionen#lifecycle
