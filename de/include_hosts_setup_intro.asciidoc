...
Generell hat es sich bewährt, sich als erstes die Strukturen zu überlegen und diese danach mit Inhalt zu füllen. Konkret bedeutet das also, sich erst mit dem Aufbau der Ordnerstruktur zu befassen und danach die Hosts "einzusortieren".