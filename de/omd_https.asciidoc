...
* Ist der Eintrag zu dem HSTS einmal vom Browser des Nutzers angelegt, kann er -- zumindest vor Ablauf der Zeit -- nur mit entsprechendem Detailwissen zu dem jeweiligen Browsers entfernt werden. Beachten Sie, dass das auf viele User nicht zutrifft.
