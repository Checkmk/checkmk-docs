...
//SP: Der Satz klingt eigenartig. Ich vermute, das Verb ist falsch.
...
// New
Zunächst müssen Sie in der SSL-Konfigurationsdatei die korrekten Pfade zu Schlüssel, Zertifikat und IM-Zertifikat angeben, im Beispiel oben sind das:
