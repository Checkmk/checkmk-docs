...
=== Zertifikate wurde kommerzieller Zertifizierungsstelle ausgestellt
...
=== Zertifikate wurden mithilfe von Letsencrypt generiert
...
=== Zertifikate wurden mit eigener CA ausgestellt
