...
Inc. Fred Router
//SP: Stimmt hier die Formatierung?
...
//SP: Was sind SNMP-Bereiche? Der Begriff taucht hier plötzlich erstmals auf.
...
Da die Fehlerbehebung exakt der im gleichnamigen Kapitel im Artikel zu xref:draft_devel_check_plugins#errors[agentenbasierten Plugins entspricht], gehen wir hier nur auf SNMP-Spezifika ein.
