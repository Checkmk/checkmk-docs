...
xref:draft_devel_intro#[Erweiterungen für {CMK} entwickeln]
...
Da die Fehlerbehebung im wesentlichen der im gleichnamigen Kapitel im Artikel zu xref:draft_devel_check_plugins#errors[agentenbasierten Plugins entspricht], gehen wir hier nur auf SNMP-Spezifika ein.
