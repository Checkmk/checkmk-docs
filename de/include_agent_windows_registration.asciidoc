...
Zwar ist unmittelbar nach Installation des {v21} Agenten oder Update von {v20} eine unverschlüsselte Kommunikation möglich, diese wird aber spätestens bei der nächsten Aktualisierung des Agenten deaktiviert.
