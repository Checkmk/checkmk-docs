...
Mit [.guihint]#Number of columns# können auswählen, in wie vielen Tabellen die Objekte in der Ansicht nebemeinander angezeigt werden (z.B. um Ihren breiten Bildschirm voll auszunutzen). Im obigen Beispiel steht der Wert auf `1`.
