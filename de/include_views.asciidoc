...
Andere Ansichten funktionieren global, z.&ThinSpace;B. diejenige, die Ihnen alle Services anzeigt, die gerade ein Problem haben.

All die *globalen* Ansichten können Sie aus dem [.guihint]#Monitor#-Menü öffnen, unterhalb des jeweiligen Themas, z.&ThinSpace;B. [.guihint]#All Hosts#, [.guihint]#Service problems# oder [.guihint]#{CMK} sites#. 
