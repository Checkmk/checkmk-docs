...
All die *globalen* Ansichten können Sie aus dem [.guihint]#Monitor#-Menü öffnen, unterhalb des jeweiligen Themas, z.B. [.guihint]#All Hosts#, [.guihint]#Service problems# oder [.guihint]#{CMK} sites#.
