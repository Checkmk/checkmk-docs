...
:revdate: 2019-10-14
:title: Der definitive Einstieg in das Monitoring mit {CMK}
:description: {CMK} ist eine komplexe Komplettlösung für Ihr Monitoring. Dieser Einsteigerleitfaden führt kompakt durch die ersten Schritte, um eine optimale Überwachung zu meistern.
...
Die {CRE} (*CRE*) ist kostenlos und zu 100{nbsp}%
...
die {SE} unverbindlich testen wollen oder {CMK}
im kleinen Rahmen einer Instanz mit bis zu 25 überwachten Hosts
einsetzen möchten. Die {FE}
enthält alle Features der {SE}, ist kostenlos und in den ersten 30 Tagen nicht limitiert bzgl. Instanzen und Hosts. Sowohl
...
es noch gibt, erfahren Sie in einem link:cmk_versions.html[eigenen Artikel.]
