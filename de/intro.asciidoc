...
* Die Parameter erlauben Schwellwerte, die von der Größe des Dateisystems abhängen. Wählen Sie dazu link:.guihint].html#Levels for filesystems|Levels for filesystem used space[Dynamic levels#. Mit dem Knopf [.guihint]#Add new element# definieren Sie jetzt pro Plattengröße eigene Schwellwerte.
...
Knopf ICON[icon_rulesets.png] [.guihint]#Rules# im Modul [.guihint]#Contact groups.# Aber
...
. Setzen Sie ferner link:.guihint].html#Data sources[Check_MK Agent# auf [.guihint]#No agent.#
...
. Wählen Sie bei link:.guihint].html#Data sources[Check_MK Agent# die Einstellung [.guihint]#No agent# und speichern Sie ohne Serviceerkennung.
. Legen Sie jetzt eine Regel im Regelsatz link:.guihint].html#Active Checks (HTTP, TCP, etc.)[Check HTTP service# an, die für diesen Host greift (z.B. mit [.guihint]#Explicit hosts# oder einem passenden Host-Tag).
