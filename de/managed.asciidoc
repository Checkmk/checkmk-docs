...
[.relateddoc]
distributed_monitoring, cmk_versionen, update
...
image::managed_distributed_monitoring.png[center, width=470]
...
Schritt: Wählen Sie unter [.guihint]#WATO|Customers}} den Knopf {{New Customer#
...
Neu auf dem Dashboard [.guihint]#Main Overview}} ist die Spalte {{Customers#, welche
sich links der Service Probleme befindet:

image::managed_dashboard.png[center, width=350]
...
image::managed_snapin.png[center, width=270]
...
[.guihint]#WATO|Global Settings# mit dem Button ICON[button_read_only_mode.png]:
