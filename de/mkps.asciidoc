...
// IGNORE Ascii Benachrichtigungs Checkplugins Metrikdefinitionen Steckersymbol Unpackaged auszurollen hochzuladen unpaketiert unpaketierten
...
Erst mit dem Klick auf das Steckersymbol icon:icon_install[] wird ein installiertes Paket aktiviert.
...
=== Pakete deaktivieren und deinstallieren
...
Beim Löschen wird das Paket mitsamt den installierten Dateien gelöscht und somit die Erweiterung komplett entfernt – also das Gegenteil der _Installation_.
...
// MA: Es funktioniert nur "Bei einem verteilten Setup ...".
...
// MA: Hier würde ich erwarten, dass die konkrete Option noch einmal hervorgehoben wird (roter Kasten)
...
Sie können durch die Möglichkeit, Pakete sowohl für die alte als auch für die neue Version zu installieren und freizuschalten, beim Update wird dann automatisch das neuere aktiviert.
