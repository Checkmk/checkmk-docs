...
// IGNORE Ascii Benachrichtigungs Checkplugins Metrikdefinitionen Steckersymbol Unpackaged auszurollen  hochzuladen unpaketiert unpaketierten vorzuhalten p21 p33
...
*Hinweis:* Das in diesem Artikel geschilderte Verhalten mit zweistufiger Installation/Deinstallation entspricht {CMK} {v20}p33.
...
[{shell}]
----
{c-omd} mkp install /tmp/hello_world-0.2.0.mkp
----
...
[{shell}]
----
{c-omd} mkp disable hello_world 0.2.0
----
