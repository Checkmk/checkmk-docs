...
// IGNORE Ascii Benachrichtigungs Checkplugins Metrikdefinitionen Steckersymbol Unpackaged auszurollen  hochzuladen unpaketiert unpaketierten vorzuhalten p21
// MFS: Nicht im Wörterbuch im 2.1.0 Branch:
// IGNORE Agentenplugins Skriptsprachen
...
// MA: Das Icon wird nicht geladen
...
// MA: Wer macht denn diese Änderung? Ich benötige sie, weiß aber nicht, woher ich sie bekomme. Vielleicht eher so: "Nun führen Sie nur noch die xref:wato#activate_changes[Aktivierung der Änderungen] und alle Funktionen [...]"
...
// MA: Hier könnte man einen Link auf das verteilte Setup setzen. Es gibt derzeit noch keinen manuellen Anker dort.
...
=== Pakete auflösen
// MA: Dieser Teil wird nicht im GUI-Teil erklärt, oder? Wieso?
