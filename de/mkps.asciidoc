...
// MFS: Pfad selbst korrigiert, Rest siehe Einleitung "All diese Erweiterungen werden durch Ablage von zusätzlichen Dateien unterhalb des Verzeichnisses `~/local` innerhalb der {CMK}-Instanz realisiert."
