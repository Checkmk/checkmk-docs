...
[.relateddoc]
check_plugins_catalog, localchecks, dev_guidelines
...
* Das WATO-Modul ICON[icon_mkps.png] [.guihint]#Extension Packages# (nur [CEE])
...
== Erweiterungspakete über WATO verwalten#wato

[CEE] Im WATO finden Sie das Modul ICON[icon_mkps.png] [.guihint]#Extension Packages#,
...
image::mkp_manager_sidebar.png[center, width=300]
...
image::mkps_unpackaged.png[center, width=600]
...
== MKP auf der Kommandozeile#commandline
...
== MKPs in verteilten Umgebungen#distr_wato
...
[.guihint]#Enable replication}} auf {{Push configuration to this site# eingestellt ist.


== Feature Packs installieren#feature_packs
