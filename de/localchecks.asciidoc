...
:description: {CMK} kann auch ohne große Programmierkenntnis sehr einfach erweitert werden. Erfahren Sie hier ausführlich, dem Agent ein eigenes Skript übergeben wird.
...
|`%PROGRAMDATA%\checkmk\agent\local` |Windows (Agent seit Version {v16})
|===
