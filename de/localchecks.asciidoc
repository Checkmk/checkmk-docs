...
Daher sind in der Ausgabe auch keine Zeilenumbruchzeichen erlaubt -- es sei denn, sie sind maskiert, zum Beispiel für eine xref:locaclchecks#multi-line[mehrzeilige Ausgabe] in {CMK}.
