...
Zuletzt können Sie die Verarbeitung der Skriptausgaben auch auf dem {CMK}-Server mit dem Befehl `cmk` testen -- einmal für die Serviceerkennung (um die im aktuellen Kontext nicht relevanten Zeilen gekürzt):
...
&#8230; und mit einem ähnlichen Befehl auch die Verarbeitung der Serviceausgabe (ebenfalls gekürzt):
