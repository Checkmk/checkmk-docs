...
Wir werden uns in diesem Artikel mit allen Elementen beschäftigen, die Sie auf dieser Startseite sehen -- und arbeiten uns dabei von links nach rechts durch die {CMK}-Benutzeroberfläche: von der Navigationsleiste über die link:user_interface#main_page[Hauptseite] zur link:user_interface#sidebar[Seitenleiste].
...
Eine Übersicht der persönliche Einstellungen finden Sie im link:user_interface#user_menu[Kapitel zum User-Menü].
...
|Startseite ([.guihint]#Start URL to display in main frame#) |URL der Startseite festlegen. Wird auf der Hauptseite ein link:user_interface#dashboards[Dashboard] angezeigt, können Sie dieses alternativ über das Menü [.guihint]#Dashboard# zur Startseite machen.
...
Ein View ist eine vordefinierte Statusansicht, die Ihnen den aktuellen Zustand von Hosts, Services oder auch anderen Objekten unter einer bestimmten Perspektive als Tabelle anzeigt.
