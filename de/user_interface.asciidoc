...
|Benachrichtigungsregeln ([.guihint]#Notification rules#) |Regeln zu xref:notifications#personal[benutzerdefinierten Benachrichtigungen]. Der Eintrag wird nur angezeigt, wenn [.guihint]#Setup > Global Settings > Rule based notifications# angeschaltet ist (was der Default ist).
...
|Oberflächen-Thema ([.guihint]#User interface theme#) |Die Umschaltung zwischen [.guihint]#Dark# und [.guihint]#Light# ist über [.guihint]#User interface - Color theme# direkt im [.guihint]#User#-Menü möglich.
|Position der Seitenleiste ([.guihint]#Sidebar position#) |Auch hier kann zwischen [.guihint]#Right# und [.guihint]#Left# mit [.guihint]#User interface# umgeschaltet werden.
...
|Zwei-Faktor-Authentifizierung ([.guihint]#Two-factor authentication#) |Aktivierung der erhöhten Sicherheit durch xref:wato_user#2fa[Zwei-Faktor-Authentifizierung] (nur direkt im [.guihint]#User#-Menü möglich).
