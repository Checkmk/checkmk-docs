...
auch mit [.guihint]#New list}} eine ganz neue Liste anlegen. Der {{Titel# einer Liste
...
[.guihint]#Modern (Dark)}} und {{Classic}}. Standardmäßig ist das Theme {{Modern#
...
[.guihint]#User interface theme}} auf den Knopf {{Modern#. Im folgenden Dialog können
