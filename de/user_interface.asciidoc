...
Häufig verwendete Einstellungen können per Klick direkt im [.guihint]#User#-Menü umgeschaltet werden ([.guihint]#User interface#), manche durch Aufruf einer spezifischen Seite, z.B. zum Ändern des Passworts. 
...
|Sprache der Benutzeroberfläche ([.guihint]#Language#) |Standardmäßig können Sie hier zwischen den offiziell von {CMK} unterstützten Sprachen Deutsch und Englisch wählen. Aktivieren Sie in [.guihint]#Setup > Global settings > User interface# die Option [.guihint]#Enable community translated languages (not supported)#, so stehen Ihnen zusätzlich die von der Community übersetzten Sprachen zur Verfügung.
...
|Oberflächen-Thema ([.guihint]#User interface theme#) |Die Umschaltung zwischen [.guihint]#Dark# und [.guihint]#Light# ist auch direkt im [.guihint]#User#-Menü über [.guihint]#User interface > Color theme# möglich.
