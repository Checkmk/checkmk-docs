...
=== IP-Adressen oder Hostnamen der Knoten
...
- Aktualisieren Sie die Nodes nacheinander wie im xref:appliance_usage#cma_webconf_firmware[Appliance-Hauptartikel] beschrieben.
