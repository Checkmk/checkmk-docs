...
Auf der Seite [.guihint]#Clone view# werden im Kasten [.guihint]#Columns# die Spalten der Tabelleninhalt definiert.
...
Sie werden in ihrer eigenen Kategorie gesammelt und tauchen nicht in den Tabellen der aktiven oder der vergangenen Alerts auf.
...
*Hinweis:* Dieses Dashboard ist ähnlich aufgebaut wie die drei Alert-spezifischen Reiter der Seite [.guihint]#Network statistics and flows# (siehe Abschnitt xref:ntop_nw_statistics[Netzwerk-Statistik eines Hosts]).
...
*Hinweis:* Dieses Dashboard ist ähnlich aufgebaut wie der Reiter [.guihint]#Flows# auf der Seite [.guihint]#Network statistics and flows# (siehe Abschnitt xref:ntop_nw_statistics[Netzwerk-Statistik eines Hosts]).
...
*Hinweis:* Dieses Dashboard ist ähnlich aufgebaut wie das link:https://www.ntop.org/guides/ntopng/web_gui/dashboard.html#professional-enterprise-dashboard[Traffic Dashboard^] in der ntopng-Oberfläche.
