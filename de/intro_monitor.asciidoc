...
* In Tabellenansichten wird ein Service mit dem Symbol icon:icon_downtime[alt="Symbol zur Anzeige der Wartungszeit bei Services."] markiert. Ein Host inklusive der mit ihm in die Wartung geschickten Services erhält das Symbol icon:icon_derived_downtime[alt="Symbol zur Anzeige der Wartungszeit bei Hosts."].
