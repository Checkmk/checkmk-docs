...
Wird ein Host mit allen seinen Services in die Wartung geschickt, erhalten die Services das icon:icon_derived_downtime[alt="Symbol zur Anzeige einer abgeleiteten Wartungszeit bei einem Services."] blaue Pause-Zeichen.
