...
Rufen Sie zunächst eine Statusansicht auf, in der das Problem enthalten ist. Am einfachsten ist der Einstieg über die vordefinierten Statusansichten im Menü [.guihint]#Monitor => Problems => Host problems# oder [.guihint]#Service problems#. Zu diesen gelangen Sie übrigens fast noch schneller, wenn Sie in der [.guihint]#Tactical overview# die Zahl der Probleme anklicken.
...
einrichten wollen. Zum Beispiel können Sie in der [.guihint]#Tactical overview# auf die Zahl der Hosts oder der Services klicken, um sich alle Objekte auflisten zu lassen.
