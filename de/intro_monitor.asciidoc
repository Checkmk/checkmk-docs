...
In diesem Kapitel befassen wir uns nur mit den ersten und dem letzten Punkt. Die Benachrichtigungen behandeln wir später in einem link:intro_notifications.html[eigenen Kapitel], da für dieses Thema einige spezielle Vorbereitungen zu treffen sind.
