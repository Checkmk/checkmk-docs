...
* Das Objekt (Host oder Service) wird in Tabellenansichten mit dem Symbol icon:icon_ack[Symbol zur Anzeige der Quittierung.] markiert.
...
image::command_acknowledge.png[Eingeblendeter Bereich zum Quittieren von Problemen.]
...
image::really_acknowledge.png[Dialog zur Bestätigung der Quittierung.]
...
image::command_downtime.png[Eingeblendeter Bereich zur Festlegung einer Wartungszeit.]
...
* Die Objekte werden in Tabellenansichten mit dem Symbol icon:icon_downtime_20[Symbol zur Anzeige der Wartungszeit.] markiert.
