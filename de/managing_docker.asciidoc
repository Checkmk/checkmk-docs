...
=== Zugriff per Kommandozeile#bash
...
== Einen {CMK}-Container aktualisieren#update_easy
...
=== Detailliertes Update für frühere {CMK}-Images#update_complex
