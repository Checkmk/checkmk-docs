...
link:monitoring_basics.html#notifications[Benachrichtigungen] per E-Mail
...
ist im Artikel über die link:notifications.html[Benachrichtigungen] genauer beschrieben.
