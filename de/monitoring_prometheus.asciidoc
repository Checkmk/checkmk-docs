...
[.relateddoc]
check_plugins_catalog, monitoring_kubernetes
...
können Sie Prometheus in {CMK} ab der Version VERSION[1.6.0p12] integrieren. Die
...
*  link:check_plugins_catalog.html#cAdvisor[cAdvisor (Container Advisor)]
...
Über das Auswahlmenü [.guihint]#Entity level used to create Checkmk piggyback hosts#
...
Wählen Sie hierbei entweder [.guihint]#Both}} oder {{Container# aus, legen Sie
...
[.guihint]#Processes}} und den beiden Metriken {{Running}} und {{Blocked# zusammengefasst.
...
== Dynamische Hostkonfiguration#dcd
...
=== Besonderheit im Zusammenspiel mit cAdvisor#dcd_cadvisor
