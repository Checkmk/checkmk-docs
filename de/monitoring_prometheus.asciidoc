...
die Verbindung zu dem Webfrontend Ihres Prometheus-Servers anzupassen.
Bitte beachten Sie,
...
* [.guihint]#Protocol#: Nach der Installation wird das Webfrontend per HTTP zur Verfügung gestellt. Sofern Sie den Zugriff mit HTTPS abgesichert haben, stellen Sie hier das Protokoll entsprechend um.
