...
// MFS: Hinweis auf CRE-Inkompatibilitäten sollte zumindest rein.

== Einleitung
// MFS: Evtl. "...(MKPs) können neben funktionalen Erweiterungen auch solche für die GUI enthalten, also..."
...
// MFS: Bitte Icon vom Buttontext trennen.
...
// MFS: Sieht IMHO übersichtlicher aus wenn man hart umbricht:
...
|===
|Pfad |Bedeutung
// MFS: Bitte auch für Dateinamen Backticks verwenden, um Monospaced zu erreichen.
