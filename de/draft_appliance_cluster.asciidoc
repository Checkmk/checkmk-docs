...
//SP: Die Bezeichnungen eth0 und eth1 tauchen hier erstmals auf. In der Skizze sind sie auch nicht sichtbar. Braucht es dazu eine Erklärung?
...
//SP: Ich verstehe hier den Sinn der Klammer nicht. Worauf bezieht sich der Text darin oder was will er mir sagen?
...
//SP: Entspricht _enp0s32_ dem im Screenshot sichtbaren Namen _ens32_?
