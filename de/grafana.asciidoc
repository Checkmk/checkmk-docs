...
Bei der Verwendung des Development-Tress müssen Sie fehlende Cache-Verzeichnisse etc. anlegen.
...
Nach Updates oder der Installation des Plugins starten Sie den Grafana-Serverdienst neu:
