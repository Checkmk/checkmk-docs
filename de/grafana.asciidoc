...
Die Grafana-Anbindung benötigt auf Seite von {CMK} einen Nutzer, der über ausreichende Berechtigungen verfügt und sich zudem über ein _Automation secret_ statt einem Passwort authentifiziert.
