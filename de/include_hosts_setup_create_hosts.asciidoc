...
// MFS: Müsste man beim Consulting nachfragen oder schauen, ob wir einen Simulator haben.
...
* _automation_: der Host wurde durch den xref:wato_user#automation[Automationsbenutzer] erstellt, z.B. auf der Kommadozeile
...
// MFS: Notiz für später – nach Erweiterung des dcd Artikels hier Link hinzufügen.
