...
Angenommen, Sie haben drei Hosts und wollen für jeden dieser Hosts mit der Regel _Periodic notifications during host problems_ bei Host-Problemen unterschiedliche Benachrichtigungszyklen festlegen:
