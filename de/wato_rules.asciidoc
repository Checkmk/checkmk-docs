...
|icon:icon_rulematch[] |Diese Regel greift und definiert einen oder mehrere Parameter.
...
Wenn Sie nun Ihre Konfiguration aktivieren, läuft {CMK} die Regelkette von oben nach unten durch. Es ergibt sich so die folgende Auswertung:
