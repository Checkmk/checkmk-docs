...
| —  |ICMP |  Ping | {CMK} überwacht die Erreichbarkeit von Hosts per Ping, ist dies nicht möglich, muss eine Regel xref:hosts_setup#monitoring_agents[_Host Check Command_] verwendet werden
|===
