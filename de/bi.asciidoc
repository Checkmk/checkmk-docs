...
[.relateddoc]
views, availability, basics_downtimes
...
Zu diesem Zweck gibt es bei den ICON[icon_commands.png] link:commands.html[Kommandos]
ein
...
dafür sind die sogenannten [.guihint]#Display options#, welche Sie über das Symbol ICON[icon_painteroptions.png]
...
[.guihint]#BI Visualization# über ICON[icon_aggr.png] in der regulären
Aggregatsansicht.
...
Wie hält es BI eigentlich mit ICON[icon_downtime.png] link:basics_downtimes.html[Wartungszeiten]? Nun, hier haben
...
ICON[icon_ack.png] link:basics_ackn.html[quittiert] ist, von BI automatisch berechnet.
