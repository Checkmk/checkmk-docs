...
* link:notifications.html[Benachrichtigungen] bei einem Problem oder gar einem Ausfall einer Anwendung.
...
_Am betreffenden Objekt wird gerade gearbeitet. Mit Ausfällen ist zu rechnen. Auch wenn das Objekt gerade {OK} ist, sollte man sich nicht drauf verlassen. Es kann jederzeit {CRIT} werden. Dies ist bekannt und dokumentiert. Es soll nicht benachrichtigt werden._
...
link:notifications.html[benachrichtigen]? Nun -- auf direktem Wege geht das erst mal nicht,
...
Diesen Service können Sie dann wie gewohnt Kontakten zuordnen und als Basis für Benachrichtigungen verwenden.
