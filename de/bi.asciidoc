...
image::icon_aggr.png[float=left, width=80]
...
image::bi_example.png[align=center, width=90%]
...
image::button_bi_aggregations.png[float=left, width=150]
...
image::button_bi_new_aggregation.png[float=left, width=150]
...
image::bi_button_create.png[float=left, width=60]
...
image::master_control_checks_off.png[float=right, width=280]
...
image::bi_service_popup.png[align=center, width=52%]
...
image::bi_tree_less_minimal.png[align=center, width=240]
...
image::bi_host_tree_tree.png[align=center, width=40%]

image::button_aggregations.png[float=left, width=30%]
...
image::icon_ack.png[float=left, width=40]
