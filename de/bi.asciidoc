// -*- coding: utf-8 -*-
// IGNORE Aggregationen Hilfs Hostgroups backup3 Aggregatsansicht Aggregatsfunktion Aggregatsfunktionen Infrastrukturdiensten aggregiert ausgedünnt durchklicken gefakte gematchten zurückerinnern
...
Damit wird das Aggregat beim Speichern eingefroren - und zwar immer, wenn das Häkchen neu gesetzt wird; auch wenn das Aggregat vorher schon bestanden hat (trotz des Hinweises auf [.guihint]#New aggregations ...#).
