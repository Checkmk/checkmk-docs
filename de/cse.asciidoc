...
|Support Diagnostics |Einige Optionen zur Auswahl von Daten für einen _Dump_ in den xref:support_diagnostics#[Support Diagnostics] gibt es nur in den kommerziellen Editionen, etwa zum Checkmk Micro Core (CMC) oder zur Lizensierung.
|===
