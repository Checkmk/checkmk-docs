...
Zum Testen oder für kleinere Installationen von {CMK} können Sie auf eine der beiden link:https://checkmk.com/de/download[kostenlosen Editionen^] zurückgreifen:
die {RE}, welche Open Source ist, und die bis 750 Services gratis nutzbare {CE}.
