...
xref:hosts_structure#[Host structuring]
{related-end}
...
Ein gutes Beispiel für eine solche Host-Merkmalsgruppe ist _Datacenter_ mit den möglichen Merkmalen _Datacenter 1_ und _Datacenter 2._
