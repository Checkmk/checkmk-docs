...
This may be necessary in individual cases if changes to the network topology are pending, or a downgrade to the {CSE} -- in which only the pull mode is possible -- is to be carried out.
...
.List of rules for the agent plug-ins in the commercial editions
