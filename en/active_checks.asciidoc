...
for the service name `Certificate`. In the following example the label has been
set on four hosts. In the [.guihint]#Status Details# you can then actually see that several
