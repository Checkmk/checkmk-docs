...
.The [.guihint]#Overview# snapin in Show less mode
image::gui_overview_less.png[alt="Overview snapin in Show less mode.",width=50%]
...
.The [.guihint]#Overview# snapin in Show more mode
