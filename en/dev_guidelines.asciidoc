...
* If there are ONLY upper, or ONLY lower thresholds (the commonest cases), then the entry fields in WATO should be coded with [.guihint]#Warning at ______}} and {{Critical at ______#.
