...
*Note:* The mentioned 30 MByte are an estimate for basic orientation. The actual value may be higher on specific circumstances -- e.g. because IPMI has been configured on the xref:hosts_setup#management_board[Management board].
