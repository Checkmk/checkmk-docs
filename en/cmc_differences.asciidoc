...
As an alternative to the [.guihint]#Core statistics# snapin, you can also have your xref:analyze_configuration.html[configuration analyzed by {CMK}], with [.guihint]#Setup > Maintenance > Analyze configuration#. 
