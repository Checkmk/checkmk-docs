...
As a rule, this number corresponds to the number of cores of your server. 
Since the checkers are not IO-bound, they are most effective if each checker gets its own core.
