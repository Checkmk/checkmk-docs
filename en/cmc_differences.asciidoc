...
Gathering this information takes some time, but consumes little memory.
...
The checkers need a lot of memory because they have to carry the {CMK} configuration with them. 
On the other hand, they do not cause any network load and are very fast in execution.
