...
link:https://github.com/Checkmk/grafana-checkmk-datasource/tree/old-main[Archive on GitHub].
...
* You download the 1.x.x zip file from the link:https://github.com/Checkmk/grafana-checkmk-datasource/tags[GitHub project], and manually paste the content into the Grafana plug-in directory.
