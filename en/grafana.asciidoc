...
Wenn Sie bspw. den Sitenamen in einer Metrik, aber nicht als Filterkriterium benötigen, legen Sie einen Regex-Filter an, der mit Asterisk `*` alle Sites matcht.
