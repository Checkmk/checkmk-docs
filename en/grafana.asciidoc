...
To do so, open `/etc/grafana/grafana.ini` in your favorite editor, navigate to the`[plug-ins]` section and modify the line `;allow_loading_unsigned_plug-ins =` as follows.
