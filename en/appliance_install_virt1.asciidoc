...
1. the creation of the virtual machine via the Proxmox web interface
2. uploading the OVA file to the Proxmox server
3. unpacking the OVA file in the terminal
4. importing the virtual hard disks using the terminal
...
You have now completed the VMware Proxmox-specific steps.
