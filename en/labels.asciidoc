...
// TK: Translation: The following sentence remains commented-out.
...
// TK: Translation: Please add the follwoing sentence:
...
// TK: Translation: The following part remains commented-out.
////
...
and select as mode [.guihint]#Only discover new host labels# 
...
The second way to turn the discovery check green is to reconfigure it so that it no longer warns you for new labels. 
...
// TK: Translation: Please add the following new section:
////
[#agent_plugins]
...
// TK: Translation: Please add the following new chapter:
////
