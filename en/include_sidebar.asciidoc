...
If you click on icon:button_sidebar_add_snapin[alt="Icon for displaying all snapins."] at the very bottom of the sidebar, the main page will show you all the snapins that are currently *not* in your sidebar and that you can add with a single click.
