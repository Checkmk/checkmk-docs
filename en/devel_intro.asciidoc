...
By the way, the https://docs.checkmk.com/latest/de/devel_intro.html[German version] of this article has already been updated -- if that is an alternative for you.
