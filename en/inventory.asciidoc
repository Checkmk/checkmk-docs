...
you will also find a button labelled ICON[icon_inv.png] [.guihint]#Inventory#.
...
and then to ICON[icon_inv.png] [.guihint]#Show Hardware/Software Inventory of this host#:
...
Starting from the three basic categories ICON[icon_hardware.png] [.guihint]#Hardware#,
ICON[icon_networking.png] [.guihint]#Networking#
and ICON[icon_software.png] [.guihint]#Software#, you can expand and collapse the
tree’s sub-branches:
...
one is, e.g. the [.guihint]#ICONlink:icon_software.png] Software.html[ICON[icon_packages.png] Packages# table:
...
word [.guihint]#Search}} do not submit data until you press the {{Search# button (after
...
histories from a hostview using the ICON[icon_inv.png] [.guihint]#Inventory History#
button:
