...
This can be found in the commercial editions via [.guihint]#Setup > Agents > Windows, Linux, Solaris, AIX > Related# page, and in the {RE} directly under [.guihint]#Setup > Agents.#
