...
As a site user, you can change the `cmkadmin` user's password - as of patch release 2.1.0p16 - as follows:
...
In all previous patch releases of {CMK} {v21}, you still need to trouble `htpasswd` to change a user's password:
