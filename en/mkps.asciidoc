...
* The ICON[icon_mkps.png] [.guihint]#Extension Packages# WATO module (only [CEE])
...
== Managing extension packages via WATO#wato

[CEE] In WATO you will find the ICON[icon_mkps.png] [.guihint]#Extension Packages#
...
== MKPs on the command line#commandline
...
== MKPs in distributed environments#distr_wato
...
== Installing Feature Packs#feature_packs
...
for example, extensions of existing link:check_plugins_catalog.html[checks], or
