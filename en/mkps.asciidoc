...
Bei einem xref:distributed_monitoring#livestatus[verteilten Monitoring] reicht
...
xref:datasource_programs#specialagents[Spezialagenten] sein. Sie sind in der
...
xref:devel_check_plugins#[Programmierschnittstellen und der
Dateisystemstruktur], der xref:bakery_api#[Integration in die Agentenbäckerei] sowie die
