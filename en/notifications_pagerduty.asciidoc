...
For testing you can use the [.guihint]#Fake check results# and [.guihint]#Custom notification# link:commands.html[commands] and set a host covered by the rule to {DOWN}.
