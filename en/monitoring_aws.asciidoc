...
{CCE-only}
For a convenient start into monitoring AWS, the {CE} of {CMK} ships the two built-in xref:glossar#dashboard[dashboards] [.guihint]#AWS EC2 instances# and [.guihint]#AWS S3# with it.
