...
image::command_acknowledge.png[alt=Faded in area for acknowledging problems]

Enter a comment and click [.guihint]#Acknowledge# -- and with the confirmation of the
'Are you sure?' question{nbsp}...

image::really_acknowledge.png[alt=Confirmation of acknowledgement]
...
image::command_downtime.png[alt=Faded in area for setting a scheduled downtime]
...
* The relevant objects are marked in views with the icon:icon_downtime_20[alt=Icon for displaying the scheduled downtime] symbol.
