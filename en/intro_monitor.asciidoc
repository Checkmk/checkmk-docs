...
* In views, a service is marked with the icon:icon_downtime[alt="Icon for displaying the scheduled downtime for services."] icon. A host, including the services sent to downtime with it, is marked with the icon:icon_derived_downtime[alt="Icon to display the scheduled downtime for hosts."] icon.
