...
the ICON[icon_alert_handlers.png] [.guihint]#Alert Handlers# WATO module.
...
don't yet function. In the ICON[icon_timeperiods.png] [.guihint]#Timeperiods# WATO module
