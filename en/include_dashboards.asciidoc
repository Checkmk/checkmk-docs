...
image::dashboard_problem.png[alt="The 'Problem dashboard'."]

If one of these dashboards is displayed, you can quickly switch to the others: 
...
{cre-only}
The [.guihint]#Main# dashboard of the {EE}, which shows the state of the site, is not included in the {RE}. 
In the {RE}, the [.guihint]#Main# dashboard is the [.guihint]#Problem# dashboard of the {EE}.
...
You can learn all the relevant details for this in the link:dashboards.html[article on the dashboards].
