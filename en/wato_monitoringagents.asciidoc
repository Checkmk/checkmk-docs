...
Baked packages for xref:agent_linux#[Linux] and xref:agent_windows#[Windows] are installed in the same way as the packages you can download from the {CMK} xref:download_page[download page].
