...
An agent collects data relevant to monitoring from a host and transmits the data to the monitoring server.
...
image::agent_access.png[alt="Illustration of the ways {CMK} accesses monitored systems.",width=450px]
...
[{image-border}]
image::agent_windows_communication_flow.png[alt="Illustration of communication between agent and site."]
