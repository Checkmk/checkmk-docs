...
. link:https://documentation.suse.com/sles/12-SP4/html/SLES-all/cha-planning.html#sec-planning-registering[Registering SLES 12^]
. link:https://documentation.suse.com/sles/12-SP4/html/SLES-all/cha-add-ons.html#sec-add-ons-installation[Installing the 'Web and Scripting' module^]
...
* link:https://documentation.suse.com/sles/15-SP1/html/SLES-all/cha-register-sle.html[Registering SLES 15 and Managing Modules^]


== Download the appropriate packages

If you have a subscription, you will find in the link:https://portal.checkmk.com/[customer portal^] a suitable RPM or DEB package for your distribution for every available xref:cmk_versions#[{CMK} version].
...
You can do that for example with the _WinSCP_ program or -- if you are able to use SSH connections -- with the command line tool `scp`.
