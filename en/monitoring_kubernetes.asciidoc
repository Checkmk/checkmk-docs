...
Next, in the GUI of {CMK}, we move on to setting up the xref:glossary#special_agent[specialagent] and a rule to automatically create hosts for your Kubernetes objects.
