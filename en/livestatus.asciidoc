...
|Formats the output conforming to link:https://tools.ietf.org/html/rfc4180[RFC-4180].
...
link:ttps://old.nagios.org/developerinfo/externalcommands/commandlist.ph[Nagios].
