...
link:livestatus.html#network[network], you may possibly want to keep the channel open to
...
[.guihint]#Global Settings > Monitoring Core > Maximum concurrent Livestatus connections#.
