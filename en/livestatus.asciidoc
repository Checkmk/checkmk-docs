...
//Hints for translation start at line 1082
...
The chapter above "Using Livestatus in network environments" is outdated and can be deleted.
This chapter will be replaced by the following chapter in German: commented out to be translated newly.
////
