...
In principle you can proceed in exactly the same way as with {CMK}'s configuration environment:
...
Finally, the changes can be activated as in {CMK}'s' configuration environment:
