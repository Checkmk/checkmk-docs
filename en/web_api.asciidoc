...
In principle you can proceed in exactly the same way as with {CMK}'s link:wato.html[Setup]:
...
Finally, the changes can be activated as in {CMK}'s link:wato.html#activate_changes[Setup]:
