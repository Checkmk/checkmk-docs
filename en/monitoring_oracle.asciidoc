...
* `details`: Here you can determine what should be output in the generated service's [.guihint]#Status Detail#. This line is introduced with the keyword and a colon. The rest of the line is the output.
