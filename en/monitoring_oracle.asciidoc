...
* link:check_oracle_instance.html[Instance state]
* link:check_oracle_version.html[Version]
* link:check_oracle_jobs.html[Jobs]
* link:check_oracle_locks.html[Locks]
* link:check_oracle_processes.html[Processes]
* link:check_oracle_sessions.html[Number of active sessions]
* link:check_oracle_recovery_area.html[Recovery area]
* link:check_oracle_logswitches.html[Log switch activity]
* link:check_oracle_tablespaces.html[General tablespace information]
* link:check_oracle_performance.html[Tablespaces performance]
* link:check_oracle_longactivesessions.html[Long active sessions]
* link:check_oracle_undostat.html[Undo retention]
* link:check_oracle_recovery_status.html[Checkpoint and online backup state]
* link:check_oracle_sql.html[Custom SQLs]
* link:check_oracle_rman.html[RMAN backup status]
* link:check_oracle_rman_backups.html[RMAN backups]
* link:check_oracle_asm_diskgroup.html[ASM disk groups]
* link:check_oracle_dataguard_stats.html[Apply and transport lag of Oracle Data-Guard]
* link:check_oracle_crs_res.html[Oracle Clusterware: Cluster resources]
* link:check_oracle_crs_version.html[Oracle Clusterware: Version]
* link:check_oracle_crs_voting.html[Oracle Clusterware: Voting]
...
//## Erweiterte OptionenHere is still missing a tutorial on how to do this with custom files and mk_oracle.d.
...
they can also be configured as link:cluster_hosts.html[_Clustered Services_].
