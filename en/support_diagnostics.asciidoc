...
the official link:https://checkmk.com/product/support[{CMK}-Support^] and the link:https://forum.checkmk.com/[{CMK}-Forum^] are available which provide two excellent
contact points.
