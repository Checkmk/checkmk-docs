...
//F-:
//
//H2:Optional general information
//
...
//
//BI:support_diagnostics_sensivity_levels.png
//
//Als Nächstes haben Sie die Möglichkeit, {{Performance Graphs of {CMK} Server}}
...
//generiert.
//
//H2:Component specific information
//
...
//
//
//H1: Support Diagnostics über die Kommandozeile
//
...
//
//<tr>
//<td class=tt style="width:40%">--local-files</td>
//<td>Liste aller installierter, unpaketierter und optionaler Dateien unterhalb von `$OMD_ROOT/local`. Dies beeinhaltet auch Informationen über installierte MKPs.</td>
//</tr>
//
//<tr>
//<td class=tt>--omd-config</td>
//<td>Inhalt der Datei `~/etc/omd/site.conf`.</td>
//</tr>
//
//<tr>
//<td class=tt>--checkmk-overview </td>
//<td>Informationen aus [.guihint]#HW/SW Inventory-Knoten Software > Applications > Checkmk# der {CMK}-Server.</td>
//</tr>
//
//<tr>
//<td class=tt>--checkmk-config-files FILE,FILE ...</td>
//<td>Alle .mk- und .conf-Datein aus dem Verzeichnis `~/etc/checkmk`.</td>
//</tr>
//
//<tr>
//<td class=tt>--checkmk-log-files FILE,FILE ...</td>
//<td>Alle Log-Dateien (.log und .state) aus `~/var/log`.</td>
//</tr>
//
//<tr>
//<td class=tt>--performance-graphs</td>
//<td>Performancegraphen (bspw. CPU load, CPU utilization) des {CMK}-Servers.</td>
//</tr>
//
//
...
//
//H1:Fehlende Informationen im Diagnose-Dump
//
//H2:Aktueller Agent benötigt
//
...
//
//H2:Label cmk/check_mk_server:yes
//
