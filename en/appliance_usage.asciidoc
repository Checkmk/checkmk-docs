// -*- coding: utf-8 -*-
// IGNORE +49 CFW CIFS CMA FQDNs Infos NFS SSHFS User_Memory cma netmask pre snapin support@checkmk unmount
...
An update from the {FE} to a full version of the {EE} is of course also possible.
