...
The [.guihint]#{CMK} Appliance# snap-in is available for all sites on the appliance:
...
An update of the {CE} in the license state "Trial" or "Free" to a full version of one of the commercial editions is of course also possible.
