...
After you have logged in with the previously set device password, the main menu will open. 
...
You can combine two Checkmk appliances into a failover cluster. All
