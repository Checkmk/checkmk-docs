...
|icon:icon_derived_downtime[alt="Icon to display the scheduled downtime for hosts."] |The host is in a scheduled downtime. Services whose host is in a downtime are also marked with this icon.
|===
...
|icon:icon_derived_downtime[alt="Icon to display the scheduled downtime for hosts."] |This host is in a scheduled downtime. Services whose host is in a downtime are also marked with this symbol.
