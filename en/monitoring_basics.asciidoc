...
[.relateddoc]
wato_hosts, check_mk_getting_started, wato_monitoringagents
...
at its center (shown here as ICON[parent_map_root.png]):
...
a green double-arrow (ICON[icon_reload.png]) is shown, but a gray four-way-arrow
