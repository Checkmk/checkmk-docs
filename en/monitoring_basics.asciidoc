...
|icon:icon_downtime[] |The service is in a scheduled downtime
|icon:icon_derived_downtime[] |The host (on which the service is located) has a scheduled downtime
|===
...
|icon:icon_downtime[] |This host/service currently has a scheduled downtime at the moment
|icon:icon_derived_downtime[] |This service's host currently has a scheduled downtime at the moment
...
|icon:icon_software[] |This host/service has inventory data. A click on it shows the related view
