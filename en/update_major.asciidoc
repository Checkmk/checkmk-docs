...
xref:agent_registration[TLS registration] of monitored hosts requires access to ports 443 (respectively 80) for REST API calls and port 8000 (new component _Agent Receiver_) of the {CMK} server.
