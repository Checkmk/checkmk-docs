...
To perform xref:agent_registration[TLS registration] of a host in monitoring, that host needs access to {CMK} server ports: port 443 (respectively 80) for REST API requests and port 8000 for the new Agent Receiver.
