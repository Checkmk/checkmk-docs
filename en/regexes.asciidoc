...
In the [ec|Event Console], in link:bi.html[Business Intelligence (BI)] and also in
...
== Table of all special characters#characters
...
== If you'd like to learn the full details#reference
...
the [ec|Event Console] and link:bi.html[Business Intelligence (BI)]. The Python-regexes are an
