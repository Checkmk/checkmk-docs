...
:description: In {CMK}, you can use regular expressions in many places to capture a group of objects and thus achieve a high dynamic.
...
For the time being, please refer to the https://docs.checkmk.com/1.6.0/en/regexes.html[article for {CMK} {v16}], which is still valid in most parts. +
By the way, https://docs.checkmk.com/latest/de/regexes.html[this article in German] is already updated -- if that is an alternative for you.
