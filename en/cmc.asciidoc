...
The CMC utilizes a unique software architecture, and it has been perfectly-tailored for {CMK}.
...
The CMC is included as a component in the xref:intro_setup#editions[{EE}].
The {SE}, {CE} and {ME} are available via subscriptions.
The {CE} can be tested without obligation for a limited period of time and operated permanently without licensing on a small scale.
