...
* The low CPU utilization enables virtualisation to substitute for hardware in many cases.
...
// The graphic below shows the CPU utilization for a {CMK} server before and after changing from
...
By default the {EE} create new sites with the CMC as their core.
