...
As with link:views.html[table views] and link:dashboards.html[dashboards], supplied standard reports cannot be changed – however an existing report can be cloned, and the clone can then be customised as desired.
