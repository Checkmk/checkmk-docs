= Reports
:revdate: 2015-08-22
[.seealso][#views] [#graphing] [#dashboards]:title: Generating and sending reports in Checkmk
...
In Checkmk, a report is a compilation of diverse elements -- [views|views],
...
As with [views|views] and [dashboards|dashboards], Checkmk-supplied reports
