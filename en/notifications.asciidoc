...
[#ticketsystem]
=== Special cases: Ticket system and event engine 
...
*Note:* When using a ticket system or an event engine, you should also observe the notes on these xref:ticketsystem[special cases].
