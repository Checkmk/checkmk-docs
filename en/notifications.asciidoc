...
The most common procedure is for notifications to be sent to all users who have been registered as a xref:wato_user#contacts[contact] for the respective host/service.
