...
Enter 3 to 99999 as the range for the sequential number so that the rule takes effect from the third notification on.
...
Ab der sechsten Benachrichtigung um 14 Uhr bekommt nun zusätzlich auch der Teamleiter eine E-Mail -- aber auch dieser kann keinen der Mitarbeiter zur Problemlösung bewegen.
