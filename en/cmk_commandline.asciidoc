...
|`cmk -N` |`cmk --nagios-config`|For diagnostic purposes, this outputs the configuration to be generated on the standard output, without altering the actual configuration file. Here you can enter a host's name simply in order to view the host's configuration (e.g. `cmk -N myserver123`).
|===
