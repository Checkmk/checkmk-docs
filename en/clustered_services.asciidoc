...
* Cluster hosts can be configured in the same way as 'normal' hosts, for example with xref:wato_rules#hosttags[host tags] or xref:wato_hosts#hostgroups[host groups].
