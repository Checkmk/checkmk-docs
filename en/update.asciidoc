...
Should you not be able to assign all packages via the check of the installed MKPs and the comparison with our catalogue, we recommend the xref:update_20#dry_run[dry run of the update] described below in order to identify incompatibilities and then remove these from your production monitoring before the update.
...
For example, if you want to update from {v15} to {v20}, update to {v16} first.
