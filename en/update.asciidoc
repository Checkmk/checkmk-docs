...
link:install_packages.html[installation] of the desired new link:cmk_versionen.html[version] of {CMK}.
...
//
//LI:Sie haben eine inkompatible Erweiterung installiert.
//LI:Es befinden sich inkompatible Skripte in der Local-Struktur von {CMK}.
//LI:Der durch ein inkompatibles Werk notwendige manuelle Eingriff wurde nicht vorgenommen.
//
