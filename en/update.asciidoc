...
See the article on updating {CMK} version {v16} to {v20} for advice on handling xref:update_20#incompatible[incompatible changes], xref:update_20#local_files[local files] and xref:update_20#incompatible_mkps[incompatible and obsolete MKPs].
