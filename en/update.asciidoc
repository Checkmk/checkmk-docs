...
:description: No matter whether {RE} or one of the {EE}: updating {CMK} is as simple as possible. The principles are explained here.
...
// This block replaces the following text block
// start translation
////
