...
Such an upgrade of a {FE} {v21} is fully covered by the xref:update_major#[Update to version {v22}] article.

If in your case the {FE}'s limit of 25 hosts was sufficient for your needs, but 750 free services are not enough, you have the option of downgrading to the {RE} in addition to purchasing a subscription.
In this case, perform the xref:#cee2cre[downgrade to {RE}] _before_ updating to {v22}.
