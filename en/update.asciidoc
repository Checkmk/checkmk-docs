...
For this you must also upgrade the firmware of the appliance!

. xref:appliance_usage.html#cma_webconf_firmware[First upgrade the firmware] of the appliance via its web interface from the _demo version_ to the current firmware of the _full version_.
