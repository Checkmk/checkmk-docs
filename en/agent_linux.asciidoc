...
To remove a registration using the setup, navigate to #[.guihint]Properties of host# then use the menu entry #[.guihint]#Host > For this host > Remove TLS registration#.
