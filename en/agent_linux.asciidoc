...
|`/var/lib/cmk-agent/pre_configured_connections.json` |Contains a preconfigured connection to a site for the xref:hosts_autoregister#[auto-registration] in the {CE}, integrated into the agent package via Agent Bakery.
