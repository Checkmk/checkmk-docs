...
[{file}]
----
Foo_Application [hilite]#(interval=300)# /usr/local/bin/check_foo -w 60 -c 80
Bar_Extender /usr/local/bin/check_bar -s -X -w 4:5
----
...
service check_mk
{
        ...
        only_from      = [hilite]#10.118.14.5 10.118.14.37#
        disable        = no
}
----
...
[.guihint]#Normal Checkmk agent# and the option [.guihint]#SNMP# to either [.guihint]#SNMP v2 or v3# or
