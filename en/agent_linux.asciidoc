...
image::linux.png[left, width=120]
...
[CEE] The {CEE} utilises the link:wato_monitoringagents.html#bakery[Agent-Bakery] via a
...
== Integration of classic check plug-ins#mrpe
...
=== Asynchronous execution#async_plugins
...
== Extending agents with plug-ins#plugins
...
=== Manual installation of plug-ins#manualplugins
...
=== Configuration of plug-ins#pluginconfig
...
== Monitoring Linux over SNMP#snmp
