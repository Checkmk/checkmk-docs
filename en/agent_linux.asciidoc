...
Dies führt dazu, dass nach Ausführung von `cmk-agent-ctl delete-all` und späterer Reinstallation des Agenten gar keine Verbindung auf Port 6556 möglich ist.
