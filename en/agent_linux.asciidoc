...
[.relateddoc]
wato_monitoringagents, agent_deployment, datasource_programs
...
* The host has been configured in {CMK} for an additional monitoring per link:agent_linux.html#snmp[SNMP], with [.guihint]#Agent type}} set to {{Dual: Check_MK Agent + SNMP#.
