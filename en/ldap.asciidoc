...
== Configuring an LDAP connection#connect
...
entered in the [.guihint]#Description}} field. As always the {{ID# must be unique and an
...
=== Testing the configuration#config_test
...
[cols=<th style="width: 35%">Plug-in</th>,<th style="width: 55%">Description</th>,options="header"]
|===
...
== LDAP in distributed environments#distr_wato
