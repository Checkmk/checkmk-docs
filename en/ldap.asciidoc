...
|[.guihint]#Disable Notifications# |start_url |Deactivates *all* notifications to the user
|[.guihint]#Start-URL to display in main frame# |start_url |The view to be displayed in the right frame
|[.guihint]#Visibility of Hosts/Services# |start_url |Only display hosts/services for which one is a contact
|===
