...
as long as this has not been deactivated with the [.guihint]#No persistent connection#
...
Now with the help of the [.guihint]#Search Filter# option you can further narrow the
...
without this attribute, can be learned link:ldap.html#filter_group[below]:
...
The [.guihint]#Filter Group# option should only be used if the LDAP server is not an
...
with the icon:button_sync_users[] button. In addition, a user will be
...
|[.guihint]#Alias# |cn |Normally the user’s first and last name
|[.guihint]#Authentication Expiration# |pwdlastset |When a user will be logged out or locked out
|[.guihint]#Email address# |mail |The user’s email address
|[.guihint]#Pager# |mobile |A nominated telephone/pager contact number
|[.guihint]#Disable Notifications# |disable_notifications |Deactivates *all* notifications to the user
|[.guihint]#Start-URL to display in main frame# |start_url |The view to be displayed in the right frame
|[.guihint]#Visibility of Hosts/Services# |force_authuser |Only display hosts/services for which one is a contact
|===
...
An error diagnosis is implemented directy in the link:ldap.html#config_test[Configuration settings].
