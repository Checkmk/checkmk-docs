...
Behind these three symbols are more or less extensive menus, the so-called 'mega menus' or symbol menus, whose entries are divided into several topics -- for example, in the [.guihint]#Setup# menu under the [.guihint]#Hosts# topic you will find entries for configuring hosts, host groups, host tags and host-specific rules.
