...
image::empty_dashboard.png[{CMK} startpage page with Main dashboard still empty.]
...
image::mainpage_default.png[{CMK} main page with 'Main dashboard'.]
...
image::monitor_menu_showmore.png[First line of the Monitor menu with search input field and Show more symbol.]
...
icon:button_showmore[Icon for switching to 'Show more' mode.] and show less with icon:button_showless[Icon for switching to 'Show less' mode.].
