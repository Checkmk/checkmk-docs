...
.The main page with the [.guihint]#Main dashboard# of the {RE}
...
*Note:* The search in the monitoring environment will not return any results until you add the first host to the monitoring.
