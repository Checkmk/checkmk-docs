...
*Note:* The [.guihint]#Main dashboard# shown above is that of the {RE}. The {EE} offer by default a different Main link:intro_tools#dashboards[dashboard] that shows the state of the site.
