...
In the Monitor menu you can search for hosts and
...
By the way, the search function in the [.guihint]#Monitor# menu is identical to that offered to you by the [.guihint]#Quicksearch# snapin.
