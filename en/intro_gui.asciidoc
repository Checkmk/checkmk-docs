...
You set the general behavior in the settings for your user profile ([.guihint]#User > Edit profile > Show more / Show less > Set custom show mode#) by setting one of the two modes as the default -- or do without both modes and face the unfiltered complexity.
