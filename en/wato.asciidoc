...
experienced users can edit manually, or even create with scripts.


[#quick_setup]
== Quick setup

Once you have worked longer with the [.guihint]#Setup# menu, you will have
...
xref:user_interface#sidebar[sidebar] with icons for each [.guihint]#Setup# menu
item:
...
accumulated changes" are they transferred to the *monitoring environment*.
...
pending changes."]. This button will take you to a list of these changes:
