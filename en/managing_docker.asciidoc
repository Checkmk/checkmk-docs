...
[.relateddoc]
introduction_docker, cma_virt1_basic_esx, cma_virt1_basic_virtualbox
...
=== Access via the command line#bash
...
== Updating a {CMK} container#update_easy
...
=== Detailed update for older {CMK} images#update_complex
