// -*- coding: utf-8 -*-
// IGNORE GSM H5 MTD SMS UMTS iDrac rack4+
...
These are marked with the numbers 0 and 1 on the rack4 devices.
...
If you are using a *rack4+*: For the initial setup, you must use one of the copper network ports.
...
All supported models can be found in the link:https://kb.checkmk.com/display/KB/Tested+and+qualified+SMS+Modems[{CMK} Knowledge Base.^]
