...
[CEE] The connection of <a href="https://www.servicenow.com/">ServiceNow</a> is
...
. For the [.guihint]#Notification Method}} choose the item {{Servicenow (Enterprise only)#.
...
unique to ServiceNow, [.guihint]#Urgency}} and {{Impact#, you will find links to the
