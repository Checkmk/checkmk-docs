...
* CFW file: The firmware of the appliance. 
...
The xref:appliance_usage#cma_webconf_firmware[firmware update] is done with the appliance Web-GUI.
+
...
You also carry out the xref:appliance_usage#manage_cmk[installation of the {CMK} software] with the appliance Web-GUI. 
The CMA file is offered to you in the download area after selecting the {CMK} edition, version and platform appliance.
+
