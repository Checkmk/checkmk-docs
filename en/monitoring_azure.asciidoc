...
// IGNORE + 25% 50% Balancer Piggyhosts Webserver accout mk timeframe
...
In addition to general information about the costs that are incurred by your Azure environment and the current status of link:https://checkmk.com/integrations/azure_status[Azure in your region^], you can monitor the following Azure products with all editions of {CMK}:

* link:https://checkmk.com/integrations?distributions%5B%5D=check_mk&distributions%5B%5D=check_mk_cloud&search=azure_ad[AD Connect^]
* link:https://checkmk.com/integrations?distributions%5B%5D=check_mk&distributions%5B%5D=check_mk_cloud&search=azure_app_gateway[Application Gateway^]
* link:https://checkmk.com/integrations?distributions%5B%5D=check_mk&distributions%5B%5D=check_mk_cloud&search=azure_vm[Azure Virtual Machines^]
...
* link:https://checkmk.com/integrations?distributions%5B%5D=check_mk&distributions%5B%5D=check_mk_cloud&search=azure_databases[SQL Databases^]
