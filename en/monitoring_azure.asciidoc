...
{CCE-only}
For a convenient start into monitoring Azure, the {CE} of {CMK} ships the two built-in xref:glossar#dashboard[dashboards] [.guihint]#Azure VM instances# and [.guihint]#Azure storage accounts# with it.
