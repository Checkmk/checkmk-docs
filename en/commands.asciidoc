...
|Fake check results |Manually determine the results of checks, i.e. the output, performance data or simply the status of a host or service. This is useful, for example, to test the effects of different outputs and statuses on monitoring, views or even xref:notifications#notification_testing [notifications].
