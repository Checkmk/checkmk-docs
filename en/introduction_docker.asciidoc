...
Since you get a reduced performance with every virtualization and your monitoring in general should have a minimum of physical dependencies, it is not a good solution to use a {CMK} container to monitor your complete infrastructure.
...
Created new site cmk with version 2.1.0p17.cre.
