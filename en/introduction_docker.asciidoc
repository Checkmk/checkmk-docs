...
In order to make the setting-up as easy as possible for you, we supply each {CMK} edition inclusive of its own specific image, which contains the Linux operating system Ubuntu (_Jammy Jellyfish_) in addition to {CMK}:
