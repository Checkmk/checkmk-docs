...
An overview of the link:cmk_versions.html#lifecycle[support periods] can be found at the end of this article.
...
{cee-only}
Since daily builds and beta versions are only recommended for testing purposes
