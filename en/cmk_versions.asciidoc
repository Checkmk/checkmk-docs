...
:revdate: 2021-03-22
:title: {CMK} versions
:description: The software development cycle goes through daily builds, innovation versions, beta versions up to the stable {CMK} version. For stable versions there is active and passive maintenance in fixed periods.
...
An overview of the link:cmk_versions.html#support_periods[support periods] can be found at the end of this article.
...
|{v20} |2021-03-09 |March 2022footnote:stable_version[This is a provisional date. It will be updated after the release of the follow-up version.] |September 2023footnote:stable_version[]
