...
{cee-only} If you use the {CSE}, the {CME} or the {CCE} (exceeding the limits of the "Free" license state: 750 services, one site), you are obliged to regularly provide an overview of the use of {CMK} in your organization to {comfull}.
...
Then click on the icon:icon_assume_0[alt="Icon for offline transfer of license data."] [.guihint]#Offline verification# button in the {CE}, or [.guihint]#Submit license usage offline# in the other {EE}.

One of the following pages will be opened:

.Offline verification of the license in the {CE}
image::license_offline_verification.png[alt="Page for offline verification of {CE} license information.", width=85%]

.Offline submission of license information in the other {EE}
image::license_offline_submission.png[alt="Page for offline submission of {EE} license information.", width=85%]
