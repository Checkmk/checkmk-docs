...
Afterwards log in to the link:https://portal.checkmk.com/[{CMK} customer portal^] with your access data (additional options are available to {com} partners here).
