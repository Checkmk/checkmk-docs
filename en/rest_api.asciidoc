...
= Configuration via Checkmk REST-API
:revdate: draft
:title: 
:description: 
...
This article is currently being prepared for publication. Please be patient. It's coming soon - we promise...
...
//BI:help_menu.png center width:50%
...
//C+:
//OM:touch rest-api_test.sh
//OM:chmod +x rest-api_test.sh
//C-:
...
//BI:restapi_redoc_2pane.png border
