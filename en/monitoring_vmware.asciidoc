...
link:https://checkmk.com/cms_check_plugins_catalog.html[Catalog of check plug-ins] in
...
* From Version {v14}i1] it is possible to use the VM’s operating system’s host name, if this can be accessed via the vSphere-API
