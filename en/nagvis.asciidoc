...
xref:monitoring_basics#parents[Parent-Child-Relationships].
NagVis is responsible for such maps.
The xtension enables a visualisation of, for example, infrastructures, servers, ports or processes.
