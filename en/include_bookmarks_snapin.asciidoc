...
At first, the [.guihint]#Bookmarks# snapin is still empty:

image::gui_empty_bookmarks.png[alt="Bookmarks snapin still without bookmarks.",width=50%]
...
image::gui_bookmarks.png[alt="Bookmarks snapin with one bookmark.",width=50%]
