...
// MFS: There is a new section, please translate and insert here.
...
// MFS: Baking and signing is done in a single step, so this section has to be replaced by a complete translation of the german section:
[#bakery]
=== Baking agents
...
// MFS: End of massively changed section.
...
If the settings differ for each remote site, they can be edited in
[.guihint]#Setup > General > Distributed monitoring > Site specific global settings#. icon:icon_site_globals[].
