...
By the way, the https://docs.checkmk.com/master/de/install_azure.html[German version] of this article has already been updated -- if that is an alternative for you.
