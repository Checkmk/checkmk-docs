...
https://help.webex.com/en-US/article/hk71r4/Webex-App-|-Create-a-space[Webex App -- Create a Space^].
...
link:https://apphub.webex.com/applications/incoming-webhooks-cisco-systems-38054-23307[Webex App Hub^].
...
After a short waiting period, at first it looks as if not much has changed -- but now, at the end of the input and selection fields, you can specify both a name for the webhook and the area to be used in Webex Teams.
