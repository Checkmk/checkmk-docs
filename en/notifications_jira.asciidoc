...
image::jira_logo.png[left, width=7.5%]
...
image::jira_admin_settings.png[center, width=300]

Next select [.guihint]#Issues}}, and in the {{Fields}} section navigate to {{Custom Fields#.
...
Find the [.guihint]#Number field}} option, and press the {{Next# button.
...
At [.guihint]#User Name}} and {{Password# enter the user and password for access.

Now you need the previously determined IDs in the fields [.guihint]#Project ID}} and {{Issue type ID#.
Enter the IDs of the custom fields created in Jira under [.guihint]#Host custom field ID}} and {{Service custom field ID#.
...
using the [.guihint]#Summary for host notifications}} and the {{Summary for service notifications# options.
