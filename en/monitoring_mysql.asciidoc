...
link:check_plugins_catalog.html#Applications[Catalogue of Check Plug-ins].
...
With the help of the link:check_logwatch.html[Logwatch] check plug-in you can also
