...
link:https://checkmk.com/cms_check_plugins_catalog.html.html#Applications[Catalogue of Check Plug-ins].
Among other things, {CMK} can monitor the following:

* link:https://checkmk.com/cms_check_mysql.sessions.html.html[ MySQL Database sessions]
* link:https://checkmk.com/cms_check_mysql.galeradonor.html.html[ MySQL Database: Galera Donor]
* link:https://checkmk.com/cms_check_mysql.galerasize.html.html[ MySQL Database: Galera Size]
* link:https://checkmk.com/cms_check_mysql.galerastartup.html.html[ MySQL Database: Galera Startup]
* link:https://checkmk.com/cms_check_mysql.galerastatus.html.html[ MySQL Database: Galera Status]
* link:https://checkmk.com/cms_check_mysql.galerasync.html.html[ MySQL Database: Galera Sync Status]
* link:https://checkmk.com/cms_check_mysql.connections.html.html[ MySQL Maximum connection usage since startup]
* link:https://checkmk.com/cms_check_mysql_slave.html.html[ MySQL Database: Slave Sync Status]
* link:https://checkmk.com/cms_check_mysql_ping.html.html[ MySQL Deamon: Status]
* link:https://checkmk.com/cms_check_mysql.innodb_io.html.html[ MySQL InnoDB engine IO statistics]
* link:https://checkmk.com/cms_check_mysql.html.html[ MySQL: Version]
* link:https://checkmk.com/cms_check_mysql_capacity.html.html[ Size of MySQL tablespaces]
...
link:check_mysql_capacity.html[mysql_capacity] check plug-in. Threshold values for this
...
With the help of the link:https://checkmk.com/cms_check_logwatch.html.html[Logwatch] check plug-in you can also
...
|C:\Program Files (x86)\checkmk\agent\config\ |The usual configuration directory up to {CMK}-Version VERSION[1.6.0]
|C:\Program Files (x86)\check_mk\plugins\ |The usual plug-ins directory up to {CMK}-Version VERSION[1.6.0]
|===
