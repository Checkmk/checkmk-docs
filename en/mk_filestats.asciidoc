...
This completes the configuration and you can distribute the plug-in including its configuration via the xref:agent_linux#_plugins_via_the_agent_bakery_install[Agent Bakery].
...
This completes the configuration and you can manually install the plug-in on xref:agent_linux#manualplugins[Linux] or on xref:agent_windows#_manual_installation_of_plugins[Windows].
