...
[{shell}]
----
{c-root} scp check-mk-raw-2.0.0b7-el8-38.x86_64.rpm root@mymonitoring.mydomain.org:
----
...
[{shell}]
----
{c-root} rpm -K check-mk-raw-2.0.0b7-el8-38.x86_64.rpm
check-mk-raw-2.0.0b7-el8-38.x86_64.rpm: digests signatures OK
{c-root} yum install check-mk-raw-2.0.0b7-el8-38.x86_64.rpm
----
