...
:description: Each Linux distribution has its own special features which need to be considered when installing {CMK}. Here we describe the requirements for Red Hat and CentOS.
