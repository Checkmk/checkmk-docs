...
By the way, the https://docs.checkmk.com/latest/de/analyze_configuration.html[German version] of this article has already been updated -- if that is an alternative for you.
