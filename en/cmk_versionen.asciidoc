...
=== Daily builds from the master#daily
...
A table of support periods can be found at the link:cmk_versionen.html#lifecycle[end of this article.]
...
== Support periods for stable Versions#lifecycle
