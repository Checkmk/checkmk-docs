...
* via the icon:button_save_and_services.png] button or ICON[button_host_services[] in the host details in WATO
* via the icon:icon_services[] symbol in the list of hosts in a folder in WATO
* via the icon:icon_services[] [.guihint]#Edit services}} entry in a host’s service’s context menu link:wato_services.html#discovery_check[{{Check_MK Discovery#]
...
Check's icon:icon_menu.png] context menu using the ICON[icon_services[]
