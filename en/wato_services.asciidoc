...
* via the button icon:icon_save_to_services[] [.guihint]#Save & go to service configuration# in the [.guihint]#Properties of host# in the setup
* in the menu bar of the [.guihint]#Properties of host# via [.guihint]#Hosts > Service configuration#
