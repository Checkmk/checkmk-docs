...
Now use [.guihint]#Create rule in folder# to do just that. First you specify which service group to assign services to, for example _myservicegroup01_ or its alias _My service group 1_.
...
Secondly, you name the services you would like to group, such as [.guihint]#Filesystem# and [.guihint]#myservice# to create a set of file systems.
