...
* via the ICON[icon_services.png] [.guihint]#Edit services# entry in a host’s service’s context menu link:wato_services.html#discovery_check[[.guihint]#Check_MK Discovery#]
