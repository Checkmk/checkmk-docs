...
ordered to disable the service. And naturally, don't forget the usual
...
[#update_labels]
=== Update host labels
Updating only the labels of a host can easily achieved via [.guihint]#Actions >
...
how the interface should look look in the name of the service. You can shoose between
