...
Alongside this there is the pleasant side benefit of the availability of completely-free distributions of Linux with Debian, Ubuntu and AlmaLinux, which are enterprise-capable and supported by {CMK}.
...
* SUSE Linux Enterprise Server (SLES) Version 12 from SP4 and Version 15 from SP1
...
* xref:install_packages_redhat#[Red Hat Enterprise Linux and derivatives]
