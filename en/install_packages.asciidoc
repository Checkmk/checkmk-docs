...
[.relateddoc]
introduction, check_mk_getting_started, introduction_virt1, install_packages_debian, install_packages_redhat, install_packages_sles
...
possible to run {CMK} as link:introduction_virt1.html[a virtual appliance], <a
...
image::linux.png[left, width=150]
...
=== SMTP for outgoing emails#smtpconfig
