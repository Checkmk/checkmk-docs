...
A more detailed table of all of the metrics for a service can be found by clicking on the service in its detailed view in the [.guihint]#Service Metrics# line:
