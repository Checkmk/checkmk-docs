...
In addition to the {OK} status, we can see that approximately, of the file system's total of 50{nbsp}Gbyte, 38{nbsp}Gbyte has been used -- which is around 76{nbsp}%.
