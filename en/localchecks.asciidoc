...
[#metricname]
=== Metric name
When choosing the identifier of this metric - called `metricname` in the example
here - you should also take special care. We recommend to prefix your
identifiers with a prefix to avoid overlaps with metrics already overlap with
metrics already present in {CMK}.
