...
|`%PROGRAMFILES(X86)%\check_mk\local` |Windows (Agent up to version VERSION[1.5.0]) 
|`%PROGRAMFDATA%\check_mk\local` |Windows (Agent starting with version VERSION[1.6.0]) 
|===
