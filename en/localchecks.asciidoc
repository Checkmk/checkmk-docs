...
Therefore, no newline characters are allowed in the output -- unless they are masked, for example for a xref:localchecks#multi-line[multiline output] in {CMK}.
