...
Recommendations to be performed into your checkmk Enterprise App in Azure Active Directory:

- Go to Users and Groups and add your Active Directory Groups.
- Go to Properties and enable the option  Assignment Required. That way Azure you show a  block users that are not members of the authorized groups to access checkmk. 
- Go to Properties and change the logo. Use the icon available at https://checkmk.com/company/brand-assets in Symbols section, download the first one.
