...
- Set UserPrincipalName in LDAP connection as identifier (more infos at link:https://ldapwiki.com/wiki/UserPrincipalName#:~:text=UserPrincipalName%20is%20a%20SINGLE%2DVALUE,the%20Internet%20standard%20RFC%20822.&text=By%20convention%2C%20this%20should%20map%20to%20the%20user's%20email%20name[LDAPwiki.com^]).
