...
An update to version {v20} does not require a specific {v16} patch release.
However, it is recommended to first update {CMK} to the current {v16} patch release and only then update to {v20}.
