...
You can find out which Linux distribution versions {CMK} supports in the xref:update_matrix#[update matrix for version {v20}] and on the link:https://checkmk.com/download[download page] after you have selected the {CMK} version and your Linux distribution.
