...
In {CMK} {v20}, these auxiliary processes perform their tasks in an even more specialised and targeted way. Instead of fetching the information *and* subsequently evaluating it, as in {v16}, one part of the auxiliary processes is only responsible for fetching the information. These processes are called _{CMK} fetchers_. The other part, on the other hand, takes care of evaluating the information passed by the fetchers. We call these processes _{CMK} checkers_.
