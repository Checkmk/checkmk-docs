...
The push mode function in the {CCE} is also dependent on the Agent Controller and is therefore not available in the legacy mode.
...
This can either be created manually in the {RE} or with the Agent Bakery in the {EE}.
