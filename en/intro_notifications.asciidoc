...
* Do not activate notifications for other users until you have reduced the false alarms (_false positives_) to a minimum. We have described what you can do for this in the link:intro_finetune.html[chapter on fine-tuning monitoring].
