...
Linux can be found in the link:notifications.html#smtp[article on alerting].
...
open the detail page for that service by clicking on the service in the Monitoring
screen. Select [.guihint]#Service > Service Notifications# from the menu. There you will
