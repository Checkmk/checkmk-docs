...
{related-end}
//MD:Das aktuelle Kapitel des Leitfadens für {CMK} Einsteiger stellt kurz das {CMK} Handbuch im allgemeinen und im besonderen den Leitfaden vor, der kompakt durch die ersten Schritte führt, um das IT-Monitoring mit {CMK} optimal einzurichten.
...
//
//NL:einen Leitfaden für Einsteiger, dessen Einleitung Sie gerade lesen, und der Sie in den folgenden Kapiteln beim Kennenlernen von {CMK} begleitet;
//
//NL:einen umfassenden Referenzteil für Experten, der den Rest des Handbuchs umfasst.
//
