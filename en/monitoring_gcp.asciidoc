...
Auf der rechten Seite finden Sie aktuelle Daten der jeweiligen Buckets.
Auf der linken werden wieder die wichtigsten Metriken im zeitlichen Verlauf dargestellt:
