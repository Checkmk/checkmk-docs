...
Please be patient. +
By the way, the link:https://docs.checkmk.com/master/de/monitoring_gcp.html[German version] of this article has already been updated -- if that is an alternative for you.
