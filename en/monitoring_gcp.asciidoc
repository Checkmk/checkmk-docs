...
{CCE-only}
For a convenient start into monitoring GCP, the {CE} of {CMK} ships the two built-in xref:glossar#dashboard[dashboards] [.guihint]#GCP GCE instances# and [.guihint]#GCP storage buckets#  with it.
Both can be found in the monitoring as menu items under [.guihint]#Monitor > Cloud#.
