...
In addition to general information about the costs that are incurred by your Google Cloud and the current status of link:https://checkmk.com/integrations/gcp_status[Google services in your region^], you can monitor the following Google Cloud products with all editions of {CMK} from version {v22} onwards:
