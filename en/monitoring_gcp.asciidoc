...
{CCE-only}
For a convenient start into monitoring GCP, the {CMK} {CE} ships with the two built-in xref:glossar#dashboard[dashboards], [.guihint]#GCP GCE instances# and [.guihint]#GCP storage buckets#.
