...
The {CFE} (CFE) is the right one for you if you want to test the {SE} or {CE} without obligation , or if you want to use {CMK} on a small scale permanently with up to 750 services. 
The {FE} contains all of the features of the {CE}, is free of charge and is not limited for the first 30 days.
The {FE} -- as well as the {RE} -- can later be turned into a {SE} or {CE}.
