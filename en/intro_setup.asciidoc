...
[{image-border}]
image::omd_site_not_started.png[alt="Error message in the web browser about a not-started site."]

If there is no site with this name at all -- or you have landed on a server without {CMK} -- it will look more like this:

[{image-border}]
image::omd_site_not_found.png[alt="Error message in the web browser about a non-existent site."]
