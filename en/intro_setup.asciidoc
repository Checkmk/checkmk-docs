...
{cee-only}
In this User Guide, whenever we discuss functions that apply only to one of the {EE} -- i.e. to the CSE, CCE or CME -- we mark this with the icon as in this paragraph.
