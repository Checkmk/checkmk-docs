...
:description: Setting up {CMK} includes selecting the appropriate {CMK} edition and version, installing the software, creating and starting a site, and logging in to the interface.
