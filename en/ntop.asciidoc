...
:revdate: 2021-03-31
:title: Integrating ntop in {CMK}
:description: ntop is the powerful and resource-saving software for monitoring and analysing network traffic. Through the integration of ntop, the functional scope of {CMK} is extended by two important tasks -- the monitoring of the network data flow and the in-depth analysis of the network traffic.
