...
*Note:* This dashboard is similar in structure to the three alert-specific tabs on the [.guihint]#Network statistics and flows# page (see the chapter link:ntop.html#ntop_nw_statistics[Network statistics for a host]).
