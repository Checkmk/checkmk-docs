...
There are several options to customize the connection of your Prometheus server's web frontend, regardless of which exporter you want to use. Pelase notice, only the port option has been available before version {v20}.
