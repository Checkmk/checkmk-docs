...
image::livestatus_tcp_1.png[align=center, width=380]
...
image::livestatus_tcp_3.png[align=center, width=380]
...
image::folder_monitored_on.png[align=center, width=550]
...
image::distributed_monitoring_tls.png[align=center, width=69%]
...
image::dm_service_details.png[align=center, width=480]
...
image::dm_filter_site.png[align=center, width=270]
...
image::snapin_site_status.png[align=center, width=240]
...
image::dm_master_control.png[align=center, width=240]
...
image::dm_change_password.png[float=left, width=150]
...
[CRE] In the {CRE} the link:http://docs.pnp4nagios.org/[PNP4Nagios]
...
image::nagvis.png[float=left, width=170]
...
* A dump of the configuration is also possible on a [cmc|CMC-core] -- the importing of which requires Nagios. If the link:cmc.html[CMC] is running on your master use link:distributed_monitoring.html#cmcdump[CMCDump].
...
image::omd_config_mknotifyd.png[align=center, width=300]
