...
This displays the status of the individual sites, and it also provides the option to temporarily disable and re-enable a single site by clicking on the status -- or all sites at once by clicking [.guihint]#Disable all# or [.guihint]#Enable all#.
