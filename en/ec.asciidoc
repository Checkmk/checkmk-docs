...
* link:.guihint].html#Matching criteria[Invert matching# to [.guihint]#Negate match: Execute this rule if the upper conditions are not fulfilled.#
* link:.guihint].html#Outcome & action[Rule type# to [.guihint]#Skip this rulepack, continue rule execution with next rulepack#
