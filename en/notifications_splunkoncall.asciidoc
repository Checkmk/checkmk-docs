...
The incident management platform link:https://www.splunk.com/en_us/observability/on-call.html[Splunk On-Call^] handles the distribution of messages from dozens of different sources, which can be selected as integrations directly in the web interface.
