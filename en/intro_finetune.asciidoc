...
click on the icon:icon_menu[Icon for opening the action menu.] menu option and select the [.guihint]#Parameters for this service# entry:

image::service_rule_icon.png[View of service with open action menu.]

You will receive a page from which you can access all of the rule sets for this service:

image::parameters_of_this_service.png[List of all rule sets for a service.]
...
image::ruleset_search_tablespace.png[Result of the search for 'tablespace' in rules.]
...
image::ruleset_oracle_tablespaces.png[Dialog for creating a rule from the 'Oracle Tablespaces' rule set.]
...
image::rule_ora_properties.png[Dialog for setting the properties for the new rule.]
...
image::rule_ora_value.png[Dialog for setting the values for the new rule.]
...
image::rule_ora_condition.png[Dialog for setting the conditions for the new rule.]
...
image::ruleset_ora_one_rule.png[List of rules with the new rule created.]
...
image::wato_tag_groups.png[List of host tag groups.]
...
image::new_taggroup_basic.png[Dialog for defining the Basic settings for the new host tag group.]
...
image::new_taggroup_choices.png[Dialog for setting the tags for the new host tag group.]
...
image::host_custom_attributes.png[Properties of a host with the new host tag group.]
...
image::host_check_command.png[Dialog for setting the 'Host Check Command' in the rule of the same name.]
...
image::rule_status_of_cmk_services.png[Dialog for setting the state of '{CMK} Services' in a rule.]
...
image::port_discovery.png[Dialog with settings for monitoring switch ports in a rule.]
...
a host by clicking on icon:icon_service_to_disabled[Icon for deactivating a service.], a rule is automatically
...
image::cpu_util_average.png[Dialog for setting mean values for CPU utilization in a rule.]
...
image::discovery_service.png[Service list with the 'Check_MK Discovery' service.]
