...
productive systems. First select the host tag group [.guihint]#Criticality# from the
...
'productive' systems. More specifically, in that rule we defined a condition
