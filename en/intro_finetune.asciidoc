...
image::service_rule_icon.png[alt=Service with open action menu]
...
image::ruleset_oracle_tablespaces.png[alt="Creating a rule from the 'Oracle Tablespaces' rule set"]
...
image::rule_ora_properties.png[alt=Setting the properties for the new rule]
...
image::rule_ora_value.png[alt=Setting the values for the new rule]
...
image::rule_ora_condition.png[alt=Setting the conditions for the new rule]
...
image::new_taggroup_basic.png[alt=Defining the Basic settings for the new host tag group]
...
image::new_taggroup_choices.png[alt=Setting the tags for the new host tag group]
...
image::host_custom_attributes.png[alt=Properties of a host with the new host tag group]
...
image::host_check_command.png[alt="Setting the 'Host Check Command' in the rule of the same name".]
...
image::rule_status_of_cmk_services.png[alt="Setting the state of '{CMK} Services' in a rule".]
...
image::port_discovery.png[alt=Settings for monitoring switch ports in a rule]
...
image::cpu_util_average.png[alt=Setting mean values for CPU utilization in a rule]
