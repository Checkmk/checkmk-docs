...
How to use the configuration created up to this point without such an SLA service connection is described below under xref:moreslaviews[Column-specific SLA display.]
...
How and why it is better to do that with a column-specific SLA view can be seen xref:slacolumn[below].
