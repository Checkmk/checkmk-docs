...
#*Important:* Please take note that, ex-factory, the management interface supplied with all Checkmk racks is *initially deactivated* and needs to be xref:appliance_rack_config#ipmi[enabled manually in the web interface].
