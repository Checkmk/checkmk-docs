...
#*Important:* Please take note, that the management interface of all Checkmk racks is *initially deactivated* and needs to be xref:appliance_rack_config#ipmi[enabled manually in the web interface]. You *must* take this into consideration, when delivering a rack to a remote location, for example. xref:appliance_rack_config#ipmi[More ...]#
