...
// This block replaces the following section "Predefined roles"
// start translation
////
[#predefined_roles]
...
As standard {CMK} comes with the following three predefined roles, which can never be deleted, but can be customized at will:
