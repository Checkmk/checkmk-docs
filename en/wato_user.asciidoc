...
For the time being, please refer to the https://docs.checkmk.com/1.6.0/en/wato_user.html[article for {CMK} 1.6.0], which is still valid in most parts. It differs mainly in the screenshots of the GUI and the click-paths.

Or if it is at all, possible you can also check https://docs.checkmk.com/latest/de/wato_user.html[this article in German].
