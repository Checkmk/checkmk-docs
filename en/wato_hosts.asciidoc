...
icon:icon_insert.png] button and the edit host ICON[icon_edit[] button
...
* in the icon:icon_menu.png] menu, by selecting the [.guihint]#Check_MK Discovery}} service with the ICON[button_services[] {{Edit Services# entry
