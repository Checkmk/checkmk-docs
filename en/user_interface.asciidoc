...
create a completely new list with [.guihint]#New list}}. The {{Title# for a list
...
== Themes
The GUI is available with three different themes: [.guihint]#Modern}}, {{Modern (Dark)#
and [.guihint]#Classic}}. The theme {{Modern# is activated by default, as seen here in
the screenshot.
...
[.guihint]#User Interface}} area and click the {{Modern# button next to the {{User
