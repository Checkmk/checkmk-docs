...
|1 |   Your {CMK} installation’s link:cmk_versionen.html[version]. Clicking on the   version number opens a summary of updates for this version.
...
|3 |   An interactive field for searching for hosts and services. More about this link:user_interface.html#quicksearch[later below …]
...
dark area</b> of an element up or down.
...
image::user_interface_bookmarks.png[float=left, width=50%]
...
image::user_interface_quicksearch.png[float=left, width=50%]
