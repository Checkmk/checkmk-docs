...
|[.guihint]#User interface theme# |Switching between [.guihint]#Dark# and [.guihint]#Light# is also possible directly in the [.guihint]#User# menu via [.guihint]#User interface > Color theme#.
|[.guihint]#Sidebar position# |Here, too, you can again switch between [.guihint]#Right# and [.guihint]#Left# directly in the [.guihint]#User# menu.
...
|[.guihint]#Two-factor authentication# |Activation of increased security through xref:wato_user#2fa[two-factor authentication] (possible only directly in the [.guihint]#User# menu).
