...
In this article, we will look at all the elements you see on this start page -- working our way through the {CMK} user interface from left to right: from the navigation bar to the link:user_interface.html#main_page[main page] to the link:user_interface.html#sidebar[sidebar].
...
|[.guihint]#Start URL to display in main frame# |Set the URL of the start page. If a link:user_interface.html#dashboards[Dashboard] is displayed on the main page, you can alternatively make this the start page via the [.guihint]#Dashboard# menu.
