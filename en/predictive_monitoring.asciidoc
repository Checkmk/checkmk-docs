...
|Arbeitsspeicher | link:https://checkmk.com/integrations/mem_linux[Linux: Detailed Usage of RAM, Swap, VMalloc and other Memory Areas], link:https://checkmk.com/integrations/winperf_mem[Windows: Memory Statistics], link:https://checkmk.com/integrations/hp_procurve_mem[HP Procurve Switches: Memory Usage], link:https://checkmk.com/integrations/f5_bigip_mem[F5 Big-IP: Usage of Memory]
|Festplatte | link:https://checkmk.com/integrations/diskstat[Disk Throughput], link:https://checkmk.com/integrations/winperf_phydisk[Windows: Disk Throughput], link:https://checkmk.com/integrations/scaleio_volume[EMC ScaleIO: Volume Size and Throughput], link:https://checkmk.com/integrations/esx_vsphere_counters_diskio[VMWare ESX Host Systems: Disk Throughput], link:https://checkmk.com/integrations/aws_ec2_disk_io[AWS EC2: Instance Disk IO],
|Schnittstelle | link:https://checkmk.com/integrations/lnx_if[Linux: State of Network Interfaces], link:https://checkmk.com/integrations/winperf_if[Windows: State and Performance of Network Interfaces], link:https://checkmk.com/integrations/statgrab_net[Network Interfaces: Traffic], link:https://checkmk.com/integrations/if64[Monitor Network Interfaces via Standard MIB Using 64 Bit Counters]
