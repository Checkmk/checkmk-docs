...
:description: Predictive monitoring evaluates historical measured data, and uses this data to calculate a prediction of how a service in {CMK} will behave in the future.
