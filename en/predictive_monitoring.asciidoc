...
|CPU |link:https://checkmk.de/cms_check_kernel.util.html.html[CPU Utilization] + link:https://checkmk.de/cms_check_cpu.loads.html.html[CPU Load] + link:https://checkmk.de/cms_check_vms_cpu.html.html[OpenVMS: CPU Utilization and IO-Wait] + link:https://checkmk.de/cms_check_ucd_cpu_util.html.html[UCD SNMP Daemon: CPU Utilization]
|Arbeitsspeicher |link:https://checkmk.de/cms_check_mem.linux.html.html[Linux: Detailed Usage of RAM, Swap, VMalloc and other Memory Areas] + link:https://checkmk.de/cms_check_winperf_mem.html.html[Windows: Memory Statistics] + link:https://checkmk.de/cms_check_hp_procurve_mem.html.html[HP Procurve Switches: Memory Usage] + link:https://checkmk.com/cms_check_f5_bigip_mem.html.html[F5 Big-IP: Usage of Memory]
|Festplatte |link:https://checkmk.de/cms_check_diskstat.html.html[Disk Throughput] + link:https://checkmk.de/cms_check_winperf_phydisk.html.html[Windows: Disk Throughput] + link:https://checkmk.de/cms_check_scaleio_volume.html.html[EMC ScaleIO: Volume Size and Throughput] + link:https://checkmk.de/cms_check_esx_vsphere_counters.diskio.html.html[VMWare ESX Host Systems: Disk Throughput] + link:https://checkmk.de/cms_check_aws_ec2.disk_io.html.html[AWS EC2: Instance Disk IO]
|Schnittstelle |link:https://checkmk.de/cms_check_lnx_if.html.html[Linux: State of Network Interfaces] + link:https://checkmk.de/cms_check_winperf_if.html.html[Windows: State and Performance of Network Interfaces] + link:https://checkmk.de/cms_check_statgrab_net.html.html[Network Interfaces: Traffic] + link:https://checkmk.de/cms_check_if64.html.html[Monitor Network Interfaces via Standard MIB Using 64 Bit Counters]
|Firewall |link:https://checkmk.de/cms_check_checkpoint_packets.html.html[Checkpoint Firewalls: Packet Statistics]
|===
