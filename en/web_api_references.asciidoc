...
:description: This article describes all options to configure {CMK} via HTTP-API (or Web-API). It thus extends the introductory article on the Web API.
...
With this command you can get a list of the hostnames for all connected sites.
