...
[.relateddoc]
web_api, cmk_commandline, livestatus
...
== Activating changes#activate_changes
...
the [.guihint]#Alias}} (`alias`) and the {{Persistent Connection#
...
== Agent Bakery commands#bake_agents
