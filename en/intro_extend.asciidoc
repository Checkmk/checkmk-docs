...
image::distributed_monitoring.png[Illustration of the relationship between several sites and their components in distributed monitoring.,width=470]
...
image::avail_screenshot_neu.png[List of services with their availability percentages]
...
image::sla_view_example_modern.png[A service and its service level agreement for the last 15 days]
...
image::inventory_example.png[Tree representation of the hardware/software inventory data of a host.]
...
image::ec_open_events.png[List of events in the Event Console.]
...
[{image-border}]
image::nagvis_map_2.png[A geographic map created with NagVis with host/service state icons.]
...
image::bi_downtimes.png[Tree representation in Business Intelligence with the overall state of an application derived from individual states.]
