...
:description: docs.checkmk.com uses a Lunr-based search, which is fast and offers many configuration options. You can find out what these are here.
...
By the way, the https://docs.checkmk.com/latest/de/search.html[German version] of this article has already been updated -- if that is an alternative for you.
