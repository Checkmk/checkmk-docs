...
then the column’s respective cell is _clickable_ and takes the user to
...
The sorting within a view is configured in the fourth block. It’s only a matter
...
settings for this under [.guihint]#Setup > General > Global settings > User Interface > Custom icons and actions#.
