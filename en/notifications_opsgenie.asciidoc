...
<a href="https://www.atlassian.com/software/opsgenie">Opsgenie</a>, now a part
...
. For the [.guihint]#Notification Method}} choose the item {{Opsgenie.#
...
{DOWN} via [.guihint]#Fake check results}}. The {{Custom notification# function will not
