...
sites which belong to that customer. Individual elements in [.guihint]#WATO# will then
...
over the central WATO in their own site.
...
site assigned to them and this is in turn link:distributed_monitoring.html[connected]
