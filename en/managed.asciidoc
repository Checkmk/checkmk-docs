...
The topics mentioned in the last chapter like notifications with contact groups or host tags might leak information on organizational structures of other customers.
