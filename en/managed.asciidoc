...
in [.guihint]#WATO|Customers}} select the {{New Customer# button, and assign an
...
New on the Dashboard [.guihint]#Main Overview}} is the {{Customers# column in which links
...
[.guihint]#WATO|Global Settings# with the ICON[button_read_only_mode.png] button:
