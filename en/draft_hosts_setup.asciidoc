...
So, first you deal with the structure of the folders and their hierarchy, and then you organize the hosts in the folders.
...
* *Organization structure* (e.g. database group versus networker).
...
When choosing a network, we also recommend not to exceed the netmask of `/21`, which corresponds to 2048 IP addresses.
