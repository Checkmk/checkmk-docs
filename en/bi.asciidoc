...
Before you begin step by step with the practical application of BI, you first need to know a few terms:
...
Because you probably want to do your experiments alone in peace, leave this option disabled:
...
Once there, create your first rule right away via [.guihint]#Add BI rule#.
