...
If you now save the aggregation with [.guihint]#Save#, you will be done!
...
and icon:icon_availability[]. With the first icon -- icon:icon_showbi[] -- you come
...
|icon:icon_1[] |[.guihint]#Hierarchical style#: The standard setting with a simple hierarchy.
|icon:icon_2[] |[.guihint]#Leaf-Nodes Block style#: Leaf nodes are shown as a group with a grey background.
|icon:icon_3[] |[.guihint]#Radial style#: A circular format with a customisable sector of a circle.
|icon:icon_4[] |[.guihint]#Free-Floating style#: A dynamic layout with options such as attraction, spacing, length of the branches.
|===
...
The first rule is the rule for the root of the tree. The button
icon:button_aggregations[] on the top of the page takes you to
a list of all aggregations.
Here you can see, among other things, how the rules are nested among each other:

image::bi_host_tree_tree.png[width=42%]


You will see only one Aggregation by default.
In the icon:icon_edit[] Details simply uncheck the
checkbox at [.guihint]#Currently disable this aggregation# and immediately get, per
host, an aggregation view titled `Host myhost123` -- which you find
in the sidebar under [.guihint]#Views > Business Intelligence > Single-Host Problems#.
