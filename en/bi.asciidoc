...
For this purpose, the ICON[icon_commands.png] link:commands.html[commands]
...
for these is the so-called [.guihint]#Display options#, which you can access via the ICON[icon_painteroptions.png]
...
[.guihint]#BI Visualization# via ICON[icon_aggr.png] in the regular
Aggregations View.
...
How does BI actually manage ICON[icon_downtime.png] link:basics_downtimes.html[maintenance times]?
...
has been ICON[icon_ack.png] link:basics_ackn.html[acknowledged] the information is also
