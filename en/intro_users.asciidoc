...
:description: In {CMK} users are assigned roles for permissions and contact groups to connect with their areas of responsibility within the operations. These topics are covered in this chapter of the {CMK} Beginner's guide, which guides you through the first steps for setting up IT monitoring with {CMK} in an optimal way.
