...
image::wato_new_contact_group.png[alt=Setting the properties for the new contact group]
...
image::host_group_assignment_rule.png[alt=Assigning contact groups to hosts in a rule]
...
image::host_permissions.png[alt=Assigning contact groups to hosts in the host properties]
...
image::wato_new_user_identity.png[alt=Setting the identity for the new user]
...
image::wato_new_user_security.png[alt=Defining the security settings for the new user]
...
image::wato_new_user_contact_groups.png[alt=Selecting contact groups for the new user]
...
find the icon:icon_ldap[] [.guihint]#LDAP & Active Directory# entry in the [.guihint]#Related# menu.
