...
You can find all of the details that go beyond the introduction in this Beginner's guide in the xref:wato_user#[article on user administration].
...
*Note:* You can set the [.guihint]#Permissions# parameter in the same way at the folder level instead of at the host level.
...
-- although this would not make much sense for the three predefined roles.
