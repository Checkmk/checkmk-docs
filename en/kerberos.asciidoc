...
login window.  This option can also be link:kerberos.html#cookie[deactivated].
...
The bold entries are just examples und may differ from your configuration. Adapt these according to your environment:
