...
[{shell}]
----
{c-root} scp check-mk-raw-1.6.0p22_0.focal_amd64.deb root@mymonitoring.mydomain.org:
----
...
[{shell}]
----
{c-root} dpkg-sig --verify check-mk-enterprise-1.6.0p22_0.focal_amd64.deb
----
...
----
{c-root} omd version
OMD - Open Monitoring Distribution Version 1.6.0p22.cee
----
