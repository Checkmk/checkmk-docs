...
Im Trial gibt es einige Restriktionen, zum Beispiel können maximal 2500 xref:glossar#service[Services] überwacht werden und die automatisch angelegte {CMK}-xref:glossar#site[Instanz] wird nach 14 Tagen gelöscht.
...
Es muss mindestens 12 Zeichen lang sein und dabei einen Großbuchstaben und ein Sonderzeichen enthalten.
