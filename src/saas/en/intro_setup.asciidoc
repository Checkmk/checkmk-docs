...
Registration for the trial will be possible immediately after the release of the product.

[TIP]
====
Note that the trial has the following restrictions, among others:
A maximum of 2500 services can be monitored.
The automatically created trial {CMK} xref:glossar#site[site] cannot be deleted manually, but will be deleted automatically at the end of the 14-day trial period.
Incidentally, this automatic deletion of the trial site will also apply if you license {CE} (SaaS) within the 14-day trial phase.
====
...
To get started, click link:https://admin.checkmk.cloud/[https://admin.checkmk.cloud/^].
...
It must be at least 12 characters long and contain a capital letter, a number and a special character.
If you do not adhere to this password guideline, you will receive a corresponding error message showing, among other things, the permitted special characters.
