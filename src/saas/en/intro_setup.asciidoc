...
[TIP]
====
Note that there are some xref:cce#functions_different[restrictions] during this trial period:
For example, a maximum of 2500 xref:glossar#service[services] can be monitored.
If you _do not_ license {CE} during the trial period, the {CMK} xref:glossar#site[site] will be automatically deleted after 30 days.
====
