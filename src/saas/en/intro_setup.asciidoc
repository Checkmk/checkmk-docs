...
There are some restrictions in the trial, for example, a maximum of 2500 xref:glossar#service[services] can be monitored and the automatically created {CMK} xref:glossar#site[site] will be deleted after 14 days.
