...
.Dialog box for creating a site
image::admin_panel_create_site.png[alt=“Dialog box for creating a site.”,width=64%]

In the dialog box, enter the name of the site to be created, select the time zone and confirm with [.guihint]#Create site.#
...
[TIP]
====
Note that when the current license status is 'Trial' you cannot delete the site that was set up during registration.
====
