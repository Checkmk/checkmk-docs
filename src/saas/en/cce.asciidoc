...
A maximum of 2500 xref:glossar#service[services] can be monitored, the frequency of xref:opentelemetry#[OpenTelemetry metrics] received via the xref:metric_backend#[metric backend] is limited to one data point every 30 seconds (instead of 15 seconds), and OpenTelemetry data is retained for two days (instead of 14 days). +
