...
// MFS: Statt Bullet Lists vielleicht Zwischenüberschriften? Evtl. solche, die nicht im TOC erscheinen? 
[#admin_site]
== Instanzen verwalten
...
// MFS: Auge drauf behalten, ob und wann Updates im Hintergrund erzwungen/automatisiert werden und wie weit Nutzer dann mit Werks konfrontiert sind.
[#update]
