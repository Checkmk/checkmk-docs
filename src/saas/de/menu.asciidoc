...
// 2.4.0: Quick Setup: In intro_setup_monitor.html#cloud auf Quick Setup verweisen und Liste zum generellen Ablauf überprüfen.
...
// 2.4.0: GUI notifications overhaul: intro_notifications.html#test (neue Screenshots sollten ausreichen)
...
// 2.4.0: Neue Setup-Menüeinträge (OpenTelemetry Collector, Analyze recent notifications, Test notifications, Certificate Overview, Managed Robots): nur einige sind relevant, Snapin-Umbennung: Quick setup > Setup shortcuts

=== Hosts
- link:hosts_setup.html[Verwaltung der Hosts]
// 2.4.0: Alle Spezialagenten werden ausgeführt: 1 neuer Satz (mit Kommentar) in hosts_setup.html#monitoring_agents
...
// 2.4.0: Snapin-Umbennung: Quick setup > Setup shortcuts in user_interface.html#setup_menu
