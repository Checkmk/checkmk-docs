...
Das Admin Panel stellen wir im Kapitel zur Arbeit mit mehreren Benutzern vor.
...
// TK: Der Onboarding Guide wird in der 2.5.0 SaaS noch verschwinden. Hier ist der zugehörige Text schon mal auskommentiert
////
...
Der Guide öffnet sich, indem er sich von der rechten Seite über die GUI schiebt.
...
// TK: Das Admin Panel wird in der 2.5.0 erst dann eingeführt, wenn es gebraucht wird. Der Inhalt des folgenden Kapitels wird daher nach intro_users#create_users verschoben.
////
[#admin_panel]
== Admin Panel
