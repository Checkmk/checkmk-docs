...
// TK: Das Admin Panel wird in der 2.5.0 erst dann eingeführt, wenn es gebraucht wird. Der folgende Kapitel wurde daher nach intro_users#create_users verschoben.
