...
:description: Mit {CE-saas} gelangen Sie in wenigen Minuten zu einer laufenden {CMK}-Instanz. Lesen Sie hier, wie Sie sich registrieren und starten.           
...
[TIP]
====
Immer dann, wenn klar ist, dass eine Verwechslung mit link:https://docs.checkmk.com/master/de/cce.html[{CE-onprem}^] ausgeschlossen ist -- wie in diesem Leitfaden für Einsteiger -- nennen wir {CE-saas} einfach {CE}.
====
