...
Die zum Testen automatisch angelegte {CMK}-xref:glossar#site[Instanz] kann von Ihnen nicht manuell gelöscht werden, sie wird nach 14 Tagen automatisch gelöscht.
