...
[TIP]
====
Wenn Sie die Seite [.guihint]#Notification configuration# das erste Mal aufrufen, wird Ihnen eine Warnung zur nicht konfigurierten „fallback email address" angezeigt.
Die Warnung können Sie im Moment ignorieren.
Wir gehen darauf xref:fallback[weiter unten] ein.
====
endif::[]
...
ifdef::onprem[]
xref:includedscripts[Benachrichtigungsskripten.]
endif::[]
ifdef::saas[]
...
// TK: In 2.4.0 Pfad ändern und Screenshot auswechseln
...
// TK: In 2.4.0 Screenshot auswechseln (Icons sind jetzt anders, auch schon in der 2.3.0)
