...
:revdate: 2025-01-07
:title: {CE} (SaaS)
:description: {CE} (SaaS) bietet wartungsarmes, zuverlässiges Monitoring. Lesen Sie hier, was diese Edition gegenüber {CE} (Self-hosted) auszeichnet.                  
...
{CE} gibt es in zwei Varianten: als {CE} (SaaS) und {CE} (Self-hosted).
