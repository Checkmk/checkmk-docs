...
If you define these values _not_ in the process discovery rule but with its own, following rule, a change will be valid even without a new service discovery.
