...
To find `svhost` processes, for example, set *Process name* to `svhost %u` abd *Executable* to `svhost.exe`.
...
++++2. In the *Hosts* table, click the Linux host name of interest to open the *Properties of host* page.
...
In this step, you will change the WARN and CRIT thresholds for the maximum number for processes:
...
If you would like to have this topic in more detail and with background information refer to the link:https://docs.checkmk.com/saas/en/wato_services.html#processes.html[Checkmk Cloud User Guide].
