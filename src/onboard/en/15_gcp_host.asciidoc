...
++++1. Go to *Setup > Quick Setup > Google Cloud Platform (GCP) > link:wato.py?mode=new_special_agent_configuration%26varname=special_agents%3Agcp["Add Google Cloud Platform (GCP) configuration", window=main]*
