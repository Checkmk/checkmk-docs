...
Before you start with Checkmk, collect the following information about the Google Cloud Platform (GCP) project you want to monitor with Checkmk: _project ID_ and _service account key_.
