...
Before you start with Checkmk, you have create a user and a corresponding key in GCP and check whether the necessary APIs are activated.
While creating this user, you also have to collect the _Project ID_ of the GCP project you want to monitor with Checkmk.
