...
++++2. In the *Google Cloud Platform* box, set *Project ID* to the project ID and *JSON credentials for service account* to the service account key you previously looked up in your project.
