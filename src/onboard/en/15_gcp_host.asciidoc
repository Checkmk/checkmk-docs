...
the _project ID_ and the _service account key_.
...
host for monitoring GCP in Checkmk
...
++++2. In the *Hosts* table, click the pencil icon left to the *GCP* host to edit the *link:/pass:[$$SITE_NAME$$]/check_mk/index.py?start_url=%2Fpass:[$$SITE_NAME$$]%2Fcheck_mk%2Fwato.py%3Ffolder%3D%26host%3DGCP%26mode%3Dedit_host[Properties of host GCP]*.
