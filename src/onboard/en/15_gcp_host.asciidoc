...
++++1. Go to *Setup > Quick Setup > Google Cloud Platform (GCP) > link:wato.py%3Fmode%3Dnew_special_agent_configuration%26varname%3Dspecial_agents%253Agcp["Add Google Cloud Platform (GCP) configuration", window=main]*
