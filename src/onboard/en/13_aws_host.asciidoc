...
Before you start with Checkmk, you have create a user in AWS with enough read-only access for proper monitoring.
While creating this user, you also have to collect the following information about the Amazon Web Services (AWS) cloud infrastructure you want to monitor with Checkmk: the _access key ID_ and the _access key secret_ of the AWS user you created for Checkmk.
