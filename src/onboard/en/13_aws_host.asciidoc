...
++++1. Go to *Setup > Quick Setup > Amazon Web Services (AWS) > link:wato.py?mode=new_special_agent_configuration%26varname=special_agents%3Aaws["Add Amazon Web Services (AWS) configuration", window=main]*
