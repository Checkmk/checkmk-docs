...
:revdate: 2024-06-04
:title: Monitor AWS
:description: Monitoring Amazon Web Services (AWS) is about observing AWS-native solutions, resources, and services, hosted on the AWS cloud. Checkmk includes a comprehensive module for monitoring AWS in a very detailed way.
