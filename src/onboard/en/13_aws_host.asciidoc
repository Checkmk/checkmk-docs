...
=== Go link:/$$SITE_NAME$$/check_mk/index.py?start_url=%2F$$SITE_NAME$$%2Fcheck_mk%2Fwato.py%3Ffolder%3D%26mode%3Dnewhost[here] to create a folder
...
=== Go link:/$$SITE_NAME$$/check_mk/index.py?start_url=%2F$$SITE_NAME$$%2Fcheck_mk%2Fwato.py%3Ffolder%3Daws%26host%3DAWS%26mode%3Dedit_host[here] to trigger service discovery
...
Go link:/$$SITE_NAME$$/check_mk/index.py?start_url=%2F$$SITE_NAME$$%2Fcheck_mk%2Fwato.py%3Fmode%3Ddcd_connections[here] to set up dynamic host management
...
++++1. Find your EC2 hosts link:/$$SITE_NAME$$/check_mk/index.py?start_url=%2F$$SITE_NAME$$%2Fcheck_mk%2Fview.py%3Fview_name%3Dallhosts[here]
