...
++++1. Go to *Setup > Quick Setup > Amazon Web Services (AWS) > link:wato.py%3Fmode%3Dnew_special_agent_configuration%26varname%3Dspecial_agents%253Aaws["Add Amazon Web Services (AWS) configuration", window=main]*
