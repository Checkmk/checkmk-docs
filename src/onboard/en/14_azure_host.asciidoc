...
++++1. Click *Setup > Agents > VM, cloud, container Microsoft Azure* and then click *link:/pass:[$$SITE_NAME$$]/check_mk/index.py?start_url=%2Fpass:[$$SITE_NAME$$]%2Fcheck_mk%2Fwato.py%3Fcsrf_token%3D8ca7ad0f-823c-4276-ac37-61941704ef72%26filled_in%3Dnew_rule%26ruleset_back_mode%3Drulesets%26rule_folder%3D%26varname%3Dspecial_agents%253Aazure%26mode%3Dnew_rule%26folder%3D%26_new_dflt_rule%3DSET[Add rule]*.
...
++++6. In *Map data relating to VMs* you decide on how the virtual machine (VM) data are assigned to Checkmk hosts.
