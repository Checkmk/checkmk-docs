...
++++1. Go to *Setup > Quick Setup > Microsoft Azure > link:wato.py?mode=new_special_agent_configuration%26varname=special_agents%3Aazure["Add Microsoft Azure configuration", window=main]*
