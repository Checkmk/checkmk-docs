...
:description: To monitor services correctly, they require their parameters to be well defined. How to set parameters for services is therefor explained here.
