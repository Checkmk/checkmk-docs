...
++++4. Select the desired service, e.g. *CPU load* and click the bar chart symbol to open the context menu.

++++4. Click *Add rule*.

++++5. Modify the *Value* to fit your needs. In our example, we decrease the *Levels on CPU load* from the default settings.
...
If you would like to have this topic in more detail and with background information refer to the link:https://docs.checkmk.com/saas/en/wato_services.html#[Checkmk User Manual].  