...
++++2. In the *Hosts* table, click a name of the desired host to open the *Properties of host* page.
...
++++1. In the *CPU load* service row click the bar chart symbol to open the the *CPU load (not utilization!) for host* page .
