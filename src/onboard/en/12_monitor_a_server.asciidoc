...
=== Go link:/$$SITE_NAME$$/check_mk/index.py?start_url=%2F$$SITE_NAME$$%2Fcheck_mk%2Fwato.py%3Fmode%3Dagents[here] to download an agent
...
++++3. After successful installation the *_host will automatically appear in the folder "preconfigured_agent"_* After a couple of minutes the host will also appear in your monitoring. You can track the individual steps in the audit log link:/$$SITE_NAME$$/check_mk/index.py?start_url=%2F$$SITE_NAME$$%2Fcheck_mk%2Fwato.py%3Fmode%3Dauditlog[here]
