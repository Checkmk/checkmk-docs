...
* Windows 2012 & Windows 2012 R2 have been removed from the list of supported operating systems for the agent as they are incompatible with Python 3.12. A partial function of the current agent is possible, but cannot be guaranteed or officially supported.
