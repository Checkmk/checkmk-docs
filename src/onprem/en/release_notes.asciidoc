...
|Debian |10 Buster (deprecated) | {v22} and {v23}
| | 11 Bullseye | {v22} and {v23}
| | 12 Bookworm| {v22}p17 und {v23}
|Red Hat Enterprise Linux |8 | {v22} and {v23}
| |9 | {v22} and {v23}
| |10 | 2.3.0p41
|SUSE Linux Enterprise Server |12 SP5 (deprecated) | {v22} and {v23}
| |15 SP3 | {v22} and {v23}
| |15 SP4 | {v22} and {v23}
| |15 SP5 | {v22}p11 and {v23}
| |15 SP6 | {v22}p39 and {v23}p14
|Ubuntu |20.04 LTS Focal Fossa (deprecated) | {v22} and {v23}
| | 22.04 LTS Jammy Jellyfish | {v22} and {v23}
...
* Our list of supported Linux distributions got updated: 

* Ubuntu 24.04 LTS Noble Numbat is supported since {CMK} versions {v22}p27 and {v23}p4.
