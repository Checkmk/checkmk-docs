...
If you are planning to update {CMK} from version {oldstable} to version {current-major}, you should first read the xref:update_major#[Update to version 2.3.0] article, in which we have compiled the most important issues you should consider before and after such an update.
