...
When updating to a higher major version, you must always update step-by-step through any available intermediate major versions until the target version has been reached, and _not_ just skip over any intermediate major versions.
