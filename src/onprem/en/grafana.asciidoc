...
After selecting [.guihint]#{CMK}#, you are directly in the editing mode of the _Query_ for the newly created panel.
...
Our screenshots here show the [.guihint]#Single metric#, which contains the total execution time of the agent ([.guihint]#Time spent waiting for {CMK} agent#).
