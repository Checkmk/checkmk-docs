...
= {CMK} versions
:title: {CMK} versions
:description: Each stable version of a {CMK} edition receives active or passive maintenance for a certain time. Here you will find an overview of all versions.
...
An overview of the xref:support_periods[product lifecycle] can be found at the end of this article.
...
|{v25} |2026-04-28 |6 months after release of {v26}footnote:stable_version[Currently, no release date has been set.] |2028-10-28
|{v24} |2025-05-06 |2026-10-28 |2027-11-06
