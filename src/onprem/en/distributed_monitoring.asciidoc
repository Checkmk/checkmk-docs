...
Enabling is done using `omd config` as an site user while the site is stopped:
...
[TIP]
====
Make sure to apply the changes (using [.guihint]#Activate changes#) before continuing.
====
