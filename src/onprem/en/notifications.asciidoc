...
* The start or end of a icon:icon_downtime[alt="Icon of a scheduled downtime."] xref:basics_downtimes#[scheduled downtime].
...
[{image-left}]
mage::notifications_large_icon_downtime.png[alt="Icon of a scheduled downtime.",width=50]
