...
By the way, the https://docs.checkmk.com/master/de/notifications.html[German version] of this article has already been updated -- if that is an alternative for you.
====
// delete to here
