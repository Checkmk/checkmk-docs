...
Based on the fully Open Source variant, {CRE} (formerly {CMK} Raw), {CSE} most importantly offers performance improvements, more extensive possibilities for _dashboards_ as well as _reporting_ and facilitates _automation_.
...
To do so, follow the xref:update#updateraw[upgrade description].
