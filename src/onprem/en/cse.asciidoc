...
In this article we will introduce you to {CSE}, one of the commercial xref:intro_setup#editions[editions] most commonly encountered in professional environments.
...
xref:cce#[{CCE}] in turn builds on {SE}.
...
If you have tested {CMK} with {CE}, which is not limited for the first 30 days, you can also upgrade to {SE} permanently after the trial period.
