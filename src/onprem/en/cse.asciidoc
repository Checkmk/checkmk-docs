...
|===
|Function |Description
|Testing the edition |You can test all commercial editions for 30 days (in license state "Trial") in full functionality without obligation.
On a small scale, i.e. with one site and up to 750 services, you can also run {CMK} permanently in license state "Free" without requiring a subscription.
|===
