...
Based on the fully Open Source variant, {CRE} (formerly {CMK} Raw), {SE} most importantly offers performance improvements, more extensive possibilities for _dashboards_ as well as _reporting_ and facilitates _automation_.
