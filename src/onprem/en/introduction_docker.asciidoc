...
|Commercial editions |link:https://checkmk.com/download?method=docker&edition=cce&version=stable[{CMK} download page^] (for {CE}), link:https://portal.checkmk.com/[{CMK} customer portal^]
|===
...
Download the desired edition and version from the link:https://checkmk.com/download?method=docker&edition=cce&version=stable[{CMK} download page^] (for {CE}) or from the link:https://portal.checkmk.com/[{CMK} customer portal^].
