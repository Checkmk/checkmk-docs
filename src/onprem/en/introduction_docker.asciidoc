...
[IMPORTANT] 
==== 
To run {CMK} using the images presented here, an official Docker installation will always be required.
...
[cols="25,~,~,~,~"]
|===
|{CRE} |link:https://hub.docker.com/r/checkmk/check-mk-raw/[Docker Hub^] | link:https://checkmk.com/download?platform=docker&edition=cre[{CMK} downloads page^] |-- |--
...
|{CCE} |link:https://hub.docker.com/r/checkmk/check-mk-cloud/[Docker Hub^] |link:https://checkmk.com/download?platform=docker&edition=cce[{CMK} downloads page^] |link:https://portal.checkmk.com/[{CMK} customer portal^] |-- 
|{CME} |link:https://hub.docker.com/r/checkmk/check-mk-managed/[Docker Hub^] |link:https://checkmk.com/download?platform=docker&edition=cme[{CMK} downloads page^] |link:https://portal.checkmk.com/[{CMK} customer portal^] |-- 
|===
...
Optionally, you can force the download of the latest image by prefixing `docker pull checkmk/check-mk-raw:{current-major}-latest`.
