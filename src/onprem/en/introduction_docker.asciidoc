...
{cce-only}
The official images are also freely available on various platforms for the commercial editions of {CMK}.
These editions can be tested with all features as part of a 30-day trial period.
