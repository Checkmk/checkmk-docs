...
- link:ai_policy.html[User Guide AI Policy]
...
- link:update_major.html[Update to version {current-major}]
- link:update_matrix.html[Update matrix for version {current-major}]
...
- link:self_monitoring.html[Monitoring your own system]
- link:certificates.html[Certificate overview in {CMK}]
...
- link:cmk_processes.html[Site services - {CMK} under the hood]
...
- link:product_usage_analytics.html[Product usage analytics]
...
- link:monitoring_podman.html[Monitoring Podman]
- link:monitoring_proxmox.html[Monitoring Proxmox]
...
- link:devel_password_store.html[Password store for developers]
- link:devel_inventory_plugins.html[Developing HW/SW inventory plug-ins]
- link:bakery_api.html[The Bakery-API]
- link:devel_mkps.html[MKPs for developers]
...
[#toc_data]
=== Data management
- link:metric_backend.html[The {CMK} metrics backend]
