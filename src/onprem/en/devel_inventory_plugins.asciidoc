...
:description: If necessary, you can develop your own inventory plug-ins using Python. Read here to find out how to create and use a plug-in yourself.
:experimental:
...
// Anthony, please proofread also the description in line 6.
...
By the way, the https://docs.checkmk.com/master/de/devel_inventory_plugins.html[German version] of this article has already been updated -- if that is an alternative for you.
====
// delete to here
...
Während die maximal unterstützte USB-Version oben im simplen Beispiel noch einfach hart kodiert wurde, können Sie sich gerne Gedanken machen, wie Sie diese mittelfristig mit regulären Ausdrücken aus der Beschreibung ermitteln.
...
Daher sollen die Nutzenden die Möglichkeit haben, selbst zu entscheiden, ob Hubs erfasst werden sollen oder nicht.
...
Die Verknüpfung erfolgt im xref:#apply_ruleset[nächsten Schritt].
