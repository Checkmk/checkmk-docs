...
.. For VMware ESXi: For better performance, you should change the network card to VMXNET 3. xref:appliance_install_virt1#vmxnet[More ...]
...
Consider carefully whether this size is sufficient for your needs and, if necessary, increase the size of the virtual hard disk *before* starting virt1 for the first time. xref:appliance_install_virt1#[More ...]
