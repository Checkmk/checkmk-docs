...
. Download the {CMK} virt1 as an OVA (Open Virtualization Appliance) file from our link:https://checkmk.com/download[download page^] and import this file into your hypervisor, either Hyper-V, Proxmox or VMware ESXi (for better performance you should change the network card to VMXNET 3 when importing into ESXi). 
