...
To test the commercial editions of {CMK} without obligation, you can use {CE} -- but also {ME} -- because both editions are not limited for the first 30 days (in license state "Trial").
On a small scale, i.e. with one site and up to 750 services, you can also run {CMK} in this way permanently without licensing in the license state "Free".
...
cmk-ui-jobs:    [red]#stopped#
nagios:         [red]#stopped#
apache:         [red]#stopped#
rabbitmq:       [red]#stopped#
piggyback-hub:  [red]#stopped#
crontab:        [red]#stopped#
-----------------------
