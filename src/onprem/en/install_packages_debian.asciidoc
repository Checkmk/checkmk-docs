...
:description: In order to run {CMK} under Debian or Ubuntu, certain conditions must be met. Read here how to plan and execute the installation of {CMK}.    
...
Stability updates are provided here earlier than for the _dot releases_ (e.g. Debian 12.10).
...
Stability updates are provided here earlier than for the _dot releases_ (e.g. Ubuntu 24.04.2).
...
--
[#ubuntu2404]
The configuration files for the package sources in Ubuntu 24.04 _Noble Numbat_ use a new syntax with blocks separated by blank lines:
...
--
[#ubuntu2204]
The configuration files for the package sources in Ubuntu 22.04 _Jammy Jellyfish_ use a new syntax with blocks separated by blank lines:
...
On the link:https://checkmk.com/download[download page^] you will find {RE}, which is open-source software, and the commercial editions, which you can try out in license state 'Trial'.
...
The deletion is performed with `apt remove --purge`:

[{shell}]
----
{c-root} apt remove --purge check-mk-raw-{oldstable-patch}
Reading package lists... Done
Building dependency tree... Done
Reading state information... Done
The following packages will be REMOVED:
  check-mk-raw-{oldstable-patch}*
