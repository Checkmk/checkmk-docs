...
*All* hosts will thus be viewed as {UP}, as long as their state is being determined via Ping or Smart Ping.
...
* Hosts and services on other sites in a distributed monitoring will continue to be monitored as usual.
Only in a distributed setup will the simulation mode be passed on to the other remote sites.
