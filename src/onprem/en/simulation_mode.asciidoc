...
In this case, manually insert the following line into the `~/etc/check_mk/conf.d/wato/global.mk` file in the copied site:
...
If the `simulation_mode` has not been set in this file, the standard value (off) will be used.
