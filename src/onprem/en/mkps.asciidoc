...
// MFS: Completely rewritten, has to be translated:
////
...
// MFS: No changes here. Keep after proofreading.
...
// MFS: Just a hint on the splitted article, please translate.
////
Befehle für das Modifizieren und Erstellen von Paketen finden Sie im Artikel MKPs für Entwickler.
////
