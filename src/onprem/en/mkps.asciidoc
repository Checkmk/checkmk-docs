...
No statement can be made for the future after that at the time of revision of this article. Packages that use the APIs introduced in {CMK} {v20} will no longer work with {CMK} {v24}. Enter 2.3.99 here as the maximum supported version.
====
