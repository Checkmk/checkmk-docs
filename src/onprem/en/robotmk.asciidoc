...
For cases where RCC does not work in your environment, a fallback solution developed by Checkmk called "CSM," based on Micromamba, is available and presented xref:robotmk_mm#[in a separate version of this article].
====
