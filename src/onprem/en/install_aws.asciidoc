...
:description: You can run {CMK} as an Amazon Machine Image (AMI). In this article, you will learn how to set up and use your site in Amazon Web Services (AWS).
...
Meanwhile we take this a step further and provide link:https://aws.amazon.com/marketplace/pp/prodview-gddkal2hfn7yo[a pre-installed image^] based on Ubuntu 22.04 _(Jammy Jellyfish)_ with all of the required dependencies already included.
