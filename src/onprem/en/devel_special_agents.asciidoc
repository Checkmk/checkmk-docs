...
At this point, we are assuming that you have already familiarized yourself with the basics of xref:datasource_programs#[datasource programs] and xref:datasource_programs#specialagents[special agents] and understand their basic mechanisms.
