...
[TIP]
====
Even without a running {CMK} site, you can view a copy of the plug-in API documentation at link:https://docs.checkmk.com/plugin-api/{gitbranch}/[docs.checkmk.com/plugin-api^].
====
