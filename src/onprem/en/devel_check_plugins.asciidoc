...
An executable basic framework (link:https://github.com/Checkmk/checkmk-docs/blob/2.3.0/examples/devel_check_plugins/check_plugin_simple_myhostgroups_bare_minimum.py[Download at GitHub^]), which you will expand step by step in the following, looks like this:
...
The link:https://github.com/Checkmk/checkmk-docs/blob/2.3.0/examples/devel_check_plugins/check_plugin_simple_myhostgroups.py[check plug-in^]
and as well as the link:https://github.com/Checkmk/checkmk-docs/blob/2.3.0/examples/devel_check_plugins/agent_plugin_simple_myhostgroups[agent plug-in^]
...
The extended link:https://github.com/Checkmk/checkmk-docs/blob/2.3.0/examples/devel_check_plugins/agent_plugin_advanced_myhostgroups[agent plug-in^]
and the extended file for the link:https://github.com/Checkmk/checkmk-docs/blob/2.3.0/examples/devel_check_plugins/check_plugin_advanced_myhostgroups_step01.py[check plug-ins^]
...
link:https://github.com/Checkmk/checkmk-docs/blob/2.3.0/examples/devel_check_plugins/ruleset_myhostgroups.py[rule set^]
as well as the 
link:https://github.com/Checkmk/checkmk-docs/blob/2.3.0/examples/devel_check_plugins/check_plugin_advanced_myhostgroups.py[check plug-in^] extended by the rule set.
====
...
* The color names used in {CMK} for the `color` definition can be found at link:https://github.com/Checkmk/checkmk/blob/2.3.0/packages/cmk-graphing/cmk/graphing/v1/metrics.py[GitHub.^]
...
The graphing file for this chapter can be found at link:https://github.com/Checkmk/checkmk-docs/blob/2.3.0/examples/devel_check_plugins/graphing_myhostgroups.py[GitHub^].
...
You can find out how to migrate such outdated check plug-ins to the Check API V1 in the link:https://checkmk.com/blog/migrating-check-plug-ins-to-checkmk-2-0[blog post on migration^].
