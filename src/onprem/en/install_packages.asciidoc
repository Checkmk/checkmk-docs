...
xref:install_packages_redhat#[Installation on Red Hat and derivatives]
...
* Red Hat Enterprise Linux (RHEL) and binary compatible derivatives (CentOS, AlmaLinux, Rocky Linux, Oracle Linux...)
