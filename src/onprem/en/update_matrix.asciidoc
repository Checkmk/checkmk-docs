...
[TIP]
====
Due to internal data dependencies, the complete compatibility matrix will be available a few hours after the release of Checkmk {v23}.
====
...
As of {v23}, the xref:ossupport[OS support policy] creates clear rules.
