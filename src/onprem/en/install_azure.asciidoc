...
Only the xref:cce#[{CE-onprem}] is used here.
After setting up the first site, you can try out this commercial xref:glossar#edition[edition] in license state 'Trial'.
