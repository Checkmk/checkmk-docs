...
[TIP]
====
As of September 17, 2024, there are no ready-made images containing {CMK} {v23} available in the Microsoft Azure Marketplace.
Of course you can use the images with {CMK} {v22} and xref:update#[update to {v23}] immediately after installation.
We will remove this notice as soon as images are available and apologize for the additional work caused by this.
====
