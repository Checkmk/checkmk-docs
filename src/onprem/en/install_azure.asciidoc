...
Since {CMK} {v22} we take this a step further and provide link:https://azuremarketplace.microsoft.com/en-us/marketplace/apps/tribe29gmbh1665582614827.checkmk003?tab=Overview[a pre-installed image^], now based on Ubuntu 24.04 _(Noble Numbat)_ with all of the required dependencies already included.
