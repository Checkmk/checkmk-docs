...
[TIP]
====
As of September, 17th, 2024 there are not yet ready-made images containing {CMK} {v23} available in the Azure Marketplace.
Of course you can use the images with {CMK} {v22} and perform the xref:update#[update to {v23}] immediately after the setup.
We will remove this hint as soon as images are available and apologize for the additional work caused by this.
====
