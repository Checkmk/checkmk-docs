...
The output can simply be reversed by specifying `desc`:
...
This format works with both the Nagios-Core in the {CRE} and with the CMC in the commercial editions.
