...
|`OrderBy` |Column name or dictionary key [asc,desc]|Sorts the output by the content of the column or the value respectively.
...
|`REMOVE_HOST_ACKNOWLEDGEMENT` |link:https://assets.nagios.com/downloads/nagioscore/docs/externalcmds/cmdinfo.php?command_id=116[Delete a host problem acknowledgement^]
...
|`REMOVE_SVC_ACKNOWLEDGEMENT` |link:https://assets.nagios.com/downloads/nagioscore/docs/externalcmds/cmdinfo.php?command_id=117[Delete a service problem acknowledgement^]
