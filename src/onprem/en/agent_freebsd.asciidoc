...
If the version (e.g. {oldmajor}) of this {CMK} agent available in the FreeBSD ports is equal to or one major version lower than your {CMK} version currently in use, you can install this agent.
