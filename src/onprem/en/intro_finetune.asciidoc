...
*Tip:* An alternative to creating downtimes for hosts, which we have already described in the xref:intro_monitor#downtimes[chapter on scheduled downtimes], is the [.guihint]#Recurring downtimes for hosts# rule set in the commercial editions.
