...
:description: {CMK} offers state-of-the-art solutions for monitoring Microsoft SQL Server environments. Here you can read how to configure the legacy plugin mssql.vbs.
