...
This forces the host to use the SNMPv2c protocol -- although version 1 has been set -- however _without bulkwalk_.
...
Here it can sometimes help to go back to SNMPv1 -- which is usually much slower, but can still sometimes be faster than a broken SNMP v2c.
