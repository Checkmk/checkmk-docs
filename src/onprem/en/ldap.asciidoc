...
You do not need to specify groups to produce a functioning configuration.
...
In the second case the users on the central site are retrieved from the LDAP connections and copied to the remote sites with an xref:glossar#activate_changes[activate pending changes].
