...
An important task for the `cmk` is the generation of a
...
In every release a few new ones are added, and Version {current-major} already includes more than 2,000 plug-ins.
