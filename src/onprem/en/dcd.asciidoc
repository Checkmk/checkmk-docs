...
Here, you do *not* determine on which site the hosts are to be created. You specify this in the [.guihint]#Host attributes to set# using the [.guihint]#Basic settings: Monitored on site# host attribute.
