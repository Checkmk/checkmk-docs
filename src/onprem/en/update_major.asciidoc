...
.What will you need to do? Upgrade your Linux distribution
[%collapsible]
====
...
// start translation - NB: No text to translate here, simply insert this line once the rest of the article is translated
////
====
////
// end translation
