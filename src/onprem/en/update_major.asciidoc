...
[IMPORTANT]
====
With {CMK} {v23}b6, the check APIs for versions up to {v16} that were already marked as _deprecated_ in {v20} finally have been removed (link:https://checkmk.com/de/werk/16689[Werk #16689^]).
