...
A migration skript will be provided later in the lifecycle of {CMK} {v23}. However, a fully automated migration tends to be diffficult, because with many hosts rules from two checks have to be merged in order to benefit from the improved efficiency.
