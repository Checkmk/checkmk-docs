...
*What will you need to do?*
Read the instructions in link:https://checkmk.com/werk/19333[Werk pass:q[#]19333^] to learn how to enable sharing of individual dashboards in  {CMK} starting with version {v25}.
This can be done, for example, using a _public URL_ that contains a token for which authentication and display settings have been configured.
...
[#mssql]
=== Microsoft SQL Server (for Windows) rule set will be removed
