...
*Does this affect you?*
Hopefully not: The discontinuation only affects you if you use agent plugins written in Python on Windows Server 2008 R2 or Windows 7 (both EOL already in 2020).
