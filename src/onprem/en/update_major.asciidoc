...
More extensive checks, especially in the cloud area, can typically increase the load by 10-15{nbsp}% (in extreme cases by 20{nbsp}%), depending on the proportion of the total number of checks.
