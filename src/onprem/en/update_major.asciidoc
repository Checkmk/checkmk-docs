...
As the necessary changes are only implemented in {CMK} {v22}p17 (link:https://checkmk.com/werk/16193[Werk pass:q[#]16193^]), you must therefore update the central site to this version at least.
...
Until {CMK} {v22}, the Windows agent relied on the additional plug-in link:https://checkmk.com/integrations/winperf_if[winperf_if] to correctly transmit the status of network interfaces.
...
Further information is provided in link:https://checkmk.com/werk/15514[Werk pass:q[#]15514^].
