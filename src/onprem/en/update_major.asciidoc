...
In addition, the Check API already marked as _deprecated_ in {v20} has been permanently removed.
...
[IMPORTANT]
====
With {CMK} {v23}b6, the Check API for versions up to {v16} that was already marked as _deprecated_ in {v20} finally has been removed (link:https://checkmk.com/werk/16689[Werk #16689^]).
