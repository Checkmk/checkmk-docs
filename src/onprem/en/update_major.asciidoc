...
* Debian 10 _Buster_ (final decision still pending, Debian 10 may remain in support)
...
As the configurability as a property of a host is very limited, this option will no longer be available in the future. We explain the background and alternatives in the link:https://checkmk.com/blog/monitoring-management-boards[blog article "Monitoring management boards"].
