...
Zertifikate kommerzieller CAs, von link:https://letsencrypt.org[_Lets Encrypt_^] oder mittels link:https://smallstep.com/docs/step-ca/[Step-CA^] erstellte sind nicht betroffen.
