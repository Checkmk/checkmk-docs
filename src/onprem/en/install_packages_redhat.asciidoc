...
In order to be able to use EPEL on Red Hat and binary compatible distributions, the package sources for optional RPMs are required if these have not already been installed during the operating system installation.
