...
|Assign Memory | Startup memory | min. 8192 MB
...
|Processor | Number of virtual processors | min. 2
...
. Then navigate to [.guihint]#Processor# and assign at least 2 virtual CPUs.
...
>>>>>>> 62e94304 (KNW-1684 finalized installation instructions for Hyper-V)
