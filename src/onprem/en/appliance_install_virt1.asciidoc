...
Select the storage for this new EFI disk and hit [.guihint]#OK#.
...
As the final step, you have to disable _Secure Boot_ in the OVMF menu of the VM.
To do that, start the VM, wait a second and press the kbd:[any] key.
In the menu that opens up, select [.guihint]#Device Manager >  Secure Boot Configuration#, move down to [.guihint]#Attempt Secure Boot# and press the space bar to deactivate this option.
Press kbd:[Esc] twice, select [.guihint]#Reset# and hit kbd:[Enter].
