...
Sie haben zwei Möglichkeiten, den Simulationsmodus einzurichten.
...
Das ist sinnvoll, wenn Sie eine Kopie erstellt haben und den Modus aktivieren wollen, bevor Sie die Instanz starten.
