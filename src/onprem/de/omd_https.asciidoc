// -*- coding: utf-8 -*-
// IGNORE Einstellungen Datenschutz Zertifikate Importieren Sicherheit
// NONASCII …​
...
In der Zieldatei sind lediglich die zwei oder drei Zeilen für Schlüssel, Zertifikat und gegebenfalls Kette anzupassen:
