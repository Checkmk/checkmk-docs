...
Wir setzen an dieser Stelle voraus, dass Sie sich schon mit den Grundlagen von xref:datasource_programs#[Datenquellenprogrammen] und xref:datasource_programs#specialagents[Spezialagenten] auseinandergesetzt haben und die prinzipiellen Mechanismen verstehen.
