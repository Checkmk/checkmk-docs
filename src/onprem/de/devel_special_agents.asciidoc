...
Um nicht bei jeder noch so kleinen Änderung die Regel- und Aufrufkonfiguration nachziehen zu müssen, können Sie den Spezialagenten auch testweise als xref:datasource_programs#[klassisches Datenquellenprogramm] aufrufen.
