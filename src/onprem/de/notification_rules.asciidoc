...
// TK: Wurde das HTML-Layout der E-Mails nicht geändert? Bitte überprüfen und ggf. Screenshot ersetzen.
...
// TK: Hier steht nichts über den generellen Zweck dieses Step 2: Einschränkung auf Objekte
// TK: Der Konjunktiv macht die folgenden 2 Absätze seeeehr schwer verständlich.
...
// TK: obige Regel? die oben festgelegten Ereignisarten ... oder so ähnlich
...
// TK: Ich hab den folgenden Absatz rausgenommen, wegen des momentanen Chaos mit der kontextsensitive Hilfe UND weil es die Option Match services und den zitierten Hilfetext im Wizard gar nicht gibt.
////
Den folgenden Hinweis geben wir in diesem Handbuch daher immer wieder.
...
Der folgende Auszug aus der kontextsensitiven Hilfe zur Option [.guihint]#Match services# verdeutlicht das Verhalten sehr gut:
...
// TK: Warum ist das eine Ausnahme von der UND-Verknüpfung? M.E. kann die Zwischenüberschrift Teil 2 weg.
...
// TK: Warum sollte ich denn noch auf Create klicken, wenn ich doch schon die Parameter definiert und gerade ausgewählt habe?
...
// TK: Abschnitt eine Ebene höher gezogen und damit raus aus dem Kontext Bulk-Benachrichtigungen
