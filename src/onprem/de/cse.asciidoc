...
Folgen Sie dafür der xref:upgrade#[Upgrade-Beschreibung].
...
Folgen Sie dafür der xref:upgrade#down2cee[Downgrade-Beschreibung].
...
In kleinem Rahmen, d.h. mit _einer_ Instanz und bis zu 750 Services, kann {CMK} als kommerzielle Edition auch darüber hinaus dauerhaft ohne Subskription im Lizenzstatus „Free“ betrieben werden.
