...
Aufbauend auf der reinen Open Source Variante {CRE} (vormals {CMK} Raw) bietet {SE} vor allem Verbesserungen der Performance, umfangreichere Möglichkeiten von _Dashboards_ sowie _Reporting_ und Erleichterungen der _Automatisierung_.
