...
Aufbauend auf der reinen Open Source Variante {CRE} (vormals {CMK} Raw) bietet {CSE} vor allem Verbesserungen der Performance, umfangreichere Möglichkeiten von _Dashboards_ sowie _Reporting_ und Erleichterungen der _Automatisierung_.
...
Folgen Sie dafür der xref:update#updateraw[Upgrade-Beschreibung].
