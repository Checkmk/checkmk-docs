...
[#zombie14]
=== Versehentlich deaktivierte Benachrichtigungen

Bei Systemen, die vor langer Zeit einmal von {CMK} {v14} auf {v15} aktualisiert wurden, kann es vorkommen, dass nach dem Update von {v21} auf {v22} Benachrichtigungen nicht mehr funktionieren.

*Betrifft Sie das?*
Das Problem tritt nur auf Installationen auf, die von {CMK} {v14} auf {v15} vor p8 aktualisiert wurden. Und dort nur bei Benutzern, die zwischenzeitlich nicht mehr bearbeitet und gespeichert wurden. Bei {CMK}-Installationen, die von {CMK} {v14} auf {v15}p8 oder später aktualisiert wurden, oder erst mit {CMK} {v15} oder später installiert wurden, tritt es überhaupt nicht auf.
...
Details erklärt das link:https://checkmk.com/de/werk/6417[Werk #6417^].
