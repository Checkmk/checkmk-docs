...
Generell empfehlen wir, zuerst {CMK} auf die neueste {v23} Patch-Version zu aktualisieren und dann das Update auf die neueste Patch-Version von {v24} durchzuführen.
