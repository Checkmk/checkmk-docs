...
// TK: Ich find den in KNW-1224 genannten Hinweis nicht.
...
// TK: Meinst Du hier Patch-Versionen des Agenten?
...
[#cfe2cce]
=== Upgrade auf die {CE}
// TK: Das kann weg (oder erstmal auskommentiert werden). In 2.2.0 gibt es keine Free Edition.
...
// TK: {v23} zurück auf {v22} geändert. Die Versionsinfo kann eigentlich hier ganz raus.
...
// TK: Kommando nennen: cmk-update-agent
...
// TK: Sonst klingt das soweit ganz ok - obwohl ich beim Zertifikatsthema nach wie vor nur 3 große ??? sehe. Den Update in agent_deployment tue ich mir erst später an...
...
// TK: Versionsverhau? Werk 14964 gilt doch nur für 2.2.0. Kann das ganze Kapitel nicht weg?
