...
Umfangreichere Checks gerade im Cloud-Bereich können je nach Anteil an der Gesamtmenge der Checks für typischerweise 10–15{nbsp}% (in Extremfällen um 20{nbsp}%) mehr Last sorgen.
