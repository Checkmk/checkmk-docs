...
Alle älteren Windows-Versionen unterstützt {CMK} bereits in Version {v22} nicht mehr.
// TK: Erweitern zu?: Alle älteren Windows-Versionen -- wie Windows Server 2008 R2 -- unterstützt {CMK} bereits in Version {v22} nicht mehr.

*Was müssen Sie tun?*
// TK: Neuen Einleitungssatz hinzufügen?
// TK: Wenn Sie diese Windows-Systeme weiterhin überwachen wollen, müssen Sie Umgebung für Agentenplugins, die Python benötigen, selbst bereitstellen.
...
Im Haus entwickelte Erweiterungen können Sie meist selbst leicht testen und gegebenenfalls anpassen.
