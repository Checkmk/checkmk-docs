...
Die Anwesenheit des Pakets verursacht Fehlermeldungen beim Update (Stand {v24}b5).
====
...
Sollten Sie auf Anwendungen stoßen, in denen der neue Check den alten _keinesfalls_ ersetzen kann, können Sie sich die verwendete Kommandozeile analog zum link:https://checkmk.com/de/blog/how-monitor-servers-broken-tls-checkmk[hier beschriebenen Vorgehen^] anzeigen lassen.
