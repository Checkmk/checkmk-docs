...
Ein Migrationsskript wird im späteren Verlauf des Lifecycles von {CMK} {v23} bereitgestellt werden. Allerdings ist eine komplett automatisierte Migration tendenziell schwierig, weil bei vielen Hosts Regeln von zwei Checks zusammengeführt werden müssen, um von der verbesserten Effizienz zu profitieren.
