...
// TK: Wenn ich das Werk richtig verstehe, wird doch auch nur das Serverzertifikat importiert? Dann vielleicht so:
// TK: Ab {CMK} {v23} wird nur das Serverzertifikat importiert und diesem vertraut.
