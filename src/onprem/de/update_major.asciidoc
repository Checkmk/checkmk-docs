...
Da die {CMK} Appliance 1.6 seit langer Zeit nicht mehr mit Aktualisierungen unterstützt wird, raten wir zu folgendem Vorgehen wenn Ihre Appliance noch Firmware Version 1.6 nutzt:
