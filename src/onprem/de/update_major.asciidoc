...
{CMK} {v24} unterstützt die {CMK} Appliance ab Version 1.7.
Die von {CMK} {v23} noch unterstützte Firmware Version 1.6 wird nicht mehr unterstützt.
...
. Aktualisieren Sie {CMK} wie in diesem Artikel beschrieben auf Version {current} (Installationspakete für Appliance-Versionen 1.7 tragen `-4` im Namen)

Lesen Sie die Details zur xref:appliance_usage#cma_webconf_firmware[Aktualisierung der Appliance] im Artikel zur Nutzung der Appliance.
