...
Bis Version {v22} bot {CMK} die Möglichkeit, per Bakery-Regel eine Python 3.4 Runtime für Windows-Agenten mitzuliefern.
Diese Option fällt in {v23} weg.

*Betrifft Sie das?*
Hoffentlich nicht: Der Wegfall betrifft Sie nur, wenn Sie in Python geschriebene Agenten-Plugins auf Windows Server 2008 R2 (EOL bereits in 2020) nutzen.
