...
Bis {CMK} {v22} war der Windows-Agent auf das zusätzliche Plugin link:https://checkmk.com/integrations/winperf_if[winperf_if] angewiesen, um den Status von Netzwerk-Interfaces korrekt zu übermitteln.
...
Migrationshilfen werden während des Lifecycle von {CMK} {v23} bereitgestellt werden, allerdings ist eine komplett automatisierte Migration tendenziell schwierig, weil bei vielen Hosts Regeln von zwei Checks zusammengeführt werden müssen.
