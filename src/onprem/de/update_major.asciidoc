// -*- coding: utf-8 -*-
// IGNORE Alertmanager p17 p21 p23 p8 0pX
...
[TIP]
====
Ab dem Update auf {v23} werden Änderungen bei einem fehlgeschlagenen oder mit `Strg+C` abgebrochenen Update zurückgerollt (link:https://checkmk.com/de/werk/16408[Werk pass:q[#]16408^]).
Erst, wenn der Text [.guihint]#Completed verifying site configuration. Your site now has version {v23}pX# angezeigt wird, ist die aktualisierte Konfiguration aktiv.
Dies ersetzt kein Backup, reduziert aber meist die Ausfallzeit, wenn schief läuft.
====
