...
[IMPORTANT]
====
Beim Update von {CMK} {v22}pX auf das aktuellste Patchlevel von {v23} planen Sie bitte als Zwischenschritt Version 2.3.0p12 ein.
Stellen Sie beim Update auf 2.3.0p12 sicher, dass während des Pre-Flight-Checks gemeldete Probleme behoben sind.
In der Regel genügt es, die von {CMK} vorgeschlagene Aktion ausführen zu lassen.
Aktualisieren Sie erst danach weiter auf ein höheres Patchlevel von {v23}.
====
