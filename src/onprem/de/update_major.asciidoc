...
Sollte ein wichtigstes Thema fehlen, melden Sie bitte link:https://github.com/Checkmk/checkmk-docs/issues[via GitHub eine Issue.]
====
...
Sollten Sie von {oldoldstable} auf {current-major} aktualisieren wollen, führen Sie zunächst ein link:https://docs.checkmk.com/{oldstable}/de/update_major.html[Update auf {oldstable}] durch.
