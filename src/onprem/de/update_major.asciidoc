...
Bis {CMK} {v22} war der Windows-Agent auf ein zusätzliches Plugin angewiesen, um den Status von Netzwerk-Interfaces korrekt zu übermitteln. Ohne Plugin war der Status immer {UP}. Ab {CMK} {v23} kann der Agent alleine den korrekten Status übermitteln (link:https://checkmk.com/de/werk/15839[Werk pass:q[#]15389^]).
