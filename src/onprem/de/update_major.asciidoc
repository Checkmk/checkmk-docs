...
Bei {CMK} {ME} und {CE} mit verteiltem Setup werden mitunter beim Update keine Lizenzinformationen zu Remote Sites synchronisiert, dies muss überprüft und gegebenenfalls manuell angestoßen werden.
