...
Aktivieren Sie anschließend die Änderungen, da ein Ein- oder Ausschalten des Piggyback-Hubs einen Neustart der Instanz erfordert.
...
// ES: Historische Info erstmal als Kommentar eingefügt, aber evtl ist das für Lesende interessant, um Aufmerksamkeit darauf zu lenken, dass es sich hier um eine recht frische Änderung handelt?
// MFS: IMHO sichtbar machen. Der Wegfall der Einschränkung dürfte vielen Nutzern ihre Arbeit erleichtern. 
