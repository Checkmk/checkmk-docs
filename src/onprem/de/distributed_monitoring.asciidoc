...
Für die reibungslose Durchführung von xref:update_major#[Major-Updates] (beispielsweise von {v23} auf {v24}) in großen verteilten Umgebungen erlaubt {CMK} seit {v20} einen Mischbetrieb, bei dem die Differenz genau eine Major-Version sein darf.
