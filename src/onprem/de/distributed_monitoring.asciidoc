...
Um die Kommunikation zu ermöglichen, müssen Sie lediglich sicherstellen, dass xref:ports#cmk_incoming_remote_outgoing[Port 5672 geöffnet] ist.
Die restlichen benötigten Ports werden automatisch ausgewählt.


==== Peer-to-Peer-Verbindungen

Um Ihre Zentralinstanz zu entlasten können Sie Remote-Instanzen auch direkt miteinander kommunizieren lassen, also über eine sogenannte 
