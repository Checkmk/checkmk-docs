...
[#minimalexample]
=== Das einfachste mögliche Programm
...
Nehmen Sie diesen in die Überwachung auf, xref:glossar#activate_changes[aktivieren Sie die ausstehenden Änderungen] und Ihr erstes Datenquellprogramm läuft.
