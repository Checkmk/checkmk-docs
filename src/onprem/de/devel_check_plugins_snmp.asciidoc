...
// TK-RE: CheckResult, DiscoveryResult, StringTable werden aber gar nicht genutzt?
// MFS: Doch, implizit, also importieren wir sie.
...
// TK-RE: Nunja, neu sind auch: CheckResult, DiscoveryResult, SimpleSNMPSection
