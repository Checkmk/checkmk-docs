...
{cce-only}
Auch für die kommerziellen Editionen von {CMK} sind die offiziellen Images auf verschiedenen Plattformen frei verfügbar.
Diese Editionen können im Rahmen einer 30-tägigen Testphase mit allen Features getestet werden.
...
----
 or from the {CMK} Docker registry
