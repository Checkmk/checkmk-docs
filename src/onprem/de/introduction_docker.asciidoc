...
Laden Sie sich die gewünschte Edition und Version von der link:https://checkmk.com/de/download?method=docker&edition=cce&version=stable[{CMK}-Download-Seite^] (für {CE}) oder im link:https://portal.checkmk.com/de/[{CMK}-Kundenportal^] herunter.
