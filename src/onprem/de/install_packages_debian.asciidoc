...
//[discrete] Wohin mit den bisherigen Auszeichnungen und Ankern? Baue ich sie unten ein, werden mir die TB nicht korrekt gerendert. 
//[discrete] Wohin damit, brauchen wir discrete noch...? 
...
// Kurz und knapp oder etwas gesprächiger mit abwechslungsreichem Text? Sprechenden Namen (Bullseye) erst hier nennen und raus aus dem Tab?
...
// SH: [discrete] von Ubuntu 22.04, stand vor dem Anker. 
// SH: [discrete] von Ubuntu 24.04, stand vor dem Anker. Wohin damit? Oder löschen? ---> Löschen. Verbirgt ZÜ in TOC. Hier nicht mehr nötig.
...
+
--
// SH: Anker erstmal drin lassen für Auffindbarkeit: Müssen später ggf. rückgebaut werden für andere Lösung. Es darf dann nur eine ID geben. 
[#ubuntu2204]
