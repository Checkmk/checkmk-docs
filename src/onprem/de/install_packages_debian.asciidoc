...
Wählen Sie zunächst die für Ihre Bedürfnisse passende {CMK}-xref:glossar#edition[Edition].
Auf der link:https://checkmk.com/de/download[Download-Seite^] finden Sie {RE}, die Open Source ist, und die kommerziellen Editionen, die Sie im Lizenzstatus „Trial“ ausprobieren können.
...
Die Deinstallation geschieht mit `apt remove --purge`:
