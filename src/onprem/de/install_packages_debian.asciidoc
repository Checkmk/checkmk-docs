...
[#ubuntu2404]
Ubuntu 24.04 _Noble Numbat_ verwendet bereits die neue Konfigurations-Syntax:
...
[#ubuntu2204]
Ubuntu 22.04 _Jammy Jellyfish_ verwendet noch die alte Konfigurations-Syntax:
