...
[{shell-raw}]
----
{c-root} scp check-mk-raw-2.3.0p1_0.jammy_amd64.deb root@mymonitoring.mydomain.org:/tmp
----
...
[{shell}]
----
{c-root} dpkg-sig --verify check-mk-raw-2.3.0p1_0.jammy_amd64.deb
----
...
[{shell-raw}]
----
{c-root} gpg --verify check-mk-raw-2.3.0p1_0.jammy_amd64.deb
...
[{shell}]
----
{c-root} apt install /tmp/check-mk-raw-2.3.0p1_0.jammy_amd64.deb
----
