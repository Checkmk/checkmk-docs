...
--
[#debian11]
Version 11 von Debian verwendet noch die alte Syntax: 
...
--
[#debian12]
Version 12 von Debian verwendet bereits die neue Syntax:
// Kurz und knapp oder etwas gesprächiger mit abwechslungsreichem Text? Sprechenden Namen (Bookworm) erst hier nennen und raus aus dem Tab?
...
// [discrete] von Ubuntu 22.04, stand vor dem Anker. 
// [discrete] von Ubuntu 24.04, stand vor dem Anker. Wohin damit? Oder löschen?
...
// Reicht so ein Kurztext? Oder lieber den tierischen Langnamen der Version (Jammy Jellyfish) erst hier nennen und aus dem Tab raus?
...
// Reicht so ein Kurztext? Oder lieber den tierischen Langnamen der Version (Noble Numbat) erst hier nennen und aus dem Tab raus?
