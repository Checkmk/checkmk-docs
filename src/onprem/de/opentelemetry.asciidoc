...
[TIP]
====
Ist eine etwas komplexere Erstellung der Hostnamen gewünscht, speichern Sie die Kollektorkonfiguration und aktivieren Änderungen, ohne eine Regel für die [.guihint]#Host name computation# hinzugefügt zu haben.
