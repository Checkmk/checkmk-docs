// -*- coding: utf-8 -*-
// IGNORE Addons cancelling logfiles Eventlog Finetune Logfile logfile +1
// NONASCII
...
Wie immer in {CMK}, müssen Sie zuerst xref:glossar#activate_changes[ausstehende Änderungen aktivieren], damit diese wirksam werden.
...
Das Aktivieren ausstehender Änderungen in der EC ist nur Administratoren erlaubt.
...
Übrigens, die EC und ihre Komponenten sind darauf ausgelegt, Benachrichtigungen in einer für Menschen und Incident-Response-Teams ausgelegten Frequenz zu verschicken.
Es gibt keine harte Grenze, aber denken Sie eher in der Größenordnung „Benachrichtigungen pro Tag“ statt „pro Sekunde“ -- die EC ist keine API zur Anbindung von Drittsystemen!
...
Leider haben sich die Vorteile von Open-Source-Entwicklung bei den Autoren von MIB-Dateien noch nicht herumgesprochen, und so sind wir vom {CMK}-Projekt leider nicht in der Lage, herstellerspezifische MIB-Dateien mit auszuliefern.
