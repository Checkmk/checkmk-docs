...
Diese muss mindestens der Version 1.7.101 entsprechen.
...
Sollten Sie stattdessen den System Center Virtual Machine Manager (kurz: SCVMM) nutzen, sollten Sie dieser Anleitung ebenfalls folgen können, da die Unterschiede bei der Einrichtung einer virtuellen Maschine marginal sind.
====
...
|Assign Memory | Startup memory | mind. 8192 MB
...
|Processor | Number of virtual processors | mind. 2
...
. Zurück im Hauptbildschirm des [.guihint]#Hyper-V Manager# wählen Sie jetzt Ihre neue VM für {CMK} aus und klicken Sie dann auf [.guihint]#Settings.#
. Hier müssen Sie den Punkt [.guihint]#Security# auswählen und die Checkbox [.guihint]#Enable Secure Boot# *deaktivieren*.
. Navigieren Sie anschließend zum Punkt [.guihint]#Processor# und weisen mindestens 2 virtuelle CPUs zu.
