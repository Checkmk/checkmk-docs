...
Die folgende Tabelle enthält alle Anpassungen, die Sie während der Erzeugung der virtuellen Maschine in Hyper-V-Manager vornehmen müssen.
...
. Beim Schritt [.guihint]#Configure Networking# müssen Sie ggf. noch die richtige [.guihint]#Connection# auswählen.
. Nun müssen die im Schritt [.guihint]#Connect Virtual Hard Disk# die Option [.guihint]#Use an existing virtual hard disk# auswählen.
...
. Klicken Sie dann auf [.guihint]#Finish#, aber starten Sie die VM noch *nicht*.
. Wählen Sie jetzt Ihre neue VM für {CMK} aus und klicken Sie dann auf [.guihint]#Settings.#
. Hier müssen Sie den Punkt [.guihint]#Security# auswählen und dort die Checkbox [.guihint]#Enable Secure Boot# *deaktivieren*.
. Klicken Sie danach auf [.guihint]#SCSI Controller# und fügen Sie per [.guihint]#Add# eine neues [.guihint]#Hard Drive# hinzu. Unter dem Feld [.guihint]#Virtual hard disk# finden Sie erneut den Knopf [.guihint]#Browse#. Wählen Sie dieses mal die virtuelle Festplatte mit deren Dateiname `disk2` enthält und schließen Sie die Einstellungen mit [.guihint]#Apply#.

Jetzt können Sie die VM starten und sich zu guter Letzt - beispielsweise direkt mit dem Hyper-V Manager - verbinden.
