...
Wählen Sie den Speicherort für diese neue EFI-Disk und klicken Sie auf [.guihint]#OK#.
...
Als letzten Schritt müssen Sie _Secure Boot_ im OVMF-Menü der VM deaktivieren.
Starten Sie dazu die VM, warten Sie eine Sekunde und drücken Sie eine beliebige Taste.
In dem sich öffnenden Menü wählen Sie [.guihint]#Device Manager > Secure Boot Configuration#, gehen nach unten zu [.guihint]#Attempt Secure Boot# und drücken die Leertaste, um diese Option zu deaktivieren.
Drücken Sie zweimal kbd:[Esc], wählen Sie [.guihint]#Reset# und bestätigen Sie mit der kbd:[Eingabetaste].
