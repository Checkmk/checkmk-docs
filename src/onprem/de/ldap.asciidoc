...
In letzterem Fall werden die Benutzer auf der Zentralinstanz aus den LDAP-Verbindungen abgerufen und bei der xref:glossar#activate_changes[Aktivierung ausstehender Änderungen] auf die Remote-Instanzen kopiert.
