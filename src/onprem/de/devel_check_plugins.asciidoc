...
// MFS: Hier sollten wir nicht nur davon ausgehen, sondern der Einfachheit zuliebe Identität voraussetzen. So umformulieren, dass "Beispiel" und "ausgehen" nicht mehr enthalten sind (Dopplung).
...
// MFS: Das wäre gefährlich und würde alles importieren, was in dieser Python-Installation da ist und mglw. zu Speicherproblemen führen.
...
// MFS: Leerzeile entfernt, "also nur das" ersetzt durch "nur"...
Für unser Beispiel wird nur importiert, was im weiteren Verlauf des Artikels genutzt wird.
...
// MFS: Habe ich den Typ der Rückgabeobjektes da reingeschrieben? Entweder wir geben überall den Rückgabetyp an oder nirgendwo...
...
// MFS: Evtl. ein paar Beispiele nennen...
...
Diese können die interne Kommunikation von {CMK} durcheinanderbringen.
Alternativ können Sie die Ausgabe von Debugging-Informationen auf deren xref:custom_debug[explizite Anforderung] beschränken.
====
...
// TK-RE: Dieser Abschnitt ist m.E. überflüssig, denn die neuen APIs sollen Copy&Paste aus CMK-Soure-Dateien überflüssig machen.
// MFS: Hier geht es ja nicht um Copy and Paste, sondern um die Verwendung (als Verweis quasi).
// Ein Problem hier ist aber, dass es alte und neue gibt und die neuen wieder eigene Namespaces verwenden.
// Die alten laufen irgendwann aus... Ich kläre das mit den Devs...
////
