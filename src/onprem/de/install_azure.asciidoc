...
:description: Sie können {CMK} als VM-Image in Microsoft Azure betreiben. Lesen Sie hier, wie Sie Ihre {CMK}-Instanz in der Azure-VM einrichten und konfigurieren.
...
Mittlerweile gehen wir einen Schritt weiter und bieten link:https://azuremarketplace.microsoft.com/de-de/marketplace/apps/tribe29gmbh1665582614827.checkmk003?tab=Overview[ein vorinstalliertes Image^], welches auf Ubuntu 22.04 _(Jammy Jellyfish)_ basiert, bei dem alle Abhängigkeiten bereits erfüllt sind.
