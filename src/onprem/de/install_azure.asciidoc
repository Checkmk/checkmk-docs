...
Seit {CMK} {v22} gehen wir einen Schritt weiter und bieten link:https://azuremarketplace.microsoft.com/de-de/marketplace/apps/tribe29gmbh1665582614827.checkmk003?tab=Overview[ein vorinstalliertes Image^], welches mittlerweile auf Ubuntu 24.04 _(Noble Numbat)_ basiert, bei dem alle Abhängigkeiten bereits erfüllt sind.
