...
[TIP]
====
Stand 17. September 2024 sind noch keine fertigen Images mit {CMK} {v23} im Marketplace von Microsoft Azure verfügbar.
Selbstverständlich können Sie die Images mit {CMK} {v22} verwenden und direkt nach der Installation ein xref:update#[Update auf {v23}] durchführen.
Wir entfernen diesen Hinweis, sobald Images verfügbar sind und entschuldigen uns für den entstehenden Mehraufwand.
====
