...
* [.guihint]#Use CN from LDAP distiguished name (DN) string:# Checkmk nimmt aus dem Attribut-String den "Common name" (CN) und gleicht diesen mit dem [.guihint]#Contact group claim name# ab. Der "Distinguished name" (DN) des Strings wird als Benutzer der ermittelten Kontaktgruppe zugeordnet.
