...
Hinweise zur Auswahl zwischen diesen Funktionen finden Sie im Artikel über xref:graphing#customize_rrds[Messwerte und Graphing].
...
Zum Schluss müssen Sie noch die bisherigen RRDs xref:graphing#customize_rrds[konvertieren].
