// -*- coding: utf-8 -*-
// IGNORE Failover LAN1 LAN2 Virtualisierer bond0 bond1 clustern ens32 eth0 eth1 geclustert geclusterten gerätespezifische rack1 rack4 Anschlüsse Hardwareausfälle Netzwerkanschlüsse
...
* 1 x {CMK} rack1/rack4 und 1 x {CMK} virt1
