// -*- coding: utf-8 -*-
// IGNORE 
// SKIPCOMMITS 2025-09-08
include::global_attr.adoc[]
= {CMK} in Grafana integrieren
:revdate: 2023-11-08
:title: {CMK} in Grafana integrieren
:description: Mit dem {CMK}-Plugin für Grafana können Sie Ihre Monitoringdaten in Grafana-Dashboards visualisieren. Lesen Sie hier, wie Sie das Plugin einrichten.
