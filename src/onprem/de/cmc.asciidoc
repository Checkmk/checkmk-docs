...
Auch die kommerziellen Editionen enthalten Nagios weiterhin als optionalen Kern -- allerdings nur um die Migration der {RE} auf die kommerziellen Editionen zu unterstützen.
...
Die {CE} kann für einen begrenzten Zeitraum unverbindlich getestet und in kleinem Rahmen dauerhaft ohne Lizenzierung betrieben werden.
