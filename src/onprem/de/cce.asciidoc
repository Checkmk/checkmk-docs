...
* Observability: +
Observability erweitert das klassische Monitoring komplexer IT-Systeme durch die Analyse von Datentypen (Metriken, Logs, Traces), mit dem Ziel, nicht nur festzustellen, _dass_ ein System fehlerhaft arbeitet, sondern _warum_ dem so ist. In {CE-onprem} können Daten über den link:https://opentelemetry.io/[OpenTelemetry^]-Standard bezogen werden.
