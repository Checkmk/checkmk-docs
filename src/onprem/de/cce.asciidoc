...
= Die {CE}
:revdate: 2024-03-13
:title: Die Cloud Edition
:description: Was die Cloud Edition ausmacht, vor allem auch im Vergleich zu den anderen {CMK}-Editionen, erfahren Sie hier.
...
Inhaltlich baut die {CE} auf der xref:cse#[{CSE}] auf, bietet aber zusätzlich umfangreiche Cloud-Funktionen.
