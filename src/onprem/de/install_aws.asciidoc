...
Seit {CMK} {v22} gehen wir einen Schritt weiter und bieten link:https://aws.amazon.com/marketplace/pp/prodview-gddkal2hfn7yo[ein vorinstalliertes Image^] auf Basis von Ubuntu 22.04 _(Jammy Jellyfish)_, bei dem alle Abhängigkeiten bereits erfüllt sind.
