...
image::robotmk_services_menu.png[alt="Robotmk-Regeln im Setup-Menü.",fullscreen=1]
...
image::robotmk_scheduler_00.png[alt="Leere Robotmk-Scheduler-Regel.",fullscreen=1]
...
image::robotmk_scheduler_01.png[alt="Pfad für Test-Suites.",fullscreen=1]
...
image::robotmk_scheduler_02.png[alt="Ausführungsintervall für Sequenzen.",fullscreen=1]
...
image::robotmk_scheduler_03.png[alt="Bezeichnung und Pfad der Suite.",fullscreen=1]
...
image::robotmk_scheduler_04.png[alt="Konfiguration von Ausführungslaufzeiten und -wiederholungen.",fullscreen=1]
...
image::robotmk_scheduler_05.png[alt="RCC-Konfiguration der Suite.",fullscreen=1]
...
image::robotmk_scheduler_06.png[alt="Kommandozeilenparameter von Robot Framework.",fullscreen=1]
...
image::robotmk_scheduler_06b.png[alt="Option für geheime Umgebungsvariablen im Robotmk-Scheduler.",fullscreen=1]
...
image::robotmk_scheduler_07.png[alt="Optionen für Nutzerkontext, Host-Zuweisung und automatische Aufräumarbeiten.",fullscreen=1]
...
image::robotmk_scheduler_08.png[alt="Optionen für Proxy-Server und eine Vorlaufszeit für den Scheduler-Start.",fullscreen=1]
...
image::robotmk_scheduler_09.png[alt="Robotmk-Services im Monitoring.",fullscreen=1]
...
image::robotmk_service_suite_status_01.png[alt="Konfigurationsdialog für Grenzwerte für Laufzeiten von Test-Suites.",fullscreen=1]
...
image::robotmk_service_suite_status_02.png[alt="Dialog mit Beschränkung auf die Test-Suite 'mybot'.",fullscreen=1]
...
image::robotmk_service_test_status_01.png[alt="Regel zum Überwachen von Keywords mit Beispielwerten.",fullscreen=1]
...
image::robotmk_service_test_status_02.png[alt="Dialog mit Option zur Beschränkung auf Tests.",fullscreen=1]
...
image::robotmk_monitorng_scheduler.png[alt="Status des Schedulers im Monitoring.",fullscreen=1]
...
image::robotmk_monitorng_report_01.png[alt="Robot-Framework-Bericht für Test-Suite 'Mybot'.",fullscreen=1]
...
image::robotmk_monitorng_report_02.png[alt="Robot-Framework-Bericht auf Ebene der Keywords.",fullscreen=1]
...
image::robotmk_managed_robots_robot.png[alt="Konfiguration eines gemanagten Robots.",fullscreen=1]
...
image::robotmk_managed_robots_scheduler.png[alt="Konfiguration des Schedulers mit einem gemanagten Robot.",fullscreen=1]
...
image::robotmk_kpi_pattern.png[alt="Konfiguratin von Keywords als separate Services für Robotmk.",fullscreen=1]
...
image::robotmk_kpi_service_rule.png[alt="Service-Regel für die Auswertung von Keywords.",fullscreen=1]
...
image::robotmk_kpi_monitoring.png[alt="Muster- und Marker-basierte Keywords im Monitoring.",fullscreen=1]
...
image::robotmk_rcc_offline_dependency_handling.png[alt="Angaben zur Handhabung eines gezippten Katalogs.",fullscreen=1]
...
image::robotmk_rcc_offline_dependency_handling_2.png[alt="Angabe zur Handhabung von RCCRemote.",fullscreen=1]
...
image::robotmk_rcc_offline_tls_self.png[alt="Inaktive TLS-Validierung für selbst signierte Zertifikate.",fullscreen=1]
...
image::robotmk_rcc_offline_tls_ca.png[alt="Hinterlegtes Zertifikat der CA.",fullscreen=1]
