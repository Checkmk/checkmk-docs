// -*- coding: utf-8 -*-
// IGNORE MyApp1 MyApplication_mybot Windows|Linux mybot_managed rf Micromamba CSM namen Entwicklungs
// NONASCII
include::global_attr.adoc[]
= {CMK} Synthetic Monitoring mit Robotmk (Legacy)
:title: {CMK} Synthetic Monitoring mit Robotmk (Legacy)
