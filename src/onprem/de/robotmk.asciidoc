...
// IGNORE ${myvar} mybot + Automationspaket Automationssoftware RCC RMK Robotmk auftürmen quelloffene → Aliasse LocalSystem MyApp1  rebot MyApplication_mybot Plangruppe Plangruppen × 
// NONASCII →
