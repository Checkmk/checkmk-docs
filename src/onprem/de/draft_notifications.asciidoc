...
= Benachrichtigungen: Grundlagen und Steuerung
:revdate: 2025-04-28
:title: Benachrichtigungen: Grundlagen und Steuerung
...
{related-start}
xref:notification_rules#[Benachrichtigungen per Regel]
...
Die Erstellung dieser Benachrichtigungen wird unter xref:notification_rules#[Benachrichtigungen per Regel] beschrieben.
...
Wie diese persönlichen Einstellungen umgesetzt werden können, lesen Sie im Artikel xref:personal_notifications#[Persönliche Benachrichtigungen.]
