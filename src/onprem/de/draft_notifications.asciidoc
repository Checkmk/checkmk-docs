...
Unter [.guihint]#Global notification rules# werden die Benachrichtigungsregeln aufgelistet, die unter xref:draft_notification_rules#rules[Benachrichtigungen per Regeln steuern] genauer vorgestellt werden.
