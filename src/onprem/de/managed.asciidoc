...
= Die {ME}
:revdate: 2024-04-10
:title: Die Managed Services Edition - {CMK} als Dienstleistung anbieten
:description: Mit der {CMK} Managed Services Edition können Sie über das verteilte Monitoring voneinander abgeschottete Instanzen für mehrere Kunden betreiben.
...
// TK: Hintergrund: Auch ein IT-Dienstleister, der 20 Arztpraxen überwacht (ohne Zentralinstanz und zentrale Konfiguration) braucht die CME.
