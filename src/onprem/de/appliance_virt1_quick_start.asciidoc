...
.. Allgemein: Die virtuelle Festplatte, auf der letztlich {CMK} installiert wird und anschließend alle Instanzen und deren Daten gespeichert werden, ist auf eine Größe von 100 GB voreingestellt.
Überlegen Sie genau, ob diese Größe für Sie ausreichend ist und vergrößern Sie die virtuelle Festplatte bei entsprechendem Bedarf unbedingt *bevor* Sie die virt1 zum ersten Mal starten. xref:appliance_install_virt1#[Mehr ...]
