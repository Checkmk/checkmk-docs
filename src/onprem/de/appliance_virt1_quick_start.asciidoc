...
.. Für VMware ESXi: Für bessere Performance sollten Sie die Netzwerkkarte auf VMXNET 3 ändern.
xref:appliance_install_virt1#vmxnet[Mehr ...]
...
Überlegen Sie genau, ob diese Größe für Sie ausreichend ist und vergrößern Sie die virtuelle Festplatte bei entsprechendem Bedarf unbedingt *bevor* Sie die virt1 zum ersten Mal starten.
xref:appliance_install_virt1#[Mehr ...]
