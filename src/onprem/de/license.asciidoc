...
In einem xref:distributed_monitoring#[verteilten Monitoring] werden die Lizenzinformationen für alle verbundenen Instanzen gesammelt und bei der Online-Verifizierung gebündelt über die Zentralinstanz an {CMK} übermittelt.
