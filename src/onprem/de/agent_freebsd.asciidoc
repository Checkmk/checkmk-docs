...
Wenn die Version (z.B. {oldmajor}) dieses in den FreeBSD Ports verfügbaren {CMK}-Agenten Ihrer aktuell verwendeten {CMK}-Version entspricht oder eine Major-Version darunter liegt, können Sie diesen Agenten installieren. 
