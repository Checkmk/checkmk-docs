...
[{shell},highlight=23]]
----
2025-04-30 13:37:23 - Updating site 'mysite' from version {oldstable}p31.cre to {current}.cre...
...
ii  check-mk-raw-{oldstable}p31        0.noble  amd64  Checkmk - Best-in-class infrastructure & application monitoring
----
...
[{shell}]
----
{c-root} dpkg --purge check-mk-raw-{oldstable}p31
(Reading database ... 567850 files and directories currently installed.)
Removing check-mk-raw-{oldstable}p31 (0.noble) ...
...
----
...
check-mk-raw-{oldstable}p31-el9-38.x86_64.rpm
----
...
[{shell}]
----
{c-root} rpm -e check-mk-raw-{oldstable}p31-el9-38.x86_64.rpm
----
