...
|`--ignore-editions-incompatible` | Unterdrückt den Abbruch bei Editionsinkompatibilitäten (beispielsweise beim xref:upgrade#down2cee[Downgrade] ausgehend von {ME}).
|===
...
[cols="20,~"]
|===
|`--pre-flight=ask` | Das Starndardverhalten, es erfolgt die Nachfrage, wie vorzugehen ist.
