...
{related-start}
xref:cmk_versions.html#[{CMK}-Versionen]
...
[{shell},highlight=28]
----
2025-05-19 13:47:54 - Updating site 'mysite' from version {oldstable-patch}.cre to {current}.cre...

 * Updated        .profile
 * Installed dir  var/check_mk/packages_local
...

Installed default file of version {current}.cre.
...
Completed verifying site configuration. Your site now has version {current}.cre.
