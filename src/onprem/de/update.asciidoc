...
image::update2.png[alt="Die Instanz 'mysite' mit ihrer verwendeten Software-Version vor dem Update.",width=70%]
...
image::g42.png[alt="Die Situation nach der Installation der neuen Software-Version.",width=70%]
