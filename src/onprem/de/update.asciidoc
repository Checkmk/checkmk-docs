...
In folgendem Beispiel installieren wir das Paket für Ubuntu 24.04 (Noble Numbat):
...
Ein Beispiel für den kompletten Befehl für ein automatisches Update der Instanz `mysite` auf die Version `{current}.cee`:
