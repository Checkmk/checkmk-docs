...
Bei einem Update auf eine höhere Major-Version müssen Sie immer direkt auf die *nächste* Major-Version aktualisieren und können nicht einfach eine überspringen.
...
Wenn Sie also beispielsweise von {oldoldstable} auf {current-major} aktualisieren wollen, aktualisieren Sie zunächst auf die {oldstable}.
