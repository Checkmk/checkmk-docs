...
* _(deprecated)_: Diese Versionen werden nur noch mit der {v22} unterstützt und fallen danach aus dem Support raus.
* _(once released)_: Die Unterstützung für diese Versionen ist geplant. Sie erfolgt innerhalb kurzer Zeit, nachdem sie offiziell erschienen ist.
