...
// Ein geöffneter Tab mit einem Dashboard wird je nach Komplexität zwei bis drei Apaches beschäftigen, um flüssig bedienbar zu sein.
Kalkulieren Sie wenigstens einen Apache-Prozess pro Nutzersitzung.
Stehen ein oder zwei weitere bereit, können Anfragen parallel bearbeitet werden und die grafische Oberfläche fühlt sich schneller an.

Wir kalkulieren etwa 300 bis 500 MB RAM pro Apache-Prozess, davon 150 bis 300 MB resident während Requests bedient werden.
