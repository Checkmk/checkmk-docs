...
Orientieren Sie sich für die Justierung an den Vorschlägen der xref:analyze_configuration#[Analyse der Konfiguration] und der Speicherauslastung Ihres {CMK}-Servers.
