...
Der Instanz-Apache stellt die grafische Benutzeroberfläche von {CMK} bereit und liefert in geöffneten Tabs Aktualisierungen von Tabellen und Graphen.
...
Derzeit kalkulieren wir etwa 300 bis 500 MB RAM pro Apache-Prozess, mit 150 bis 300 MB davon resident.
