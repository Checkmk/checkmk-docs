...
// ES: Pfad für das Beispiel geändert, bitte checken, ob er jetzt richtig ist
...
// ES: Pfad geändert, bitte prüfen
.~/local/lib/python3/cmk_addons/plugins/lsusb_demo/inventory_ui/mass_storage.py
[{python}]
----
#!/usr/bin/env python3
...
// ES: Wie sieht es hiermit jetzt aus?
