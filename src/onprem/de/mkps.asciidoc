...
Benutzer der {CRE} gehen stattdessen die beiden folgenden Schritte über xref:release_mkp[auflösen] und neu xref:package_mkp[erstellen.]
...
[TIP]
====
Erweiterungen, welche die mit {CMK} {v16} eingeführten und bereits in {CMK} {v20} als _deprecated_ markierten APIs verwenden, werden von {CMK} {v23} nicht mehr unterstützt werden.
Tragen Sie hier 2.2.99 als maximal unterstützte Version ein.
Erweiterungen, welche die in {CMK} {v20} eingeführten APIs nutzen, werden bis {CMK} {v23} ohne Anpassungen funktionieren, aber nicht mit {CMK} {v24}.
Sie können hier 2.3.99 als maximal unterstützte {CMK}-Version eintragen.
====
