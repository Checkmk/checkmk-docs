// -*- coding: utf-8 -*-
// IGNORE Benachrichtigungs Programmier Unpackaged Neupaketieren
...
Ruft man ihn ohne Subbefehl auf, zeigt er Hinweise zur Verwendung.
...
Erst mit dem Subbefehl `enable` wird ein verfügbares Paket auch aktiviert.
...
|===
|Subbefehl |Parameter |Verwendungszweck
...
|`install` |Dateiname des hinzuzufügenden Pakets |Dieser Subbefehl ist abgekündigt und wird bald entfernt werden!
