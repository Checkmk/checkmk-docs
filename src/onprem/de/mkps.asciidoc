...
Sie können hier 2.5.99 als maximal unterstützte {CMK}-Version eintragen.
Für die Zukunft danach kann zum Zeitpunkt der Revision dieses Artikels keine Aussage getroffen werden.
