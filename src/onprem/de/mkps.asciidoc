...
Erst mit dem Klick auf den Knopf mit dem Steckersymbol icon:icon_install[] wird ein verfügbares Paket auch aktiviert.
...
Nun führen Sie noch eine xref:wato#activate_changes[Aktivierung ausstehender Änderungen] durch und alle Funktionen aus dem Paket sind im System verankert und stehen Ihnen bereit.
