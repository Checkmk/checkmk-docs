...
{CMK} {v25} führt Version 2 der Bakery-API ein, zunächst mit dem Zusatz _unstable_ (instabil). 
...
Anschließend starten Sie Ihre Site neu:
...
Starten Sie dann Ihre Site neu:
