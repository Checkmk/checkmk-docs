...
Dies gibt Benutzern der {RE} die Möglichkeit, Erweiterungspakete zu erstellen, welche auf allen Editionen installiert werden können.
Falls mit der Bakery-API erstellte Pakete auf einer {RE} installiert werden, wird die zusätzliche Funktionalität schlicht ignoriert.
====
