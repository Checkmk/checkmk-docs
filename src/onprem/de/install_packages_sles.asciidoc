...
Hierfür kommt pro Instanz ein Apache-Webserver zum Einsatz, der auf einem hohen Port unter dem Instanzbenutzer läuft.
...
Auf der link:https://checkmk.com/de/download[Download-Seite^] finden Sie {RE}, die Open-Source-Software ist, und die kommerziellen Editionen, die Sie im Lizenzstatus „Trial“ ausprobieren können.
