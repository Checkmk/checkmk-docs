// -*- coding: utf-8 -*-
// IGNORE lt containerisierten Selbstgewählter Selbstgewähltes durchgereicht mailrelay mydomain selbstgewähltes
// NONASCII ✔ 
...
// ES: den letzten Satz entfernen, wenn managing_docker tatsächlich obsolet wird
...
l|environment:
  ...
  `TZ` ist die Zeitzone, die Sie für den Container einstellen. Falls Sie diese Einstellung weglassen, wird der Container (und damit auch Ihre {CMK}-Instanz) automatisch mit der Zeitzone UTC arbeiten, bis Sie die Einstellung im Container ändern.
...
// ES: Letzten Satz streichen, wenn managing_docker obsolet geworden ist
...
==== HTTPS
// ES: Dieses Thema wurde bisher in managing_docker behandelt, allerdings extrem kurz. Auch der untenstehende Text ist eher oberflächlich gehalten. Thema eines noch zu erstellenden Folgetickets?
