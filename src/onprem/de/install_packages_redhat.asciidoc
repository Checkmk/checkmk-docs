...
// TK: "Dies" ist zweideutig: Es bezieht sich ja *nicht* darauf wie Docker oder eine virtuelle Maschine für CentOS aufgesetzt werden (wies im include steht), sondern wie die Paketquelle eingerichtet wird.
...
// SH: Nach einem Bugfix (Apache Webserver startete nicht neu nach Erstellen der Instanz) sollte jetzt alles passen. 
// SH: Wir haben den Artikel wo nötig auf RHEL 10 hochgezogen. 
// TK: Obige Kommentare löschen
...
// ----
// TK: Obige Kommentare können dann weg.
...
----
////
// TK: Obige Kommentare können weg.
...
// TK: Wenn der Bug weg ist, passt das so. Obige Kommentare können weg oder ggf. im Wiki parken als Hintergrundinfo.
