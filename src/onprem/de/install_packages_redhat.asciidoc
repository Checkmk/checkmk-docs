...
Ab Version 9.x verwenden AlmaLinux und Rocky Linux statt den PowerTools den CodeReady Linux Builder (CRB):
...
RHEL setzt seit Version 9 ebenfalls auf ein CRB-Repository. 
...
Seit Version 9.x und für die Zukunft setzen RHEL und die dazu binärkompatiblen Enterprise-Linux-Betriebssysteme ausschließlich auf CRB.
====
