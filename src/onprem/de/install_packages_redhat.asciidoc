...
CentOS ab 8.4, ältere Versionen von AlmaLinux und Rocky Linux:
...
AlmaLinux 10 und Rocky Linux 10 benötigen an dieser Stelle stattdessen: 
...
// SH: Das hängt davon ab, welche Version der Betriebssysteme man im Einsatz hat. Die neustes von Rocky 10 setzt auf CRB. RHEL 10 eventuell aber noch auf PowerTools. Für Alma müsste ich es raussuchen. 
// SH: Wie es für die 9er-Versionen ist, weiß ich ad hoc nicht. 
...
// SH: Hier laufen die binärkompatiblen Versionen evtl. auseinander? 
// SH: RHEL scheint noch PowerTools zu verwenden, ein Fachartikel zum Thema sitzt bei Red Hat hinter der Paywall: https://access.redhat.com/articles/4348511#enable
// SH: PowerTools und CRB sind äquivalent. Es kommt einfach drauf an, welches von beidem das eigene Betriebssystem (noch) verwendet.
// SH: Rocky setzt auf CRB. PowerTools seien ein "Carryover" von CentOS, steht in den Notes on CRB. 
// SH: Offenbar müssen wir sehr genau hinschauen, welche Aussage wir für welche Version tätigen, da die Anforderungen irgendwann nach Version 8.x (oder ab einer 8.x) auseinandergedriftet sind?
