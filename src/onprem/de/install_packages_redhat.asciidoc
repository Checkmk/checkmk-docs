...
[{shell-raw}]
----
{c-root} scp check-mk-raw-2.3.0p1-el8-38.x86_64.rpm root@mymonitoring.mydomain.org:
----
...
Unter RHEL und allen binärkompatiblen Distributionen ist auch dafür das Tool `rpm` zuständig:
...
[{shell}]
----
{c-root} rpm -K check-mk-raw-2.3.0p1-el8-38.x86_64.rpm
check-mk-raw-2.3.0p1-el8-38.x86_64.rpm: digests signatures OK
{c-root} yum install check-mk-raw-2.3.0p1-el8-38.x86_64.rpm
----
