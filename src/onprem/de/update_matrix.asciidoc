...
[TIP]
====
Wegen firmeninterner Abhängigkeiten in der Datenbereitstellung wird die komplette Kompatibilitäts-Matrix erst einige Stunden nach Release von Checkmk {v23} zur Verfügung stehen.
====
...
Ab {v23} schafft die xref:ossupport[OS Support Policy] klare Regeln.
