...
// TK: Ich hab folgenden Satz auskommentiert, weil der Absatz eh schon so lang ist und ich für ME nicht 2 Sätze spendieren will.
...
Im Checkmk Cloud Handbuch finden Sie eine https://docs.checkmk.com/saas/de/cce.html[Übersicht der Funktionen] und einen link:https://docs.checkmk.com/saas/de/intro_setup.html[Leitfaden für Einsteiger^], der Ihnen bei den ersten Schritten mit {CE-saas} hilft.
====
...
{cee-only}
// TK: Ich hab jetzt aus der Aufzählung die ME rausgenommen
