...
// ES: Ich bin mir nicht sicher, ob das immer noch optional ist. Mehr dazu anderswo. Wahrscheinlich lohnt es sich, wenn wir mit Aussagen zu Support-Paketen aktuell eher unspezifisch bleiben. Um das Thema sauber abzubilden, müssen wir dann auch sicherstellen, dass die Aussagen über Supportpakete in den einzelnen Editionsartikeln konsistent (bzw. allgemein genug) sind.
...
// ES: Für den direkten Vergleich der Editionen verlinken wir anderswo auf https://checkmk.com/de/preise, das fände ich auch hier passend.
...
// TK: Der folgende Absatz steckt jetzt im Glossar: glossar.html#edition
////
...
// TK: omd status-Ausgabe ersetzt durch link auf cmk_processes. Hier im Artikel gibt es schon genug Befehle.
