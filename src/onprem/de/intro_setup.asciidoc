...
Wenn Sie die Installation Ihrer Variante abgeschlossen haben, lesen Sie im xref:create_site[nächsten Abschnitt] weiter, in der es um die Erstellung einer Instanz geht.
...
// TK: In 2.4.0 noch nicht getestet.
[{shell}]
----
{c-omd} omd status
jaeger:         [green]#running#
