// -*- coding: utf-8 -*-
// IGNORE % Hochverfügbarkeits Willkommens
// NONASCII 
...
// TK: omd status-Ausgabe ersetzt durch link auf cmk_processes. Hier im Artikel waren es schon zuviele Befehle drin.
////
{cee-only}
...
// Ausgabe check-mk-ultimate-2.5.0-2026.01.13
[{shell}]
----
{c-omd} omd status
agent-receiver:     [green]#running#
...
Dadurch landen Sie auf der Startseite von {CMK}, die wir uns im xref:intro_setup_monitor#[nächsten Kapitel] genauer ansehen werden:
