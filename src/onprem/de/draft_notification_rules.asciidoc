...
Im linken Bereich sehen Sie erst einmal eine Übersicht über die Gesamtanzahl eingestellter, verschickter und fehlgeschlagener Benachrichtigungen:

image::notifications_failed.png[alt="Übersicht über den aktuellen Status der Benachrichtigungen.", width=60%]

Sollten die verschickten bzw. fehlgeschlagenen Benachrichtigungen mehr als Null sein, so wird zudem ein Link zu weiteren Informationen angezeigt. 
