...
= Benachrichtigungen per Regel
:revdate: 2025-04-28
:title: Benachrichtigungen per Regel
...
{related-start}
xref:notifications#[Benachrichtigungen: Grundlagen und Steuerung]
xref:personal_notifications#[Persönliche Benachrichtigungen]
...
Nachdem sich der Artikel xref:notifications#[Benachrichtigungen: Grundlagen und Steuerung] mit grundsätzlichen Dingen 
...
[TIP]
====
Wenn Sie Benachrichtigungen nur für sich persönlich abschalten wollen, können Sie dies über die xref:personal_notifications#[benutzerdefinierten Benachrichtigungen] machen.
====
endif::[]
