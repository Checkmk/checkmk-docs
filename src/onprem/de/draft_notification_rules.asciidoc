...
// ML - Review: Ab hier kommt das Ärzte-wir
...
// ML - Review: Das Beispiel ab hier macht mir etwas Sorge: Im ersten Schritt sind die Host-Ereignisse natürlich sinnvoll, dann wird dir Regel aber unten um den Service-Namen erweitert - was wie erklärt wird dazu führt, dass die Host-Ereignisse ignoriert werden. Heißt: Die Regel im Ganzen ist verkonfiguriert
...
// ML - Review: Vielleicht eine Klammer hinter Einzelbedingungen "(Statusänderungen, Service-Name, Ordner)" - ich musste jedenfalls gerade überlegen.
...
// ML - Review: Im Folgenden fehlt noch das Bild zur Kontaktauswahl - und Schritt 5 "Sending conditions". Selbst wenn da nicht viel zu zu sagen ist, aber da die Bilder nummeriert sind, fragt man sich wohl, was mit 4 und 5 los ist.
...
// ML - Review: Ich war mal so frei den Activate-Changes-Kram zu übermalen.
