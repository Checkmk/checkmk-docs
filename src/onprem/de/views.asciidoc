...
Immer vorhanden sind die Menüs [.guihint]#Commands, Add to, Export, Display# und [.guihint]#Help.#
...
|[.guihint]#Display > Modify display options > Number of columns# |Legt die Anzahl der Spalten für die Ansicht fest.
...
|`o` |Die Optionen [.guihint]#Number of columns# und [.guihint]#Refresh interval# werden entfernt, sonst einzublenden mit [.guihint]#Display > Modify display options#.
