...
// TK: Da steht zwar, dass nur die wichtigsten Kommentare gelistet werden, aber in den Development Tickets finde ich Kommandos, die ich noch nie auf der GUI gesehen habe:
// TK: CMK-13665: "Enable / Disable active checks", "Enable / Disable passive checks", "Enable / Disable notifications", "Modified attributes"
// TK: CMK-14562: EC: CommandECUpdateEvent, CommandECChangeState, CommandECCustomAction, CommandECArchiveEvent (zu "Archive events of hosts" steht auch was in CMK-7082)
// TK: CMK-14562: OTHER: CommandDeleteCrashReports, CommandFreezeAggregation 
// TK: Hab ich was verpasst? Lassen wir es so, wie es zurzeit ist?
