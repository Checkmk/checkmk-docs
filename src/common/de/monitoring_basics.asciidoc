...
|icon:icon_derived_downtime[alt="Symbol zur Anzeige einer abgeleiteten Wartungszeit bei einem Service."] |Services, deren Host sich in einer Wartung befinden, werden mit diesem Symbol gekennzeichnet.
|===
