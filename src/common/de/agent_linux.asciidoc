...
// TK: Im restlichen Artikel habe ich in 5 Kommandos automation durch agent_registration ersetzt.
// TK: Alle diese Änderungen müssen auch in agent_windows nachgezogen werden - aber erst nach dem Review.
...
{c-root} cmk-agent-ctl register --hostname mynewhost \
    ...
    --user agent_registration --password 'test23'
----
