...
[IMPORTANT]
====
Das hier beschriebene Verhalten betrifft vor allem Beta-Tester, die im Monitoring bei anderen {CMK}-Editionen befindliche Hosts _zusätzlich_ bei {CMK} (SaaS) ins Monitoring aufnehmen.
====
endif::[]
