...
In addition to the packages available in the Agent Bakery, you have the option to create your own packages for xref:hosts_autoregister#[Autoregistration].
