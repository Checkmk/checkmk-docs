...
:description: Der Agent Controller übermittelt die gesammelten Monitoringdaten vom Linux-Agentenskript an {CMK}. Hier erfahren Sie, wie Sie die Überwachung einrichten.
