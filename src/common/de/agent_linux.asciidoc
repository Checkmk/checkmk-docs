...
Erscheint dies zu aufwendig, führen Sie wenigstens die xref:registration[Registrierung] und die damit verbundene Aktivierung der TLS-Verschlüsselung zeitnah nach der Installation durch.
====
