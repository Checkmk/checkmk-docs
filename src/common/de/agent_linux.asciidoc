...
Vorbereitend sollten Sie prüfen, ob das Agentenskript und der Agent Controller im xref:agent_ctl_dump[Dump-Modus] eine identische Ausgabe liefern und gegebenenfalls eine identische _Environment_ sicherstellen.
