...
Die in der folgenden Tabelle enthaltenen Namen passen aber zum Skript, mit dem Sie im xref:jira_ids_script[nächsten Abschnitt] die Jira-IDs auslesen können.
