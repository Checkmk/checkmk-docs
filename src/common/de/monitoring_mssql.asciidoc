// -*- coding: utf-8 -*-
// IGNORE Securables Instanzsuche feedback@checkmk datafile absicherungsfähigen
...
Sollte noch kein entsprechender Nutzer auf Ihrem MSSQL-Server bzw. in Ihrer -Instanz vorhanden sein, so können Sie diesen über das Microsoft SQL Server Management Studio (mit einem beliebigen Nutzernamen) erstellen:
...
|[.guihint]#Discovery mode of databases# |Einstellungen für die Instanzsuche.
