...
Verwenden Sie stattdessen die _SQL Server Authentication_ wählen Sie hier die Option [.guihint]#SQL Database User Credentials# und geben zusätzlich den [.guihint]#Login name# im Feld [.guihint]#User# ein und fügen das zugehörige [.guihint]#Password# ein.
