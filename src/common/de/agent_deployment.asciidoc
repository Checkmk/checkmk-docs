...
// Obacht: Der folgende Code-Block(!) enthält mehrere ifdefs!
...
// TK: Obacht: Auch der folgende Code-Block enthält mehrere ifdefs!
[{shell}]
----
C:\WINDOWS\system32> "C:\Program Files (x86)\checkmk\service\check_mk_agent.exe" updater register
//SK: Prüfen, ob die folgende Zeile bei Erstinstallation wirklich angezeigt wird.
...
// TK: Obacht: Auch dieser Code-Block enthält wieder mehrere ifdefs!
[{shell}]
----
C:\WINDOWS\system32> "C:\Program Files (x86)\checkmk\service\check_mk_agent.exe" updater register ^
