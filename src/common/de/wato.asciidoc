...
[#setup_menu]
== Setup-Menü
// FIXME 2.4.0 SaaS: Neue Setup-Menüeinträge (OpenTelemetry Collector, Quick Setup, Analyze recent notifications, Test notifications, Certificate Overview, Managed Robots): nur einige sind relevant
...
die Regeln für die xref:inventory#[Hardware/Software-Inventur]
und den Kollektor für xref:opentelemetry#[OpenTelemetry-Metriken].
endif::[]
ifdef::saas[]
die xref:hosts_structure#host_groups[Host-Gruppen]
und die Regeln für die xref:inventory#[Hardware/Software-Inventur.]
endif::[]
...
ifdef::saas[]
mit Regeln für xref:notifications#[Benachrichtigungen.]
endif::[]
...
|[.guihint]#Synthetic Monitoring# |Der Einstieg in das {CMK} Synthetic Monitoring mit Robotmk.
Dieses Thema gibt es nur in den kommerziellen Editionen.
endif::[]
|===
...
.Das Snapin [.guihint]#Quick setup# im Show-less-Modus
image::wato_quick_setup_saas.png[alt="Snapin Quick setup.",width=50%]
endif::[]
