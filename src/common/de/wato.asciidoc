...
[#setup_menu]
== Setup-Menü
// FIXME 2.4.0 SaaS: Neue Setup-Menüeinträge (OpenTelemetry Collector, Analyze recent notifications, Test notifications, Certificate Overview, Managed Robots): nur einige sind relevant
