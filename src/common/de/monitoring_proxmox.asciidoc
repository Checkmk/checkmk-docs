...
Wenn Sie unserer Empfehlung gefolgt sind und auf dem Proxmox-Knoten einen Agenten installiert haben, dann setzen Sie die Option [.guihint]#{CMK} agent / API integrations# auf [.guihint]#Configured API integrations and {CMK} agent#.
