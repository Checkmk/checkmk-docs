...
Um eine Historie der Berichte aufbauen zu können, statt bei jeder Erstellung des Berichts die Vorgängerversion zu überschreiben, bietet {CMK} diverse xref:macros[Makros] (=Textbausteine) an.
