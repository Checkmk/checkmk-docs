...
Im Unterpunkt [.guihint]#Global Settings# stehen Ihnen alle `global.mk`-Dateien der einzelnen Komponenten Ihrer {CMK}-Instanz, wie beispielsweise des 
ifdef::onprem[]
Dynamic-Configuration-Daemons oder auch des Livestatus-Proxy-Daemons, zur Auswahl.
endif::[]
ifdef::saas[]
Dynamic-Configuration-Daemons, zur Auswahl.
endif::[]
