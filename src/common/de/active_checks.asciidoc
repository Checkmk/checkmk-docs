...
Die Dokumentation des Monitoring-Plugins-Projektes zu link:https://www.monitoring-plugins.org/doc/guidelines.html#AEN197[_Performance data_^] erwähnt ausdrücklich, dass hier übergebene Einheiten an Drittanwendungen weitergegeben werden (hier das Metrik- und Graphing-System von {CMK}) und es diesem freigestellt ist, was wie ausgewertet ist.
