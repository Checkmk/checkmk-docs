...
Eine Quick Setup-[.guihint]#Konfiguration# besteht aus vier Komponenten, die Sie bereits als Einzelteile aus dem Setup einer {CMK}-Instanz kennen.
Eine solche Konfiguration setzt sich zusammen aus einer Regel für den jeweiligen Spezialagenten, einem Host, einer Verbindung im [.guihint]#Dynamic host management# und einem Eintrag im [.guihint]#Password store# von {CMK}.
