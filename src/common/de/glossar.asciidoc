...
Eine solche Konfiguration besteht aus einer Regel für den jeweiligen Spezialagenten, einem Host, einer Verbindung im [.guihint]#Dynamic host management# und einem Eintrag im [.guihint]#Password store# von {CMK}.
