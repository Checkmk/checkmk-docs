...
Die Komponenten sind eine Regel für den jeweiligen Spezialagenten, ein Host, eine Verbindung in der dynamischen Host-Konfiguration und ein Eintrag im Passwortspeicher.
endif::[]
