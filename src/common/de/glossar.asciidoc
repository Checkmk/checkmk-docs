...
Also die Open Source {CRE} (vormals {CMK} Raw), für professionelle Anwender die per Subskription erhältliche {CSE} (vormals {CMK} Enterprise) und die darauf aufbauende {CCE} (vormals {CMK} Cloud (Self-hosted)).
