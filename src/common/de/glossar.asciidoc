...
Also die Open Source Edition {CRE}, die per Subskription erhältliche {CSE} für professionelle Anwender, die darauf aufbauende {CCE} sowie die mandantenfähige {CME}.
...
Daher gibt es den Push-Modus nur ab {CCE}.
