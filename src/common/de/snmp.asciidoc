...
Antworten Geräte überhaupt nicht, oder nicht zuverlässig, hilft es mitunter, Inline-SNMP
für betroffene Geräte abzuschalten und damit das etwas robustere und deutlich langsamere  `snmpget` zu aktivieren.
