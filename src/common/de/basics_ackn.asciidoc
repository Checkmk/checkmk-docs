...
|[.guihint]#Expire on# |Kommerzielle Editionen: Mit dieser Option setzen Sie eine Gültigkeitsdauer für die Quittierung.
...
// SK: Der folgende Satz war womöglich ein Missverständnos oder eine unglückliche Formulierung. Ich kommentiere ihn vorübergehend aus.
