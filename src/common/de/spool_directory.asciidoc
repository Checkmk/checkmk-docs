...
:description: Programme auf überwachten Hosts können Informationen im Spool-Verzeichnis ablegen. Lesen Sie hier, wie Sie diese für die {CMK}-Agentenausgabe nutzen.
...
- der Kontrolle von Cronjobs (wenn das xref:monitoring_jobs#[`mk-job`-Plugin] nicht genügt),
