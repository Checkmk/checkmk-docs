...
In den {CMK}-„Treasures“ finden Sie ein Skript, mit dem Sie Piggyback-Hosts ohne Zuordnung sehr einfach finden können:
...
Zu den Ergebnissen aus dem Skript kann {CMK} keinen Host mit dem gleichen Namen finden, um die Daten zuzuordnen.
