...
Der Spezialagent `agent_netapp_ontap` greift über eine REST-API auf diese Schnittstelle zu und wird über den Regelsatz [.guihint]#NetApp via Ontap REST API# eingerichtet.
