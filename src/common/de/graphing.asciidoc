...
Hier werde zwei Arten von Graphdarstellungen unterschieden:
...
Durch einen Klick auf icon:button_dissolve_operation[] machen Sie die Operation quasi rückgängig, in dem Sie die Formel wieder auflösen und die einzelnen enthaltenen Kurven wieder zum Vorschein kommen.
