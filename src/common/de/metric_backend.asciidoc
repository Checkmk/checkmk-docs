...
ifdef::saas[]
Eine explizite Einrichtung ist nicht notwendig {com} betreibt pro AWS-Region einen Clickhouse Cluster.
Bei der Erstellung Ihrer {CMK}-Instanz wurde die ihr zugeordnete Datenbank in diesem Cluster bereits erstellt.
endif::[]
