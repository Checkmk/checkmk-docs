...
Eine vollständige Übersicht der zusätzlichen Funktionalität bietet der Artikel zu xref:cce#[{CE}.]
...
Eine Übersicht der Unterschiede zwischen {CE} und {SE} liefert der xref:cce#[Artikel zu {CE}.]
