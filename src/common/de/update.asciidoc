...
Die von den allen Remote-Instanzen bereitgestellten Services werden bei der Berechnung der Subskription gleich behandelt.
// TK: den oder allen?
// TK: Inhalt versteh ich nicht: Was wird hier gleich behandelt?
. Aktualisieren Sie nach und nach die Remote-Instanzen.
. Für jede Remote-Instanz, welche das Upgrade erhalten hat, können Sie die Synchronisation der Konfiguration wieder aktivieren.
...
*Wichtig:* Nur im 30 Tage währenden Lizenzstatus „Trial“ ist der Mischbetrieb mit {SE} als Zentralinstanz möglich, hinterlegen Sie also noch keine Subskriptionsdaten!
