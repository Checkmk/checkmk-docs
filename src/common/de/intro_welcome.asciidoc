...
:description: Die Willkommens-Seite von {CMK} hilft Ihnen, grundlegende Konfigurationsaufgaben zu erledigen, z. B. einen Host zu erstellen und ins Monitoring aufzunehmen.
...
Wenn Sie ein Thema erledigt haben, können Sie dieses selbst mit dem Knopf [.guihint]#Mark as done# abhaken und mit dem nächsten Thema fortsetzen.
