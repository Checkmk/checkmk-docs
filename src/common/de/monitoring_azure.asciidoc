...
ifdef::saas[]
Zum komfortablen Einstieg in die Überwachung von Azure liefert {CE} die beiden eingebauten xref:glossar#dashboard[Dashboards] [.guihint]#Azure VM instances# und [.guihint]#Azure storage accounts# mit aus.
endif::[]
