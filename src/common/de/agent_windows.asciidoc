...
// TK: Bitte auskommentierten Befehl checken+ersetzen und Abschnitt für Windows überarbeiten, falls notwendig (in de+en)
...
[{shell}]
----
{c-root} cmk-agent-ctl -vv register \
            --hostname mynewhost \
            --server mycmkserver \
            --site mysite \
...
DEBUG [reqwest::connect] starting new connection: pass:[https://mycmkserver/]
INFO [cmk_agent_ctl::site_spec] Failed to discover agent receiver port using https.
DEBUG [cmk_agent_ctl::site_spec] https error: "Failed to discover agent receiver port from pass:[https://mycmkserver/mysite/check_mk/api/1.0/domain-types/internal/actions/discover-receiver/invoke\nerror] sending request for url (pass:[https://mycmkserver/mysite/check_mk/api/1.0/domain-types/internal/actions/discover-receiver/invoke])\nclient error (Connect)\ndns error\nfailed to lookup address information: Try again"
DEBUG [reqwest::connect] starting new connection: pass:[http://mycmkserver/]
INFO [cmk_agent_ctl::site_spec] Failed to discover agent receiver port using http.
DEBUG [cmk_agent_ctl::site_spec] http error: "Failed to discover agent receiver port from pass:[http://mycmkserver/mysite/check_mk/api/1.0/domain-types/internal/actions/discover-receiver/invoke\nerror] sending request for url (pass:[http://mycmkserver/mysite/check_mk/api/1.0/domain-types/internal/actions/discover-receiver/invoke])\nclient error (Connect)\ndns error\nfailed to lookup address information: Try again"
