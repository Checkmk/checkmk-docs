...
Da das Agentenprogramm  unter der Nutzerkennung _Local System_ aufgerufen werden muss, um exakt jene Daten zu liefern, die im Monitoring ankommen, sollten Sie es nie in einer Shell starten.
