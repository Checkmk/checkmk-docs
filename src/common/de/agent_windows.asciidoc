...
[TIP]
====
Standard-Agentenpakete öffnen sofort nach der Installation Port 6556 und geben darüber die unverschlüsselte Agentenausgabe aus.
Bei Hosts, die aus dem Internet erreichbar sind, sollten Sie daher vor der Installation per Firewall sicherstellen, dass der Zugriff auf diesen Port nur ausgewählten Hosts erlaubt ist.
...
|===
|Edition |Version
// MFS: Unterstützung für Windows NT 6.0 fällt mit Start der 2.2.0 Beta weg
// |Windows Vista, Windows Server 2008 (R1) |6.0
// MA: 2008 R2 wird nicht mehr unterstützt.
...
Da das Agentenprogramm  unter der Nutzerkennung `Local System` aufgerufen werden muss, um exakt jene Daten zu liefern, die im Monitoring ankommen, sollten Sie es nie in einer Shell starten.
