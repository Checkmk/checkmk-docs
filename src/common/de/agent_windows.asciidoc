...
[{powershell}]
----
PS C:\Users\hhirsch\Downloads\> curl.exe -OJG "\http://mycmkserver/mysite/check_mk/api/v1/domain-types/agent/actions/download/invoke" `
...
PS C:\Users\hhirsch\Downloads\> curl.exe -OJG "\http://mycmkserver/mysite/check_mk/api/v1/domain-types/agent/actions/download/invoke" `
    --header "Accept: application/octet-stream" `
    --header "Authorization: Bearer api_user myautomationsecret" `
    --data-urlencode "os_type=windows_msi"
----
endif::[]
...
[{powershell}]
----
PS C:\Users\hhirsch\Downloads\> Invoke-WebRequest `
    -Uri "\http://mycmkserver/mysite/check_mk/agents/windows/check_mk_agent.msi" `
...
[{powershell}]
----
PS C:\Users\hhirsch\Downloads\> check_mk_agent.msi
----
...
[{powershell}]
----
PS C:\Users\hhirsch\Downloads\> msiexec /i check_mk_agent.msi /qn
----
...
[{powershell}]
----
PS C:\Users\hhirsch\Downloads\> msiexec /i check_mk_agent.msi /qn WIXUI_CLEANINSTALL=
----
...
[{powershell}]
----
PS C:\Users\hhirsch\Downloads\> msiexec /i check_mk_agent.msi /qn WIXUI_MIGRATELEGACY=""
----
...
[TIP]
====
Weitere Informationen zum Thema Zertifikate finden Sie im Artikel xref:certificates#[Zertifikate in {CMK} im Überblick.]
...
[{powershell}]
----
PS C:\Windows\system32> & "C:\Program Files (x86)\checkmk\service\cmk-agent-ctl.exe" register-new `
    --server cmkserver `
    --site mysite `
...
[{powershell}]
----
PS C:\Windows\system32> & "C:\Program Files (x86)\checkmk\service\cmk-agent-ctl.exe" `
...
[{powershell}]
----
PS C:\Windows\System32> & "C:\Program Files (x86)\checkmk\service\check_mk_agent.exe" showconfig ps
...
[{powershell}]
----
PS C:\Windows\system32> & "C:\Program Files (x86)\checkmk\service\cmk-agent-ctl.exe" -vv register `
    --hostname mynewhost `
    --server cmkserver `
    --site mysite `
    --user agent_registration
[2026-05-18 23:13:32.722947 -07:00] INFO [cmk_agent_ctl] D:\y5\winagt-build\checkout\packages\cmk-agent-ctl\src\main.rs:16: starting
[2026-05-18 23:13:32.734893 -07:00] INFO [cmk_agent_ctl] D:\y5\winagt-build\checkout\packages\cmk-agent-ctl\src\lib.rs:51: Loaded config from '"C:\\ProgramData\\checkmk\\agent\\cmk-agent-ctl.toml"', connection registry from '"C:\\ProgramData\\checkmk\\agent\\registered_connections.json"'
[2026-05-18 23:13:32.736471 -07:00] DEBUG [reqwest::connect] C:\Users\jenkins\.cargo\registry\src\index.crates.io-1949cf8c6b5b557f\reqwest-0.12.23\src\connect.rs:882: starting new connection: \https://mycmkserver/
[2026-05-18 23:13:53.755340 -07:00] INFO [cmk_agent_ctl::site_spec] D:\y5\winagt-build\checkout\packages\cmk-agent-ctl\src\site_spec.rs:254: Failed to discover agent receiver port using https.
[2026-05-18 23:13:53.767766 -07:00] DEBUG [cmk_agent_ctl::site_spec] D:\y5\winagt-build\checkout\packages\cmk-agent-ctl\src\site_spec.rs:255: https error: "Failed to discover agent receiver port from \https://mycmkserver/mysite/check_mk/api/1.0/domain-types/internal/actions/discover-receiver/invoke\nerror sending request for url (\https://mycmkserver/mysite/check_mk/api/1.0/domain-types/internal/actions/discover-receiver/invoke)\nclient error (Connect)\ntcp connect error\nA connection attempt failed because the connected party did not properly respond after a period of time, or established connection failed because connected host has failed to respond. (os error 10060)"
[2026-05-18 23:13:53.768905 -07:00] DEBUG [reqwest::connect] C:\Users\jenkins\.cargo\registry\src\index.crates.io-1949cf8c6b5b557f\reqwest-0.12.23\src\connect.rs:882: starting new connection: \http://mycmkserver/
[2026-05-18 23:14:14.815083 -07:00] INFO [cmk_agent_ctl::site_spec] D:\y5\winagt-build\checkout\packages\cmk-agent-ctl\src\site_spec.rs:254: Failed to discover agent receiver port using http.
[2026-05-18 23:14:14.815471 -07:00] DEBUG [cmk_agent_ctl::site_spec] D:\y5\winagt-build\checkout\packages\cmk-agent-ctl\src\site_spec.rs:255: http error: "Failed to discover agent receiver port from \http://mycmkserver/mysite/check_mk/api/1.0/domain-types/internal/actions/discover-receiver/invoke\nerror sending request for url (\http://mycmkserver/mysite/check_mk/api/1.0/domain-types/internal/actions/discover-receiver/invoke)\nclient error (Connect)\ntcp connect error\nA connection attempt failed because the connected party did not properly respond after a period of time, or established connection failed because connected host has failed to respond. (os error 10060)"
[2026-05-18 23:14:14.815937 -07:00] ERROR [cmk_agent_ctl] D:\y5\winagt-build\checkout\packages\cmk-agent-ctl\src\main.rs:35: Failed to discover agent receiver port from Checkmk REST API, both with http and https. Run with verbose output to see errors.
----
...
----
PS C:\Windows\System32> & "C:\Program Files (x86)\checkmk\service\cmk-agent-ctl.exe" dump | more
<<<check_mk>>>
Version: 2.5.0p4
BuildDate: May 27 2026
AgentOS: windows
Hostname: WIN-0HLK813TS1I
Architecture: 64bit
OSName: Microsoft Windows Server 2025 Standard
OSVersion: 10.0.26100
OSType: windows
Time: 2026-06-02T05:30:33-0700
...
PS C:\Windows\System32> netsh advfirewall firewall add rule `
    name="Checkmk Agent" `
    description="Allow inbound network traffic to the Checkmk Agent" `
    dir=in `
    localport=6556 `
    protocol=tcp `
    action=allow `
...
*Hinweis:* Der Befehl wurde zugunsten der Lesbarkeit in mehrere Zeilen aufgeteilt.
endif::[]
...
[{powershell}]
----
PS C:\Users\hhirsch\Downloads\> msiexec /x check_mk_agent.msi /qn
----

Alternativ können Sie auch CIM-Cmdlets für die Deinstallation verwenden:

[{powershell}]
----
PS C:\> Get-CimInstance -ClassName Win32_Product -Filter "Name LIKE '%Checkmk%'" | Invoke-CimMethod -MethodName Uninstall
----

War die Deinstallation erfolgreich, erhalten Sie als Bestätigung eine `ReturnValue` mit dem Wert `0`.
Andernfalls erhalten Sie einen MSI-Fehlercode, mit dem Sie einordnen können, warum die Deinstallation nicht geklappt hat.
...
|`~/tmp/check_mk/cache` |In diesem Verzeichnis werden Cache-Daten von Hosts abgelegt, die mit dem {CMK}-Agenten im Pull-Modus überwacht werden.
|`~/tmp/check_mk/data_source_cache/push-agent/<HOSTNAME>/agent_output` | Cache-Daten von Hosts, die den Agenten im Push-Modus verwenden, liegen unterhalb dieses Verzeichnises.
|===
endif::[]
