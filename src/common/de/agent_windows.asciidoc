...
:description: Der Agent Controller übermittelt die gesammelten Monitoringdaten vom Windows-Agenten an {CMK}. Hier erfahren Sie, wie Sie die Überwachung einrichten.
