...
{CCE-only}
Zum komfortablen Einstieg in die Überwachung von GCP liefert {CMK} ab {CE} die beiden eingebauten xref:glossar#dashboard[Dashboards] [.guihint]#GCP GCE instances# und [.guihint]#GCP storage buckets# mit aus.
