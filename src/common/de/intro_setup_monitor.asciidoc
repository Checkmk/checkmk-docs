...
// TK: ein Switchport gelöscht wg. SaaS
...
Neben den Paketen für Windows und Linux gibt es dort übrigens auch Pakete für Solaris und AIX.
...
//TK: Hier geht es doch um die Community-Einstellung der SNMP-Geräte. Falls die nicht "public" ist, muss ich das in CMK entsprechend eintragen. Da ist es doch egal, welche Default-Einstellung CMK hat. Oder meinst Du was anderes?
