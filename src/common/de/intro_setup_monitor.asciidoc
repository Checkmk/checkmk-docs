...
// ES: Ich wollte die Aufzählung übersichtlicher machen, bin aber noch nicht mit der von mir hier vorgeschlagenen Präsentation zufrieden. Kannst du gerne noch ändern.
...
Im Artikel über die xref:wato.html#activate_changes[Konfiguration von {CMK}] erfahren Sie übrigens mehr über den Unterschied zwischen Konfigurations- und Monitoring-Umgebung.
...
Der Artikel zu den xref:wato_services.html#discovery[Services] beschreibt, welche Möglichkeiten Sie dabei haben.
