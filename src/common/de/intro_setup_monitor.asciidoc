...
Anschließend ist der zweite Schritt ausgewählt:
...
// ES: Ist das wahr - ich muss keine Änderungen aktivieren, um meinen ersten Host sehen zu können?
...
// ES: Der Satz mit "auch" war ein Rückbezug, der nur für SaaS interpretierbar war. Mir ist unklar, ob wir hier in onprem nicht vielleicht vermeiden können/wollen, auf die Willkommens-Seite zu verweisen? Direkt im Abschnitt über Windows unten steht ja wieder erklärt, wie man die Einrichtung "zu Fuß" erledigt.
ifdef::onprem[]
