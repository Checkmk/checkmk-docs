...
Falls es Probleme bei der Service-Erkennung gibt und auch ein wiederholtes [.guihint]#Resan# keinen Erfolg bringt, überprüft {CMK}, ob der Agent überhaupt installiert und registriert ist.
