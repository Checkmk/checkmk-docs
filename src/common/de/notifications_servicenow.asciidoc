...
:description: {CMK} kann Benachrichtigungen zur Weiterverarbeitung an das Incident-Management-System ServiceNow senden. Lesen Sie hier, wie Sie die Anbindung umsetzen.
...
. Für die beiden ServiceNow-eigenen Optionen [.guihint]#Urgency# und [.guihint]#Impact# finden Sie in der link:https://www.servicenow.com/docs/csh?topicname=prioritise-problems.html&version=latest[Dokumentation von ServiceNow^] eine detaillierte Aufstellung und Beschreibung.
