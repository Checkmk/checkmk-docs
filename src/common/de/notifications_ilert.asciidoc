...
:description: {CMK} kann Benachrichtigungen an die Plattform ilert senden, wo sie als Alarme weiterverarbeitet werden. Wie Sie die Anbindung umsetzen, lesen Sie hier.
...
wie die Einrichtung von Arbeitsabläufen (_workflows_) oder die Weiterleitung per E-Mail und an andere Incident-Management-Systeme wie z.B. Jira oder TOPdesk.
