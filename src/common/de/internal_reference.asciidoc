...
Erklärungen für Linux sind oft etwas länger als für Linux, daher steht hier ein dritter Absatz.
...
Dennoch sollten wir darauf achten, dass die Höhen nicht zu dolle abweichen. Ich habe jetzt mal zum Testen die Höhe per JavaScript vereinheitlicht.
--
OS/2::
+
--
