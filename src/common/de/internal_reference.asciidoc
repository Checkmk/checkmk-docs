...
Damit Keyboard-Makros funktionieren, muss das Dokumentattribut `:experimental:` gesetzt sein! Keyboard-Makros funktionieren inline und in Tabellen oder Listen. Bitte lange Makros wie kbd:[Ctrl+Alt+Del] inline sparsam einsetzen. Sequenzen wie das für die link:https://www.mnemonic-device.com/computer/raising-elephants-is-so-utterly-boring/[Elefantenaufzucht^] sind nicht vorgesehen: kbd:[Alt+PrtScn+R] kbd:[E] kbd:[I] kbd:[S] kbd:[U] kbd:[B]. Dass wir Überschneidungen vermeiden sollten, seht Ihr, oder?
