...
Tips und Warnungen kennt Asciidoc als _Admonitions_ – und davon ziemlich viele mit einigen Überschneidungen.
...
[TIP]
====
Der Typ `pass:[[TIP]]` wird für Tips und Anmerkungen wie Hintergrundinformationen verwendet.
