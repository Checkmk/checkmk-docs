...
Mit Gnome-Terminal kann man bunte Screenshots aus TUI-Oberflächen erstellen: Terminal auf 80x24 oder 132x43 einstelle (je nachdem, was besser aussieht) und dann mit [.guihint]#Edit > Select all# gefolgt von [.guihint]#Edit > Copy HTML# das HTML-Fragment kopieren.
