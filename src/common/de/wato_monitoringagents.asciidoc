...
*Hinweis:* Bei jedem Backvorgang kann eine fortlaufende Bake Revision -- für die Unterscheidbarkeit verschiedener Backvorgänge -- erzeugt werden.
...
Wenn Sie automatisch gebackene Agenten _mit_ fortlaufenden Revisionen benötigen, sollten Sie zum Beispiel die REST-API statt der Regel einsetzen.
