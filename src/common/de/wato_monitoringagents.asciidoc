...
ifdef::saas[]
// TK: Den letzten Satz im folgenden Tipp würde ich rausnehmen.
[TIP]
====
...
ifdef::saas[]
// TK: Dieses Kapitel braucht das CMK-Handbuch, um zu erklären, wie man mit der CRE Agenten lädt.
// TK: In der SaaS hast Du ja immer die Agentenbäckerei. Also muss das Kapitel weg und alles zum Download im Abschnitt "Agent herunterladen" stehen.
// TK: Der Inhalt dieses Kapitels gehört ans Ende des Abschnitts "Agent herunterladen". Das passt (natürlich) nicht 1:1 und ein paar Glättungen und Feinschliff sind nötig ;-)
[#download_page]
== Vorbereitete Agenten herunterladen

// TK: Zuviel {CE} (SaaS): In {CE} (SaaS) gelangen Sie mit dem Menüeintrag ... > Sie gelangen mit dem Menüeintrag ...
...
// TK: Obacht: Onboarding Guide kommt in der SaaS GUI gar nicht vor, also kein guihint. Ich habs durch einen Link ersetzt.
...
// TK: Evtl. ergänzen, um die Abkürzung zu verdeutlichen: Diese Kommandos können Sie auf jedem Host ausführen, um sich die vorkonfigurierten Agenten herunterzuladen.
...
ifdef::saas[]
// TK: Auch hier: {CE} (SaaS) weglassen.
...
// TK: Den folgenden Screenshot auswechseln mit dem von SaaS.
