...
Sie gelangen mit dem Menüeintrag [.guihint]#Windows, Linux, Solaris, AIX# zu einer Seite, die Ihnen Zugang zur xref:bakery[Agentenbäckerei] bietet.
...
// MFS: Achtung: Jetzt sind neue Maßnahmen erforderlich, um DeepL-Übersetzungen an dieser Stelle zu vermeiden.
