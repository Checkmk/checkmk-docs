...
Die Funktion ist ab {CMK} 2.3.0 standardmässig deaktiviert, um Probleme bei der automatischen Agentenbäckerei zu vermeiden.
Wenn Sie die Erhöhung der Back-Revision dennoch aktivieren möchten, z.B. für die eindeutige Verarbeitung in einem Paketmanager, schalten Sie die Option [.guihint]#Setup > Global settings > Setup > Apply bake revision# ein.
