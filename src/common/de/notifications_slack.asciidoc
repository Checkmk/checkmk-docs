...
:description: {CMK} kann Benachrichtigungen über einen Webhook an den Instant-Messaging-Dienst Slack senden. Wie Sie die Anbindung durchführen, erfahren Sie hier.
