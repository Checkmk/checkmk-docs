...
////
// ES: Der hier auskommentierte Abschnitt stand hier ursprünglich, bevor ich Tabs eingebaut habe.
// Einfach Kommentarzeichen verschieben, um die vorige Variante wieder zu sehen (Stand vom 2025-10-27).
