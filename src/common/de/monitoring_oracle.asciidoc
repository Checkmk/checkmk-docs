...
// TK: Das hier Windows erwähnt wird, ist jetzt überraschend. Oracle-Wallet gibt es auch unter Windows, die Einrichtung ist aber nur für Linux beschrieben.
...
|===
// TK: MAX_TASKS in diese Tabelle eingefügt, obwohl es nicht wirklich zur Überschrift dieses Abschnitts passt.
...
// TK: Passwortdatei? Welche? Was ist zu tun?
...
====
// TK: Wo finde ich denn elapsed überhaupt? Wird mir das in meine MySQL.sql geschrieben? Siehe Werk #10504 (sehr dünne).
...
// TK: Sehr dünne Infos zu SQLS_PARAMETERS stehen in der mk_oracle help und in Werk #7095.
...
// TK: SQLS_ITEM_SID wird nicht in der mk_oracle help erwähnt, sondern nur hier: Werk #10671  
