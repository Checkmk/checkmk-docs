...
Das bedeutet, dass Eigentümer und Gruppe der manuell erstellten Dateien in `/etc/check_mk/` angepasst werden müssen, damit sie von dem Prozess gelesen werden können.
