...
Sobald Sie alle Punkte der Einrichtung durchlaufen haben, kann das SAML-Login vom Benutzer in {CMK} verwendet werden. Die Button-Beschriftung kann verändert werden, wie xref:configure_saml[unten beschrieben.]
