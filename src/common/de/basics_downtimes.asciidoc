...
Wenn es nur um die xref:glossar#notification[Benachrichtigungen] geht, können Sie hierzu mit xref:glossar#time_period[Zeitperioden] und dem Regelsatz [.guihint]#Notification period for Hosts/Services# arbeiten.
...
*erste* Auftreten tragen Sie über [.guihint]#Start# und [.guihint]#End# ein. Von dem hier eingetragenen Startzeitpunkt aus wird die
...
Zwar könnten Sie fast das Gleiche erreichen, indem Sie mit der Host-Suche alle betroffenen Server finden und die Wartungszeit dann über ein Kommando
eintragen.
...
image::basics_downtimes_advanced.png[alt="Die erweiterten Optionen zur Wartungszeit."]
...
Mit einem Klick auf [.guihint]#Schedule downtime on service# bzw. [.guihint]#Schedule downtime on host# aktivieren Sie die soeben definierten Einstellungen für die betreffenden Services bzw. Hosts.
...
== Verfügbarkeitsanalyse und Wartungszeiten
