...
Da Kommandos im Gegensatz zu Regeln weder eine Konfigurationsberechtigung noch ein xref:glossar#activate_changes[Aktivieren der Änderungen] benötigen, können sie daher eine Lösung sein, um auf eine Situation schnell zu reagieren.
