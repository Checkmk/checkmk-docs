// -*- coding: utf-8 -*-
// IGNORE Standardeinträge Zeiträume
...
Im Regelsatz [.guihint]#Do HW/SW Inventory# sind bereits einige Regeln standardmäßig aktiv, die sich auf Host-xref:labels#[Labels] beziehen. 
