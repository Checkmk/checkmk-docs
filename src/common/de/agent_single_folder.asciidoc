...
ist auch der xref:agent_deployment#[Agent Updater] als Agentenplugin mit der unprivilegierten Ausführung kompatibel.
...
Beachten Sie, dass Ihre Auswahl für den Benutzer des Agent Controllers auch den xref:agent_deployment#[Agent Updater] betrifft, da dieser unter dem Benutzer des Agent Controllers ausgeführt wird.
