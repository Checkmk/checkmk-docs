...
{cee-only}
Nutzen Sie eine der kommerziellen Editionen, d.h. {CSE}, {CME} oder {CCE} (oberhalb der Grenzen des Lizenzstatus „Free“: 750 Services, eine Instanz), so sind Sie verpflichtet, regelmäßig eine Übersicht über den Einsatz von {CMK} in Ihrem Unternehmen an die {comfull} zu liefern.

Nach der Ersteinrichtung - und im Falle von {CE} der Lizenzeinspielung zum Ende der Testphase (Lizenzstatus „Trial“) - kann {CMK} Ihnen den Rest dieser Verwaltungsarbeit komplett abnehmen.
...
// Nothing of relevance, just force a rebuild...
