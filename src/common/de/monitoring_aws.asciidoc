...
Eine detaillierte Anleitung, wie Sie die notwendigen Vorbereitungen in Ihrer AWS-Umgebung vornehmen können, finden Sie im Kapitel xref:#preparationp[AWS für {CMK} vorbereiten].
