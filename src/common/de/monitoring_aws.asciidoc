...
{CCE-only}
Zum komfortablen Einstieg in die Überwachung von AWS liefert {CE} von {CMK} die beiden eingebauten xref:glossar#dashboard[Dashboards] [.guihint]#AWS EC2 instances# und [.guihint]#AWS S3# mit aus.
