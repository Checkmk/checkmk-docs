// -*- coding: utf-8 -*-
// IGNORE ReadOnlyAccess AssumeRole
// NONASCII
include::global_attr.adoc[]
= Amazon Web Services (AWS) überwachen
:title: Amazon Web Services (AWS) überwachen
:description: {CMK} kann Daten und Kosten von Amazon S3, EC2, EBS, RDS, ELB und verwandten Produkten überwachen. Lesen Sie hier, wie Sie die Überwachung verwalten.
...
Nachdem Sie die Services hinzugefügt haben, sieht das nach der xref:glossar#activate_changes[Aktivierung ausstehender Änderungen] etwa so im Monitoring aus:
...
Ein solcher Piggybacked-Host könnte also beispielsweise `172.23.1.123-ap-northeast-2-i-0b16121900a32960c` heißen.
...
|CE |[.guihint]#Costs & Usage# |Beim AWS-Host
|EBS |[.guihint]#Block Storages# |Werden der EC2-Instanz angefügt, sofern diese der Instanz gehören, ansonsten dem AWS-Host
|S3 |[.guihint]#Simple Storages# |Beim AWS-Host
|RDS |[.guihint]#Relational Databases# |Beim AWS-Host
|===
...
ifdef::onprem[]
{CCE-only}
Zum komfortablen Einstieg in die Überwachung von AWS liefert {CMK} in {CE}
endif::[]
ifdef::saas[]
Zum komfortablen Einstieg in die Überwachung von AWS liefert {CE}
endif::[]
