...
Die Funktion der weiteren angebotenen Optionen sind bereits sehr detailliert in der Inline-Hilfe an dieser Stelle beschrieben und werden hier nicht dupliziert.
...
|`overflow` |[.guihint]#In case of an overflow...# |`overflow=W` |
