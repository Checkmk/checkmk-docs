...
//SK: Der folgede Satz kann doch jetzt raus, oder? In der Inline-Hilfe sind nur IGNORE, REWRITE und APPEND beschrieben und die stehen jetzt alle hier.
Die Funktionen der weiteren angebotenen Optionen sind bereits sehr detailliert in der Inline-Hilfe an dieser Stelle beschrieben und werden hier nicht näher erläutert.
