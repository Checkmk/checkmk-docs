...
|1. |Sie geben _keine_ IP-Adresse an. Der Host-Name muss per DNS auflösbar sein. |Bei der xref:glossar#activate_changes[Aktivierung ausstehender Änderungen]
...
* Nach jeder Änderung ist eine xref:glossar#activate_changes[Aktivierung ausstehender Änderungen] nötig, um diese wirksam zu machen.
...
Nach Abschluss der Service-Erkennung fehlt nur noch die gewohnte xref:glossar#activate_changes[Aktivierung ausstehender Änderungen], dann befinden sich alle neuen Hosts im Monitoring.
