...
Diese Option gibt es ab {CE} übrigens auch in den Eigenschaften eines Ordners und wird dort verwendet, um per Autoregistrierung xref:hosts_autoregister#[Hosts automatisch erstellen zu lassen.]
