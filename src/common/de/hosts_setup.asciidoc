...
* Name eines Automationsbenutzers: Der Host wurde durch einen xref:glossar#automation_user[Automationsbenutzer] erstellt, z.B. mit der xref:rest_api#[REST-API.]
