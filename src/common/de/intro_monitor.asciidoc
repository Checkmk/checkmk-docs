...
// TK: icon_derived_downtime.png abgelegt in check_mk zeigt das blaue Pause-Zeichen. In 2.3.0 ist aber ein anderes Symbol zu sehen, das ich nicht in git finde: blaues Dokument mit Pylone
