...
Dazu dient die Option [.guihint]#Expire acknowledgement after#, die aber nur in den kommerziellen Editionen wirksam ist.
...
.Der Dialog zur Wartungszeit eines Hosts in der {RE}
