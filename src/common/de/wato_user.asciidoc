...
Sollten Sie sich als Admin endgültig ausgesperrt sein, so können Sie Ihr Konto nur noch auf der Kommandozeile entsperren.
...
* die Webdomain wird durchgängig im gleichen Format eingegeben, also beispielsweise immer `\https://www.mycompany.com/mysite`.
// MFS: Was ist eine Webdomain? Ich kenne Internetdomains und Websites... Vielleicht: die URL wird durchgängig im gleichen Format eingegeben...
...
[.guihint]#Register authenticator app# für die Konfiguration einer App, die Einmalpasswörter generiert oder [.guihint]#Register security token# für die Verwendung eines Hardware-Token.
...
Die Sitzung wird in beiden Fällen nahtlos weiter geführt.
