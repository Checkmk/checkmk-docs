...
Sie können Hardware-Authentifikatoren (meist USB- oder NFC-Token wie der YubiKey) oder jede andere von Browser und Betriebssystem unterstützte FIDO2 kompatible Hardware verwenden. 
...
Die Sitzung wird nahtlos weiter geführt.

Bei Nutzung von Einmalpasswörtern (_TOTP_) müssen Sie ein generiertes Passwort zur Bestätigung eingeben und werden dann abgemeldet.
Als nächstes können Sie sich direkt erstmals mit der Zwei-Faktor-Authentifizierung in {CMK} anmelden. Erst geben Sie, wie gewohnt, Ihren Benutzernamen und das Passwort ein. Dann erscheint ein weiterer Anmeldebildschirm:

image::wato_user_2fa_login.png[alt="Anmeldung mit dem zweiten Authentifizierungsfaktor.", width=55%]
...
Erstellen Sie sich dazu vorab auf der Seite [.guihint]#User > Two-factor authentication# mit Hilfe von icon:icon_regenerate[alt="Knopf zur Erstellung von Backup-Codes."] [.guihint]#Regenerate backup codes# eine Liste mit Backup-Codes. 
...
image::wato_user_2fa_login2.png[alt="Aufforderung zur Eingabe des Backup-Codes.", width=55%]
