...
Mit der Spalte [.guihint]#Hosts: Hostname# ist es zum Beispiel möglich, den Host-Namen über die Option [.guihint]#Coloring# entsprechend seines Zustands farblich zu hinterlegen.
