...
image::global_settings_enable_sound.png[alt="Globale Einstellung zum Einschalten von Alarmtönen in Ansichten."]
...
image::views_manage_icons_upload.png[alt="Dialog zur Auswahl und zum Hochladen eines eigenen Icons."]
...
image::views_global_settings_custom_icons_and_actions.png[alt="Eigenschaften für eigene Icons."]
