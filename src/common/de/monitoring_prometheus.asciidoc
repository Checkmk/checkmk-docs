...
Legen Sie nun über [.guihint]#Setup > Hosts > Hosts > Dynamic host management > Add connection# eine neue Verbindung an, wählen als Sie als Connector type [.guihint]#Piggyback data# und legen Sie über [.guihint]#Add new element# die Bedingungen fest, unter denen neue Hosts dynamisch erstellt werden sollen.
...
Wenn ein Container nur neu gestartet werden, möchten Sie sehr wahrscheinlich deren Historie nicht verlieren.
