...
// MFS: Hier könnten wir "Single pane of glass" droppen, bißchen Search Engine Stuffing...
...
// MFS: FQDN ist doch unnötig, wenn die Search Domain passt, bzw. der Hostnamen generell auflösbar ist. Evtl.
// Sollte der angegebene Host-Name nicht vom {CMK} Server auflösbar sein, ...
...
// MFS: Evtl. so?
// MFS: Ist ein Login erforderlich, geben Sie die Zugangsdaten hier an.
...
// MFS: einfach? Wenn ich weiß, wo ich suchen muss, ist das einfach, sonst nicht.
...
// MFS: Beachten, ... ob nötig ... – passt m.M. nicht zusammen, evtl.
// MFS: Beachten Sie, dass es auch möglich ist, Hosts wieder dynamisch zu löschen, wenn keine Daten mehr über den Piggyback-Mechanismus bei {CMK} ankommen.
...
// MFS: Singular und Plural gemischt, evtl. besser:
// Um das zu erreichen, legen Sie Container nicht unter ihren IDs, sondern stattdessen unter ihren Namen an...
