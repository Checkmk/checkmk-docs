...
image::avail_states.png[alt="Graphische Übersicht über die möglichen Zustände."]
...
image::avail_screenshot.png[alt="Tabelle der Verfügbarkeiten für alle Services."]
...
image::avail_timeline.png[alt="Tabellarische Ansicht der Zeitreihendarstellung."]
...
image::avail_anno_1.png[alt="Einstellung der Anmerkungen."]
...
image::avail_anno_2.png[alt="Auswahl der Option Reclassify downtime in den Anmerkungseinstellungen."]
...
image::avail_history.png[alt="Ansicht der Verfügbarkeitstabelle inklusive zusätzlicher Informationen."]
...
[{image-left}]
image::avail_menu_options.png[width=350, alt="Menüauswahl zur Anpassung der Auswertung."]
...
--
[{image-left}]
image::avoption_time_range2.png[width=350, alt="Einstellung des Zeitbereichs."]
...
--
[{image-left}]
image::avoption_time_range.png[width=350, alt="Weitere Einstellung des Zeitbereichs."]
...
[{image-left}]
image::avoption_only_outages.png[width=350, alt="Einstellung, um Zeilen mit 100 % Verfügbarkeit auszublenden."]
...
[{image-left}]
image::avoption_labelling.png[width=350, alt="Auswahl der Beschriftungsoptionen."]
...
[{image-left}]
image::avoption_visual_levels.png[width=350, alt="Einstellung der farbigen Darstellung von SLAs mit Schwellwerten."]
...
--
[{image-left}]
image::avoption_outage_statistics.png[width=350, alt="Sichtbar machen von Anzahl und Dauer."]
...
--
[{image-left}]
image::avoption_count_max.png[width=350, alt="Ansicht der entstandenen zusätzlichen Spalten."]
...
[{image-left}]
image::avoption_format_time.png[width=350, alt="Formatierung von Zeiträumen."]
...
[{image-left}]
image::avoption_format_timestamps.png[width=350, alt="Formatierung von Zeitangaben."]
...
[{image-left}]
image::avoption_summary_line.png[width=350, alt="Auswahl der Darstellung der Summenzeile."]
...
[{image-left}]
image::avoption_timeline.png[width=350, alt="Auswahl der Option für die kleine Zeitleiste."]
...
[{image-left}]
image::avoption_group.png[width=350, alt="Auswahl der Gruppierung nach Hosts."]
...
[{image-left}]
image::avoption_availability.png[width=350, alt="Einschränkung der Anzeige auf die Verfügbarkeit."]
...
[{image-left}]
image::avoption_status_grouping.png[width=350, alt="Umstellung von Zuständen."]
...
[{image-left}]
image::avoption_host_status_grouping.png[width=350, alt="Weitere Umstellung eines Zustands."]
...
[{image-left}]
image::avoption_status_classification.png[width=350, alt="Einstellung für die Behandlung nicht überwachter Zeiträume."]
...
[{image-left}]
image::avoption_downtimes.png[width=350, alt="Definition für geplante Wartungszeiten."]
...
[{image-left}]
image::avoption_phase_merging.png[width=350, alt="Gruppierung von Phasen."]
...
[{image-left}]
image::avoption_short_times.png[width=350, alt="Einstellung zur Behandlung kurzer Störungen."]
...
[{image-left}]
image::avoption_service_time.png[width=350, alt="Einstellung für Wartungszeiten."]
...
[{image-left}]
image::avoption_notification_period.png[width=350, alt="Festlegung eines Benachrichtigungszeitraumes."]
...
[{image-left}]
image::avoption_query_time_limit.png[width=350, alt="Begrenzung des Zeitraumes."]
...
[{image-left}]
image::avoption_limit_data.png[width=350, alt="Begrenzung der Datenmenge."]
...
image::avail_bi_icon.png[alt="Ansicht des Symbols für den Aufruf der Verfügbarkeiten."]
...
image::avail_bi_table.png[alt="Ansicht der Verfügbarkeitsanzeige."]
...
image::avail_bi_timeline.png[alt="Zeitleistenansicht."]
...
image::avail_bi_timewarp.png[alt="Ansicht des Timewarp."]
...
image::avail_addto.png[alt="Auswahl des Reports, in den die Verfügbarkeit integriert werden soll."]
...
image::avail_reporting_options.png[alt="Ansicht der Optionen für die Darstellung."]

Eine Besonderheit ist die allerletzte Option:

image::avail_reporting_elements.png[alt="Ansicht der Optionen für die Darstellung."]
