...
* Aktivieren Sie die ausstehenden Änderungen.
...
Bei einer xref:glossar#activate_changes[Aktivierung ausstehender Änderungen] bleibt der Cache erhalten!
Er muss nur bei einem echten (Neu-)Start von {CMK} neu berechnet werden -- z.B. nach einem Booten des Servers oder nach einem Update von {CMK}.
