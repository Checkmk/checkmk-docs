...
Eine wichtige Funktion der Verfügbarkeitsberechnung in den kommerziellen xref:glossar#edition[Editionen] von {CMK} ist, dass Sie diese Berechnungen von xref:glossar#time_period[Zeitperioden] abhängig machen können.
