...
Wenn Sie sich unsicher sind, in welcher Kategorie der Regelsatz zu finden ist, können Sie auch gleich *alle* Regeln durchsuchen, indem Sie entweder die xref:intro_gui#search[Suche] im Setup-Menü nutzen oder über [.guihint]#Setup > General > Rule search# die Seite zur Regelsuche öffnen.
