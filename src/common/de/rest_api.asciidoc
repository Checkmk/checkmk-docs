...
// ES: Please review for KNW-1797 in comparison to the version of this article at commit b625d657b314fa9e1e65864463e989aa5b926c18

// ES: CMK-29243 is related to the recent changes in this article but is not currently blocking KNW-1797. Once CMK-29243 is resolved, make sure that all claims here are consistent with the results of CMK-29243.
...
// ES: CMK-29526 blockiert hier nicht direkt, wir sollten aber dennoch sicherstellen, dass das Ticket erledigt wird, damit der obige Satz wirklich korrekt ist
endif::[]
...
// ES: Bisher nicht möglich, aber vielleicht eines Tages: WD-1345
...
// ES: Schrifthöhe im Bild bei "Introduction": 17 px
...
// ES: Interessiert das die Lesenden hier? Ich will eigentlich nur begründen, warum die Seite extern geöffnet wird und komplett anders aussieht als sowohl die Web-GUI als auch das Handbuch.
...
// ES: aktuell stimmt das nicht, siehe CMK-31473
...
// ES: Neuen Screenshot erzeugen - not blocked
...
// ES: blocked by CMK-31473
// ES: Seltsame Ergebnisse. Bei korrekten Parametern, vorhandenem Host usw. erhalte ich hier den Response Code 204. Der ist in der API-Doku für diesen Endpunkt gar nicht vorgesehen.
...
[{shell}]
----
{c-omd} python3 service_discovery.py
----
--
...
// ES: ETags überall kürzen für bessere Lesbarkeit der Code-Blöcke ohne Scrollbalken
...
// ES: Hilfe, die Beschreibung der zwei zusätzlichen Befehle ist zu holprig. Irgendwelche Vorschläge?
...
----
{c-omd} python3 show_pending_changes.py 
{...
...
[{shell},highlight=30]
----
{c-omd} python3 activate_changes.py 
{'domainType': 'activation_run',
...
// ES: In früheren Versionen stand in diesem Abschnitt immer "die (interaktive) REST-API GUI". Ich finde die Formulierung wie hier in der Überschrift lesbarer - Feedback? In der Weboberfläche wird diese Ressource als "Interactive GUI" im Menü für die REST-API verlinkt.
...
// ES: Screenshot sauber zurechtschneiden, nicht blockiert!
...
// ES: Ist diese Zusatzinfo hier zuviel?

// ES: Ergebnisse meiner Tests in einer Checkmk Pro (formerly Enterprise) 2.5.0-2026.02.16:
////
...
// ES: Sicherstellen, dass alle eingehenden Links zu diesem Artikel korrekt sind und funktionieren