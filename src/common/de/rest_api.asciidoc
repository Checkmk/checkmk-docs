...
// ML-RE: Statt Link auf sich selbst vielleicht besser den Pfad zur gemeinten ReDoc-API-Doku: [.guihint]#Help > REST API documentation#?
...
// ML-RE: Die unten manuell gelöschten -G-Zeilen sind hier noch im Screenshot, würde ich ausschneiden.
[{image-border}]
