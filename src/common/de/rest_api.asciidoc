...
ifdef::onprem[]
Im xref:cmk_versions#[Entwicklungszyklus von {CMK}] kommt es gelegentlich vor, dass neue Features oder Korrekturen für bestehende Features auch in Patch-Releases für ältere, noch im Supportzeitraum befindliche Major-Versionen von {CMK} zurückportiert werden.
