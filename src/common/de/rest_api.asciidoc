...
// ES: blocked by KNW-1719
// ES: blocked by CMK-29243: update all API URLs by searching for "1.0" and replacing with "v1"

[{image-border}]
image::restapi_redoc_2pane.png[alt="Der Eintrag in der API-Dokumentation zum Erstellen eines Hosts.",fullscreen=1]
// ES: Neuen Screenshot erzeugen - blocked by CMK-29243
...
{'domainType': 'activation_run',
 ...
 'links': [{'domainType': 'link',
            'href': '\http://myserver/mysite/check_mk/api/1.0/objects/activation_run/c123e01b-95ab-4898-b12e-859193ea30f5',
            'method': 'GET',
            'rel': 'self',
            'type': 'application/json'},
           {'domainType': 'link',
            'href': '\http://myserver/mysite/check_mk/api/1.0/objects/activation_run/c123e01b-95ab-4898-b12e-859193ea30f5/actions/wait-for-completion/invoke',
            'method': 'GET',
