...
Hier wird die Service-Erkennung auf dem Host `mylinuxserver` durchgeführt mit der Option `tabula_rasa`, was in der {CMK}-GUI dem Knopf [.guihint]#Remove all and find new# entspricht:
