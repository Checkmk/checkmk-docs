...
Im verteilten Monitoring können Sie Ihre Piggyback-Daten entsprechend Ihrer Struktur ordnen.
Das heißt, Piggyback-Daten, die über einen Host ins Monitoring einfliessen, können - auch instanzübergreifend - einem anderen Host für die Auswertung zugewiesen werden.
