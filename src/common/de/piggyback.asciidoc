...
können Sie dies mithilfe der xref:dcd#[dynamischen Konfiguration] automatisieren und Hosts, für die Piggyback-Daten vorhanden sind, automatisch anlegen lassen.
