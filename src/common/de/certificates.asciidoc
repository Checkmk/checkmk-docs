...
Diese verweigern häufig die Kommunikation, wenn der zum Verbindungsaufbau benutzte Hostname nicht im Zertifikat enthalten ist.
Bei {UE} ab Version {v25} betrifft dies nur die xref:opentelemetry#[OpenTelemetry-Anbindung].
In künftigen Versionen werden aber weitere Komponenten hinzukommen, welche das Instanz-Zertifikat nutzen. 

Aus diesem Grund ist es sinnvoll, die verwendeten Hostnamen im Zertifikat zu hinterlegen.
