...
ifdef::saas[]
Die letzten beiden unten aufgeführten Tabelleneinträge sind Zertifikate für das verteilte Monitoring und somit derzeit nur in den On-Premises-Editionen von {CMK} relevant.
endif::[]
