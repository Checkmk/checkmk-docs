...
{CMK} stattet bereits beim Implementieren alle Monitoring-Instanzen mit den eigenen CAs und Zertifikaten aus, die für den Betrieb und für die Kommunikation zwischen den Komponenten eines {CMK}-Setups grundlegend sind (etwa zwischen den Agenten und der Instanz). 
