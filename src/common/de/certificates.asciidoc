...
// SH: Bug in meiner AsciiDoc-Syntax? Der folgende Text wird von Docserve nicht gerendert! 
// SH: Wenn ich die "Pipe" | oben entferne, rutscht der gesamte Text hingegen in die letzte Tabellenspalte und zerstört das Tabellen-Layout. 
// SH: Ich habe ad hoc nicht herausgefunden, wie sich die Syntax reparieren lässt. 
