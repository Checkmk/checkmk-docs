...
Es fußt in einer hierarchischen Zertifikatskette (Chain of Trust), bei der das Vertrauen in einer bestimmten Richtung fließt – vom Root-Zertifikat zu Leaf-Zertifikaten, bildlich gesprochen vom Stamm zu den Blättern. 
////
