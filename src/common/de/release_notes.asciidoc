...
Das xref:relay#[{CMK} Relay] offiziell auf den folgenden Distributionen unterstützt (ausschließlich `x86_64`):
...
Eine Liste der unterstützten Betriebssysteme für den Betrieb des xref:relay#[{CMK} Relay] wurde hinzugefügt.
