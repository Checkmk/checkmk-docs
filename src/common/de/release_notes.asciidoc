...
Diese sind nach der Edition und Version benannt, also beispielsweise link:https://download.checkmk.com/checkmk/{current}/check-mk-raw-{current}-bill-of-materials.json[check-mk-raw-{current}-bill-of-materials.json^] und link:https://download.checkmk.com/checkmk/{current}/check-mk-raw-{current}-bill-of-materials.json.hash[check-mk-raw-{current}-bill-of-materials.json.hash^] für {RE} {current}.
endif::[]
