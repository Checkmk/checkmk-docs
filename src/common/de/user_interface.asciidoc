...
[TIP]
====
Auch den Inhalt des [.guihint]#Setup#-Menüs können Sie sich in die Seitenleiste laden mit dem Snapin [.guihint]#Quick setup.#
====
...
Die Sichtbarkeit der Einträge im Menü [.guihint]#Language# können Sie in [.guihint]#Setup > Global settings > User interface > Enable community translated languages (not supported)# einstellen.
