...
*Hinweis:* Die Anzeige der sichtbaren Optionen in der Konfigurationsumgebung ist abhängig von Ihren Rechten. Sollten Sie einzelne Optionen oder auch Gruppen von Optionen in Ihrem {CMK} nicht sehen, so fehlen Ihnen die entsprechenden Zugriffsrechte.
