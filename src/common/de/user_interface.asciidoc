...
// TK: So ein Möchtegern-Signposting steckt ja bereits im include_navigation_bar. Das möchte ich aber nicht ausbauen, da das include ja nicht nur in user_interface sondern auch in intro_gui verwendet wird. Wenn ich da mehr Links in user_interface-Kapitel reinstecke, wird die Leserin bei jedem Thema in intro_gui quer durchs Handbuch geschickt, obwohl sie den Leitfaden ja sequentiell lesen soll.
