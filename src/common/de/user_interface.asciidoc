...
// FIXME 2.4.0 SaaS: Snapin-Umbennung: Quick setup > Setup shortcuts
[TIP]
====
ifdef::onprem[]
...
Nach Auswahl eines der Einträge im [.guihint]#Monitor#-Menü wird Ihnen auf der Hauptseite die angeforderte Information in der Regel entweder als xref:dashboards[Dashboard] oder als xref:views[Tabellenansicht] angezeigt, auf die wir in den folgenden Kapiteln näher eingehen werden.
