...
// ES: TODO - stimmt leider nicht, es ist nicht vollständig anonym wegen den Check-Namen
...
// ES: Darauf hinweisen, dass man auch mit "Klick hier" den Dump einsehen kann?
...
{c-omd} cmk-product-usage --dry-run
{
  ...
  "data": {
    "id": "f5dd0775-81bf-48e2-9544-ac25e8bcb974",
    "count_hosts": 1,
    "count_services": 2,
    "count_folders": 0,
    "edition": "pro",
    "cmk_version": "2.5.0-2026.02.05",
    "timestamp": 1770385503,
    "checks": {
      "check-mk-inventory": {
        "count": 1,
        "count_hosts": 1,
...
// ES: brauche hier noch einen Satz zur Speicherdauer
