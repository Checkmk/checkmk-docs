...
Diese Funktion ist verfügbar in Version {v25} sowie in einem bald verfügbaren Patch-Update für {v24} und {v23}.
// ES: Genaue Patchversionen hier nachtragen, sobald bekannt. Dann den auskommentierten Satz übernehmen und den aktuell verwendeten Satz löschen. Auch im englischen Artikel aktualisieren.
...
ifdef::onprem[]
Dieser Artikel beschreibt, wie Sie die Übermittlung von Produktnutzungsdaten in Ihrer {CMK}-Instanz ablehnen oder aktivieren können.
Um einen Überblick darüber zu erhalten, was für Daten bei aktiver Datenübermittlung gesammelt werden, werfen Sie gerne einen Blick in das link:https://checkmk.com/product-usage-analytics/manifest[_Product usage analytics manifest_^].
endif::[]
ifdef::saas[]
Um einen Überblick darüber zu erhalten, was für Daten gesammelt werden, werfen Sie gerne einen Blick in das link:https://checkmk.com/product-usage-analytics/manifest[_Product usage analytics manifest_^].
endif::[]
...
Ein modaler Dialog dazu wird Ihnen nach 30 Tagen auf einer entsprechenden {CMK}-Version in der GUI angezeigt.
// ES: Patchversionen korrigieren, sobald final bekannt. Dann den verwendeten Satz durch den kommentierten Satz ersetzen. Auch im englischen Artikel aktualisieren
...
Nach weiteren 30 Tagen erscheint der modale Dialog in der gleichen Form erneut.
...
Einen vollständigen Überblick über die Daten, die gesammelt werden, erhalten Sie im link:https://checkmk.com/product-usage-analytics/manifest[_Product usage analytics manifest_^].
// Einen Link zu diesem Dokument finden Sie auch im [.guihint]#Help#-Menü in Ihrer {CMK}-Instanz.
// ES: Satz einkommentieren abhängig davon, ob der Link im Produkt tatsächlich vorhanden ist
