...
Es muss zumindest eine Benachrichtigungsregel greifen, daraus eine Benachrichtigung resultieren und die Benachrichtigung muss versendet worden sein, was die Meldung `Notifications have been sent` anzeigt.
...
Falls Sie im realen Monitoring, d. h. abseits der Simulation, keine Benachrichtigung bekommen haben, muss das nicht gleich ein Fehler sein, denn es gibt Situationen, in denen die Benachrichtigungen von {CMK} absichtlich unterdrückt werden, z.B.:
