...
Wir hatten bereits im xref:intro_finetune#filesystems[Kapitel über die Feinjustierung des Monitoring] die Möglichkeit vorgestellt, Schwellwerte in Abhängigkeit von der  Dateisystemgröße festzulegen
