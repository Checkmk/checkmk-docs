...
Die folgende Tabelle zeigt die Schwellwerte für Warnungen, die der Magic Factor für eine Referenzgröße von 20{nbsp}GB und dem zugehörigen Schwellwert von 80{nbsp}% ermittelt:
