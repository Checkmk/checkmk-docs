...
Die folgende Tabelle zeigt die resultierenden und tatsächlich angewendeten Schwellwerte für Warnungen, die mit dem jeweiligen Magic Factor für eine Referenzgröße von 20{nbsp}GB und einen Ausgangsschwellwert von 80{nbsp}% berechnet werden:

// Tabelleninhalt ist in de und en unterschiedlich (Komma vs. Punkt).
[cols="15,~,~,~,~,~,~,~",options="header"]
|===
|Magic Factor |5{nbsp}GB |20{nbsp}GB |100{nbsp}GB |500{nbsp}GB |1{nbsp}TB |10{nbsp}TB |50{nbsp}TB
|*1,0* |*80,0{nbsp}%* |*80,0{nbsp}%* |*80,0{nbsp}%* |*80,0{nbsp}%* |*80,0{nbsp}%* |*80,0{nbsp}%* |*80,0{nbsp}%*
|*0,9* |77,0{nbsp}% |*80,0{nbsp}%* |83,0{nbsp}% |85,5{nbsp}% |86,5{nbsp}% |89,3{nbsp}% |90,9{nbsp}%
|*0,8* |73,6{nbsp}% |*80,0{nbsp}%* |85,5{nbsp}% |89,5{nbsp}% |90,9{nbsp}% |94,2{nbsp}% |95,8{nbsp}%
|*0,7* |69,7{nbsp}% |*80,0{nbsp}%* |87,7{nbsp}% |92,4{nbsp}% |93,8{nbsp}% |96,9{nbsp}% |98,1{nbsp}%
|*0,6* |65,2{nbsp}% |*80,0{nbsp}%* |89,5{nbsp}% |94,5{nbsp}% |95,8{nbsp}% |98,3{nbsp}% |99,1{nbsp}%
|*0,5* |60,0{nbsp}% |*80,0{nbsp}%* |91,1{nbsp}% |96,0{nbsp}% |97,2{nbsp}% |99,1{nbsp}% |99,6{nbsp}%
|===
...
* Die Spalte für 20{nbsp}GB zeigt die Referenzgröße selbst an, bei der jeder Faktor den Schwellwert unverändert lässt.
...
Mit dem Standardfaktor von 0,8 erreicht ein 10-TB-Dateisystem den {WARN}-Zustand bei 94,2{nbsp}%, wodurch etwa 580{nbsp}GB frei bleiben.
Bei einem Faktor von 0,5 erreicht dasselbe Dateisystem den {WARN}-Zustand erst bei 99,1{nbsp}%, und es bleiben nur noch 89{nbsp}GB übrig.
...
* Wenn das kleinste von Ihnen überwachte Dateisystem bereits mehrere hundert Gigabytes groß ist, entspricht die Referenzgröße von 20{nbsp}GB nicht mehr annähernd Ihrer Infrastruktur, und jedes Dateisystem wird nach oben skaliert.
...
Bei einer Referenzgröße von 1000{nbsp}GB erreicht beispielsweise ein 500-GB-Dateisystem den {WARN}-Zustand bei 77,0{nbsp}% und ein 50-TB-Dateisystem bei 90,9{nbsp}%.
