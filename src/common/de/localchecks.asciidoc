...
Unter Windows kommt hinzu, dass der Agent Controller unter dem lokalen Systemkonto (_Local System account_) läuft, der Aufruf im Terminal aber unter einem normalen Benutzer oder Administrator erfolgt.
