...
Zudem geben lokale Checks den _Admins von Servern_ weit reichende Freiheiten.
_Monitoring-Admins_ müssen nur noch die Entscheidung treffen, _ob_ sie neue lokale Checks als Service aufnehmen.
...
Für beide existieren vordefinierte Metrikdefinitionen, welche die Metrik mit den korrekten Einheiten versehen.
