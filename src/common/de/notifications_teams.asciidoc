...
. Erstellen Sie neue Parameter für Mattermost mit [.guihint]#Setup > Events >  Notifications > Parameters for notification methods > Parameters for Microsoft Teams > Add parameter.#
. Geben Sie die kopierte URL unter [.guihint]#Webhook URL# ein:
+
