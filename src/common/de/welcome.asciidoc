...
Was {CE-saas} auszeichnet, erfahren Sie in einem xref:cce#[eigenen Artikel].
endif::[]
...
Werfen Sie gerne einen Blick in unsere xref:ai_policy#[KI-Richtlinie], um zu erfahren, wie wir zur Verwendung von KI-Werkzeugen bei der Handbucharbeit stehen.
