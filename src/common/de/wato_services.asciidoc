...
Menüleiste auf [.guihint]#Hosts > On selected hosts > Run bulk service discovery#
drücken.
...
Menüleiste über [.guihint]#Hosts > On selected hosts > Run bulk service discovery# gehen.
. In einem Ordner in der Menüleiste auf [.guihint]#Hosts > *In this folder* >
Run bulk service discovery# klicken.
...
Letztere Option finden Sie im Drop-down-Menü unter dem Namen [.guihint]#Refresh all services and host labels (tabula rasa)#.
