...
in der Regel über die Befehls-Pipe des Cores. Hier ist ein Schritt-für-Schritt-Vorgehen
...
So schön eine GUI ist, so praktisch ist doch manchmal noch die gute alte Befehlszeile --
