...
Optional können Spezialagenten – wenn sie in Python implementiert sind – direkt auf den Passwortspeicher zugreifen.
Dies erklärt der separate Artikel xref:devel_password_store#[_Der Passwortspeicher für Entwickelnde_].
