...
image::dashboard_example_10.png[width=55%, alt="Hinzufügen der geplanten Wartungszeiten zum Dashboard."]
...
image::dashboard_example_11.png[alt="The complete dashboard."]
