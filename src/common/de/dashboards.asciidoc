...
image::dashboard_main_numbered.png[alt="Ansicht eines Dashboards."]
...
Bei der {CRE} ist das Haupt-Dashboard auf der Startseite hingegen das [.guihint]#Problem Dashboard#, welches auch in den kommerziellen Editionen über icon:icon_dashboard_problems[] aufrufbar ist und ganz klassisch unerledigte Probleme und aktuelle Events in Listenform zeigt:

image::dashboard_main_numbered_raw.png[alt="Ansicht eines Dashboards mit Nummern für die Beschreibung."]
...
image::dashboard_layout_example_1.png[alt="Ansicht eines Dashlets in der Dashboard-Mitte."]
...
image::dashboard_layout_example_2.png[alt="Zweite Ansicht eines Dashlets inmitten weiterer Dashlets."]
...
image::dashboard_layout_example_3.png[alt="Dritte Ansicht sich verändernder Dashlet-Einteilungen."]
...
image::dashboard_config_dashboard.png[width=60%, alt="Einstellungen für die Dashboard-Konfiguration im Menü."]
...
image::dashboard_config_example_dashboard.png[alt="Eingabe von Titel und allgemeinen Angaben zum Dashboard."]
...
image::dashboard_config_dashlet.png[width=60%, alt="Aufruf der Dashlet-Konfiguration aus einem Dashlet heraus."]
...
image::dashboard_config_example_dashlet.png[alt="Festlegung der Eigenschaften eines Dashlets."]
...
image::dashboard_config_permissions.png[alt="Eingabe der Rechte eines Benutzers für Dashboards."]
...
image::dashboard_example_view.png[alt="Ansicht des Beispiel-Dashboards."]
...
image::dashboard_example_1.png[alt="Auswahl der Dashboard-Art."]
...
image::dashboard_example_2.png[alt="Eigenschaften des neuen Dashboards."]
...
image::dashboard_example_3.png[alt="Allgemeine Angaben und Titel des Dashlets."]
...
image::dashboard_example_4.png[alt="Einstellung der Kontextfilter für das Dashlet."]
...
image::dashboard_example_5.png[alt="Auswahl des Graphen."]
...
image::dashboard_example_6.png[alt="Einstellung der Breite des neuen Dashlets."]
...
image::dashboard_example_7.png[alt="Einstellung der Eigenschaften für das neue Dashlet."]
...
image::dashboard_example_8.png[alt="Positionierung des neuen Dashlets."]
...
image::dashboard_example_9a.png[alt="Festlegen des Filters my*."]
...
image::dashboard_example_9b.png[alt="Einstellung der Graph-Ansicht als Balkendiagramm."]
...
image::dashboard_example_9c.png[alt="Positionierung des neuen Dashlets."]
...
Um die Ansicht der geplanten Wartungszeiten einzufügen, rufen Sie diese zum Beispiel über [.guihint]#Monitor > Overview > Scheduled downtimes# auf. Anschließend fügen Sie die Ansicht Ihrem Dashboard über [.guihint]#Export > Add to dashboard# hinzu.

image::dashboard_example_10.png[width=55%, alt="Hinzufügen der geplanten Wartungszieten zum Dashboard."]

Wählen Sie Ihr Dashboard aus.

image::dashboard_example_10a.png[alt="Das Dashboard auswählen."]
...
image::dashboard_example_11.png[alt="Ansicht des kompletten Dashboards."]
...
image::dashboard_example_mandatory.png[width=60%, alt="Anzeige der Funktion zum Anwenden eines Filters."]
...
Die Cloud-Anbieter-spezifischen Dashboards finden Sie nur in der {CE}, die {RE} beschränkt sich auf einige Basis-Dashboards.
...
|`problems` |Problems > Problems dashboard |Probleme und Statistiken aller Hosts und Services. Das [.guihint]#Problems dashboard# ist in der {RE} das [.guihint]#Main dashboard#.
...
image::dashboard_topdown1.png[alt="Beispiel-Dashboard aller my-Hosts."]
...
image::dashboard_topdown2.png[alt="Die Rückkehrfunktion in einem Dashboard."]
