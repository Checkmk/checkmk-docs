...
|5672 |TCP |Advanced Message Queuing Protocol (AMQP) |Ein Message Broker wird für das xref:piggyback#distributed_piggyback[Piggyback im verteilten Monitoring] benötigt
