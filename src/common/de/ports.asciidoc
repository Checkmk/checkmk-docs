...
|443 |TCP |HTTPS |Kommunikation mit dem xref:license#[Lizenzserver] (nur kommerzielle Editionen, Server: `license.checkmk.com`, Alternative: xref:license#manualtrans_cce[manuelle Übermittlung]). +
