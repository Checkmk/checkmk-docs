...
// ES: gedoppelte Präposition, ich finde, das zweite "von" trifft den Kern nicht ganz. Besser wäre vielleicht "via" oder "aus", oder eine Umstellung wie "Verbindung zu `hub.docker.com` für die Installation und Updates von Relay-Images"
