...
Kommunikation mit dem Server der {comfull} für die xref:product_usage_analytics#[Analyse der Produktnutzungsdaten], falls ein Administrator die Zustimmung dazu erteilt hat (ab {CMK} {v23}p47). +
