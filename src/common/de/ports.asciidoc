...
|15671 |TCP .2+| RabbitMQ Management .2+|Dieser Port wird intern für die Verwaltung des Message Brokers RabbitMQ (s.o.) verwendet.
|25672 |TCP 
|===
endif::[]
...
Kommunikation mit dem Server der {comfull} für die xref:product_usage_analytics#[Analyse der Produktnutzungsdaten], falls ein Administrator die Zustimmung dazu erteilt hat (ab {CMK} {v24}p26). +
