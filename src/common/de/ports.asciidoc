...
Falls Ihre Firewall keine Möglichkeit bietet, ausgehenden Verkehr anhand von Hostnamen zu erlauben, ziehen Sie in Erwägung, xref:license#license_cmk[einen Proxy] für die Kommunikation mit dem Lizenzserver zu verwenden.
====
