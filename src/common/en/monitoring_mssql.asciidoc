...
{CMK} allows you to comprehensively monitor Microsoft SQL Server. A complete list of the monitoring options can be found in our
in our link:https://checkmk.com/integrations?tags=mssql[Catalog of check plug-ins].
