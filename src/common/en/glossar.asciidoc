...
On a small scale—that is, with a _single_ site and up to 750 services—{CMK} can also be operated permanently beyond that period in license state 'Free' without requiring a subscription.
