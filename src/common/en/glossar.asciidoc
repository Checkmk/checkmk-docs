...
Two automation users are already set up in a fresh {CMK} site: for web services and for registering the agent with the {CMK} server for TLS-encrypted data transfer.
