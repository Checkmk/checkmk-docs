...
ifdef::onprem[]
From {CE} onwards you will find the [.guihint]#{CMK} agent connection mode# option in the properties of the host in the section on xref:hosts_setup.html#monitoring_agents[monitoring agents].
