...
We recommend using the built-in (symmetric) encryption in this case with the rule [.guihint]#Symmetric encryption (Linux, Windows)#.
...
In this case we recommend using the built-in (symmetric) encryption using the rule [.guihint]#Symmetric encryption (Linux, Windows)# rule.
...
As the agent program must be called under the user ID _Local System_ in order to deliver exactly the data that arrives in the monitoring, you should never start it in a shell.
...
In this case, we recommend using the built-in (symmetric) encryption with the rule [.guihint]#Symmetric encryption (Linux, Windows)#.
