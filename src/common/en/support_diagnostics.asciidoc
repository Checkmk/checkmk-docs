...
ifdef::onprem[]
The most essential information is of course the xref:cmk_versions.html#[version] and the xref:cmk_versions.html#suffix[edition] of {CMK} that you are using.
...
[IMPORTANT]
====
The information you select here *may* contain confidential data.
