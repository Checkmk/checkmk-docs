...
If you choose [.guihint]#Local Files# here, {CMK} will additionally create an overview of all files located in the `~/local/` directory of your site.
This can be useful if your local customizations are incompatible with a recent update of {CMK}.
