...
. Then create a new rule from the [.guihint]#Check HTTP web service# rule set that will only apply to the new host (e.g. via the [.guihint]#Explicit hosts# condition).
