...
The following table shows the warning thresholds calculated by the magic factor for a reference size of 20{nbsp}GB and the corresponding threshold of 80{nbsp}%:
