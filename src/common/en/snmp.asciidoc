...
the `snmpget` and `snmpbulkwalk` commands, and a built-in SNMP engine that executes SNMP requests with high performance without spawning additional processes.
