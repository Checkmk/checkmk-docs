...
* _Query_ refers to the user's perspective--that is, what data should be retrieved:
...
* _Request_ always refers to the specific way in which a device provides data.
