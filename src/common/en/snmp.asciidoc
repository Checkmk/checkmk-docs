...
[TIP]
====
This article is currently being translated after an overhaul.
If you are interested in the new content, head over to the link:../de/snmp.html[German version] and use your favorite translation tool to translate to English.
====
...
Aus diesem Grund ist es wichtig, dass Sie sich mit der Performance überwachter Geräte vertraut machen, problematische Geräte identifizieren und proaktiv xref:core_tuning#[Optimierungen] durchführen.
