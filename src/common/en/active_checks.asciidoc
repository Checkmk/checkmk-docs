...
Once you have activated the rule you have just created, xref:user_interface#search[search] in the [.guihint]#Monitor# menu for the `Basic webserver health` service name that you have just defined.
