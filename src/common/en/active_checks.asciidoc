...
It can also examine certificates in much greater detail, for example for specific host names stored via link:https://de.wikipedia.org/wiki/Server_Name_Indication[Server Name Indication (SNI)^].
====
