...
:description: {CMK} provides robust and informative forecasts about the future utilization of monitored objects. Details on how to configure forecasts are found here.
