...
With the column [.guihint]#Hosts: Hostname#, for example, it is possible to color the host name according to its state using the [.guihint]#Coloring# option.
...
image::global_settings_enable_sound.png[alt="Global setting for switching on alarm sounds in views."]
