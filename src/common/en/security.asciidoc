...
This article will be gradually expanded to provide a central overview on all aspects of security measures implemented in {CMK} and aids on further improving security.
