...
A careless `C:\**` leads either to a 6-digit number of serves or a timeout during discovery.

.Monitoring all files in this direcotry and all its subdirectories
