...
:description: {CMK} can send notifications to the incident management system ServiceNow for further processing. Find out here how to set up the connection.
...
. For the two ServiceNow-specific options [.guihint]#Urgency# and [.guihint]#Impact#, you will find a detailed list and description in the link:https://www.servicenow.com/docs/csh?topicname=prioritise-problems.html&version=latest[ServiceNow documentation^].
