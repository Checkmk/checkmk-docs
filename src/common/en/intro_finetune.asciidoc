...
By the way, the https://docs.checkmk.com/saas/de/intro_finetune.html[German version] of this article has already been updated -- if that is an alternative for you.
====
endif::[]
