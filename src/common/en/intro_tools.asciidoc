...
Now that your monitoring system has something to do, and you have mastered the {CMK} user interface, it is time to take a closer look at the elements of the user interface that will help you with your daily monitoring (or operating) tasks.
...
In the [.guihint]#Service name (regex)# input field, enter `cpu` and click [.guihint]#Apply filters#:
