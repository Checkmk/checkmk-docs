...
In this way you can save yourself the trouble of baking and rolling out the new agent, and after customizing the above-mentioned rule accordingly, will need to--onetime only--quickly activate the pending changes.
