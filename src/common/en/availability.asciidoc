...
An important function of the availability calculations in the commercial xref:glossar#edition[editions] of {CMK} is that these calculations can be made dependent on xref:glossar#time_period[time periods]. 
