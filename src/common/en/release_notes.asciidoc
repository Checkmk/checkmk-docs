...
|Debian |11 Bullseye (deprecated) | {v25}
| |12 Bookworm | {v25}
| |13 Trixie | {v25}
|Red Hat Enterprise Linux |8 | {v25}
| |9 | {v25}
| |10 | {v25}
|SUSE Linux Enterprise Server |15 SP3 (deprecated) | {v25}
| |15 SP4 (deprecated) | {v25}
| |15 SP5 | {v25}
| |15 SP6 | {v25}
| |15 SP7 | {v25}
| |16 | (once released)
|Ubuntu |22.04 LTS Jammy Jellyfish | {v25}
| |24.04 LTS Noble Numbat | {v25}
| |26.04 LTS _Resolute Raccoon_ | (once released)
|===
endif::[]
...
// SH: Folgender Abschnitt ist für den Master/2.5.0 dann obsolet, kann zum Release entfernt werden. 
// SH: Changelog 2025-02-17 galt für die Übergangsphase 2.3.0 auf 2.4.0.
// ifdef::saas[]
// == Change log
