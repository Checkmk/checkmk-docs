...
* Alert handlers are independent of xref:glossar#scheduled_downtime[scheduled downtimes], notification periods, xref:basics_ackn#[acknowledgements] and similar controls.
