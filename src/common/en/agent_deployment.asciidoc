...
By the way, the https://docs.checkmk.com/saas/de/agent_deployment.html[German version] of this article has already been updated -- if that is an alternative for you.
====
endif::[]
// delete to here
