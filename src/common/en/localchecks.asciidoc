...
// This block replaces the following 2 paragraphs
// start translation
////
...
There must always be *exactly one space* between the four parts of this output.
Inside of the status details spaces can be used at will.
...
Der Zeichensatz-bezogenen Fehlersuche widmen wir im Artikel zu Spool-Dateien ein xref:spool_directory#charset[eigenes Kapitel.]
====
////
// end translation
