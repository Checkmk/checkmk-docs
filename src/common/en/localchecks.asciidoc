...
Under Windows, the Agent Controller also runs under the _Local System account_, but the call in the terminal is made under a normal user or administrator.
