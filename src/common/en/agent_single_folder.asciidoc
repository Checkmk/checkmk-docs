...
This affects in {CMK} {v24} `mdadm` (for reading the status of various software RAIDs and encrypted drives),`mailq` (for reading the email queue of the postfix MTA), and the scripts for monitoring {CMK} sites.
