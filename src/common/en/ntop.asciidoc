...
ntopng is available in a free 'Community' version, as well as in several extended 'Professional' and 'Enterprise' link:https://www.ntop.org/guides/ntopng/what_is_ntopng.html#available-versions[commercial versions^].
...
In each tab, you can use the [.guihint]#View data in ntopng# link to access the associated ntopng page, which will take you to the ntopng link:https://www.ntop.org/guides/ntopng/web_gui/hosts.html#host-details[Host Details^].
...
[TIP]
====
This dashboard is similar in structure to the link:https://www.ntop.org/guides/ntopng/web_gui/dashboard.html#professional-enterprise-dashboard[Traffic Dashboard^] in the ntopng interface.
====
