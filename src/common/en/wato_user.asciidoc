...
At the same time, you can use [.guihint]#Advise re-authentication before termination# to specify when the user should be notified to save their entries, log out and log in again before the "hard" termination of their session:
