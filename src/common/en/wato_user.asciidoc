...
The email address is optional and is only required if the user is to become a contact who is to be xref:notifications#[notified] by email (xref:notifications#smtp[SMTP configuration] required).
