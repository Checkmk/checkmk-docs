...
[TIP]
====
When using the agent packages from {CE} that are xref:intro_setup_monitor#first[preconfigured for auto-registration], this first step - adding the services - is carried out automatically.
