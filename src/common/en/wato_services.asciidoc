...
ifdef::saas[]
Service groups make it easy for you to bring a lot more order to monitoring via
xref:views#[views], and to switch targeted
...
ifdef::saas[]
As already mentioned, the service groups are used in several places, like xref:views#[views] and xref:notifications#[notifications].
endif::[]
...
ifdef::onprem[]
When you use service groups in xref:notifications#[notifications] and xref:alert_handlers#[alert handlers],
endif::[]
ifdef::onprem[]
When you use service groups in xref:notifications#[notifications],
endif::[]
