...
If you do not define at least one active check, {CMK} will automatically create a PING service.
|===
...
* Automation user name (in the picture above [.guihint]#automation#): the host was created by an xref:glossar#automation_user[automation user], e.g. using the xref:rest_api#[REST API].
