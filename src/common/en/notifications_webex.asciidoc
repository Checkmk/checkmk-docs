...
. Create new parameters for Mattermost with [.guihint]#Setup > Events >  Notifications > Parameters for notification methods > Parameters for Cisco Webex Teams > Add parameter.#
. Enter the copied webhook URL:
+
