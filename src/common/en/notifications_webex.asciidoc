...
. For the [.guihint]#Notification Method# choose [.guihint]#Cisco Webex Teams#.
. Enter the copied webhook URL:
+
image::notifications_webex4.png[alt="The notification method settings for Cisco Webex Teams."]
+
