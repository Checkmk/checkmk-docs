...
Groups become important when the number of aggregations exceeds what you want to see on a screen.
...
It is a bit risky when items that should be present are silently missing from the reporting, right?
