// -*- coding: utf-8 -*-
// IGNORE Aggr Hostgroups backup3 isn't
// NONASCII
include::global_attr.adoc[]
= Business Intelligence (BI)
:title: Business Intelligence (BI) - Reduce complexity with BI
:description: {CMK}'s Business Intelligence (BI) module can aggregate many individual states into applications, using rules. Learn here how to set up BI aggregations.
...
Of course to make the new, bigger tree visible, you will once again need to create an aggregation.
...
First of all, you will see two new items 
