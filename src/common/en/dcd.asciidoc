...
To view these anyway, click on the clock symbol icon:icon_dcd_history[alt="Icon of the execution history."] in the [.guihint]#Actions# column, which will bring you to the [.guihint]#Execution history of this connection# (xref:execution_history[Execution history]).
// ES: Alternate phrasing, leaving out the guihint:
