...
:description: {CMK} can send notifications to the SIGNL4 alerting software for further processing. Find out here how to set up the connection.
...
+
. In the [.guihint]#{CMK} URL# field, enter the base URL of the REST API of your {CMK} site, e.g: `\https://mydomain/mysite/check_mk/api/v1/`.
