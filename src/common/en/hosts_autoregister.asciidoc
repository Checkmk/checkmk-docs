...
|`/var/lib/cmk-agent/pre_configured_connections.json` |Contains a pre-configured connection integrated into the agent package via the Agent Bakery to a site for the auto-registration from {CE} onwards.
|===
...
|`C:\ProgramData\checkmk\agentregistered_connections.json` |Contains a pre-configured connection integrated into the agent package via the Agent Bakery to a site for the auto-registration from {CE} onwards.
|===
