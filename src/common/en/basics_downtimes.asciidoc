...
:description: Scheduled downtimes must be taken into account in monitoring. Learn here how you can configure individual or repeated scheduled downtimes in {CMK}.
