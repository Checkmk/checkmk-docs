...
:description: In {CMK} and in the official {CMK} User Guide, you will frequently encounter certain terms and concepts. The most important terms are explained here.
...
The rule sets [.guihint]#Check period for hosts#, [.guihint]#Check period for active services# and [.guihint]#Check period for passive {CMK} services# serve this purpose.
