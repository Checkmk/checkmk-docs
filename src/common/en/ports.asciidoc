...
|5672 |TCP |Advanced Message Queuing Protocol (AMQP) |A message broker is needed for xref:piggyback#distributed_piggyback[Piggyback in distributed monitoring]
