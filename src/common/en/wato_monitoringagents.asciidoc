...
By the way, the https://docs.checkmk.com/saas/de/wato_monitoringagents.html[German version] of this article has already been updated -- if that is an alternative for you.
====
endif::[]
// delete to here
...
ifdef::saas[]
* Autoregistration in a specific folder (configuration required)
endif::[]
...
ifdef::saas[]
.In the Agent Bakery, you can download preconfigured agents for push mode and autoregistration
