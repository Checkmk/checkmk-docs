...
ifdef::onprem[]
image::gui.png[alt="The start page of {CE}.",fullscreen=1]
endif::[]
ifdef::saas[]
image::gui.png[alt="The start page of {CE}.",fullscreen=1]
endif::[]
...
[#livestatus]
To conclude this section, here is a brief digression for those interested in what happens behind the scenes at {CMK}:
...
If you enter your search term in the search field of the [.guihint]#Monitor# menu and submit it with kbd:[Enter], you will receive a view listing the hosts/services that match your search.
...
For example, entering `h: localhost s: mem s: cpu h: switch-intern` in the search field of the Monitor menu looks something like this as a Livestatus query on the command line:
...
Then enter the Livestatus query in the following blank line, as it was displayed in the {CMK} GUI: in the example, these are the following four lines.
...
image::setup_menu.png[alt="Setup menu in the navigation bar.",fullscreen=1]
endif::[]
ifdef::saas[]
.The [.guihint]#Setup# menu in show less mode
image::setup_menu_saas.png[alt="Setup menu in the navigation bar.",fullscreen=1]
endif::[]
