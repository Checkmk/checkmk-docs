...
ifdef::onprem[]
By the way -- with the command xref:piggyback#orphaned_piggyback_data[`cmk-piggyback list orphans`] you will find all of the piggybacked hosts for which there are data,
