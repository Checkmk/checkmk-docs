...
Eine detaillierte Anleitung, wie Sie die notwendigen Vorbereitungen in Ihrer Azure-Umgebung vornehmen können, finden Sie im Kapitel xref:#preparationp[Azure für {CMK} vorbereiten].
