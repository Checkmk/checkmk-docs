...
// This block replaces the following text
// start translation - NB: No text to translate here, simply replace these lines once the rest of the article is translated
////
...
// start translation - NB: No text to translate here, simply replace these lines once the rest of the article is translated
////
Finally, change the permissions of the files and directories created manually in this section so that xref:access[access rights on execution] are set correctly.
////
// end translation
// delete from here
...
To use the agent plug-in under Windows, you need PowerShell version 5.x or higher and also the following directories:
...
// This block replaces the following text
// start translation - NB: No text to translate here, simply replace these lines once the rest of the article has been translated
////
[#install_plugin]
...
// This block replaces the following text.
// start translation - NB: No text to translate here, simply replace this line once the rest of the article is translated
////
[#advanced_user]
////
// end translation
...
// start translation - NB: No text to translate here, just insert these lines here once the rest of the article is translated
////
[.tabs]
====
Linux, Solaris, AIX::
...
// start translation - NB: No text to translate here, simply insert these lines once the rest of the article is translated
////
...
// start translation - NB: No text to translate here, just insert these lines once the rest of the article is translated
////
[.tabs]
====
Linux, Solaris, AIX::
...
// start translation - NB: No text to translate here, simply insert these lines here once the rest of the article is translated
////
--
Windows::
+
...
// This block is to be replaced by changes inserted elsewhere in the article. Nothing to translate here, just delete the marked block
// delete from here
[#windows]
...
In addition, more options other than username or password can also be specified here
