...
|`/var/lib/cmk-agent/pre_configured_connections.json` |Contains a pre-configured connection to a site for the xref:hosts_autoregister#[auto-registration], integrated into the agent package via Agent Bakery.
