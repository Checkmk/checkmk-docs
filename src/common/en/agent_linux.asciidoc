...
By the way, the https://docs.checkmk.com/saas/de/agent_linux.html[German version] of this article has already been updated -- if that is an alternative for you.
====
endif::[]
// delete to here
...
[TIP]
====
The plugins can also be found on the {CMK} server under `~/share/check_mk/agents/plugins`.
====
endif::[]
