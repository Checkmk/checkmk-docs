...
This of course only applies for the {CE} if you have exceeded the limits of the "Free" license state.
...
As a user of the {CE} or {ME}, have {CMK} transfer your license information via online communication.
...
If you start with a {SE}, you initially simply activate your license.
...
.Offline submission of license information in the {SE}
image::license_offline_submission.png[alt="Page for offline submission of license information in the {SE}.", width=85%]
