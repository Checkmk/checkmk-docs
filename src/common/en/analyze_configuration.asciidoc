...
For the migration of even older (_legacy_) check plug-ins to Check-API V1, there is detailed information in link:https://checkmk.com/de/blog/migrating-check-plug-ins-to-checkmk-2-0[this blog article^].
