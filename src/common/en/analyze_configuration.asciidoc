...
:description: The 'Analyze configuration' tool enables you to check your {CMK} sites for performance, security, processor utilization and more.
...
|[.guihint]#Secure GUI (HTTP)# |
This check is currently only relevant for on-premises editions.
In {CE-saas}, the communication of the web frontend is secured using AWS WAF v2.
|===
endif::[]
