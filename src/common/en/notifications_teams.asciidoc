...
. Create new parameters for Mattermost with [.guihint]#Setup > Events >  Notifications > Parameters for notification methods > Parameters for Microsoft Teams > Add parameter.#
. Enter the copied URL under [.guihint]#Webhook URL#:
+
