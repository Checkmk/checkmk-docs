...
:description: Every manual has to be used in a specific way. Here we explain how the {CMK} User Guide is structured so that you can quickly find the relevant content.
:no-toc:
...
:description: Every manual has to be used in a specific way. Here we explain how the {CE} User Guide is structured so that you can find the relevant content.
:no-toc:
...
You can learn what makes {CE-saas} different in its xref:cce#[own article].
endif::[]
...
We invite you to have a look at our xref:ai_policy#[AI policy] to learn about our philosophy and practice concerning AI usage for the maintenance of the User Guide.
