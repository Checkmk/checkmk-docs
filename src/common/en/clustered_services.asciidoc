...
Complete the creation with [.guihint]#Save & view folder# and xref:glossar#activate_changes[activate the pending changes].
...
Finish creating the rule with [.guihint]#Save# and activate the pending changes.
...
Upon successful completion--indicated by the `Bulk discovery successful` message--exit and activate the pending changes.
