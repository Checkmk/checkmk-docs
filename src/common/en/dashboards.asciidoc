...
To add the Scheduled downtimes view, for example, call it up via [.guihint]#Monitor > Overview > Scheduled downtimes#.
Then add this view to your dashboard via [.guihint]#Export > Add to dashboard#

image::dashboard_example_10.png[width=55%, alt="Adding the planned scheduled downtimes to the dashboard."]

Select your dashboard.

image::dashboard_example_10a.png[alt="Select the dashboard."]
