...
| Server certificate 
| _Site certificate_ for, among other things, securing communication between the site (Agent Receiver) and host (Agent Controller). 
This is an SSL certificate and confirms the authenticity of the key for network communication.
