...
In general, any container runtime can be used, but to facilitate updates of the relay, we strongly recommend running on Podman and installing using the provided installation script.
