...
In the standard configuration (13 fetchers), you should expect memory requirements of approximately one gigabyte and a CPU utilization of less than 20% of one core on current hardware.
...
A {CMK} Relay that has been deployed weth the provided installation script keeps itself up to date automatically.
