...
There, click the button labeled [.guihint]#Add Relay configuration# to start the assistent for configuring a new relay.
...
Follow the instructions the assistent provides.
