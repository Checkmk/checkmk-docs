...
// ES: Don't describe the scenario in which the code was executed *after* showing the code and output. Instead, start with a description of what state the system is in, then show the code block
// MFS: Will differentiate later in the day with two sample outputs...
