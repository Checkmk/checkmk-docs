...
* *Additional features* -
The CMC makes use of numerous additional features, such as, e.g., recurring xref:basics_downtimes#[scheduled downtimes] and xref:basics_ackn#[acknowledgments] with automatic expiry times.
