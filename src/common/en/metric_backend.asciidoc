...
decided to initially use a column-based database as the metrics backend for OpenTelemetry data.
...
Currently, the metrics backend is used only for xref:opentelemetry#[OpenTelemetry metrics].
