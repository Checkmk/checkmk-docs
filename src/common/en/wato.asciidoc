...
durch das Aktivieren der Änderungen wird aus den Konfigurationsdateien eine neue Konfiguration für den Monitoring-Kern erzeugt und diesem der Befehl gegeben, diese Konfiguration ab sofort zu verwenden:
