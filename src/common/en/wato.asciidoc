...
:description: In {CMK}, you can configure the monitoring via the setup menu. Read here how to use the setup menu and activate changes.
...
when you activate the changes, a new configuration for the monitoring core is generated from the configuration files, 
