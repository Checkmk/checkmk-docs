...
{CCE-only}
For a convenient start into monitoring GCP, {CMK} ships from {CE} onwards the two built-in xref:glossar#dashboard[dashboards], [.guihint]#GCP GCE instances# and [.guihint]#GCP storage buckets#.
