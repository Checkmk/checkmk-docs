...
:description: In {CMK}, regular expressions can capture groups of strings. Here you will find an overview of the syntax of regular expressions.
...
[TIP]
====
In {CMK}, regular expressions are allowed in input fields on various pages.
...
[TIP]
====
If you need one of the characters `-`, `[` or `]`, you will have to use a trick.
