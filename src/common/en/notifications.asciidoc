...
You can select as the event a state change or the start of a xref:glossar#scheduled_downtime[scheduled downtime].
...
This allows you to see the environment variables and their values valid in the context of this notification. 
