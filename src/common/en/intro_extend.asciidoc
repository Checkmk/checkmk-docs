...
Here you work with several {CMK} sites that are interconnected to form a large system and which can be configured centrally in xref:glossar#distributed_setup[distributed setup] if required.
