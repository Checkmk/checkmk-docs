...
image::intro_really_acknowledge.png[alt="Dialog for confirmation of acknowledgment."]

&#8230; all the selected problems will be flagged as having been acknowledged.

Finally, a couple of tips:

* You can also remove an acknowledgment with the [.guihint]#Remove acknowledgement# button.
