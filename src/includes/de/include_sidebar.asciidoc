...
Zeigen Sie mit der Maus auf die untere rechte Ecke des Snapins, bis das icon:icon_delete[alt="Symbol für das Löschen."] Abfalleimer-Symbol erscheint, und klicken Sie auf das Symbol.
====
