...
// include_bookmarks_snapin wird genutzt in user_interface und intro_tools
...
image::gui_empty_bookmarks.png[alt="Das Snapin 'Bookmarks' noch ohne Lesezeichen.",width=50%]
...
.Das erste persönliche Lesezeichen im Snapin
image::gui_bookmarks.png[alt="Das Snapin 'Bookmarks' mit einem Lesezeichen.",width=50%]
