// include_appliance_cmk_install wird genutzt in appliance_usage und install_appliance_cmk (1 Level höher)
[#basics]
=== Grundsätzliches	
...
Die Installation von {CMK} läuft in der Appliance nicht wie auf normalen Rechnern über die Befehlszeile, sondern bequem über eine eigene Weboberfläche -- wie Sie im Folgenden sehen werden.
