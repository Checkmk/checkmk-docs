...
//SK: Im [.guihint]#Monitor#-Menü können Sie Hosts, Services und Ansichten (Views) suchen.

Im [.guihint]#Monitor#-Menü können Sie Hosts und Services suchen.
...
// Beschränkung auf 10 Ergebnisse gilt auch im Setup-Menü. Im Setup-Menü werden pro Kategorie max. 80 Einträge angezeigt.
