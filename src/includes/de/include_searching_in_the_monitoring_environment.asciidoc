...
.Interaktive Suche im [.guihint]#Monitor#-Menü
...
.[#search_tips]#Tipps für die Suche#
[%collapsible]
====
...
Drücken Sie nach Eingabe Ihres Suchbegriffs einfach die kbd:[Enter]-Taste und Sie erhalten in der Hauptseite das passende Ergebnis mit allen aufgelisteten Hosts bzw. Services.
