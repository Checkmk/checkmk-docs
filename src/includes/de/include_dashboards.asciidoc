...
//SK: Die Frage, wie es der CMK-Instanz geht beantwortet die SaaS m.E. an dieser Stelle nicht, weil sie nicht ja nicht selbst überwacht.
//SK: Die Hinweise auf das Dashboard "Checkmk" müssen m.E. weg.
//SK: Klar, wenn auf einem überwachten Host Checkmk läuft, dann würde das hier angezeigt, aber welchen Sinn ergäbe das?
...
ifdef::saas[]
das [.guihint]#Main#, das [.guihint]#Problem# und das [.guihint]#Checkmk# dashboard.
endif::[]
