// -*- coding: utf-8 -*-
// include_uninstall_rpm wird genutzt in install_packages_sles und install_packages_redhat
// IGNORE
// NONASCII
...
Für die Deinstallation bringt `omd` einen Wrapper mit, der unbenutzte {CMK}-Pakete xref:omd_basics#cleanup[findet und _nur_ diese deinstalliert].
