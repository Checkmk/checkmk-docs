...
// include_overview_snapin wird genutzt in user_interface und intro_tools

Prominent im oberen Bereich der Seitenleiste platziert finden Sie das Snapin [.guihint]#Overview#:

.Das Snapin [.guihint]#Overview# im Show-less-Modus
ifdef::onprem[]
image::gui_overview_less.png[alt="Das Snapin 'Overview' im Show-less-Modus.",width=50%]
endif::[]
ifdef::saas[]
image::gui_overview_less_saas.png[alt="Das Snapin Overview im Show-less-Modus.",width=50%]
endif::[]
...
ifdef::onprem[]
image::overview_more.png[alt="Das Snapin 'Overview' im Show-more-Modus.",width=50%]
endif::[]
ifdef::saas[]
image::overview_more_saas.png[alt="Das Snapin 'Overview' im Show-more-Modus.",width=50%]
endif::[]
...
In diesem Beispiel sind die Zahlen in der zweiten und dritten Spalte identisch, da noch kein Problem quittiert wurde.
