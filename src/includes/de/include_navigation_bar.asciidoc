...
// SK: Die Reihenfolge der Bescheibung ist derzeit - würde man von oben nach unten Durchnummerieren: 2. User > 3. Admin > 1. Help > 4. Sidebar
// SK: Ich sehe allerdings ein, das sich das in der GUI jederzeit ändern kann und wir da nicht bei jeder Änderung den Artikel umstellen wolle.
...
// SK: Ich bin für:
// SK: Der [.guihint]#Admin#-Knopf öffnet das xref:admin_panel#[Admin Panel] für die Verwaltung von {CE} in einem neuen Tab.
// SK: Oder:
// SK: Der mit dem Wort [.guihint]#Admin# beschriftete Knopf öffnet das xref:admin_panel#[Admin Panel] in einem neuen Tab.
endif::[]
