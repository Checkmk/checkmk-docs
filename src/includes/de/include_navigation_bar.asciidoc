...
// ML: Ich hätte es gerne vor "Im unteren Bereich ..." platziert, aber die Tabelle wird erst unter dem Screenshot gebaut, sieht nicht gut aus.
// TK: Ich hab das 1. ESC nach oben gezogen, weil es die Menünavigation abschließt. Die nächsten 4 dann nur für die Suche.
