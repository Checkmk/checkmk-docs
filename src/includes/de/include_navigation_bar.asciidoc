...
|===
|Kürzel |Aktion
|`ALT+m` |Öffnet [.guihint]#Monitor#-Menü
|`ALT+c` |Öffnet [.guihint]#Customize#-Menü
|`ALT+s` |Öffnet [.guihint]#Setup#-Menü
|`TAB` |Nächster Treffer in Suchergebnissen
|`UMSCHALT+TAB` |Voriger Treffer in Suchergebnissen
|`ENTER` |Suchtreffer aufrufen
|`ESC` |Mit aktivem Such-Term: Term löschen
|`ESC` |Ohne aktiven Such-Term: Menü schließen
|===
