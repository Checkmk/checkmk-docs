...
// Die Shortcuts zur Suche kommen eigentlich zu früh, da die Suche in beiden Artikeln später kommt. Aber dafür 2 Tabellen einzuführen, finde ich noch schlechter. 
