...
[discrete]
==== Übersicht der wichtigsten Tastaturbefehle

kbd:[Alt+M] öffnet das [.guihint]#Monitor#-Menü, kbd:[Alt+C] öffnet das [.guihint]#Customize#-Menü und kbd:[Alt+S] öffnet das [.guihint]#Setup#-Menü.

// SH: alte Syntax, von MFS im Code auskommentiert: [.tablecollapsible,cols="20,~",options="header"]

.[#tastaturbefehle]#Weitere Tastaturbefehle#
[%collapsible]
====
