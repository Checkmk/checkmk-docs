...
:psscript: source,powershell,subs="attributes+,+macros,+quotes"
// Bash script
...
// cmd.exe
:cmd: source,doscon,subs="attributes+,+macros,+quotes"
// Interactive python prompt, does not work well with copy button
:pycon: source,pycon,subs="attributes+,+macros,+quotes"
