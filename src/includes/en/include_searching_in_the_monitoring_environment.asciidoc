...
so as soon as you have typed something, you will immediately see the results matching your input below the search field:
...
After entering your search term, simply press the kbd:[Enter] key and you will receive the appropriate result on the main page in the form of a list of all hosts and/or services.
