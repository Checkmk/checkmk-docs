...
ifdef::onprem[]
.View of service problems on the main page
image::gui_view_service_problems.png[alt="'Service problems' view."]
endif::[]
ifdef::saas[]
image::gui_view_service_problems_saas.png[alt="'Service problems' view."]
endif::[]
...
[.guihint]#Entries per row# lets you choose in how many tables the objects are displayed next to each other in the view (e.g. to make full use of your wide screen).
In the example above the value is set to `1`.
