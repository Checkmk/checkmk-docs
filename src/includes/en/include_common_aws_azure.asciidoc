...
Alternatively, you can combine the push mode with pre-configured agent packages for the xref:hosts_autoregister#[auto-registration] to further increase convenience.
