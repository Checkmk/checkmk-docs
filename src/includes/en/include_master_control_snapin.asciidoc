...
image::gui_master_control.png[alt="'Master control' snap-in of {RE}.",width=50%]
endif::[]
ifdef::saas[]
...
[TIP]
====
Make sure that all switches are turned on during normal operation, otherwise important monitoring functions may be switched off.
====