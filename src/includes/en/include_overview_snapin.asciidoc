...
Prominently placed in in the upper area of the sidebar you will find the [.guihint]#Overview# snap-in:
...
By the way, problems of services whose hosts are {DOWN} or in a xref:glossar#scheduled_downtime[scheduled downtime] are not counted here.
...
In this example, the numbers in the second and third columns are identical because we have not yet acknowledged any problem.
