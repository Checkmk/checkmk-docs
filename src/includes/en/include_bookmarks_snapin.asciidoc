...
.Empty bookmark list
image::gui_empty_bookmarks.png[alt="The 'Bookmarks' snap-in still without bookmarks.",width=50%]
...
.The first personal bookmark in the snap-in
image::gui_bookmarks.png[alt="The 'Bookmarks' snap-in with one bookmark.",width=50%]
