...
[horizontal]
link:contrib/intro.adoc[*Einleitung*]:: Grundprinzipien dazu, wie wir uns eine gute Dokumention vorstellen.
link:contrib/git.adoc[*Aufbau des Git*]:: Hier wird beschrieben, wie der Aufbau dieses Repository gedacht ist.
link:contrib/guide.adoc[*Leitfaden zum Schreiben*]:: Best-Practices und Hilfestellungen zum Schreiben, um selbst an der Dokumentation mitzuwirken.
link:contrib/dev.adoc[*Hilfe zur Entwicklungsumgebung*]:: Anleitungen für die Arbeit mit Code Editoren und zum lokalen konvertieren nach HTML
